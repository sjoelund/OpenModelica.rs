...
fn fun_52(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_includes: Tpl::Text, mut in_a_functionPrototypes: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    ...
    (out_txt, out_a_includes, out_a_functionPrototypes) = (match (in_txt, in_a_simCode, in_a_includes, in_a_functionPrototypes) {
        (mut txt, ref i_simCode @ SimCode::SimCode { fileNamePrefix: ref i_fileNamePrefix, fullPathPrefix: ref i_fullPathPrefix, modelInfo: SimCode::ModelInfo { functions: _, varInfo: SimCode::VarInfo { numZeroCrossings: ref i_varInfo_numZeroCrossings, .. }, name: ref i_modelInfo_name, .. }, timeEvents: ref i_timeEvents, .. }, mut a_includes, mut a_functionPrototypes) => {
            ...
            a_includes = Tpl::writeTok(a_includes.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            a_includes = fun_51(a_includes.clone(), i_varInfo_numZeroCrossings.clone())?;
            l_headerFileName = Tpl::writeStr(Tpl::emptyTxt.clone(), (i_fileNamePrefix.clone()).clone())?;
            l_headerFileName = Tpl::writeTok(l_headerFileName, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_omsic")).clone() }))?;
            ...
            txt_3 = Tpl::writeTok(txt_3, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/")).clone() }))?;
            txt_3 = Tpl::writeText(txt_3, l_headerFileName)?;
            txt_3 = Tpl::writeTok(txt_3, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".h")).clone() }))?;
            Tpl::textFile(l_headerFileContent, (Tpl::textString(txt_3)?).clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_modelNamePrefixStr)?;
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("}\n")).clone(), (literal!("\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::writeText(txt.clone(), l_functionInitSampleCode)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
...
fn fun_54(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_InitDerMatFiles: Tpl::Text, mut in_a_fileNamePrefix: ArcStr, mut in_a_InitAlgSystemFiles: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
...
fn fun_58(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_SimDerMatFiles: Tpl::Text, mut in_a_SimAlgSystemFiles: Tpl::Text, mut in_a_InitDerMatFiles: Tpl::Text, mut in_a_InitAlgSystemFiles: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_SimDerMatFiles, out_a_SimAlgSystemFiles, out_a_InitDerMatFiles, out_a_InitAlgSystemFiles) = (::match_deref::match_deref! { match &((in_txt, in_a_simCode, in_a_SimDerMatFiles, in_a_SimAlgSystemFiles, in_a_InitDerMatFiles, in_a_InitAlgSystemFiles)) {
        (txt, SimCode::SimCode { fileNamePrefix: i_fileNamePrefix, omsiData: Some(SimCode::OMSIData { simulation: Deref @ SimCode::OMSIFunction { equations: i_simulation_equations, .. }, initialization: Deref @ SimCode::OMSIFunction { equations: i_initialization_equations, .. } }), .. }, a_SimDerMatFiles, a_SimAlgSystemFiles, a_InitDerMatFiles, a_InitAlgSystemFiles) => {
            ...
            let mut a_InitDerMatFiles = (*a_InitDerMatFiles).clone();
            let mut a_InitAlgSystemFiles = (*a_InitAlgSystemFiles).clone();
            (l_0__, a_InitDerMatFiles, a_InitAlgSystemFiles) = lm_55(Tpl::emptyTxt.clone(), i_initialization_equations.clone(), a_InitDerMatFiles.clone(), (i_fileNamePrefix.clone()).clone(), a_InitAlgSystemFiles.clone())?;
            (l_0___1, a_SimDerMatFiles, a_SimAlgSystemFiles) = lm_57(Tpl::emptyTxt.clone(), i_simulation_equations.clone(), a_SimDerMatFiles.clone(), (i_fileNamePrefix.clone()).clone(), a_SimAlgSystemFiles.clone())?;
...
fn fun_70(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fileNamePrefix: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_fileNamePrefix) {
        ...
        (mut txt, _, mut a_fileNamePrefix) => {
            ...
            txt = fun_69(txt.clone(), (ret_0).clone(), (a_fileNamePrefix.clone()).clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_71(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_SimDerMatFiles: Tpl::Text, mut in_a_SimAlgSystemFiles: Tpl::Text, mut in_a_InitDerMatFiles: Tpl::Text, mut in_a_InitAlgSystemFiles: Tpl::Text) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode, in_a_SimDerMatFiles, in_a_SimAlgSystemFiles, in_a_InitDerMatFiles, in_a_InitAlgSystemFiles) {
        (mut txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { name: _, .. }, makefileParams: SimCodeFunction::MakefileParams { platform: mut i_makefileParams_platform, omhome: mut i_makefileParams_omhome, ccompiler: mut i_makefileParams_ccompiler, cxxcompiler: mut i_makefileParams_cxxcompiler, exeext: mut i_makefileParams_exeext, dllext: mut i_makefileParams_dllext, .. }, simulationSettingsOpt: _, fileNamePrefix: mut i_fileNamePrefix, fmuTargetName: mut i_fmuTargetName, .. }, mut a_SimDerMatFiles, mut a_SimAlgSystemFiles, mut a_InitDerMatFiles, mut a_InitAlgSystemFiles) => {
            ...
            l_includedir = Tpl::writeTok(l_includedir, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".fmutmp/sources/include/")).clone() }))?;
            l_mkdir = fun_59(Tpl::emptyTxt.clone(), (i_makefileParams_platform.clone()).clone())?;
            l_OMLibs = fun_60(Tpl::emptyTxt.clone(), (i_makefileParams_platform.clone()).clone())?;
            l_lapackDirWin = fun_61(Tpl::emptyTxt.clone(), (i_makefileParams_platform.clone()).clone())?;
            l_libEnding = fun_62(Tpl::emptyTxt.clone(), (i_makefileParams_platform.clone()).clone())?;
            l_rpath = fun_63(Tpl::emptyTxt.clone(), (i_makefileParams_platform.clone()).clone())?;
            l_fPIC = fun_64(Tpl::emptyTxt.clone(), (i_makefileParams_platform.clone()).clone())?;
            ...
            txt = Tpl::writeStr(txt.clone(), (i_makefileParams_omhome.clone()).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_OMLibs)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_fPIC)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_lapackDirWin)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("LAPACK_LIB=")).clone() }))?;
            txt = fun_65(txt.clone(), (i_makefileParams_platform.clone()).clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = fun_68(txt.clone(), (i_makefileParams_platform.clone()).clone(), l_libEnding)?;
            ...
            txt = fun_70(txt.clone(), ret_10, (i_fileNamePrefix.clone()).clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_includedir)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\t")).clone() }))?;
            ...
            txt = Tpl::writeText(txt.clone(), l_rpath)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\t")).clone() }))?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("cp -a ")).clone() }))?;
            txt = Tpl::writeStr(txt.clone(), (i_fileNamePrefix.clone()).clone())?;
...
fn fun_73(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_InitDerMatFiles: Tpl::Text, mut in_a_FileNamePrefix: ArcStr, mut in_a_InitAlgSystemFiles: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_InitDerMatFiles: Tpl::Text;
    let mut out_a_InitAlgSystemFiles: Tpl::Text;
    (out_txt, out_a_InitDerMatFiles, out_a_InitAlgSystemFiles) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_InitDerMatFiles, in_a_FileNamePrefix, in_a_InitAlgSystemFiles)) {
...
fn fun_77(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_SimDerMatFiles: Tpl::Text, mut in_a_SimAlgSystemFiles: Tpl::Text, mut in_a_InitDerMatFiles: Tpl::Text, mut in_a_FileNamePrefix: ArcStr, mut in_a_InitAlgSystemFiles: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_SimDerMatFiles, out_a_SimAlgSystemFiles, out_a_InitDerMatFiles, out_a_InitAlgSystemFiles) = (::match_deref::match_deref! { match &((in_txt, in_a_simCode, in_a_SimDerMatFiles, in_a_SimAlgSystemFiles, in_a_InitDerMatFiles, in_a_FileNamePrefix, in_a_InitAlgSystemFiles)) {
        (txt, SimCode::SimCode { omsiData: Some(SimCode::OMSIData { simulation: Deref @ SimCode::OMSIFunction { equations: i_simulation_equations, .. }, initialization: Deref @ SimCode::OMSIFunction { equations: i_initialization_equations, .. } }), .. }, a_SimDerMatFiles, a_SimAlgSystemFiles, a_InitDerMatFiles, a_FileNamePrefix, a_InitAlgSystemFiles) => {
            ...
            let mut a_InitDerMatFiles = (*a_InitDerMatFiles).clone();
            let mut a_InitAlgSystemFiles = (*a_InitAlgSystemFiles).clone();
            (l_0__, a_InitDerMatFiles, a_InitAlgSystemFiles) = lm_74(Tpl::emptyTxt.clone(), i_initialization_equations.clone(), a_InitDerMatFiles.clone(), (a_FileNamePrefix.clone()).clone(), a_InitAlgSystemFiles.clone())?;
            (l_0___1, a_SimDerMatFiles, a_SimAlgSystemFiles) = lm_76(Tpl::emptyTxt.clone(), i_simulation_equations.clone(), a_SimDerMatFiles.clone(), (a_FileNamePrefix.clone()).clone(), a_SimAlgSystemFiles.clone())?;
            (txt.clone(), a_SimDerMatFiles.clone(), a_SimAlgSystemFiles.clone(), a_InitDerMatFiles.clone(), a_InitAlgSystemFiles.clone())
        },
...
fn fun_88(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_common: Tpl::Text, mut in_a_FMUVersion: Tpl::Text) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode, in_a_common, in_a_FMUVersion) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { directory: ref i_modelInfo_directory, .. }, makefileParams: SimCodeFunction::MakefileParams { libs: ref i_makefileParams_libs, platform: ref i_makefileParams_platform, omhome: ref i_makefileParams_omhome, .. }, simulationSettingsOpt: ref i_sopt, fileNamePrefix: ref i_fileNamePrefix, fmuTargetName: ref i_fmuTargetName, .. }, mut a_common, mut a_FMUVersion) => {
            ...
            l_dirExtra = fun_79(Tpl::emptyTxt.clone(), (i_modelInfo_directory.clone()).clone())?;
            ...
            l_libsStr = lm_80(l_libsStr, i_makefileParams_libs.clone())?;
            l_libsStr = Tpl::popIter(l_libsStr)?;
            l_libsPos1 = fun_81(Tpl::emptyTxt.clone(), l_dirExtra.clone(), l_libsStr.clone())?;
            l_libsPos2 = fun_82(Tpl::emptyTxt.clone(), l_dirExtra.clone(), l_libsStr)?;
            ...
            l_extraCflags = fun_84(Tpl::emptyTxt.clone(), i_sopt.clone())?;
            txt_7 = CodegenUtilSimulation::modelNamePrefix(Tpl::emptyTxt.clone(), i_simCode.clone())?;
            l_compilecmds = CodegenFMU::getPlatformString2(Tpl::emptyTxt.clone(), (Tpl::textString(txt_7)?).clone(), (i_makefileParams_platform.clone()).clone(), (i_fileNamePrefix.clone()).clone(), (i_fmuTargetName.clone()).clone(), (Tpl::textString(l_dirExtra.clone())?).clone(), (Tpl::textString(l_libsPos1.clone())?).clone(), (Tpl::textString(l_libsPos2.clone())?).clone(), (i_makefileParams_omhome.clone()).clone(), (Tpl::textString(a_FMUVersion.clone())?).clone())?;
            l_mkdir = fun_85(Tpl::emptyTxt.clone(), (i_makefileParams_platform.clone()).clone())?;
            ...
            txt = fun_86(txt.clone(), ret_9, (i_makefileParams_omhome.clone()).clone())?;
...
fn fun_98(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_common: Tpl::Text, mut in_a_FMUVersion: Tpl::Text) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode, in_a_common, in_a_FMUVersion) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { varInfo: SimCode::VarInfo { numLinearSystems: ref i_varInfo_numLinearSystems, numNonLinearSystems: ref i_varInfo_numNonLinearSystems, numMixedSystems: ref i_varInfo_numMixedSystems, numStringAlgVars: ref i_varInfo_numStringAlgVars, .. }, directory: ref i_modelInfo_directory, .. }, delayedExps: SimCode::DelayedExpression { maxDelayedIndex: ref i_maxDelayedIndex, .. }, makefileParams: SimCodeFunction::MakefileParams { libs: ref i_makefileParams_libs, platform: ref i_makefileParams_platform, omhome: ref i_makefileParams_omhome, includes: ref i_makefileParams_includes, .. }, simulationSettingsOpt: ref i_sopt, fileNamePrefix: ref i_fileNamePrefix, fmuTargetName: ref i_fmuTargetName, .. }, mut a_common, mut a_FMUVersion) => {
            ...
            let mut l_libsStr: Tpl::Text;
            let mut l_dirExtra: Tpl::Text;
            l_dirExtra = fun_89(Tpl::emptyTxt.clone(), (i_modelInfo_directory.clone()).clone())?;
            l_libsStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            l_libsStr = lm_90(l_libsStr, i_makefileParams_libs.clone())?;
            l_libsStr = Tpl::popIter(l_libsStr)?;
            l_libsPos1 = fun_91(Tpl::emptyTxt.clone(), l_dirExtra.clone(), l_libsStr.clone())?;
            l_libsPos2 = fun_92(Tpl::emptyTxt.clone(), l_dirExtra.clone(), l_libsStr)?;
            l_extraCflags = fun_94(Tpl::emptyTxt.clone(), i_sopt.clone())?;
            txt_6 = CodegenUtilSimulation::modelNamePrefix(Tpl::emptyTxt.clone(), i_simCode.clone())?;
            l_compilecmds = CodegenFMU::getPlatformString2(Tpl::emptyTxt.clone(), (Tpl::textString(txt_6)?).clone(), (i_makefileParams_platform.clone()).clone(), (i_fileNamePrefix.clone()).clone(), (i_fmuTargetName.clone()).clone(), (Tpl::textString(l_dirExtra)?).clone(), (Tpl::textString(l_libsPos1)?).clone(), (Tpl::textString(l_libsPos2)?).clone(), (i_makefileParams_omhome.clone()).clone(), (Tpl::textString(a_FMUVersion.clone())?).clone())?;
            ...
            txt = lm_96(txt.clone(), i_makefileParams_includes.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
            ret_9 = Flags::isSet(Flags::FMU_EXPERIMENTAL.clone())?;
            txt = fun_97(txt.clone(), ret_9)?;
...
fn fun_99(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_target: ArcStr, mut in_a_common: Tpl::Text, mut in_a_FMUVersion: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_target, in_a_common, in_a_FMUVersion, in_a_simCode)) {
        ...
        (txt, Deref @ "gcc", _, a_common, a_FMUVersion, a_simCode) => {
            let mut txt = (*txt).clone();
            txt = fun_98(txt.clone(), a_simCode.clone(), a_common.clone(), a_FMUVersion.clone())?;
            txt.clone()
        },
        (txt, _, a_target, _, _, _) => {
            ...
            txt = CodegenUtil::error(txt.clone(), Tpl::sourceInfo((literal!("CodegenOMSIC.tpl")).clone(), 469, 25), (Tpl::textString(txt_0)?).clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
