...
pub static MODELICA_BUILTIN: &str = include_str!("builtins/ModelicaBuiltin.mo");
/// `NFModelicaBuiltin.mo` — the new-frontend variant of the Modelica builtins.
pub static NF_MODELICA_BUILTIN: &str = include_str!("builtins/NFModelicaBuiltin.mo");
/// `MetaModelicaBuiltin.mo` — the MetaModelica builtin operators/types.
pub static META_MODELICA_BUILTIN: &str = include_str!("builtins/MetaModelicaBuiltin.mo");
...
/// instantiation.
pub static ANNOTATIONS_BUILTIN_1_X: &str = include_str!("builtins/AnnotationsBuiltin_1_x.mo");
pub static ANNOTATIONS_BUILTIN_2_X: &str = include_str!("builtins/AnnotationsBuiltin_2_x.mo");
pub static ANNOTATIONS_BUILTIN_3_X: &str = include_str!("builtins/AnnotationsBuiltin_3_x.mo");
