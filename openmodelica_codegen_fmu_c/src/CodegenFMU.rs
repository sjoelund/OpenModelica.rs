...
use openmodelica_codegen_fmu::CodegenFMU1;
...
fn fun_54(mut in_txt: Tpl::Text, mut in_a_sc_fmiSimulationFlags: Option<SimCode::FmiSimulationFlags>, mut in_a_fileNamePrefix: ArcStr, mut in_a_fileNamePrefixHash: Tpl::Text) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_sc_fmiSimulationFlags, in_a_fileNamePrefix, in_a_fileNamePrefixHash) {
...
pub(crate) fn generateSimulationFiles(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_guid: ArcStr, mut in_a_modelNamePrefix: ArcStr, mut in_a_fmuVersion: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode, in_a_guid, in_a_modelNamePrefix, in_a_fmuVersion) {
...
fn fun_57(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_sourceFiles: Arc<metamodelica::List<ArcStr>>, mut in_a_FMUType: ArcStr, mut in_a_guid: ArcStr, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_sourceFiles, in_a_FMUType, in_a_guid, in_a_simCode)) {
...
pub fn fmuModelDescriptionFile(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_guid: ArcStr, mut in_a_FMUVersion: ArcStr, mut in_a_FMUType: ArcStr, mut in_a_sourceFiles: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_simCode, in_a_guid, in_a_FMUVersion, in_a_FMUType, in_a_sourceFiles)) {
...
fn lm_59(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<(ArcStr, ArcStr)>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_59 in &*items {
        let mut lstElt_59 = lstElt_59.clone();
        txt = (match lstElt_59.clone() {
        (mut i_name, mut i_value) => {
...
pub(crate) fn fmuSimulationFlagsFile(mut in_txt: Tpl::Text, mut in_a_fmiSimulationFlags: SimCode::FmiSimulationFlags) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmiSimulationFlags) {
...
pub(crate) fn VendorAnnotations(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_62(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_simCode) {
...
fn fun_65(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_guid: ArcStr, mut in_a_FMUVersion: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode, in_a_guid, in_a_FMUVersion) {
...
pub(crate) fn fmumodel_identifierHeaderFile(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_guid: ArcStr, mut a_FMUVersion: ArcStr, mut a_FMUType: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_65(txt, a_simCode, (a_guid).clone(), (a_FMUVersion).clone())?;
    Ok(out_txt)
}
...
fn fun_67(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_FMUType: ArcStr, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_FMUType, in_a_modelInfo, in_a_simCode) {
...
pub(crate) fn fmumodel_identifierFile(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_guid: ArcStr, mut a_FMUVersion: ArcStr, mut a_FMUType: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_68(txt, a_simCode, (a_FMUVersion).clone(), (a_FMUType).clone())?;
    Ok(out_txt)
}
...
fn fun_70(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_listStates: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut in_a_varInfo_numStateVars: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_listStates, in_a_varInfo_numStateVars)) {
...
fn fun_71(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_simCode: SimCode::SimCode, mut in_a_name: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_simCode, in_a_name)) {
...
fn lm_72(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_72 in &*items {
        let mut lstElt_72 = lstElt_72.clone();
        txt = (match lstElt_72.clone() {
...
fn lm_74(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_74 in &*items {
        let mut lstElt_74 = lstElt_74.clone();
        txt = (match lstElt_74.clone() {
        SimCodeVar::SimVar { name: ref i_name, .. } => {
            let mut ret_1: bool;
            let mut txt_0: Tpl::Text;
            txt_0 = CodegenUtil::crefStr(Tpl::emptyTxt.clone(), i_name.clone())?;
...
fn lm_75(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<Arc<SimCodeFunction::Function::Function>>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_75 in &*items {
        let mut lstElt_75 = lstElt_75.clone();
        txt = (::match_deref::match_deref! { match &(lstElt_75.clone()) {
        i_fn => {
...
fn fun_76(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_modelInfo, in_a_simCode)) {
        (txt, SimCode::ModelInfo { varInfo: SimCode::VarInfo { numStateVars: i_varInfo_numStateVars, numDiscreteReal: i_varInfo_numDiscreteReal, numAlgVars: i_varInfo_numAlgVars, numParams: i_varInfo_numParams, numAlgAliasVars: i_varInfo_numAlgAliasVars, numIntAlgVars: i_varInfo_numIntAlgVars, numIntParams: i_varInfo_numIntParams, numIntAliasVars: i_varInfo_numIntAliasVars, numStringAlgVars: i_varInfo_numStringAlgVars, numStringParamVars: i_varInfo_numStringParamVars, numStringAliasVars: i_varInfo_numStringAliasVars, numBoolAlgVars: i_varInfo_numBoolAlgVars, numBoolParams: i_varInfo_numBoolParams, numBoolAliasVars: i_varInfo_numBoolAliasVars, numRealInputVars: i_varInfo_numRealInputVars, numZeroCrossings: i_varInfo_numZeroCrossings, .. }, vars: SimCodeVar::SimVars { stateVars: i_vars_stateVars @ i_listStates, derivativeVars: i_vars_derivativeVars, .. }, functions: i_functions, .. }, a_simCode) => {
            ...
            txt = lm_72(txt.clone(), i_vars_stateVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!(" }\n")).clone(), (literal!("#define STATESDERIVATIVES { ")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_74(txt.clone(), i_vars_derivativeVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!(" }\n")).clone(), (literal!("\n")).clone()], lastHasNewLine: true }))?;
            ...
            txt = lm_75(txt.clone(), i_functions.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt.clone()
        },
        (txt, _, _) => {
...
pub(crate) fn ModelDefineData(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_76(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

pub(crate) fn dervativeNameCStyle(mut in_txt: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn lm_80(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_81(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_89(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
pub(crate) fn setDefaultStartValues(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo) {
        (mut txt, SimCode::ModelInfo { varInfo: SimCode::VarInfo { numStateVars: _, numAlgVars: _, .. }, vars: SimCodeVar::SimVars { stateVars: ref i_vars_stateVars, derivativeVars: ref i_vars_derivativeVars, algVars: ref i_vars_algVars, discreteAlgVars: ref i_vars_discreteAlgVars, intAlgVars: ref i_vars_intAlgVars, boolAlgVars: ref i_vars_boolAlgVars, stringAlgVars: ref i_vars_stringAlgVars, paramVars: ref i_vars_paramVars, intParamVars: ref i_vars_intParamVars, boolParamVars: ref i_vars_boolParamVars, stringParamVars: ref i_vars_stringParamVars, .. }, .. }) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_80(txt.clone(), i_vars_stateVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_81(txt.clone(), i_vars_derivativeVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_82(txt.clone(), i_vars_algVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_83(txt.clone(), i_vars_discreteAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_84(txt.clone(), i_vars_intAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_85(txt.clone(), i_vars_boolAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_86(txt.clone(), i_vars_stringAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_87(txt.clone(), i_vars_paramVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_88(txt.clone(), i_vars_intParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_89(txt.clone(), i_vars_boolParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_90(txt.clone(), i_vars_stringParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}")).clone() }))?;
...
fn lm_92(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_92 in &*items {
...
fn lm_93(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_93 in &*items {
...
fn lm_101(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_101 in &*items {
...
fn lm_102(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_102 in &*items {
...
pub(crate) fn setStartValues(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo) {
        (mut txt, SimCode::ModelInfo { varInfo: SimCode::VarInfo { numStateVars: _, numAlgVars: _, .. }, vars: SimCodeVar::SimVars { stateVars: ref i_vars_stateVars, derivativeVars: ref i_vars_derivativeVars, algVars: ref i_vars_algVars, discreteAlgVars: ref i_vars_discreteAlgVars, intAlgVars: ref i_vars_intAlgVars, boolAlgVars: ref i_vars_boolAlgVars, stringAlgVars: ref i_vars_stringAlgVars, paramVars: ref i_vars_paramVars, intParamVars: ref i_vars_intParamVars, boolParamVars: ref i_vars_boolParamVars, stringParamVars: ref i_vars_stringParamVars, .. }, .. }) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_92(txt.clone(), i_vars_stateVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_93(txt.clone(), i_vars_derivativeVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_94(txt.clone(), i_vars_algVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_95(txt.clone(), i_vars_discreteAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_96(txt.clone(), i_vars_intAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_97(txt.clone(), i_vars_boolAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_98(txt.clone(), i_vars_stringAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_99(txt.clone(), i_vars_paramVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_100(txt.clone(), i_vars_intParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_101(txt.clone(), i_vars_boolParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_102(txt.clone(), i_vars_stringParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("}\n")).clone(), (literal!("\n")).clone()], lastHasNewLine: true }))?;
...
fn lm_104(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut a_sub: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut txt: Tpl::Text = txt;
    let mut a_sub: Tpl::Text = a_sub;
    for mut lstElt_104 in &*items {
        let mut lstElt_104 = lstElt_104.clone();
        (txt, a_sub) = (::match_deref::match_deref! { match &(lstElt_104.clone()) {
        Deref @ SimCode::SimEqSystem::SES_SIMPLE_ASSIGN { cref: i_cref, .. } => {
            let mut ret_1: ArcStr;
            let mut txt_0: Tpl::Text;
...
pub(crate) fn initializeFunction(mut txt: Tpl::Text, mut a_allEquations: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("// Used to set the first time event, if any.\n")).clone(), (literal!("void initialize(ModelInstance* comp, fmiEventInfo* eventInfo) {\n")).clone(), (literal!("\n")).clone()], lastHasNewLine: true }))?;
    ...
    (out_txt, l_sub) = lm_104(out_txt, a_allEquations, l_sub)?;
...
fn fun_106(mut in_txt: Tpl::Text, mut in_a_type__: Arc<DAE::Type>, mut in_a_var_index: i32, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_type__, in_a_var_index, in_a_arrayName)) {
...
fn fun_107(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_var_index: i32, mut in_a_arrayName: ArcStr, mut in_a_type__: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_var_index, in_a_arrayName, in_a_type__)) {
        (txt, false, a_var_index, a_arrayName, a_type__) => {
            let mut txt = (*txt).clone();
            txt = fun_106(txt.clone(), a_type__.clone(), a_var_index.clone(), (a_arrayName.clone()).clone())?;
            txt.clone()
        },
        (txt, _, _, _, _) => {
            txt.clone()
...
fn fun_108(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_var_index: i32, mut in_a_arrayName: ArcStr, mut in_a_type__: Arc<DAE::Type>, mut in_a_name: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_var_index, in_a_arrayName, in_a_type__, in_a_name)) {
...
pub(crate) fn initVals(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub(crate) fn initParams(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var, in_a_arrayName)) {
...
pub(crate) fn initValsDefault(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var, in_a_arrayName)) {
...
pub(crate) fn initParamsDefault(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var, in_a_arrayName)) {
        ...
        (txt, SimCodeVar::SimVar { index: i_index, type_: Deref @ DAE::Type::T_STRING { varLst: _ }, initialValue: Some(i_v @ Deref @ DAE::Exp::SCONST { string: _ }), .. }, a_arrayName) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("comp->fmuData->modelData->")).clone() }))?;
            txt = Tpl::writeStr(txt.clone(), (a_arrayName.clone()).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("Data[")).clone() }))?;
...
fn fun_113(mut in_txt: Tpl::Text, mut in_a_var_type__: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var_type__)) {
...
fn fun_114(mut in_txt: Tpl::Text, mut in_a_var_initialValue: Option<Arc<DAE::Exp>>, mut in_a_var_type__: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var_initialValue, in_a_var_type__)) {
        ...
        (txt, _, a_var_type__) => {
            let mut txt = (*txt).clone();
            txt = fun_113(txt.clone(), a_var_type__.clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub(crate) fn initValDefault(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub(crate) fn eventUpdateFunction(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, SimCode::SimCode { modelInfo: _, .. }) => {
...
fn lm_119(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_119 in &*items {
        let mut lstElt_119 = lstElt_119.clone();
        txt = (match lstElt_119.clone() {
        mut i_var => {
...
fn lm_120(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_120 in &*items {
        let mut lstElt_120 = lstElt_120.clone();
        txt = (match lstElt_120.clone() {
        mut i_var => {
            txt = SwitchVars(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("realVars")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_121(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_121 in &*items {
...
fn lm_122(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_122 in &*items {
...
fn lm_123(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_123 in &*items {
        let mut lstElt_123 = lstElt_123.clone();
        txt = (match lstElt_123.clone() {
        mut i_var => {
...
fn lm_124(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn fun_125(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { stateVars: ref i_vars_stateVars, derivativeVars: ref i_vars_derivativeVars, algVars: ref i_vars_algVars, discreteAlgVars: ref i_vars_discreteAlgVars, paramVars: ref i_vars_paramVars, aliasVars: ref i_vars_aliasVars, .. }, varInfo: SimCode::VarInfo { numStateVars: _, numAlgVars: _, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_119(txt.clone(), i_vars_stateVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_120(txt.clone(), i_vars_derivativeVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_121(txt.clone(), i_vars_algVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_122(txt.clone(), i_vars_discreteAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_123(txt.clone(), i_vars_paramVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_124(txt.clone(), i_vars_aliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn getRealFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_125(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_127(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_128(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_129(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_129 in &*items {
...
fn lm_130(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_130 in &*items {
...
fn lm_131(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_132(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_132 in &*items {
...
fn fun_133(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { stateVars: ref i_vars_stateVars, derivativeVars: ref i_vars_derivativeVars, algVars: ref i_vars_algVars, discreteAlgVars: ref i_vars_discreteAlgVars, paramVars: ref i_vars_paramVars, aliasVars: ref i_vars_aliasVars, .. }, varInfo: SimCode::VarInfo { numStateVars: _, numAlgVars: _, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_127(txt.clone(), i_vars_stateVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_128(txt.clone(), i_vars_derivativeVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_129(txt.clone(), i_vars_algVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_130(txt.clone(), i_vars_discreteAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_131(txt.clone(), i_vars_paramVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_132(txt.clone(), i_vars_aliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn setRealFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_133(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_135(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_135 in &*items {
...
fn lm_136(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_137(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_137 in &*items {
        let mut lstElt_137 = lstElt_137.clone();
        txt = (match lstElt_137.clone() {
        mut i_var => {
...
fn fun_138(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { intAlgVars: ref i_vars_intAlgVars, intParamVars: ref i_vars_intParamVars, intAliasVars: ref i_vars_intAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_135(txt.clone(), i_vars_intAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_136(txt.clone(), i_vars_intParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_137(txt.clone(), i_vars_intAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return 0;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn getIntegerFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_138(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_140(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_141(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_141 in &*items {
        let mut lstElt_141 = lstElt_141.clone();
        txt = (match lstElt_141.clone() {
        mut i_var => {
...
fn lm_142(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_142 in &*items {
        let mut lstElt_142 = lstElt_142.clone();
        txt = (match lstElt_142.clone() {
        mut i_var => {
...
fn fun_143(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { intAlgVars: ref i_vars_intAlgVars, intParamVars: ref i_vars_intParamVars, intAliasVars: ref i_vars_intAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_140(txt.clone(), i_vars_intAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_141(txt.clone(), i_vars_intParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_142(txt.clone(), i_vars_intAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return fmiError;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn setIntegerFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_143(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_145(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_145 in &*items {
        let mut lstElt_145 = lstElt_145.clone();
        txt = (match lstElt_145.clone() {
        mut i_var => {
...
fn lm_146(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_146 in &*items {
        let mut lstElt_146 = lstElt_146.clone();
        txt = (match lstElt_146.clone() {
        mut i_var => {
...
fn lm_147(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn fun_148(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { boolAlgVars: ref i_vars_boolAlgVars, boolParamVars: ref i_vars_boolParamVars, boolAliasVars: ref i_vars_boolAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_145(txt.clone(), i_vars_boolAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_146(txt.clone(), i_vars_boolParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_147(txt.clone(), i_vars_boolAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn getBooleanFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_148(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_150(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_150 in &*items {
        let mut lstElt_150 = lstElt_150.clone();
        txt = (match lstElt_150.clone() {
        mut i_var => {
...
fn lm_151(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_151 in &*items {
        let mut lstElt_151 = lstElt_151.clone();
        txt = (match lstElt_151.clone() {
        mut i_var => {
...
fn lm_152(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_152 in &*items {
        let mut lstElt_152 = lstElt_152.clone();
        txt = (match lstElt_152.clone() {
        mut i_var => {
...
fn fun_153(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { boolAlgVars: ref i_vars_boolAlgVars, boolParamVars: ref i_vars_boolParamVars, boolAliasVars: ref i_vars_boolAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_150(txt.clone(), i_vars_boolAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_151(txt.clone(), i_vars_boolParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_152(txt.clone(), i_vars_boolAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return fmiError;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn setBooleanFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_153(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_155(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_155 in &*items {
        let mut lstElt_155 = lstElt_155.clone();
        txt = (match lstElt_155.clone() {
        mut i_var => {
...
fn lm_156(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_156 in &*items {
        let mut lstElt_156 = lstElt_156.clone();
        txt = (match lstElt_156.clone() {
        mut i_var => {
...
fn lm_157(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_157 in &*items {
        let mut lstElt_157 = lstElt_157.clone();
        txt = (match lstElt_157.clone() {
        mut i_var => {
...
fn fun_158(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { stringAlgVars: ref i_vars_stringAlgVars, stringParamVars: ref i_vars_stringParamVars, stringAliasVars: ref i_vars_stringAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_155(txt.clone(), i_vars_stringAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_156(txt.clone(), i_vars_stringParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_157(txt.clone(), i_vars_stringAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn getStringFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_158(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_160(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_160 in &*items {
        let mut lstElt_160 = lstElt_160.clone();
        txt = (match lstElt_160.clone() {
        mut i_var => {
...
fn lm_161(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_161 in &*items {
...
fn lm_162(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn fun_163(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { stringAlgVars: ref i_vars_stringAlgVars, stringParamVars: ref i_vars_stringParamVars, stringAliasVars: ref i_vars_stringAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_160(txt.clone(), i_vars_stringAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_161(txt.clone(), i_vars_stringParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_162(txt.clone(), i_vars_stringAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return fmiError;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn setStringFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_163(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}
...
pub(crate) fn eventUpdateFunction2(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, SimCode::SimCode { modelInfo: _, .. }) => {
...
fn lm_167(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_167 in &*items {
        let mut lstElt_167 = lstElt_167.clone();
        txt = (match lstElt_167.clone() {
        SimCodeVar::SimVar { aliasvar: mut i_aliasvar, .. } => {
...
fn fun_168(mut in_txt: Tpl::Text, mut in_a_numAlgAliasVars: i32, mut in_a_simCode: SimCode::SimCode, mut in_a_vars_aliasVars: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_numAlgAliasVars, in_a_simCode, in_a_vars_aliasVars)) {
        (txt, 0, _, _) => {
            txt.clone()
        },
...
fn fun_169(mut in_txt: Tpl::Text, mut in_a_numAlgAliasVars: i32, mut in_a_ixFirstAlias: Tpl::Text, mut in_a_ixEnd: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_numAlgAliasVars, in_a_ixFirstAlias, in_a_ixEnd) {
        (mut txt, 0, _, _) => {
            txt.clone()
        },
...
pub(crate) fn getRealFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_170(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}
...
pub(crate) fn setRealFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_173(txt, a_modelInfo)?;
    Ok(out_txt)
}

fn fun_175(mut in_txt: Tpl::Text, mut in_a_v: SimCodeVar::AliasVariable, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_v, in_a_simCode) {
...
pub(crate) fn aliasSetVR(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_v: SimCodeVar::AliasVariable) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_175(txt, a_v, a_simCode)?;
    Ok(out_txt)
}

fn lm_177(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_177 in &*items {
        let mut lstElt_177 = lstElt_177.clone();
        txt = (match lstElt_177.clone() {
        SimCodeVar::SimVar { aliasvar: mut i_aliasvar, .. } => {
            txt = aliasSetVR(txt.clone(), a_simCode.clone(), i_aliasvar.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn fun_178(mut in_txt: Tpl::Text, mut in_a_numAliasVars: i32, mut in_a_simCode: SimCode::SimCode, mut in_a_vars_intAliasVars: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_numAliasVars, in_a_simCode, in_a_vars_intAliasVars)) {
        (txt, 0, _, _) => {
            txt.clone()
        },
        (txt, i_numAliasVars, a_simCode, a_vars_intAliasVars) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 20, alignOfset: 0, alignSeparator: Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(",\n")).clone() }), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_177(txt.clone(), a_vars_intAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("};\n")).clone(), (literal!("\n")).clone()], lastHasNewLine: true }))?;
...
fn fun_179(mut in_txt: Tpl::Text, mut in_a_numAliasVars: i32, mut in_a_ixFirstAlias: Tpl::Text, mut in_a_ixEnd: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_numAliasVars, in_a_ixFirstAlias, in_a_ixEnd) {
        (mut txt, 0, _, _) => {
            txt.clone()
        },
        (mut txt, _, mut a_ixFirstAlias, mut a_ixEnd) => {
...
pub(crate) fn getIntegerFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_180(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}
...
pub(crate) fn setIntegerFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_183(txt, a_modelInfo)?;
    Ok(out_txt)
}

fn lm_185(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_185 in &*items {
        let mut lstElt_185 = lstElt_185.clone();
        txt = (match lstElt_185.clone() {
        mut i_var => {
            txt = SwitchVars(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("booleanVars")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_186(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_186 in &*items {
        let mut lstElt_186 = lstElt_186.clone();
        txt = (match lstElt_186.clone() {
        mut i_var => {
            txt = SwitchParameters(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("booleanParameter")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_187(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn fun_188(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { boolAlgVars: ref i_vars_boolAlgVars, boolParamVars: ref i_vars_boolParamVars, boolAliasVars: ref i_vars_boolAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_185(txt.clone(), i_vars_boolAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_186(txt.clone(), i_vars_boolParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_187(txt.clone(), i_vars_boolAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn getBooleanFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_188(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_190(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_190 in &*items {
        let mut lstElt_190 = lstElt_190.clone();
        txt = (match lstElt_190.clone() {
        mut i_var => {
            txt = SwitchVarsSet(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("booleanVars")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_191(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_191 in &*items {
        let mut lstElt_191 = lstElt_191.clone();
        txt = (match lstElt_191.clone() {
        mut i_var => {
            txt = SwitchParametersSet(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("booleanParameter")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_192(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_192 in &*items {
        let mut lstElt_192 = lstElt_192.clone();
        txt = (match lstElt_192.clone() {
        mut i_var => {
            txt = SwitchAliasVarsSet(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("Boolean")).clone(), (literal!("!")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn fun_193(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { boolAlgVars: ref i_vars_boolAlgVars, boolParamVars: ref i_vars_boolParamVars, boolAliasVars: ref i_vars_boolAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_190(txt.clone(), i_vars_boolAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_191(txt.clone(), i_vars_boolParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_192(txt.clone(), i_vars_boolAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn setBooleanFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_193(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_195(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_195 in &*items {
        let mut lstElt_195 = lstElt_195.clone();
        txt = (match lstElt_195.clone() {
        mut i_var => {
            txt = SwitchVars(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("stringVars")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_196(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_196 in &*items {
        let mut lstElt_196 = lstElt_196.clone();
        txt = (match lstElt_196.clone() {
        mut i_var => {
            txt = SwitchParameters(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("stringParameter")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_197(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_197 in &*items {
        let mut lstElt_197 = lstElt_197.clone();
        txt = (match lstElt_197.clone() {
        mut i_var => {
            txt = SwitchAliasVars(txt.clone(), a_simCode.clone(), i_var.clone(), (literal!("String")).clone(), (literal!("")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn fun_198(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { stringAlgVars: ref i_vars_stringAlgVars, stringParamVars: ref i_vars_stringParamVars, stringAliasVars: ref i_vars_stringAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_195(txt.clone(), i_vars_stringAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_196(txt.clone(), i_vars_stringParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_197(txt.clone(), i_vars_stringAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return \"\";\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn getStringFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_198(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

fn lm_200(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
...
fn lm_201(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_201 in &*items {
...
fn lm_202(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_202 in &*items {
...
fn fun_203(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { stringAlgVars: ref i_vars_stringAlgVars, stringParamVars: ref i_vars_stringParamVars, stringAliasVars: ref i_vars_stringAliasVars, .. }, .. }, mut a_simCode) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_200(txt.clone(), i_vars_stringAlgVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_201(txt.clone(), i_vars_stringParamVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_202(txt.clone(), i_vars_stringAliasVars.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return fmi2Error;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn setStringFunction2(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_203(txt, a_modelInfo, a_simCode)?;
    Ok(out_txt)
}

pub(crate) fn setExternalFunction2(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_modelInfo) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { stateVars: _, .. }, functions: ref i_functions, .. }) => {
            let mut l_externalFuncs: Tpl::Text;
...
fn lm_206(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<Arc<SimCodeFunction::Function::Function>>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_206 in &*items {
        let mut lstElt_206 = lstElt_206.clone();
        txt = (::match_deref::match_deref! { match &(lstElt_206.clone()) {
        i_fn => {
...
pub(crate) fn setExternalFunctionsSwitch(mut txt: Tpl::Text, mut a_functions: Arc<metamodelica::List<Arc<SimCodeFunction::Function::Function>>>) -> Result<Tpl::Text> {
    ...
    out_txt = lm_206(out_txt, a_functions)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}
...
fn fun_210(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_index: i32, mut in_a_arrayName: ArcStr, mut in_a_simCode: SimCode::SimCode, mut in_a_name: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_index, in_a_arrayName, in_a_simCode, in_a_name)) {
...
fn fun_211(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_index: i32, mut in_a_simCode: SimCode::SimCode, mut in_a_name: Arc<DAE::ComponentRef>, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_index, in_a_simCode, in_a_name, in_a_arrayName)) {
...
fn fun_212(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_index: i32, mut in_a_simCode: SimCode::SimCode, mut in_a_arrayName: ArcStr, mut in_a_name: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_index, in_a_simCode, in_a_arrayName, in_a_name)) {
...
fn fun_213(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simVar, in_a_simCode, in_a_arrayName) {
...
pub(crate) fn SwitchVars(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVar: SimCodeVar::SimVar, mut a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_213(txt, a_simVar, a_simCode, (a_arrayName).clone())?;
    Ok(out_txt)
}
...
pub(crate) fn SwitchParameters(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVar: SimCodeVar::SimVar, mut a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_217(txt, a_simVar, a_simCode, (a_arrayName).clone())?;
    Ok(out_txt)
}
...
fn fun_220(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_simCode: SimCode::SimCode, mut in_a_varName: Arc<DAE::ComponentRef>, mut in_a_arrayName: ArcStr, mut in_a_crefName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_simCode, in_a_varName, in_a_arrayName, in_a_crefName)) {
...
fn fun_221(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_simCode: SimCode::SimCode, mut in_a_varName: Arc<DAE::ComponentRef>, mut in_a_arrayName: ArcStr, mut in_a_negate: ArcStr, mut in_a_crefName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_simCode, in_a_varName, in_a_arrayName, in_a_negate, in_a_crefName)) {
...
fn fun_222(mut in_txt: Tpl::Text, mut in_a_aliasvar: SimCodeVar::AliasVariable, mut in_a_negate: ArcStr, mut in_a_simCode: SimCode::SimCode, mut in_a_arrayName: ArcStr, mut in_a_crefName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_aliasvar, in_a_negate, in_a_simCode, in_a_arrayName, in_a_crefName) {
...
fn fun_223(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode, mut in_a_arrayName: ArcStr, mut in_a_negate: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simVar, in_a_simCode, in_a_arrayName, in_a_negate) {
...
pub(crate) fn SwitchAliasVars(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVar: SimCodeVar::SimVar, mut a_arrayName: ArcStr, mut a_negate: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_223(txt, a_simVar, a_simCode, (a_arrayName).clone(), (a_negate).clone())?;
    Ok(out_txt)
}
...
pub(crate) fn SwitchVarsSet(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVar: SimCodeVar::SimVar, mut a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_229(txt, a_simVar, a_simCode, (a_arrayName).clone())?;
    Ok(out_txt)
}
...
pub(crate) fn SwitchParametersSet(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVar: SimCodeVar::SimVar, mut a_arrayName: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_233(txt, a_simVar, a_simCode, (a_arrayName).clone())?;
    Ok(out_txt)
}
...
fn fun_237(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_negate: ArcStr, mut in_a_simCode: SimCode::SimCode, mut in_a_varName: Arc<DAE::ComponentRef>, mut in_a_arrayName: ArcStr, mut in_a_crefName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_negate, in_a_simCode, in_a_varName, in_a_arrayName, in_a_crefName)) {
...
pub(crate) fn SwitchAliasVarsSet(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVar: SimCodeVar::SimVar, mut a_arrayName: ArcStr, mut a_negate: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_239(txt, a_simVar, a_simCode, (a_arrayName).clone(), (a_negate).clone())?;
    Ok(out_txt)
}
...
fn fun_241(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_index0: i32, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var, in_a_index0, in_a_simCode)) {
...
fn lm_242(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_242 in &*items {
        let mut lstElt_242 = lstElt_242.clone();
        txt = (match lstElt_242.clone() {
        mut i_var => {
...
fn lm_244(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_244 in &*items {
        let mut lstElt_244 = lstElt_244.clone();
        txt = (match lstElt_244.clone() {
        mut i_var => {
            let mut x_index0: i32;
            x_index0 = Tpl::getIteri_i0(txt.clone())?;
...
pub(crate) fn mapInputAndOutputs(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { vars: SimCodeVar::SimVars { inputVars: ref i_inputVars, outputVars: ref i_outputVars, .. }, .. }, .. }) => {
            ...
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_242(txt.clone(), i_inputVars.clone(), i_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_244(txt.clone(), i_outputVars.clone(), i_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return -1;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn fun_246(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_FMUType: ArcStr, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var, in_a_FMUType, in_a_simCode)) {
...
fn lm_247(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_FMUType: ArcStr, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_247 in &*items {
        let mut lstElt_247 = lstElt_247.clone();
        txt = (match lstElt_247.clone() {
        mut i_var => {
            txt = fun_246(txt.clone(), i_var.clone(), (a_FMUType.clone()).clone(), a_simCode.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
pub(crate) fn mapRealOutputDerivatives(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_FMUType: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode, in_a_FMUType) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { vars: SimCodeVar::SimVars { outputVars: ref i_outputVars, .. }, .. }, .. }, mut a_FMUType) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_247(txt.clone(), i_outputVars.clone(), (a_FMUType.clone()).clone(), i_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return -1;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn lm_249(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<(i32, Arc<DAE::ComponentRef>)>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_249 in &*items {
        let mut lstElt_249 = lstElt_249.clone();
        txt = (::match_deref::match_deref! { match &(lstElt_249.clone()) {
        (i_index, i_cref) => {
            let mut ret_0: i32;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("case ")).clone() }))?;
...
pub(crate) fn mapInitialUnknownsdependentCrefs(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelStructure: Some(SimCode::FmiModelStructure { fmiInitialUnknowns: SimCode::FmiInitialUnknowns { sortedUnknownCrefs: ref i_sortedUnknownCrefs, .. }, .. }), .. }) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_249(txt.clone(), i_sortedUnknownCrefs.clone(), i_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return -1;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn lm_251(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<(i32, Arc<DAE::ComponentRef>)>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_251 in &*items {
        let mut lstElt_251 = lstElt_251.clone();
        txt = (::match_deref::match_deref! { match &(lstElt_251.clone()) {
        (i_index, i_cref) => {
            let mut ret_0: i32;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("case ")).clone() }))?;
            ret_0 = SimCodeUtil::lookupVR(i_cref.clone(), a_simCode.clone())?;
...
pub(crate) fn mapInitialUnknownsIndependentCrefs(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelStructure: Some(SimCode::FmiModelStructure { fmiInitialUnknowns: SimCode::FmiInitialUnknowns { sortedknownCrefs: ref i_sortedknownCrefs, .. }, .. }), .. }) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_251(txt.clone(), i_sortedknownCrefs.clone(), i_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("default:\n")).clone(), (literal!("  return -1;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn fun_255(mut in_txt: Tpl::Text, mut in_a_platform: ArcStr, mut in_a_libsPos2: ArcStr, mut in_a_libsPos1: ArcStr, mut in_a_dirExtra: ArcStr, mut in_a_modelNamePrefix: ArcStr, mut in_a_fmuTargetName: ArcStr, mut in_a_fileNamePrefix: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_platform, in_a_libsPos2, in_a_libsPos1, in_a_dirExtra, in_a_modelNamePrefix, in_a_fmuTargetName, in_a_fileNamePrefix)) {
...
pub fn getPlatformString2(mut txt: Tpl::Text, mut a_modelNamePrefix: ArcStr, mut a_platform: ArcStr, mut a_fileNamePrefix: ArcStr, mut a_fmuTargetName: ArcStr, mut a_dirExtra: ArcStr, mut a_libsPos1: ArcStr, mut a_libsPos2: ArcStr, mut a_omhome: ArcStr, mut a_FMUVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    l_fmudirname = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_1).clone())?;
    l_fmudirname = Tpl::writeTok(l_fmudirname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".fmutmp")).clone() }))?;
    out_txt = fun_255(txt, (a_platform).clone(), (a_libsPos2).clone(), (a_libsPos1).clone(), (a_dirExtra).clone(), (a_modelNamePrefix).clone(), (a_fmuTargetName).clone(), (a_fileNamePrefix).clone())?;
    Ok(out_txt)
}
...
fn lm_259(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_259 in &*items {
        let mut lstElt_259 = lstElt_259.clone();
        txt = (match lstElt_259.clone() {
        mut i_it => {
...
fn lm_260(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_260 in &*items {
...
fn lm_261(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_261 in &*items {
        let mut lstElt_261 = lstElt_261.clone();
        txt = (match lstElt_261.clone() {
        mut i_it => {
            txt = Tpl::writeStr(txt.clone(), (i_it.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_262(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_262 in &*items {
        let mut lstElt_262 = lstElt_262.clone();
        txt = (match lstElt_262.clone() {
        mut i_it => {
            txt = Tpl::writeStr(txt.clone(), (i_it.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_263(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_263 in &*items {
        let mut lstElt_263 = lstElt_263.clone();
        txt = (match lstElt_263.clone() {
        mut i_it => {
            txt = Tpl::writeStr(txt.clone(), (i_it.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn fun_264(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_sundialsObjectFiles: Arc<metamodelica::List<ArcStr>>, mut in_a_runtimeObjectFiles: Arc<metamodelica::List<ArcStr>>, mut in_a_cminpackObjectFiles: Arc<metamodelica::List<ArcStr>>, mut in_a_dgesvObjectFiles: Arc<metamodelica::List<ArcStr>>, mut in_a_sourceFiles: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_simCode, in_a_sundialsObjectFiles, in_a_runtimeObjectFiles, in_a_cminpackObjectFiles, in_a_dgesvObjectFiles, in_a_sourceFiles)) {
        (txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { name: _, .. }, makefileParams: SimCodeFunction::MakefileParams { ccompiler: _, .. }, simulationSettingsOpt: _, .. }, a_sundialsObjectFiles, a_runtimeObjectFiles, a_cminpackObjectFiles, a_dgesvObjectFiles, a_sourceFiles) => {
            ...
            txt = lm_259(txt.clone(), a_sourceFiles.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_260(txt.clone(), a_dgesvObjectFiles.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_261(txt.clone(), a_cminpackObjectFiles.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("endif\n")).clone(), (literal!("ifneq ($(NEED_RUNTIME),)\n")).clone(), (literal!("RUNTIMEFILES=")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_262(txt.clone(), a_runtimeObjectFiles.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            ...
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_263(txt.clone(), a_sundialsObjectFiles.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
fn lm_266(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_266 in &*items {
        let mut lstElt_266 = lstElt_266.clone();
        txt = (match lstElt_266.clone() {
        mut i_lib => {
...
fn lm_274(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_274 in &*items {
        let mut lstElt_274 = lstElt_274.clone();
        txt = (match lstElt_274.clone() {
        mut i_lib => {
            txt = Tpl::writeStr(txt.clone(), (i_lib.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_278(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_278 in &*items {
        let mut lstElt_278 = lstElt_278.clone();
        txt = (match lstElt_278.clone() {
        mut i_it => {
            txt = Tpl::writeStr(txt.clone(), (i_it.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn fun_279(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_common: Tpl::Text, mut in_a_FMUVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode, in_a_common, in_a_FMUVersion) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { varInfo: SimCode::VarInfo { numZeroCrossings: _, .. }, directory: ref i_modelInfo_directory, .. }, delayedExps: SimCode::DelayedExpression { maxDelayedIndex: _, .. }, makefileParams: SimCodeFunction::MakefileParams { libs: ref i_makefileParams_libs, platform: ref i_makefileParams_platform, omhome: ref i_makefileParams_omhome, includes: ref i_makefileParams_includes, .. }, simulationSettingsOpt: _, fmiSimulationFlags: ref i_fmiSimulationFlags, fileNamePrefix: ref i_fileNamePrefix, fmuTargetName: ref i_fmuTargetName, .. }, mut a_common, mut a_FMUVersion) => {
            ...
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_278(txt.clone(), i_makefileParams_includes.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::writeText(txt.clone(), a_common.clone())?;
...
fn fun_280(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_target: ArcStr, mut in_a_common: Tpl::Text, mut in_a_FMUVersion: ArcStr, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_target, in_a_common, in_a_FMUVersion, in_a_simCode)) {
        (txt, Deref @ "msvc", _, a_common, a_FMUVersion, a_simCode) => {
            let mut txt = (*txt).clone();
            txt = fun_272(txt.clone(), a_simCode.clone(), a_common.clone(), (a_FMUVersion.clone()).clone())?;
            txt.clone()
        },
        (txt, Deref @ "gcc", _, a_common, a_FMUVersion, a_simCode) => {
            let mut txt = (*txt).clone();
            txt = fun_279(txt.clone(), a_simCode.clone(), a_common.clone(), (a_FMUVersion.clone()).clone())?;
            txt.clone()
        },
...
pub fn fmuMakefile(mut txt: Tpl::Text, mut a_target: ArcStr, mut a_simCode: SimCode::SimCode, mut a_FMUVersion: ArcStr, mut a_sourceFiles: Arc<metamodelica::List<ArcStr>>, mut a_runtimeObjectFiles: Arc<metamodelica::List<ArcStr>>, mut a_dgesvObjectFiles: Arc<metamodelica::List<ArcStr>>, mut a_cminpackObjectFiles: Arc<metamodelica::List<ArcStr>>, mut a_sundialsObjectFiles: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    ...
    l_common = fun_264(Tpl::emptyTxt.clone(), a_simCode.clone(), a_sundialsObjectFiles, a_runtimeObjectFiles, a_cminpackObjectFiles, a_dgesvObjectFiles, a_sourceFiles)?;
    txt_1 = CodegenUtil::getGeneralTarget(Tpl::emptyTxt.clone(), (a_target.clone()).clone())?;
    str_2 = (Tpl::textString(txt_1)?).clone();
    out_txt = fun_280(txt, (str_2).clone(), (a_target).clone(), l_common, (a_FMUVersion).clone(), a_simCode)?;
    Ok(out_txt)
}
...
fn fun_283(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_modelInfo_name: Arc<Absyn::Path>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_modelInfo_name)) {
...
fn fun_285(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_fileNamePrefixHash: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode, in_a_fileNamePrefixHash) {
...
pub(crate) fn fmuSourceMakefile(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_FMUVersion: ArcStr, mut a_fileNamePrefixHash: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_285(txt, a_simCode, (a_fileNamePrefixHash).clone())?;
    Ok(out_txt)
}
...
pub fn fmudeffile(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_FMUVersion: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode, in_a_FMUVersion) {
...
fn fun_290(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiInfo_fmiDescription: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_fmiInfo_fmiDescription) {
...
fn lm_292(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::ModelVariables>>, mut a_generateOutputConnectors: bool, mut a_generateInputConnectors: bool, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut a_FMUVersion: ArcStr) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_292 in &*items {
        let mut lstElt_292 = lstElt_292.clone();
        txt = (match lstElt_292.clone() {
        mut i_fmiModelVariable => {
            txt = dumpFMUModelDescriptionVariable(txt.clone(), (a_FMUVersion.clone()).clone(), i_fmiModelVariable.clone(), a_fmiTypeDefinitionsList.clone(), a_generateInputConnectors, a_generateOutputConnectors)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn fun_295(mut in_txt: Tpl::Text, mut in_a_isInputOrOutput: Tpl::Text, mut in_a_y2Placement: i32, mut in_a_y1Placement: i32, mut in_a_x2Placement: i32, mut in_a_x1Placement: i32, mut in_a_description: ArcStr, mut in_a_generateOutputConnectors: bool, mut in_a_generateInputConnectors: bool, mut in_a_baseType: ArcStr, mut in_a_causality: ArcStr, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_isInputOrOutput, in_a_y2Placement, in_a_y1Placement, in_a_x2Placement, in_a_x1Placement, in_a_description, in_a_generateOutputConnectors, in_a_generateInputConnectors, in_a_baseType, in_a_causality, in_a_name)) {
...
fn fun_304(mut in_txt: Tpl::Text, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_generateOutputConnectors: bool, mut in_a_generateInputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmiModelVariable, in_a_generateOutputConnectors, in_a_generateInputConnectors) {
...
fn fun_305(mut in_txt: Tpl::Text, mut in_a_FMUVersion: ArcStr, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_generateInputConnectors: bool, mut in_a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_FMUVersion, in_a_fmiModelVariable, in_a_generateInputConnectors, in_a_generateOutputConnectors)) {
        (txt, Deref @ "1.0", a_fmiModelVariable, a_generateInputConnectors, a_generateOutputConnectors) => {
            let mut txt = (*txt).clone();
            txt = fun_304(txt.clone(), a_fmiModelVariable.clone(), a_generateOutputConnectors.clone(), a_generateInputConnectors.clone())?;
            txt.clone()
        },
        (txt, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn dumpFMUModelDescriptionVariable(mut txt: Tpl::Text, mut a_FMUVersion: ArcStr, mut a_fmiModelVariable: FMI::ModelVariables, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut a_generateInputConnectors: bool, mut a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_305(txt, (a_FMUVersion).clone(), a_fmiModelVariable, a_generateInputConnectors, a_generateOutputConnectors)?;
    Ok(out_txt)
}

fn fun_307(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_name) {
        (mut txt, false, _) => {
            txt.clone()
        },
...
fn fun_308(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_name: ArcStr, mut in_a_baseType: ArcStr, mut in_a_causality: ArcStr, mut in_a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_name, in_a_baseType, in_a_causality, in_a_generateOutputConnectors) {
...
fn fun_311(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_name: ArcStr, mut in_a_generateOutputConnectors: bool, mut in_a_baseType: ArcStr, mut in_a_causality: ArcStr, mut in_a_generateInputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_name, in_a_generateOutputConnectors, in_a_baseType, in_a_causality, in_a_generateInputConnectors) {
...
fn fun_312(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_name: ArcStr, mut in_a_causality: ArcStr, mut in_a_baseType: ArcStr, mut in_a_generateInputConnectors: bool, mut in_a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_name, in_a_causality, in_a_baseType, in_a_generateInputConnectors, in_a_generateOutputConnectors) {
...
pub(crate) fn dumpFMUModelDescriptionInputOutputVariable(mut txt: Tpl::Text, mut a_name: ArcStr, mut a_causality: ArcStr, mut a_baseType: ArcStr, mut a_generateInputConnectors: bool, mut a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_3: bool;
    let mut ret_2: bool;
    let mut ret_1: bool;
    ...
    out_txt = fun_312(txt, ret_3, (a_name).clone(), (a_causality).clone(), (a_baseType).clone(), a_generateInputConnectors, a_generateOutputConnectors)?;
    Ok(out_txt)
}

fn fun_314(mut in_txt: Tpl::Text, mut in_a_fmiInfo: FMI::Info, mut in_a_name: ArcStr, mut in_a_fmi: FMI::FmiImport) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_fmiInfo, in_a_name, in_a_fmi)) {
        ...
        (txt, FMI::Info { fmiVersion: Deref @ "1.0", fmiType: 1, .. }, a_name, a_fmi) => {
            let mut txt = (*txt).clone();
            txt = importFMU1CoSimulationStandAlone(txt.clone(), a_fmi.clone(), (a_name.clone()).clone())?;
            txt.clone()
        },
        (txt, FMI::Info { fmiVersion: Deref @ "2.0", fmiType: 1, .. }, a_name, a_fmi) => {
            let mut txt = (*txt).clone();
...
pub fn importFMUModelica(mut in_txt: Tpl::Text, mut in_a_fmi: FMI::FmiImport, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmi, in_a_name) {
...
fn fun_316(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiInfo: FMI::Info, mut in_a_fmiInfo_fmiModelIdentifier: ArcStr, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_fmiInfo, in_a_fmiInfo_fmiModelIdentifier, in_a_name) {
...
fn fun_318(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_realInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_realInputVariablesReturnNames) {
...
fn fun_319(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_integerInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_integerInputVariablesReturnNames) {
...
fn fun_320(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_booleanInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_booleanInputVariablesReturnNames) {
...
fn fun_321(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_stringInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_stringInputVariablesReturnNames) {
...
fn fun_323(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_realParametersNames: Tpl::Text, mut in_a_realParametersVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_realParametersNames, in_a_realParametersVRs) {
...
fn fun_324(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_integerParametersNames: Tpl::Text, mut in_a_integerParametersVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_integerParametersNames, in_a_integerParametersVRs) {
...
fn fun_325(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_booleanParametersNames: Tpl::Text, mut in_a_booleanParametersVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_booleanParametersNames, in_a_booleanParametersVRs) {
...
fn fun_326(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_stringParametersNames: Tpl::Text, mut in_a_stringParametersVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_stringParametersNames, in_a_stringParametersVRs) {
...
fn fun_327(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_realDependentParametersVRs: Tpl::Text, mut in_a_realDependentParametersNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_realDependentParametersVRs, in_a_realDependentParametersNames) {
...
fn fun_328(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_integerDependentParametersVRs: Tpl::Text, mut in_a_integerDependentParametersNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_integerDependentParametersVRs, in_a_integerDependentParametersNames) {
...
fn fun_329(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_booleanDependentParametersVRs: Tpl::Text, mut in_a_booleanDependentParametersNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_booleanDependentParametersVRs, in_a_booleanDependentParametersNames) {
...
fn fun_330(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_stringDependentParametersVRs: Tpl::Text, mut in_a_stringDependentParametersNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_stringDependentParametersVRs, in_a_stringDependentParametersNames) {
...
fn fun_331(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_realInputVariablesNames: Tpl::Text, mut in_a_realInputVariablesVRs: Tpl::Text, mut in_a_realInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_realInputVariablesNames, in_a_realInputVariablesVRs, in_a_realInputVariablesReturnNames) {
...
fn fun_332(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_integerInputVariablesNames: Tpl::Text, mut in_a_integerInputVariablesVRs: Tpl::Text, mut in_a_integerInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_integerInputVariablesNames, in_a_integerInputVariablesVRs, in_a_integerInputVariablesReturnNames) {
...
fn fun_333(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_booleanInputVariablesNames: Tpl::Text, mut in_a_booleanInputVariablesVRs: Tpl::Text, mut in_a_booleanInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_booleanInputVariablesNames, in_a_booleanInputVariablesVRs, in_a_booleanInputVariablesReturnNames) {
...
fn fun_334(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_stringStartVariablesNames: Tpl::Text, mut in_a_stringInputVariablesVRs: Tpl::Text, mut in_a_stringInputVariablesReturnNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_stringStartVariablesNames, in_a_stringInputVariablesVRs, in_a_stringInputVariablesReturnNames) {
...
fn fun_335(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_realOutputVariablesVRs: Tpl::Text, mut in_a_realOutputVariablesNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_realOutputVariablesVRs, in_a_realOutputVariablesNames) {
...
fn fun_336(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_integerOutputVariablesVRs: Tpl::Text, mut in_a_integerOutputVariablesNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_integerOutputVariablesVRs, in_a_integerOutputVariablesNames) {
...
fn fun_337(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_booleanOutputVariablesVRs: Tpl::Text, mut in_a_booleanOutputVariablesNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_booleanOutputVariablesVRs, in_a_booleanOutputVariablesNames) {
...
fn fun_338(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_stringOutputVariablesVRs: Tpl::Text, mut in_a_stringOutputVariablesNames: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_stringOutputVariablesVRs, in_a_stringOutputVariablesNames) {
...
fn lm_339(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_339 in &*items {
        let mut lstElt_339 = lstElt_339.clone();
        txt = (match lstElt_339.clone() {
        mut i_eventIndicator => {
...
fn fun_340(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiInfo_fmiNumberOfEventIndicators: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_fmiInfo_fmiNumberOfEventIndicators)) {
        (txt, false, _) => {
            let mut txt = (*txt).clone();
        ...
        (txt, _, a_fmiInfo_fmiNumberOfEventIndicators) => {
            ...
            txt = lm_339(txt.clone(), a_fmiInfo_fmiNumberOfEventIndicators.clone())?;
            txt = Tpl::popIter(txt.clone())?;
...
fn lm_341(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_341 in &*items {
        let mut lstElt_341 = lstElt_341.clone();
        txt = (match lstElt_341.clone() {
        mut i_continuousStates => {
...
fn fun_342(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiInfo_fmiNumberOfContinuousStates: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_fmiInfo_fmiNumberOfContinuousStates)) {
        (txt, false, _) => {
            txt.clone()
        },
        (txt, _, a_fmiInfo_fmiNumberOfContinuousStates) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_341(txt.clone(), a_fmiInfo_fmiNumberOfContinuousStates.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn importFMU1ModelExchange(mut in_txt: Tpl::Text, mut in_a_fmi: FMI::FmiImport, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmi, in_a_name) {
...
fn fun_347(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nRealInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nRealInputVariables) {
...
fn fun_349(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nIntegerInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nIntegerInputVariables) {
...
fn fun_351(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nBooleanInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nBooleanInputVariables) {
...
fn fun_353(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nStringInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nStringInputVariables) {
...
fn fun_355(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nRealEventInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nRealEventInputVariables) {
...
fn fun_356(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nIntegerEventInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nIntegerEventInputVariables) {
...
fn fun_357(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nBooleanEventInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nBooleanEventInputVariables) {
...
fn fun_358(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_nStringEventInputVariables: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_nStringEventInputVariables) {
...
fn fun_368(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_realInputVariablesNames: Tpl::Text, mut in_a_realInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_realInputVariablesNames, in_a_realInputVariablesVRs) {
...
fn fun_369(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_integerInputVariablesNames: Tpl::Text, mut in_a_integerInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_integerInputVariablesNames, in_a_integerInputVariablesVRs) {
...
fn fun_370(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_booleanInputVariablesNames: Tpl::Text, mut in_a_booleanInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_booleanInputVariablesNames, in_a_booleanInputVariablesVRs) {
...
fn fun_371(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_stringStartVariablesNames: Tpl::Text, mut in_a_stringInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_stringStartVariablesNames, in_a_stringInputVariablesVRs) {
...
fn lm_380(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_380 in &*items {
        let mut lstElt_380 = lstElt_380.clone();
        txt = (match lstElt_380.clone() {
        mut i_eventIndicator => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("change(fmi_z_positive[")).clone() }))?;
            txt = Tpl::writeStr(txt.clone(), (intString(i_eventIndicator.clone())).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("])")).clone() }))?;
...
fn fun_381(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiInfo_fmiNumberOfEventIndicators: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_fmiInfo_fmiNumberOfEventIndicators)) {
        ...
        (txt, _, a_fmiInfo_fmiNumberOfEventIndicators) => {
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("when {")).clone() }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" or ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_380(txt.clone(), a_fmiInfo_fmiNumberOfEventIndicators.clone())?;
            txt = Tpl::popIter(txt.clone())?;
...
fn fun_382(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_realEventInputVariablesNames: Tpl::Text, mut in_a_realEventInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_realEventInputVariablesNames, in_a_realEventInputVariablesVRs) {
...
fn fun_383(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_integerEventInputVariablesNames: Tpl::Text, mut in_a_integerEventInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_integerEventInputVariablesNames, in_a_integerEventInputVariablesVRs) {
...
fn fun_384(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_booleanEventInputVariablesNames: Tpl::Text, mut in_a_booleanEventInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_booleanEventInputVariablesNames, in_a_booleanEventInputVariablesVRs) {
...
fn fun_385(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_stringEventStartVariablesNames: Tpl::Text, mut in_a_stringEventInputVariablesVRs: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_stringEventStartVariablesNames, in_a_stringEventInputVariablesVRs) {
...
fn lm_386(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_386 in &*items {
        let mut lstElt_386 = lstElt_386.clone();
        txt = (match lstElt_386.clone() {
        mut i_continuousStates => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("reinit(fmi_x[")).clone() }))?;
            txt = Tpl::writeStr(txt.clone(), (intString(i_continuousStates.clone())).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("], fmi_x_new[")).clone() }))?;
...
fn fun_387(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiInfo_fmiNumberOfContinuousStates: Arc<metamodelica::List<i32>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_fmiInfo_fmiNumberOfContinuousStates)) {
        ...
        (txt, _, a_fmiInfo_fmiNumberOfContinuousStates) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_386(txt.clone(), a_fmiInfo_fmiNumberOfContinuousStates.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("    end if;")).clone() }))?;
...
pub(crate) fn importFMU2ModelExchange(mut in_txt: Tpl::Text, mut in_a_fmi: FMI::FmiImport, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmi, in_a_name) {
        (mut txt, FMI::FmiImport { fmiInfo: ref i_fmiInfo @ FMI::Info { fmiModelIdentifier: ref i_fmiInfo_fmiModelIdentifier, fmiDescription: ref i_fmiInfo_fmiDescription, fmiNumberOfContinuousStates: ref i_fmiInfo_fmiNumberOfContinuousStates, fmiNumberOfEventIndicators: ref i_fmiInfo_fmiNumberOfEventIndicators, .. }, fmiExperimentAnnotation: FMI::ExperimentAnnotation { fmiExperimentStartTime: mut i_fmiExperimentAnnotation_fmiExperimentStartTime, fmiExperimentStopTime: mut i_fmiExperimentAnnotation_fmiExperimentStopTime, fmiExperimentTolerance: mut i_fmiExperimentAnnotation_fmiExperimentTolerance }, fmiModelVariablesList: ref i_fmiModelVariablesList, fmiTypeDefinitionsList: ref i_fmiTypeDefinitionsList, fmuWorkingDirectory: mut i_fmuWorkingDirectory, fmiLogLevel: mut i_fmiLogLevel, fmiDebugOutput: mut i_fmiDebugOutput, generateInputConnectors: mut i_generateInputConnectors, generateOutputConnectors: mut i_generateOutputConnectors, .. }, mut a_name) => {
            let mut ret_126: bool;
            let mut ret_125: bool;
            let mut ret_124: i32;
            let mut ret_123: bool;
            let mut ret_122: bool;
            let mut ret_121: bool;
            let mut ret_120: bool;
            let mut ret_119: bool;
            let mut ret_118: i32;
            let mut ret_117: bool;
            let mut ret_116: bool;
            let mut ret_115: bool;
            let mut ret_114: bool;
            let mut ret_113: bool;
            let mut ret_112: bool;
            let mut ret_111: bool;
            let mut ret_110: bool;
            let mut ret_109: bool;
            let mut ret_108: bool;
            let mut ret_107: bool;
            let mut ret_106: bool;
            let mut ret_105: bool;
            let mut ret_104: bool;
            let mut ret_103: bool;
            let mut ret_102: bool;
            let mut ret_101: bool;
            let mut ret_100: bool;
            let mut ret_99: bool;
            let mut ret_98: bool;
            let mut ret_97: bool;
            let mut ret_96: bool;
            ...
            let mut ret_60: i32;
            let mut ret_59: Arc<metamodelica::List<FMI::ModelVariables>>;
            ...
            let mut ret_54: i32;
            let mut ret_53: Arc<metamodelica::List<FMI::ModelVariables>>;
            ...
            let mut ret_48: i32;
            let mut ret_47: Arc<metamodelica::List<FMI::ModelVariables>>;
            ...
            let mut ret_42: i32;
            let mut ret_41: Arc<metamodelica::List<FMI::ModelVariables>>;
            let mut l_nRealEventInputVariables: Tpl::Text;
            let mut l_stringInputVariablesReturnNames: Tpl::Text;
            let mut l_stringStartVariablesNames: Tpl::Text;
            let mut l_stringInputVariablesVRs: Tpl::Text;
            let mut ret_36: i32;
            let mut ret_35: Arc<metamodelica::List<FMI::ModelVariables>>;
            let mut l_nStringInputVariables: Tpl::Text;
            let mut l_booleanInputVariablesReturnNames: Tpl::Text;
            let mut l_booleanInputVariablesNames: Tpl::Text;
            let mut l_booleanInputVariablesVRs: Tpl::Text;
            let mut ret_30: i32;
            let mut ret_29: Arc<metamodelica::List<FMI::ModelVariables>>;
            let mut l_nBooleanInputVariables: Tpl::Text;
            let mut l_integerInputVariablesReturnNames: Tpl::Text;
            let mut l_integerInputVariablesNames: Tpl::Text;
            let mut l_integerInputVariablesVRs: Tpl::Text;
            let mut ret_24: i32;
            let mut ret_23: Arc<metamodelica::List<FMI::ModelVariables>>;
            let mut l_nIntegerInputVariables: Tpl::Text;
            let mut l_realInputVariablesReturnNames: Tpl::Text;
            let mut l_realInputVariablesNames: Tpl::Text;
            let mut l_realInputVariablesVRs: Tpl::Text;
            let mut ret_18: i32;
            let mut ret_17: Arc<metamodelica::List<FMI::ModelVariables>>;
...
pub(crate) fn importFMU1CoSimulationStandAlone(mut in_txt: Tpl::Text, mut in_a_fmi: FMI::FmiImport, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmi, in_a_name) {
...
fn lm_406(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::TypeDefinitions>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_406 in &*items {
        let mut lstElt_406 = lstElt_406.clone();
        txt = (match lstElt_406.clone() {
        mut i_fmiTypeDefinition => {
...
pub(crate) fn dumpFMITypeDefinitions(mut txt: Tpl::Text, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    out_txt = lm_406(out_txt, a_fmiTypeDefinitionsList)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}

pub(crate) fn dumpFMITypeDefinition(mut in_txt: Tpl::Text, mut in_a_fmiTypeDefinition: FMI::TypeDefinitions) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmiTypeDefinition) {
...
fn lm_409(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::EnumerationItem>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_409 in &*items {
        let mut lstElt_409 = lstElt_409.clone();
        txt = (match lstElt_409.clone() {
        mut i_item => {
...
pub(crate) fn dumpFMITypeDefinitionsItems(mut txt: Tpl::Text, mut a_items: Arc<metamodelica::List<FMI::EnumerationItem>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(",\n")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    out_txt = lm_409(out_txt, a_items)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}

pub(crate) fn dumpFMITypeDefinitionsItem(mut in_txt: Tpl::Text, mut in_a_item: FMI::EnumerationItem) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_item) {
...
fn lm_412(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::TypeDefinitions>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_412 in &*items {
        let mut lstElt_412 = lstElt_412.clone();
        txt = (match lstElt_412.clone() {
        mut i_fmiTypeDefinition => {
...
pub(crate) fn dumpFMITypeDefinitionsMappingFunctions(mut txt: Tpl::Text, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    out_txt = lm_412(out_txt, a_fmiTypeDefinitionsList)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}

fn lm_414(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::EnumerationItem>>, mut a_name: ArcStr) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_414 in &*items {
        let mut lstElt_414 = lstElt_414.clone();
        txt = (match lstElt_414.clone() {
        mut i_item => {
            let mut x_i0: i32;
...
pub(crate) fn dumpFMITypeDefinitionMappingFunction(mut in_txt: Tpl::Text, mut in_a_fmiTypeDefinition: FMI::TypeDefinitions) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmiTypeDefinition) {
        (mut txt, FMI::TypeDefinitions { name: mut i_name, items: ref i_items, .. }) => {
            let mut ret_1: bool;
            ...
            txt = lm_414(txt.clone(), i_items.clone(), (i_name.clone()).clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
...
fn fun_417(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_name: ArcStr, mut in_a_typeName: ArcStr, mut in_a_i: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_name, in_a_typeName, in_a_i) {
...
pub(crate) fn dumpFMITypeDefinitionMappingFunctionItems(mut in_txt: Tpl::Text, mut in_a_item: FMI::EnumerationItem, mut in_a_typeName: ArcStr, mut in_a_i: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_item, in_a_typeName, in_a_i) {
...
fn lm_419(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::TypeDefinitions>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_419 in &*items {
        let mut lstElt_419 = lstElt_419.clone();
        txt = (match lstElt_419.clone() {
        mut i_fmiTypeDefinition => {
...
pub(crate) fn dumpFMITypeDefinitionsArrayMappingFunctions(mut txt: Tpl::Text, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    out_txt = lm_419(out_txt, a_fmiTypeDefinitionsList)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}

pub(crate) fn dumpFMITypeDefinitionsArrayMappingFunction(mut in_txt: Tpl::Text, mut in_a_fmiTypeDefinition: FMI::TypeDefinitions) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_fmiTypeDefinition) {
...
fn lm_422(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::ModelVariables>>, mut a_generateOutputConnectors: bool, mut a_generateInputConnectors: bool, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut a_FMUVersion: ArcStr) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_422 in &*items {
        let mut lstElt_422 = lstElt_422.clone();
        txt = (match lstElt_422.clone() {
        mut i_fmiModelVariable => {
            txt = dumpFMIModelVariable(txt.clone(), (a_FMUVersion.clone()).clone(), i_fmiModelVariable.clone(), a_fmiTypeDefinitionsList.clone(), a_generateInputConnectors, a_generateOutputConnectors)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
pub(crate) fn dumpFMIModelVariablesList(mut txt: Tpl::Text, mut a_FMUVersion: ArcStr, mut a_fmiModelVariablesList: Arc<metamodelica::List<FMI::ModelVariables>>, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut a_generateInputConnectors: bool, mut a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    out_txt = lm_422(out_txt, a_fmiModelVariablesList, a_generateOutputConnectors, a_generateInputConnectors, a_fmiTypeDefinitionsList, (a_FMUVersion).clone())?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}
...
fn fun_424(mut in_txt: Tpl::Text, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut in_a_FMUVersion: ArcStr, mut in_a_generateOutputConnectors: bool, mut in_a_generateInputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_fmiModelVariable, in_a_fmiTypeDefinitionsList, in_a_FMUVersion, in_a_generateOutputConnectors, in_a_generateInputConnectors)) {
        ...
        (txt, FMI::ModelVariables::INTEGERVARIABLE { variability: i_variability, causality: i_causality, baseType: i_baseType, name: i_name, hasStartValue: i_hasStartValue, startValue: i_startValue_1, isFixed: i_isFixed, description: i_description, x1Placement: i_x1Placement, x2Placement: i_x2Placement, y1Placement: i_y1Placement, y2Placement: i_y2Placement, .. }, _, a_FMUVersion, a_generateOutputConnectors, a_generateInputConnectors) => {
            let mut txt = (*txt).clone();
            txt = dumpFMIModelVariableVariability(txt.clone(), (i_variability.clone()).clone())?;
            txt = dumpFMIModelVariableCausalityAndBaseType(txt.clone(), (i_causality.clone()).clone(), (i_baseType.clone()).clone(), a_generateInputConnectors.clone(), a_generateOutputConnectors.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
        ...
        (txt, FMI::ModelVariables::BOOLEANVARIABLE { variability: i_variability, causality: i_causality, baseType: i_baseType, name: i_name, hasStartValue: i_hasStartValue, startValue: i_startValue_2, isFixed: i_isFixed, description: i_description, x1Placement: i_x1Placement, x2Placement: i_x2Placement, y1Placement: i_y1Placement, y2Placement: i_y2Placement, .. }, _, a_FMUVersion, a_generateOutputConnectors, a_generateInputConnectors) => {
            let mut txt = (*txt).clone();
            txt = dumpFMIModelVariableVariability(txt.clone(), (i_variability.clone()).clone())?;
            txt = dumpFMIModelVariableCausalityAndBaseType(txt.clone(), (i_causality.clone()).clone(), (i_baseType.clone()).clone(), a_generateInputConnectors.clone(), a_generateOutputConnectors.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
        ...
        (txt, FMI::ModelVariables::STRINGVARIABLE { variability: i_variability, causality: i_causality, baseType: i_baseType, name: i_name, hasStartValue: i_hasStartValue, startValue: i_startValue_3, isFixed: i_isFixed, description: i_description, x1Placement: i_x1Placement, x2Placement: i_x2Placement, y1Placement: i_y1Placement, y2Placement: i_y2Placement, .. }, _, a_FMUVersion, a_generateOutputConnectors, a_generateInputConnectors) => {
            let mut txt = (*txt).clone();
            txt = dumpFMIModelVariableVariability(txt.clone(), (i_variability.clone()).clone())?;
            txt = dumpFMIModelVariableCausalityAndBaseType(txt.clone(), (i_causality.clone()).clone(), (i_baseType.clone()).clone(), a_generateInputConnectors.clone(), a_generateOutputConnectors.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
        ...
        (txt, FMI::ModelVariables::ENUMERATIONVARIABLE { variability: i_variability, causality: i_causality, baseType: i_baseType, name: i_name, hasStartValue: i_hasStartValue, startValue: i_startValue_1, isFixed: i_isFixed, description: i_description, x1Placement: i_x1Placement, x2Placement: i_x2Placement, y1Placement: i_y1Placement, y2Placement: i_y2Placement, .. }, a_fmiTypeDefinitionsList, _, a_generateOutputConnectors, a_generateInputConnectors) => {
            let mut txt = (*txt).clone();
            txt = dumpFMIModelVariableVariability(txt.clone(), (i_variability.clone()).clone())?;
            txt = dumpFMIModelVariableCausalityAndBaseType(txt.clone(), (i_causality.clone()).clone(), (i_baseType.clone()).clone(), a_generateInputConnectors.clone(), a_generateOutputConnectors.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
...
pub(crate) fn dumpFMIModelVariable(mut in_txt: Tpl::Text, mut in_a_FMUVersion: ArcStr, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut in_a_generateInputConnectors: bool, mut in_a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_FMUVersion, in_a_fmiModelVariable, in_a_fmiTypeDefinitionsList, in_a_generateInputConnectors, in_a_generateOutputConnectors)) {
        (txt, i_FMUVersion @ Deref @ "1.0", a_fmiModelVariable, a_fmiTypeDefinitionsList, a_generateInputConnectors, a_generateOutputConnectors) => {
            let mut txt = (*txt).clone();
            txt = fun_424(txt.clone(), a_fmiModelVariable.clone(), a_fmiTypeDefinitionsList.clone(), (i_FMUVersion.clone()).clone(), a_generateOutputConnectors.clone(), a_generateInputConnectors.clone())?;
            txt.clone()
        },
...
fn fun_427(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_variability: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_variability) {
...
pub(crate) fn dumpFMIModelVariableVariability(mut txt: Tpl::Text, mut a_variability: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_0: bool;
    ret_0 = stringEq((a_variability.clone()).clone(), (literal!("")).clone());
    out_txt = fun_427(txt, ret_0, (a_variability).clone())?;
    Ok(out_txt)
}

fn fun_429(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_baseType: ArcStr, mut in_a_causality: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_baseType, in_a_causality) {
...
fn fun_431(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_baseType: ArcStr, mut in_a_causality: ArcStr, mut in_a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_baseType, in_a_causality, in_a_generateOutputConnectors) {
...
fn fun_434(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_generateOutputConnectors: bool, mut in_a_baseType: ArcStr, mut in_a_causality: ArcStr, mut in_a_generateInputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_generateOutputConnectors, in_a_baseType, in_a_causality, in_a_generateInputConnectors) {
...
fn fun_435(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_causality: ArcStr, mut in_a_baseType: ArcStr, mut in_a_generateInputConnectors: bool, mut in_a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_causality, in_a_baseType, in_a_generateInputConnectors, in_a_generateOutputConnectors) {
...
pub(crate) fn dumpFMIModelVariableCausalityAndBaseType(mut txt: Tpl::Text, mut a_causality: ArcStr, mut a_baseType: ArcStr, mut a_generateInputConnectors: bool, mut a_generateOutputConnectors: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_3: bool;
    let mut ret_2: bool;
    let mut ret_1: bool;
    ...
    ret_2 = boolAnd(ret_0, ret_1);
    ret_3 = boolAnd(a_generateInputConnectors, ret_2);
    out_txt = fun_435(txt, ret_3, (a_causality).clone(), (a_baseType).clone(), a_generateInputConnectors, a_generateOutputConnectors)?;
    Ok(out_txt)
}

fn fun_437(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_causality: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_causality) {
...
pub(crate) fn dumpFMIModelVariableCausality(mut txt: Tpl::Text, mut a_causality: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_0: bool;
    ret_0 = stringEq((a_causality.clone()).clone(), (literal!("")).clone());
    out_txt = fun_437(txt, ret_0, (a_causality).clone())?;
    Ok(out_txt)
}
...
fn fun_440(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_isFixed: bool, mut in_a_hasStartValue: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_isFixed, in_a_hasStartValue) {
...
fn fun_441(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_startValue: metamodelica::Real, mut in_a_isFixed: bool, mut in_a_hasStartValue: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_startValue, in_a_isFixed, in_a_hasStartValue) {
...
fn fun_443(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_startValue: metamodelica::Real) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_startValue) {
        (mut txt, false, _) => {
            txt.clone()
        },
...
fn fun_444(mut in_txt: Tpl::Text, mut in_a_variabilityCausality: ArcStr, mut in_a_startValue: metamodelica::Real, mut in_a_isFixed: bool, mut in_a_hasStartValue: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_variabilityCausality, in_a_startValue, in_a_isFixed, in_a_hasStartValue)) {
...
pub(crate) fn dumpFMIRealModelVariableStartValue(mut in_txt: Tpl::Text, mut in_a_FMUVersion: ArcStr, mut in_a_variabilityCausality: ArcStr, mut in_a_hasStartValue: bool, mut in_a_startValue: metamodelica::Real, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_FMUVersion, in_a_variabilityCausality, in_a_hasStartValue, in_a_startValue, in_a_isFixed)) {
        (txt, Deref @ "1.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_444(txt.clone(), (a_variabilityCausality.clone()).clone(), a_startValue.clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, Deref @ "2.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_450(txt.clone(), (a_variabilityCausality.clone()).clone(), a_startValue.clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, _, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn dumpFMIIntegerModelVariableStartValue(mut in_txt: Tpl::Text, mut in_a_FMUVersion: ArcStr, mut in_a_variabilityCausality: ArcStr, mut in_a_hasStartValue: bool, mut in_a_startValue: i32, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_FMUVersion, in_a_variabilityCausality, in_a_hasStartValue, in_a_startValue, in_a_isFixed)) {
        (txt, Deref @ "1.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_457(txt.clone(), (a_variabilityCausality.clone()).clone(), a_startValue.clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, Deref @ "2.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_463(txt.clone(), (a_variabilityCausality.clone()).clone(), a_startValue.clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, _, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn dumpFMIBooleanModelVariableStartValue(mut in_txt: Tpl::Text, mut in_a_FMUVersion: ArcStr, mut in_a_variabilityCausality: ArcStr, mut in_a_hasStartValue: bool, mut in_a_startValue: bool, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_FMUVersion, in_a_variabilityCausality, in_a_hasStartValue, in_a_startValue, in_a_isFixed)) {
        (txt, Deref @ "1.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_470(txt.clone(), (a_variabilityCausality.clone()).clone(), a_startValue.clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, Deref @ "2.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_476(txt.clone(), (a_variabilityCausality.clone()).clone(), a_startValue.clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, _, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn dumpFMIStringModelVariableStartValue(mut in_txt: Tpl::Text, mut in_a_FMUVersion: ArcStr, mut in_a_variabilityCausality: ArcStr, mut in_a_hasStartValue: bool, mut in_a_startValue: ArcStr, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_FMUVersion, in_a_variabilityCausality, in_a_hasStartValue, in_a_startValue, in_a_isFixed)) {
        (txt, Deref @ "1.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_483(txt.clone(), (a_variabilityCausality.clone()).clone(), (a_startValue.clone()).clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, Deref @ "2.0", a_variabilityCausality, a_hasStartValue, a_startValue, a_isFixed) => {
            let mut txt = (*txt).clone();
            txt = fun_489(txt.clone(), (a_variabilityCausality.clone()).clone(), (a_startValue.clone()).clone(), a_isFixed.clone(), a_hasStartValue.clone())?;
            txt.clone()
        },
        (txt, _, _, _, _, _) => {
            txt.clone()
...
fn fun_491(mut in_txt: Tpl::Text, mut in_a_hasStartValue: bool, mut in_a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut in_a_baseType: ArcStr, mut in_a_startValue: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_hasStartValue, in_a_fmiTypeDefinitionsList, in_a_baseType, in_a_startValue)) {
        (txt, false, _, _, _) => {
            txt.clone()
        },
...
pub(crate) fn dumpFMIEnumerationModelVariableStartValue(mut txt: Tpl::Text, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut a_baseType: ArcStr, mut a_hasStartValue: bool, mut a_startValue: i32, mut a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_491(txt, a_hasStartValue, a_fmiTypeDefinitionsList, (a_baseType).clone(), a_startValue)?;
    Ok(out_txt)
}

fn fun_493(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_description: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_description) {
...
pub(crate) fn dumpFMIModelVariableDescription(mut txt: Tpl::Text, mut a_description: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_0: bool;
    ret_0 = stringEq((a_description.clone()).clone(), (literal!("")).clone());
    out_txt = fun_493(txt, ret_0, (a_description).clone())?;
    Ok(out_txt)
}
...
fn fun_495(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_y2Placement: i32, mut in_a_x2Placement: i32, mut in_a_y1Placement: i32, mut in_a_x1Placement: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_y2Placement, in_a_x2Placement, in_a_y1Placement, in_a_x1Placement) {
...
fn fun_496(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_x1Placement: i32, mut in_a_x2Placement: i32, mut in_a_y1Placement: i32, mut in_a_y2Placement: i32, mut in_a_generateOutputConnectors: bool, mut in_a_causality: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_x1Placement, in_a_x2Placement, in_a_y1Placement, in_a_y2Placement, in_a_generateOutputConnectors, in_a_causality) {
...
pub(crate) fn dumpFMIModelVariablePlacementAnnotation(mut txt: Tpl::Text, mut a_x1Placement: i32, mut a_x2Placement: i32, mut a_y1Placement: i32, mut a_y2Placement: i32, mut a_generateInputConnectors: bool, mut a_generateOutputConnectors: bool, mut a_causality: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_1: bool;
    let mut ret_0: bool;
    ret_0 = stringEq((a_causality.clone()).clone(), (literal!("input")).clone());
    ret_1 = boolAnd(a_generateInputConnectors, ret_0);
    out_txt = fun_496(txt, ret_1, a_x1Placement, a_x2Placement, a_y1Placement, a_y2Placement, a_generateOutputConnectors, (a_causality).clone())?;
    Ok(out_txt)
}

fn lm_498(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::ModelVariables>>, mut a_fmiVersion: ArcStr, mut a_what: i32, mut a_dependent: bool, mut a_variabilityCausality: ArcStr, mut a_type: ArcStr) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_498 in &*items {
        let mut lstElt_498 = lstElt_498.clone();
        txt = (match lstElt_498.clone() {
        mut i_fmiModelVariable => {
            txt = dumpVariable(txt.clone(), i_fmiModelVariable.clone(), (a_type.clone()).clone(), (a_variabilityCausality.clone()).clone(), a_dependent, a_what, (a_fmiVersion.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
pub(crate) fn dumpVariables(mut txt: Tpl::Text, mut a_fmiModelVariablesList: Arc<metamodelica::List<FMI::ModelVariables>>, mut a_type: ArcStr, mut a_variabilityCausality: ArcStr, mut a_dependent: bool, mut a_what: i32, mut a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    out_txt = lm_498(out_txt, a_fmiModelVariablesList, (a_fmiVersion).clone(), a_what, a_dependent, (a_variabilityCausality).clone(), (a_type).clone())?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}
...
fn fun_501(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_valueReference: metamodelica::Real, mut in_a_name: ArcStr, mut in_a_what: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_valueReference, in_a_name, in_a_what) {
...
fn fun_504(mut in_txt: Tpl::Text, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_what: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_fmiModelVariable, in_a_what)) {
...
fn fun_505(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        (mut txt, false, _, _) => {
            txt.clone()
        },
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_504(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_511(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _, _) => {
            txt = fun_510(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_517(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _, _) => {
            txt = fun_516(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_523(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _, _) => {
            txt = fun_522(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_525(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_name: ArcStr, mut in_a_what: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_name, in_a_what) {
...
fn fun_528(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _, _) => {
            txt = fun_527(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_533(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _, _) => {
            txt = fun_532(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_538(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _, _) => {
            txt = fun_537(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_543(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _, _) => {
            txt = fun_542(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_547(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_546(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_551(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_550(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_552(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiVersion: ArcStr, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_fmiVersion, in_a_what, in_a_fmiModelVariable, in_a_variabilityCausality, in_a_type) {
...
fn fun_556(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_555(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_560(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_559(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_561(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiVersion: ArcStr, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_dependent: bool, mut in_a_variabilityCausality: ArcStr, mut in_a_type: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_fmiVersion, in_a_what, in_a_fmiModelVariable, in_a_dependent, in_a_variabilityCausality, in_a_type) {
...
fn fun_565(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_564(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_569(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_568(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_574(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_573(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_578(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_577(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_583(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_582(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_587(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_586(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_592(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_591(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_596(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_595(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_601(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_600(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_605(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_604(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_610(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable) => {
            txt = fun_609(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_614(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_what: i32, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_what, in_a_fmiModelVariable, in_a_fmiVersion) {
        ...
        (mut txt, _, mut a_what, mut a_fmiModelVariable, _) => {
            txt = fun_613(txt.clone(), a_fmiModelVariable.clone(), a_what.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_615(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_type: ArcStr, mut in_a_variabilityCausality: ArcStr, mut in_a_dependent: bool, mut in_a_what: i32, mut in_a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_fmiModelVariable, in_a_type, in_a_variabilityCausality, in_a_dependent, in_a_what, in_a_fmiVersion) {
...
pub(crate) fn dumpVariable(mut txt: Tpl::Text, mut a_fmiModelVariable: FMI::ModelVariables, mut a_type: ArcStr, mut a_variabilityCausality: ArcStr, mut a_dependent: bool, mut a_what: i32, mut a_fmiVersion: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_4: bool;
    let mut ret_3: bool;
    let mut ret_2: bool;
    ...
    ret_0 = stringEq((a_type.clone()).clone(), (literal!("real")).clone());
    ret_1 = stringEq((a_variabilityCausality.clone()).clone(), (literal!("parameter")).clone());
    ret_2 = boolNot(a_dependent);
    ret_3 = boolAnd(ret_1, ret_2);
    ret_4 = boolAnd(ret_0, ret_3);
    out_txt = fun_615(txt, ret_4, a_fmiModelVariable, (a_type).clone(), (a_variabilityCausality).clone(), a_dependent, a_what, (a_fmiVersion).clone())?;
    Ok(out_txt)
}

fn lm_617(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<FMI::ModelVariables>>, mut a_fmiType: ArcStr, mut a_fmiGetFunction: ArcStr, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_617 in &*items {
        let mut lstElt_617 = lstElt_617.clone();
        txt = (match lstElt_617.clone() {
        mut i_fmiModelVariable => {
...
pub(crate) fn dumpOutputGetEnumerationVariables(mut txt: Tpl::Text, mut a_fmiModelVariablesList: Arc<metamodelica::List<FMI::ModelVariables>>, mut a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut a_fmiGetFunction: ArcStr, mut a_fmiType: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = lm_617(txt, a_fmiModelVariablesList, (a_fmiType).clone(), (a_fmiGetFunction).clone(), a_fmiTypeDefinitionsList)?;
    Ok(out_txt)
}

pub(crate) fn dumpOutputGetEnumerationVariable(mut in_txt: Tpl::Text, mut in_a_fmiModelVariable: FMI::ModelVariables, mut in_a_fmiTypeDefinitionsList: Arc<metamodelica::List<FMI::TypeDefinitions>>, mut in_a_fmiGetFunction: ArcStr, mut in_a_fmiType: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_fmiModelVariable, in_a_fmiTypeDefinitionsList, in_a_fmiGetFunction, in_a_fmiType)) {
        ...
        (txt, FMI::ModelVariables::ENUMERATIONVARIABLE { variability: Deref @ "", causality: Deref @ "output", name: i_name, baseType: i_baseType, valueReference: i_valueReference, .. }, a_fmiTypeDefinitionsList, a_fmiGetFunction, a_fmiType) => {
            let mut ret_1: ArcStr;
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("{")).clone() }))?;
            txt = Tpl::writeStr(txt.clone(), (i_name.clone()).clone())?;
...
fn lm_620(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_620 in &*items {
        let mut lstElt_620 = lstElt_620.clone();
        txt = (match lstElt_620.clone() {
        mut i_var => {
...
fn lm_621(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_621 in &*items {
...
fn lm_622(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_622 in &*items {
        let mut lstElt_622 = lstElt_622.clone();
        txt = (match lstElt_622.clone() {
        mut i_var => {
            txt = ScalarVariableFMU(txt.clone(), i_var.clone(), (literal!("realVarsData")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_623(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_623 in &*items {
        let mut lstElt_623 = lstElt_623.clone();
        txt = (match lstElt_623.clone() {
        mut i_var => {
            txt = ScalarVariableFMU(txt.clone(), i_var.clone(), (literal!("realVarsData")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_624(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_624 in &*items {
...
fn lm_625(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_625 in &*items {
        let mut lstElt_625 = lstElt_625.clone();
        txt = (match lstElt_625.clone() {
        mut i_var => {
            txt = ScalarVariableFMU(txt.clone(), i_var.clone(), (literal!("realVarsData")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
...
fn lm_626(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_626 in &*items {
        let mut lstElt_626 = lstElt_626.clone();
        txt = (match lstElt_626.clone() {
        mut i_var => {
...
fn lm_627(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_627 in &*items {
        let mut lstElt_627 = lstElt_627.clone();
        txt = (match lstElt_627.clone() {
        mut i_var => {
...
fn lm_628(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_628 in &*items {
        let mut lstElt_628 = lstElt_628.clone();
        txt = (match lstElt_628.clone() {
        mut i_var => {
...
fn lm_629(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_629 in &*items {
        let mut lstElt_629 = lstElt_629.clone();
        txt = (match lstElt_629.clone() {
        mut i_var => {
...
fn lm_630(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_630 in &*items {
        let mut lstElt_630 = lstElt_630.clone();
        txt = (match lstElt_630.clone() {
        mut i_var => {
...
fn lm_631(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_631 in &*items {
        let mut lstElt_631 = lstElt_631.clone();
        txt = (match lstElt_631.clone() {
        mut i_var => {
...
fn lm_632(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    let mut txt: Tpl::Text = txt;
    for mut lstElt_632 in &*items {
        let mut lstElt_632 = lstElt_632.clone();
        txt = (match lstElt_632.clone() {
        mut i_var => {
...
fn fun_633(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { functions: _, varInfo: SimCode::VarInfo { numZeroCrossings: _, .. }, vars: SimCodeVar::SimVars { stateVars: ref i_vars_stateVars, derivativeVars: ref i_vars_derivativeVars, algVars: ref i_vars_algVars, discreteAlgVars: ref i_vars_discreteAlgVars, realOptimizeConstraintsVars: ref i_vars_realOptimizeConstraintsVars, realOptimizeFinalConstraintsVars: ref i_vars_realOptimizeFinalConstraintsVars, paramVars: ref i_vars_paramVars, intAlgVars: ref i_vars_intAlgVars, intParamVars: ref i_vars_intParamVars, boolAlgVars: ref i_vars_boolAlgVars, boolParamVars: ref i_vars_boolParamVars, stringAlgVars: ref i_vars_stringAlgVars, stringParamVars: ref i_vars_stringParamVars, .. }, .. }, simulationSettingsOpt: Some(SimCode::SimulationSettings { startTime: ref i_s_startTime, stopTime: ref i_s_stopTime, stepSize: ref i_s_stepSize, tolerance: ref i_s_tolerance, method: ref i_s_method, outputFormat: ref i_s_outputFormat, variableFilter: ref i_s_variableFilter, .. }), makefileParams: SimCodeFunction::MakefileParams { omhome: ref i_makefileParams_omhome, .. }, .. }) => {
            ...
            txt = lm_620(txt.clone(), i_vars_stateVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_621(txt.clone(), i_vars_derivativeVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_622(txt.clone(), i_vars_algVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_623(txt.clone(), i_vars_discreteAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_624(txt.clone(), i_vars_realOptimizeConstraintsVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_625(txt.clone(), i_vars_realOptimizeFinalConstraintsVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_626(txt.clone(), i_vars_paramVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_627(txt.clone(), i_vars_intAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_628(txt.clone(), i_vars_intParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_629(txt.clone(), i_vars_boolAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_630(txt.clone(), i_vars_boolParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_631(txt.clone(), i_vars_stringAlgVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            txt = lm_632(txt.clone(), i_vars_stringParamVars.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            System::tmpTickResetIndex(0, 2);
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn simulationInitFunction(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_guid: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_633(txt, a_simCode)?;
    Ok(out_txt)
}

fn fun_635(mut in_txt: Tpl::Text, mut in_a_isReadOnly: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_isReadOnly) {
        (mut txt, false) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("0")).clone() }))?;
            txt.clone()
        },
...
fn fun_636(mut in_txt: Tpl::Text, mut in_a_info: SourceInfo, mut in_a_str: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_info, in_a_str) {
        (mut txt, SourceInfo { fileName: mut i_fileName, lineNumberStart: mut i_lineNumberStart, columnNumberStart: mut i_columnNumberStart, lineNumberEnd: mut i_lineNumberEnd, columnNumberEnd: mut i_columnNumberEnd, isReadOnly: mut i_isReadOnly, .. }, mut a_str) => {
            ...
            txt = fun_635(txt.clone(), i_isReadOnly.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(";")).clone() }))?;
            txt.clone()
        },
        (mut txt, _, _) => {
...
pub(crate) fn getInfoArgsFMU(mut txt: Tpl::Text, mut a_str: ArcStr, mut a_info: SourceInfo) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_636(txt, a_info, (a_str).clone())?;
    Ok(out_txt)
}
...
pub(crate) fn ScalarVariableFMU(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_classType: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_simVar, in_a_classType)) {
...
fn fun_641(mut in_txt: Tpl::Text, mut in_a_e: Arc<DAE::Exp>, mut in_a_default: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_e, in_a_default)) {
        ...
        (txt, Deref @ DAE::Exp::BCONST { bool: i_bool }, _) => {
            let mut txt = (*txt).clone();
            txt = fun_640(txt.clone(), i_bool.clone())?;
            txt.clone()
        },
...
pub(crate) fn optInitValFMU(mut in_txt: Tpl::Text, mut in_a_exp: Option<Arc<DAE::Exp>>, mut in_a_default: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_default)) {
        (txt, Some(i_e), a_default) => {
            let mut txt = (*txt).clone();
            txt = fun_641(txt.clone(), i_e.clone(), (a_default.clone()).clone())?;
            txt.clone()
        },
        (txt, _, a_default) => {
            let mut txt = (*txt).clone();
...
fn fun_643(mut in_txt: Tpl::Text, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_isFixed) {
        (mut txt, false) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("0")).clone() }))?;
            txt.clone()
        },
...
fn fun_644(mut in_txt: Tpl::Text, mut in_a_nominalValue: Option<Arc<DAE::Exp>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_nominalValue)) {
        (txt, None) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("0")).clone() }))?;
            txt.clone()
...
fn fun_648(mut in_txt: Tpl::Text, mut in_a_type__: Arc<DAE::Type>, mut in_a_attrstr: ArcStr, mut in_a_unit: ArcStr, mut in_a_displayUnit: ArcStr, mut in_a_minValue: Option<Arc<DAE::Exp>>, mut in_a_maxValue: Option<Arc<DAE::Exp>>, mut in_a_startValue: Option<Arc<DAE::Exp>>, mut in_a_nominalValue: Option<Arc<DAE::Exp>>, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_type__, in_a_attrstr, in_a_unit, in_a_displayUnit, in_a_minValue, in_a_maxValue, in_a_startValue, in_a_nominalValue, in_a_isFixed)) {
        ...
        (txt, Deref @ DAE::Type::T_INTEGER { varLst: _ }, a_attrstr, _, _, a_minValue, a_maxValue, a_startValue, _, a_isFixed) => {
            ...
            txt = Tpl::writeStr(txt.clone(), (a_attrstr.clone()).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".fixed = ")).clone() }))?;
            txt = fun_645(txt.clone(), a_isFixed.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(";\n")).clone() }))?;
            txt = Tpl::writeStr(txt.clone(), (a_attrstr.clone()).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".start = ")).clone() }))?;
...
pub(crate) fn ScalarVariableTypeFMU(mut txt: Tpl::Text, mut a_attrstr: ArcStr, mut a_unit: ArcStr, mut a_displayUnit: ArcStr, mut a_minValue: Option<Arc<DAE::Exp>>, mut a_maxValue: Option<Arc<DAE::Exp>>, mut a_startValue: Option<Arc<DAE::Exp>>, mut a_nominalValue: Option<Arc<DAE::Exp>>, mut a_isFixed: bool, mut a_type__: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_648(txt, a_type__, (a_attrstr).clone(), (a_unit).clone(), (a_displayUnit).clone(), a_minValue, a_maxValue, a_startValue, a_nominalValue, a_isFixed)?;
    Ok(out_txt)
}
