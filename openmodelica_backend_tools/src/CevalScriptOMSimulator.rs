...
pub fn ceval(mut inFunctionName: ArcStr, mut inVals: Arc<metamodelica::List<Arc<Values::Value>>>) -> Result<Arc<Values::Value>> {
    ...
    outValue = (::match_deref::match_deref! { match &((inFunctionName, inVals)) {
        (Deref @ "loadOMSimulator", Deref @ metamodelica::List::Nil) => {
            ...
            Arc::new(Values::Value::INTEGER { integer: status })
        },
        ...
        (Deref @ "oms_exportSnapshot", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::STRING { string: (contents).clone() }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        (Deref @ "oms_extractFMIKind", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: filename }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::INTEGER { integer: kind }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        (Deref @ "oms_getBoolean", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::BOOL { boolean: b }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        (Deref @ "oms_getFixedStepSize", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::REAL { real: rvalue }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        (Deref @ "oms_getInteger", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::INTEGER { integer: ivalue }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        ...
        (Deref @ "oms_getSubModelPath", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::STRING { string: (path.clone()).clone() }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        ...
        (Deref @ "oms_getTolerance", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::REAL { real: absoluteTolerance }), Arc::new(Values::Value::REAL { real: relativeTolerance }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        (Deref @ "oms_getVariableStepSize", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::REAL { real: initialStepSize }), Arc::new(Values::Value::REAL { real: minimumStepSize }), Arc::new(Values::Value::REAL { real: maximumStepSize }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        ...
        (Deref @ "oms_importFile", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: filename }, tail: Deref @ metamodelica::List::Nil }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::STRING { string: (cref.clone()).clone() }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        ...
        (Deref @ "oms_loadSnapshot", Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: cref }, tail: Deref @ metamodelica::List::Cons { head: Deref @ Values::Value::STRING { string: snapshot }, tail: Deref @ metamodelica::List::Nil } }) => {
            ...
            Arc::new(Values::Value::TUPLE { valueLst: list![Arc::new(Values::Value::STRING { string: (newCref.clone()).clone() }), Arc::new(Values::Value::INTEGER { integer: status })] })
        },
        ...
        (Deref @ "oms_getVersion", Deref @ metamodelica::List::Nil) => {
            ...
            Arc::new(Values::Value::STRING { string: (version).clone() })
        },
