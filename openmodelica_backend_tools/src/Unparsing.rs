...
fn lm_42(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_cl, tail: rest }) => {
...
pub fn programExternalHeader(mut txt: Tpl::Text, mut a_program: Arc<metamodelica::List<Arc<SCode::Element>>>) -> Result<Tpl::Text> {
    ...
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("/* Automatically generated header for external MetaModelica functions */\n")).clone(), (literal!("#ifdef __cplusplus\n")).clone(), (literal!("extern \"C\" {\n")).clone(), (literal!("#endif\n")).clone()], lastHasNewLine: true }))?;
    out_txt = lm_42(out_txt, a_program)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("#ifdef __cplusplus\n")).clone(), (literal!("}\n")).clone(), (literal!("#endif\n")).clone(), (literal!("\n")).clone()], lastHasNewLine: true }))?;
    Ok(out_txt)
}

fn lm_44(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Var>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
        },
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ DAE::Var { name: i_var_name, .. }, tail: rest }) => {
            let mut txt = (*txt).clone();
...
fn fun_45(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_fieldsStr: Tpl::Text, mut in_a_nElts: Tpl::Text, mut in_a_omcname: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_fieldsStr, in_a_nElts, in_a_omcname)) {
...
fn lm_46(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Type>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ DAE::Type::T_METARECORD { fields: i_ty_fields, path: i_path, .. }, tail: rest }) => {
            ...
            l_fieldsStr = lm_44(l_fieldsStr, i_ty_fields.clone())?;
            ...
            ret_4 = (System::stringReplace((ret_3).clone(), (literal!("$")).clone(), (literal!("_")).clone())?).clone();
            l_omcname = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_4).clone())?;
            ret_6 = (i_ty_fields.clone().len() as i32);
            l_nElts = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_6)).clone())?;
            str_8 = (Tpl::textString(l_nElts.clone())?).clone();
            l_fieldsDescription = fun_45(Tpl::emptyTxt.clone(), (str_8).clone(), l_fieldsStr, l_nElts, l_omcname.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_fieldsDescription)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_omcname)?;
...
pub fn programExternalHeaderFromTypes(mut txt: Tpl::Text, mut a_tys: Arc<metamodelica::List<Arc<DAE::Type>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("/* Automatically generated header for bootstrapping MetaModelica */\n")).clone(), (literal!("#ifdef __cplusplus\n")).clone(), (literal!("extern \"C\" {\n")).clone(), (literal!("#endif\n")).clone()], lastHasNewLine: true }))?;
...
fn lm_48(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>, mut in_a_c_name: ArcStr) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_c_name)) {
        (txt, Deref @ metamodelica::List::Nil, _) => {
            return Ok(txt.clone())
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_elt, tail: rest }, a_c_name) => {
            let mut txt = (*txt).clone();
            txt = elementExternalHeader(txt.clone(), i_elt.clone(), (a_c_name.clone()).clone())?;
            { (in_txt, in_items, in_a_c_name) = (txt.clone(), rest.clone(), (a_c_name.clone()).clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_49(mut in_txt: Tpl::Text, mut in_a_cl: Arc<SCode::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_cl)) {
...
pub(crate) fn metaHelperBoxStart(mut in_txt: Tpl::Text, mut in_a_numVariables: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_numVariables) {
...
fn lm_53(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
        },
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ SCode::Element::COMPONENT { name: i_name, .. }, tail: rest }) => {
            let mut txt = (*txt).clone();
...
fn lm_54(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn fun_56(mut in_txt: Tpl::Text, mut in_a_p_elementLst: Arc<metamodelica::List<Arc<SCode::Element>>>, mut in_a_fields: Tpl::Text, mut in_a_omcname: Tpl::Text, mut in_a_ctor: Tpl::Text, mut in_a_fullname: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_p_elementLst, in_a_fields, in_a_omcname, in_a_ctor, in_a_fullname)) {
        ...
        (txt, i_p_elementLst, a_fields, a_omcname, a_ctor, a_fullname) => {
            ...
            txt = metaHelperBoxStart(txt.clone(), ret_1)?;
            txt = Tpl::writeText(txt.clone(), a_ctor.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(",&")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), a_omcname.clone())?;
...
pub(crate) fn elementExternalHeader(mut in_txt: Tpl::Text, mut in_a_elt: Arc<SCode::Element>, mut in_a_pack: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_elt, in_a_pack)) {
        (txt, Deref @ SCode::Element::CLASS { restriction: SCode::Restriction::R_METARECORD { moved: true, name: i_r_name, index: i_r_index, .. }, classDef: Deref @ SCode::ClassDef::PARTS { elementLst: i_p_elementLst, .. }, name: i_c_name, .. }, a_pack) => {
            ...
            l_fields = lm_53(l_fields, i_p_elementLst.clone())?;
            l_fields = Tpl::popIter(l_fields)?;
            l_fieldsStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(",")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            l_fieldsStr = lm_54(l_fieldsStr, i_p_elementLst.clone())?;
            l_fieldsStr = Tpl::popIter(l_fieldsStr)?;
            l_omcname = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_pack.clone()).clone())?;
            l_omcname = Tpl::writeTok(l_omcname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_")).clone() }))?;
            l_omcname = pathString(l_omcname, i_r_name.clone())?;
            l_omcname = Tpl::writeTok(l_omcname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_")).clone() }))?;
            ret_3 = (System::stringReplace((i_c_name.clone()).clone(), (literal!("_")).clone(), (literal!("__")).clone())?).clone();
            l_omcname = Tpl::writeStr(l_omcname, (ret_3).clone())?;
            ret_5 = (i_p_elementLst.clone().len() as i32);
            l_nElts = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_5)).clone())?;
            l_fullname = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_pack.clone()).clone())?;
            l_fullname = Tpl::writeTok(l_fullname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("__")).clone() }))?;
            ret_7 = (System::stringReplace((i_c_name.clone()).clone(), (literal!("_")).clone(), (literal!("_5f")).clone())?).clone();
            l_fullname = Tpl::writeStr(l_fullname, (ret_7).clone())?;
            ret_9 = intAdd(3, i_r_index.clone());
            l_ctor = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_9)).clone())?;
            str_11 = (Tpl::textString(l_nElts.clone())?).clone();
            l_fieldsDescription = fun_55(Tpl::emptyTxt.clone(), (str_11).clone(), l_fieldsStr, l_nElts.clone(), l_omcname.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("#ifdef ADD_METARECORD_DEFINITIONS\n")).clone(), (literal!("#ifndef ")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_omcname.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("__desc_added\n")).clone(), (literal!("#define ")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_omcname.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_nElts)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_ctor.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = fun_56(txt.clone(), i_p_elementLst.clone(), l_fields, l_omcname, l_ctor, l_fullname)?;
            txt.clone()
        },
...
fn lm_58(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>, mut in_a_buf2: Tpl::Text, mut in_a_buf1: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_buf2, in_a_buf1)) {
        (txt, Deref @ metamodelica::List::Nil, a_buf2, a_buf1) => {
            return Ok((txt.clone(), a_buf2.clone(), a_buf1.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_cl, tail: rest }, a_buf2, a_buf1) => {
            let mut txt = (*txt).clone();
            ...
            { (in_txt, in_items, in_a_buf2, in_a_buf1) = (txt.clone(), rest.clone(), a_buf2.clone(), a_buf1.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_60(mut in_txt: Tpl::Text, mut in_a_cl: Arc<SCode::Element>, mut in_a_buf1: Tpl::Text, mut in_a_buf2: Tpl::Text, mut in_a_pack: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_buf1, out_a_buf2) = (::match_deref::match_deref! { match &((in_txt, in_a_cl, in_a_buf1, in_a_buf2, in_a_pack)) {
        (txt, i_c @ Deref @ SCode::Element::CLASS { name: i_c_name, .. }, a_buf1, a_buf2, a_pack) => {
            ...
            a_buf2 = Tpl::writeTok(a_buf2.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
...
pub(crate) fn classExternalHeaderJulia(mut txt: Tpl::Text, mut a_buf1: Tpl::Text, mut a_buf2: Tpl::Text, mut a_cl: Arc<SCode::Element>, mut a_pack: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_buf1: Tpl::Text;
    let mut out_a_buf2: Tpl::Text;
    (out_txt, out_a_buf1, out_a_buf2) = fun_60(txt, a_cl, a_buf1, a_buf2, (a_pack).clone())?;
    Ok((out_txt, out_a_buf1, out_a_buf2))
}

fn lm_62(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>, mut in_a_c_name: ArcStr, mut in_a_buf2: Tpl::Text, mut in_a_buf1: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_c_name, in_a_buf2, in_a_buf1)) {
        (txt, Deref @ metamodelica::List::Nil, _, a_buf2, a_buf1) => {
            return Ok((txt.clone(), a_buf2.clone(), a_buf1.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_elt, tail: rest }, a_c_name, a_buf2, a_buf1) => {
            let mut txt = (*txt).clone();
            let mut a_buf2 = (*a_buf2).clone();
            let mut a_buf1 = (*a_buf1).clone();
            (txt, a_buf1, a_buf2) = elementExternalHeaderJulia(txt.clone(), a_buf1.clone(), a_buf2.clone(), i_elt.clone(), (a_c_name.clone()).clone())?;
            { (in_txt, in_items, in_a_c_name, in_a_buf2, in_a_buf1) = (txt.clone(), rest.clone(), (a_c_name.clone()).clone(), a_buf2.clone(), a_buf1.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_63(mut in_txt: Tpl::Text, mut in_a_cl: Arc<SCode::Element>, mut in_a_buf1: Tpl::Text, mut in_a_buf2: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_buf1: Tpl::Text;
    let mut out_a_buf2: Tpl::Text;
    (out_txt, out_a_buf1, out_a_buf2) = (::match_deref::match_deref! { match &((in_txt, in_a_cl, in_a_buf1, in_a_buf2)) {
...
pub(crate) fn classExternalHeaderJuliaWork(mut txt: Tpl::Text, mut a_buf1: Tpl::Text, mut a_buf2: Tpl::Text, mut a_cl: Arc<SCode::Element>, mut a_pack: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_buf1: Tpl::Text;
    let mut out_a_buf2: Tpl::Text;
    (out_txt, out_a_buf1, out_a_buf2) = fun_63(txt, a_cl, a_buf1, a_buf2)?;
    Ok((out_txt, out_a_buf1, out_a_buf2))
}

fn lm_65(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn lm_66(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn lm_67(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SCode::Element>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn fun_68(mut in_txt: Tpl::Text, mut in_mArg: i32, mut in_a_fields1: Tpl::Text, mut in_a_fields2: Tpl::Text, mut in_a_p_elementLst: Arc<metamodelica::List<Arc<SCode::Element>>>, mut in_a_fieldsWithType: Tpl::Text, mut in_a_omcname: Tpl::Text, mut in_a_fullname: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_fields1, in_a_fields2, in_a_p_elementLst, in_a_fieldsWithType, in_a_omcname, in_a_fullname)) {
...
fn fun_69(mut in_txt: Tpl::Text, mut in_a_elt: Arc<SCode::Element>, mut in_a_buf1: Tpl::Text, mut in_a_buf2: Tpl::Text, mut in_a_pack: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_buf1: Tpl::Text;
    let mut out_a_buf2: Tpl::Text;
    (out_txt, out_a_buf1, out_a_buf2) = (::match_deref::match_deref! { match &((in_txt, in_a_elt, in_a_buf1, in_a_buf2, in_a_pack)) {
        (txt, Deref @ SCode::Element::CLASS { restriction: SCode::Restriction::R_UNIONTYPE { .. }, classDef: Deref @ SCode::ClassDef::PARTS { elementLst: _, .. }, name: i_c_name, .. }, a_buf1, a_buf2, a_pack) => {
            ...
            l_omcname = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_pack.clone()).clone())?;
            l_omcname = Tpl::writeTok(l_omcname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_")).clone() }))?;
            l_omcname = Tpl::writeStr(l_omcname, (i_c_name.clone()).clone())?;
            ...
            a_buf1 = Tpl::writeTok(a_buf1.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
        ...
        (txt, Deref @ SCode::Element::CLASS { restriction: SCode::Restriction::R_METARECORD { moved: true, name: i_r_name, .. }, classDef: Deref @ SCode::ClassDef::PARTS { elementLst: i_p_elementLst, .. }, name: i_c_name, .. }, a_buf1, a_buf2, a_pack) => {
            ...
            l_fields1 = lm_65(l_fields1, i_p_elementLst.clone())?;
            l_fields1 = Tpl::popIter(l_fields1)?;
            ...
            l_fieldsWithType = lm_67(l_fieldsWithType, i_p_elementLst.clone())?;
            l_fieldsWithType = Tpl::popIter(l_fieldsWithType)?;
            l_funcName = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_pack.clone()).clone())?;
            l_funcName = Tpl::writeTok(l_funcName, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".")).clone() }))?;
            l_funcName = pathString(l_funcName, i_r_name.clone())?;
            l_omcname = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_pack.clone()).clone())?;
            l_omcname = Tpl::writeTok(l_omcname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_")).clone() }))?;
            l_omcname = pathString(l_omcname, i_r_name.clone())?;
            l_omcname = Tpl::writeTok(l_omcname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_")).clone() }))?;
            ret_5 = (System::stringReplace((i_c_name.clone()).clone(), (literal!("_")).clone(), (literal!("__")).clone())?).clone();
            l_omcname = Tpl::writeStr(l_omcname, (ret_5).clone())?;
            l_fullname = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_pack.clone()).clone())?;
            l_fullname = Tpl::writeTok(l_fullname, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("__")).clone() }))?;
            ret_7 = (System::stringReplace((i_c_name.clone()).clone(), (literal!("_")).clone(), (literal!("_5f")).clone())?).clone();
            l_fullname = Tpl::writeStr(l_fullname, (ret_7).clone())?;
            ...
            txt = fun_68(txt.clone(), ret_8, l_fields1, l_fields2, i_p_elementLst.clone(), l_fieldsWithType, l_omcname, l_fullname)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            (txt.clone(), a_buf1.clone(), a_buf2.clone())
        },
...
pub(crate) fn elementExternalHeaderJulia(mut txt: Tpl::Text, mut a_buf1: Tpl::Text, mut a_buf2: Tpl::Text, mut a_elt: Arc<SCode::Element>, mut a_pack: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_buf1: Tpl::Text;
    let mut out_a_buf2: Tpl::Text;
    (out_txt, out_a_buf1, out_a_buf2) = fun_69(txt, a_elt, a_buf1, a_buf2, (a_pack).clone())?;
    Ok((out_txt, out_a_buf1, out_a_buf2))
}
