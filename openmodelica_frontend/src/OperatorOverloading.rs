...
pub fn elabArglist(mut inTypes: Arc<metamodelica::List<Arc<DAE::Type>>>, mut inArgs: Arc<metamodelica::List<(Arc<DAE::Exp>, Arc<DAE::Type>)>>) -> Result<(Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<metamodelica::List<Arc<DAE::Type>>>)> {
    ...
    (outArgs, outTypes) = (::match_deref::match_deref! { match &((inTypes.clone(), inArgs.clone())) {
        ...
        (Deref @ metamodelica::List::Cons { head: pt, tail: pts }, Deref @ metamodelica::List::Cons { head: (arg, atype), tail: args }) => {
            let mut arg_1: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
...
pub fn initCache() -> () {
    { let __v = (Arc::new(crate::OperatorOverloading::AvlTreePathPathEnv::Tree::EMPTY), Arc::new(crate::OperatorOverloading::AvlTreePathOperatorTypes::Tree::EMPTY)); crate::Globals::operatorOverloadingCache.with(|__root| *__root.borrow_mut() = __v) };
    ()
}
...
fn deoverloadBinaryUserdefNoConstructor(mut inTypeList: Arc<metamodelica::List<Arc<DAE::Type>>>, mut inLhs: Arc<DAE::Exp>, mut inRhs: Arc<DAE::Exp>, mut lhsType: Arc<DAE::Type>, mut rhsType: Arc<DAE::Type>, mut inAcc: Arc<metamodelica::List<(Arc<DAE::Exp>, Option<Arc<DAE::Type>>)>>) -> Result<Arc<metamodelica::List<(Arc<DAE::Exp>, Option<Arc<DAE::Type>>)>>> {
    ...
    outExps = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: Deref @ DAE::Type::T_FUNCTION { funcArg: Deref @ metamodelica::List::Cons { head: Deref @ DAE::FuncArg { ty: ty1, .. }, tail: Deref @ metamodelica::List::Cons { head: Deref @ DAE::FuncArg { ty: ty2, .. }, tail: restArgs } }, functionAttributes: attr, funcResultType: ty, path }, tail: types }, acc) => {
                    let mut daeExp: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
                    ...
                    let mut tpl: (Arc<DAE::Exp>, Option<Arc<DAE::Type>>) = (Arc::new(<DAE::Exp as ::std::default::Default>::default()), None);
...
fn deoverloadUnaryUserdefNoConstructor(mut inTypeList: Arc<metamodelica::List<Arc<DAE::Type>>>, mut inExp: Arc<DAE::Exp>, mut inType: Arc<DAE::Type>, mut inAcc: Arc<metamodelica::List<Arc<DAE::Exp>>>) -> Result<Arc<metamodelica::List<Arc<DAE::Exp>>>> {
    ...
    outExps = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: Deref @ DAE::Type::T_FUNCTION { funcArg: Deref @ metamodelica::List::Cons { head: Deref @ DAE::FuncArg { ty: ty1, .. }, tail: restArgs }, functionAttributes: attr, funcResultType: ty, path }, tail: types }, acc) => {
                    let mut exp: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
                    let mut daeExp: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
                    let mut acc = (*acc).clone();
...
fn binaryUserdefArray2(mut inCache: FCore::Cache, mut env: FCore::Graph, mut isScalar1: bool, mut isVector1: bool, mut isMatrix1: bool, mut isScalar2: bool, mut isVector2: bool, mut isMatrix2: bool, mut inOper: Absyn::Operator, mut inExp1: Arc<DAE::Exp>, mut inExp2: Arc<DAE::Exp>, mut inType1: Arc<DAE::Type>, mut inType2: Arc<DAE::Type>, mut r#impl: bool, mut pre: DAE::Prefix, mut info: SourceInfo) -> Result<(FCore::Cache, Arc<metamodelica::List<(Arc<DAE::Exp>, Option<Arc<DAE::Type>>)>>)> {
    ...
    (cache, exps) = (match (inCache.clone(), isScalar1.clone(), isVector1.clone(), isMatrix1.clone(), isScalar2.clone(), isVector2.clone(), isMatrix2.clone(), inOper.clone()) {
        ...
        (mut __esc_cache, _, _, true, _, true, _, Absyn::Operator::MUL { .. }) => {
            ...
            let mut cr3: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut cr4: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
        ...
        (mut __esc_cache, _, _, true, _, _, true, Absyn::Operator::MUL { .. }) => {
            ...
            let mut cr3: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut cr4: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut cr5: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut cr6: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut foldExp: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut transposed: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut newType1: Arc<DAE::Type> = Arc::new(DAE::Type::T_NORETCALL);
            let mut newType2: Arc<DAE::Type> = Arc::new(DAE::Type::T_NORETCALL);
            let mut newType1_1: Arc<DAE::Type> = Arc::new(DAE::Type::T_NORETCALL);
...
fn operatorsBinary(mut inOperator: Absyn::Operator, mut t1: Arc<DAE::Type>, mut e1: Arc<DAE::Exp>, mut t2: Arc<DAE::Type>, mut e2: Arc<DAE::Exp>) -> Result<(Arc<metamodelica::List<(DAE::Operator, Arc<metamodelica::List<Arc<DAE::Type>>>, Arc<DAE::Type>)>>, Arc<DAE::Type>, Arc<DAE::Exp>, Arc<DAE::Type>, Arc<DAE::Exp>, Arc<DAE::Type>, Arc<DAE::Exp>, Arc<DAE::Type>, Arc<DAE::Exp>)> {
    ...
    let int_vector: Arc<DAE::Type> = Arc::new(DAE::Type::T_ARRAY { ty: DAE::T_INTEGER_DEFAULT().clone(), dims: list![Arc::new(openmodelica_frontend_types::DAE::Dimension::DIM_UNKNOWN)] });
    let int_matrix: Arc<DAE::Type> = Arc::new(DAE::Type::T_ARRAY { ty: int_vector.clone(), dims: list![Arc::new(openmodelica_frontend_types::DAE::Dimension::DIM_UNKNOWN)] });
    let real_vector: Arc<DAE::Type> = Arc::new(DAE::Type::T_ARRAY { ty: DAE::T_REAL_DEFAULT().clone(), dims: list![Arc::new(openmodelica_frontend_types::DAE::Dimension::DIM_UNKNOWN)] });
    let real_matrix: Arc<DAE::Type> = Arc::new(DAE::Type::T_ARRAY { ty: real_vector.clone(), dims: list![Arc::new(openmodelica_frontend_types::DAE::Dimension::DIM_UNKNOWN)] });
    ...
    let addStringArrays: Arc<metamodelica::List<(DAE::Operator, Arc<metamodelica::List<Arc<DAE::Type>>>, Arc<DAE::Type>)>> = ({
        ...
        for mut at in (stringarrtypes().clone()).into_iter().cloned() {
            let __x = (DAE::Operator::ADD_ARR { ty: Arc::new(DAE::Type::T_ARRAY { ty: DAE::T_STRING_DEFAULT().clone(), dims: list![Arc::new(openmodelica_frontend_types::DAE::Dimension::DIM_UNKNOWN)] }) }, list![at.clone(), at.clone()], at.clone());
            __acc = cons(__x, __acc);
        }
        __acc.reverse()
    });
...
pub mod AvlTreePathPathEnv {
    ...
    pub fn fold<FT: Clone + 'static>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<Absyn::Path>, FT) -> Result<FT> + 'static>, mut inStartValue: FT) -> Result<FT> {
    ...
    pub fn foldCond<FT: Clone + 'static>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<Absyn::Path>, FT) -> Result<(FT, bool)> + 'static>, mut value: FT) -> Result<FT> {
    ...
    pub fn fold_2<FT1: Clone + 'static, FT2: Clone + 'static>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<Absyn::Path>, FT1, FT2) -> Result<(FT1, FT2)> + 'static>, mut foldArg1: FT1, mut foldArg2: FT2) -> Result<(FT1, FT2)> {
    ...
    pub fn map(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<Absyn::Path>) -> Result<Arc<Absyn::Path>> + 'static>) -> Result<Arc<Tree>> {
        pub type MapFunc = std::sync::Arc<dyn ::std::ops::Fn(Key, Value) -> Result<Value> + 'static>;

        let mut outTree: Arc<Tree> = inTree.clone();
        outTree = (::match_deref::match_deref! { match &(outTree.clone()) {
        Deref @ Tree::NODE { value, key, .. } => {
            let mut new_value: Value = Arc::new(<Absyn::Path as ::std::default::Default>::default());
    ...
    pub fn mapFold<FT: Clone + 'static>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<Absyn::Path>, FT) -> Result<(Arc<Absyn::Path>, FT)> + 'static>, mut inStartValue: FT) -> Result<(Arc<Tree>, FT)> {
...
pub mod AvlTreePathOperatorTypes {
    ...
    pub fn fold<FT: Clone + 'static>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<metamodelica::List<Arc<DAE::Type>>>, FT) -> Result<FT> + 'static>, mut inStartValue: FT) -> Result<FT> {
        pub type FoldFunc<FT: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT) -> Result<FT> + 'static>;
    ...
    pub fn foldCond<FT: Clone + 'static>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<metamodelica::List<Arc<DAE::Type>>>, FT) -> Result<(FT, bool)> + 'static>, mut value: FT) -> Result<FT> {
        pub type FoldFunc<FT: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT) -> Result<(FT, bool)> + 'static>;
    ...
    pub fn fold_2<FT1: Clone + 'static, FT2: Clone + 'static>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<metamodelica::List<Arc<DAE::Type>>>, FT1, FT2) -> Result<(FT1, FT2)> + 'static>, mut foldArg1: FT1, mut foldArg2: FT2) -> Result<(FT1, FT2)> {
        pub type FoldFunc<FT1: Clone + 'static, FT2: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT1, FT2) -> Result<(FT1, FT2)> + 'static>;
    ...
    pub fn map(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<metamodelica::List<Arc<DAE::Type>>>) -> Result<Arc<metamodelica::List<Arc<DAE::Type>>>> + 'static>) -> Result<Arc<Tree>> {
        pub type MapFunc = std::sync::Arc<dyn ::std::ops::Fn(Key, Value) -> Result<Value> + 'static>;
    ...
    pub fn mapFold<FT: Clone + 'static>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::Path>, Arc<metamodelica::List<Arc<DAE::Type>>>, FT) -> Result<(Arc<metamodelica::List<Arc<DAE::Type>>>, FT)> + 'static>, mut inStartValue: FT) -> Result<(Arc<Tree>, FT)> {
        pub type MapFunc<FT: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT) -> Result<Value> + 'static>;
...
fn checkOperatorFunctionOneOutput(mut ty: Arc<DAE::Type>, mut opType: Arc<DAE::Type>, mut info: SourceInfo) -> Result<bool> {
    ...
    isOK = (::match_deref::match_deref! { match &(ty.clone()) {
        ...
        Deref @ DAE::Type::T_FUNCTION { funcArg: Deref @ metamodelica::List::Cons { head: Deref @ DAE::FuncArg { defaultBinding: None, ty: ty1, .. }, tail: Deref @ metamodelica::List::Cons { head: Deref @ DAE::FuncArg { defaultBinding: None, ty: ty2, .. }, tail: _ } }, .. } => {
            let mut b: bool = false;
        ...
        Deref @ DAE::Type::T_FUNCTION { funcArg: Deref @ metamodelica::List::Cons { head: Deref @ DAE::FuncArg { defaultBinding: None, ty: ty1, .. }, tail: _ }, .. } => {
            let mut b: bool = false;
