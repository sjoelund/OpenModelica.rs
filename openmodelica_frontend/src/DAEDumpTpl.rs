...
pub fn dumpAlgorithm(in_txt: Tpl::Text, in_a_algorithm__: Arc<DAE::Algorithm>, in_a_header: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_algorithm__.clone(), in_a_header.clone())) {
        (txt, Deref @ DAE::ALGORITHM_STMTS { statementLst: i_statementLst }, a_header) => {
...
pub fn dumpAlgorithmElement(in_txt: Tpl::Text, in_a_alg: Arc<DAE::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_alg.clone())) {
        (txt, Deref @ DAE::ALGORITHM { algorithm_: i_algorithm__, .. }) => {
            let mut txt = (*txt).clone();
...
pub fn dumpAlgorithmSection(txt: Tpl::Text, a_a: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    out_txt = lm_181(out_txt.clone(), a_a.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpAnnotation(in_txt: Tpl::Text, in_a_annotation: Arc<SCode::Annotation>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_annotation.clone())) {
        (txt, Deref @ SCode::ANNOTATION { modification: i_ann__mod }) => {
            ...
            txt = fun_226(txt.clone(), ret_0.clone(), i_ann__mod.clone())?;
            txt.clone()
        },
        (txt, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
...
pub fn dumpAnnotationOpt(in_txt: Tpl::Text, in_a_annotation: Option<Arc<SCode::Annotation>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_annotation.clone()) {
        (mut txt, Some(mut i_ann)) => {
...
pub fn dumpArrayAssignStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_ASSIGN_ARR { source: i_source, exp: i_exp, lhs: i_lhs, .. }) => {
...
pub fn dumpArrayType(in_txt: Tpl::Text, in_a_ty: Arc<DAE::Type>, in_a_dims__accum: ArcStr, in_a_attributes: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    ...
    (out_txt, out_a_attributes) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone(), in_a_dims__accum.clone(), in_a_attributes.clone())) {
        (txt, Deref @ DAE::T_ARRAY { ty: i_ty, dims: i_dims }, a_dims__accum, a_attributes) => {
            ...
            l_dims__accum__str = fun_70(Tpl::emptyTxt.clone(), (a_dims__accum.clone()).clone(), l_dims__str.clone())?;
        ...
        (txt, i_ty, a_dims__accum, a_attributes) => {
            let mut i_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>;
            let mut l_ty__str: Tpl::Text;
            let mut l_dims__accum__str: Tpl::Text;
            let mut l_dims__str: Tpl::Text;
            let mut txt = (*txt).clone();
            ...
            l_dims__str = fun_71(Tpl::emptyTxt.clone(), (a_dims__accum.clone()).clone())?;
...
pub fn dumpAssert(txt: Tpl::Text, a_cond: Arc<DAE::Exp>, a_msg: Arc<DAE::Exp>, a_lvl: Arc<DAE::Exp>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_src__str: Tpl::Text;
    ...
    l_lvl__str = fun_157(Tpl::emptyTxt.clone(), a_lvl.clone())?;
...
pub fn dumpAssignment(txt: Tpl::Text, a_lhs: Arc<DAE::Exp>, a_rhs: Arc<DAE::Exp>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_src__str: Tpl::Text;
    let mut l_rhs__str: Tpl::Text;
    let mut l_lhs__str: Tpl::Text;
    l_lhs__str = fun_188(Tpl::emptyTxt.clone(), a_lhs.clone())?;
...
pub fn dumpClassAnnotation(txt: Tpl::Text, a_comment: Option<Arc<SCode::Comment>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_cmt__str: Tpl::Text;
    l_cmt__str = dumpCommentAnnotation(Tpl::emptyTxt.clone(), a_comment.clone())?;
    out_txt = fun_214(txt.clone(), l_cmt__str.clone())?;
    Ok(out_txt)
}

pub fn dumpComment(in_txt: Tpl::Text, in_a_comment: Arc<SCode::Comment>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpCommentAnnotation(in_txt: Tpl::Text, in_a_comment: Option<Arc<SCode::Comment>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpCommentAnnotationNoOpt(in_txt: Tpl::Text, in_a_comment: Arc<SCode::Comment>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_comment.clone())) {
...
pub fn dumpCommentOpt(in_txt: Tpl::Text, in_a_comment: Option<Arc<SCode::Comment>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_comment.clone()) {
        (mut txt, Some(mut i_cmt)) => {
...
pub fn dumpCommentStr(in_txt: Tpl::Text, in_a_comment: Option<ArcStr>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_comment.clone()) {
        (mut txt, Some(mut i_cmt)) => {
...
pub fn dumpComp(in_txt: Tpl::Text, in_a_fixedDae: Arc<DAEDump::compWithSplitElements>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_fixedDae.clone())) {
        (txt, Deref @ DAEDump::COMP_WITH_SPLIT { spltElems: i_spltElems, name: i_name, comment: i_comment }) => {
            let mut ret_3: bool;
            ...
            l_name__rep = fun_17(Tpl::emptyTxt.clone(), ret_3.clone(), (i_name.clone()).clone())?;
            ...
            txt = Tpl::softNewLine(txt.clone())?;
            txt = fun_18(txt.clone(), l_ann__str.clone())?;
...
pub fn dumpCompAnnotation(txt: Tpl::Text, a_comment: Option<Arc<SCode::Comment>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_cmt__str: Tpl::Text;
    l_cmt__str = dumpCommentAnnotation(Tpl::emptyTxt.clone(), a_comment.clone())?;
    out_txt = fun_216(txt.clone(), l_cmt__str.clone())?;
    Ok(out_txt)
}

pub fn dumpCompStream(in_txt: Tpl::Text, in_a_elems: Arc<DAEDump::splitElements>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_elems.clone())) {
        (txt, Deref @ DAEDump::SPLIT_ELEMENTS { sm: i_sm, a: i_a, e: i_e, ia: i_ia, ie: i_ie, v: i_v, .. }) => {
            ...
            l_sm__str = lm_20(l_sm__str.clone(), i_sm.clone())?;
...
pub fn dumpConst(in_txt: Tpl::Text, in_a_c: DAE::Const) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpCref(in_txt: Tpl::Text, in_a_c: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_c.clone())) {
        (txt, Deref @ DAE::CREF_QUAL { componentRef: i_componentRef, subscriptLst: i_subscriptLst, ident: i_ident, .. }) => {
            let mut ret_0: bool;
            let mut txt = (*txt).clone();
            ret_0 = Flags::getConfigBool(Flags::MODELICA_OUTPUT.clone())?;
            txt = fun_139(txt.clone(), ret_0.clone(), i_componentRef.clone(), i_subscriptLst.clone(), (i_ident.clone()).clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::CREF_IDENT { subscriptLst: i_subscriptLst, ident: i_ident @ Deref @ "$DER", .. }) => {
            let mut i_componentRef: Arc<DAE::ComponentRef>;
            let mut ret_0: bool;
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::CREF_IDENT { subscriptLst: i_subscriptLst, ident: i_ident, .. }) => {
            let mut i_componentRef: Arc<DAE::ComponentRef>;
            let mut ret_0: bool;
            let mut txt = (*txt).clone();
            txt = Tpl::writeStr(txt.clone(), (i_ident.clone()).clone())?;
...
pub fn dumpDAE(txt: Tpl::Text, a_fixedDaeList: Arc<metamodelica::List<Arc<DAEDump::compWithSplitElements>>>, a_funLists: DAEDump::functionList) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    l_comp__str = lm_13(l_comp__str.clone(), a_fixedDaeList.clone())?;
    l_comp__str = Tpl::popIter(l_comp__str.clone())?;
    l_fun__str = fun_14(Tpl::emptyTxt.clone(), a_funLists.clone())?;
    out_txt = fun_15(txt.clone(), l_fun__str.clone(), l_comp__str.clone())?;
    Ok(out_txt)
}

pub fn dumpDefine(txt: Tpl::Text, a_lhs: Arc<DAE::ComponentRef>, a_rhs: Arc<DAE::Exp>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_src__str: Tpl::Text;
    let mut l_rhs__str: Tpl::Text;
    let mut l_lhs__str: Tpl::Text;
...
pub fn dumpDimension(in_txt: Tpl::Text, in_a_dim: Arc<DAE::Dimension>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_dim.clone())) {
        (txt, Deref @ DAE::DIM_INTEGER { integer: i_integer }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_enumTypeName: Arc<Absyn::Path>;
            let mut txt = (*txt).clone();
            txt = Tpl::writeStr(txt.clone(), (intString(i_integer.clone())).clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::DIM_ENUM { enumTypeName: i_enumTypeName, .. }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_integer: i32;
            let mut txt = (*txt).clone();
            txt = AbsynDumpTpl::dumpPath(txt.clone(), i_enumTypeName.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::DIM_EXP { exp: i_exp }) => {
            let mut i_enumTypeName: Arc<Absyn::Path>;
            let mut i_integer: i32;
            let mut txt = (*txt).clone();
...
pub fn dumpDimensions(in_txt: Tpl::Text, in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_dims.clone())) {
        ...
        (txt, i_dims) => {
            ...
            txt = lm_85(txt.clone(), i_dims.clone())?;
...
pub fn dumpDistribution(in_txt: Tpl::Text, in_a_distribution: Arc<DAE::Distribution>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpDistributionAttr(txt: Tpl::Text, a_distribution: Arc<DAE::Distribution>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpDistributionAttrOpt(in_txt: Tpl::Text, in_a_distribution: Option<Arc<DAE::Distribution>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_distribution.clone()) {
        (mut txt, Some(mut i_d)) => {
...
pub fn dumpElseIfEquation(in_txt: Tpl::Text, in_a_condition1: Arc<metamodelica::List<Arc<DAE::Exp>>>, in_a_equations: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Element>>>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_condition1.clone(), in_a_equations.clone())) {
        (txt, Deref @ metamodelica::List::Cons { head: i_cond, tail: i_rest__conds }, a_equations) => {
            let mut txt = (*txt).clone();
            txt = fun_176(txt.clone(), a_equations.clone(), i_rest__conds.clone(), i_cond.clone())?;
            txt.clone()
        },
        (txt, _, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
...
pub fn dumpElseIfStatements(in_txt: Tpl::Text, in_a_else__: Arc<DAE::Else>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_else__.clone())) {
        (txt, Deref @ DAE::ELSEIF { else_: i_else__, statementLst: i_statementLst, exp: i_exp }) => {
            ...
            l_elseif__body__str = lm_195(l_elseif__body__str.clone(), i_statementLst.clone())?;
        ...
        (txt, Deref @ DAE::ELSE { statementLst: i_statementLst }) => {
            let mut i_else__: Arc<DAE::Else>;
            let mut i_exp: Arc<DAE::Exp>;
            let mut l_else__body__str: Tpl::Text;
            let mut l_else__str: Tpl::Text;
            let mut l_elseif__body__str: Tpl::Text;
            ...
            l_else__body__str = lm_196(l_else__body__str.clone(), i_statementLst.clone())?;
...
pub fn dumpEquEquation(txt: Tpl::Text, a_lhs: Arc<DAE::ComponentRef>, a_rhs: Arc<DAE::ComponentRef>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_src__str: Tpl::Text;
    let mut l_rhs__str: Tpl::Text;
    let mut l_lhs__str: Tpl::Text;
...
pub fn dumpEquation(txt: Tpl::Text, a_lhs: Arc<DAE::Exp>, a_rhs: Arc<DAE::Exp>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_src__str: Tpl::Text;
    let mut l_rhs__str: Tpl::Text;
    let mut l_lhs__str: Tpl::Text;
    l_lhs__str = fun_153(Tpl::emptyTxt.clone(), a_lhs.clone())?;
    l_rhs__str = dumpExp(Tpl::emptyTxt.clone(), a_rhs.clone())?;
    l_src__str = dumpSource(Tpl::emptyTxt.clone(), a_src.clone())?;
    out_txt = Tpl::writeText(txt.clone(), l_lhs__str.clone())?;
    out_txt = Tpl::writeTok(out_txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" = ")).clone() }))?;
...
pub fn dumpEquationElement(in_txt: Tpl::Text, in_a_lst: Arc<DAE::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lst.clone())) {
        (txt, Deref @ DAE::EQUATION { source: i_source, scalar: i_scalar, exp: i_exp }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
            let mut i_equations3: Arc<metamodelica::List<Arc<DAE::Element>>>;
            let mut i_equations2: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Element>>>>>;
            let mut i_condition1: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_lst: Arc<DAE::Element>;
            let mut i_componentRef: Arc<DAE::ComponentRef>;
            let mut i_rhs: Arc<DAE::Exp>;
            let mut i_lhs: Arc<DAE::Exp>;
            let mut i_array: Arc<DAE::Exp>;
            let mut i_cr2: Arc<DAE::ComponentRef>;
            let mut i_cr1: Arc<DAE::ComponentRef>;
            let mut txt = (*txt).clone();
            txt = dumpEquation(txt.clone(), i_exp.clone(), i_scalar.clone(), i_source.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::EQUEQUATION { source: i_source, cr2: i_cr2, cr1: i_cr1 }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
            ...
            let mut i_lhs: Arc<DAE::Exp>;
            let mut i_array: Arc<DAE::Exp>;
            let mut i_scalar: Arc<DAE::Exp>;
            let mut i_exp: Arc<DAE::Exp>;
            let mut txt = (*txt).clone();
            txt = dumpEquEquation(txt.clone(), i_cr1.clone(), i_cr2.clone(), i_source.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::ARRAY_EQUATION { source: i_source, array: i_array, exp: i_exp, .. }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::COMPLEX_EQUATION { source: i_source, rhs: i_rhs, lhs: i_lhs }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::DEFINE { source: i_source, exp: i_exp, componentRef: i_componentRef }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, i_lst @ Deref @ DAE::WHEN_EQUATION { condition: _, .. }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
            ...
            let mut i_cr2: Arc<DAE::ComponentRef>;
            let mut i_cr1: Arc<DAE::ComponentRef>;
            let mut i_source: Arc<DAE::ElementSource>;
            let mut i_scalar: Arc<DAE::Exp>;
            let mut i_exp: Arc<DAE::Exp>;
            let mut txt = (*txt).clone();
        ...
        (txt, i_lst @ Deref @ DAE::FOR_EQUATION { type_: _, .. }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::IF_EQUATION { source: i_source, equations3: i_equations3, equations2: i_equations2, condition1: i_condition1 }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::ASSERT { source: i_source, level: i_level, message: i_message, condition: i_condition }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_equations3: Arc<metamodelica::List<Arc<DAE::Element>>>;
            let mut i_equations2: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Element>>>>>;
        ...
        (txt, Deref @ DAE::INITIAL_ASSERT { source: i_source, level: i_level, message: i_message, condition: i_condition }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_equations3: Arc<metamodelica::List<Arc<DAE::Element>>>;
            let mut i_equations2: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Element>>>>>;
        ...
        (txt, Deref @ DAE::TERMINATE { source: i_source, message: i_message }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::INITIAL_TERMINATE { source: i_source, message: i_message }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::REINIT { source: i_source, exp: i_exp, componentRef: i_componentRef }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::NORETCALL { source: i_source, exp: i_exp }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::INITIAL_NORETCALL { source: i_source, exp: i_exp }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::INITIALDEFINE { source: i_source, exp: i_exp, componentRef: i_componentRef }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::INITIAL_ARRAY_EQUATION { source: i_source, array: i_array, exp: i_exp, .. }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::INITIAL_COMPLEX_EQUATION { source: i_source, rhs: i_rhs, lhs: i_lhs }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, i_lst @ Deref @ DAE::INITIAL_FOR_EQUATION { type_: _, .. }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::INITIAL_IF_EQUATION { source: i_source, equations3: i_equations3, equations2: i_equations2, condition1: i_condition1 }) => {
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::INITIALEQUATION { source: i_source, exp2: i_exp2, exp1: i_exp1 }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_message: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
            let mut i_equations3: Arc<metamodelica::List<Arc<DAE::Element>>>;
...
pub fn dumpEquationSection(in_txt: Tpl::Text, in_a_e: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_e.clone())) {
        ...
        (txt, i_e) => {
            ...
            txt = lm_150(txt.clone(), i_e.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt.clone()
        },
...
pub fn dumpExp(txt: Tpl::Text, a_exp: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = ExpressionDumpTpl::dumpExp(txt.clone(), a_exp.clone(), (literal!("\\\"")).clone())?;
    Ok(out_txt)
}

pub fn dumpExpAttrOpt(in_txt: Tpl::Text, in_a_exp: Option<Arc<DAE::Exp>>, in_a_attr: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_exp.clone(), in_a_attr.clone()) {
        (mut txt, Some(mut i_e), mut a_attr) => {
...
pub fn dumpExtArg(in_txt: Tpl::Text, in_a_arg: DAE::ExtArg) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_arg.clone()) {
        (mut txt, DAE::EXTARG { componentRef: ref i_componentRef, .. }) => {
            let mut i_exp: Arc<DAE::Exp>;
            txt = dumpCref(txt.clone(), i_componentRef.clone())?;
            txt.clone()
        },
        (mut txt, DAE::EXTARGEXP { exp: ref i_exp, .. }) => {
            let mut i_componentRef: Arc<DAE::ComponentRef>;
            txt = dumpExp(txt.clone(), i_exp.clone())?;
            txt.clone()
        },
        (mut txt, DAE::EXTARGSIZE { exp: ref i_exp, componentRef: ref i_componentRef, .. }) => {
...
pub fn dumpExtArgs(txt: Tpl::Text, a_args: Arc<metamodelica::List<DAE::ExtArg>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    out_txt = lm_38(out_txt.clone(), a_args.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpExternalDecl(in_txt: Tpl::Text, in_a_externalDecl: DAE::ExternalDecl) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_externalDecl.clone()) {
        (mut txt, DAE::EXTERNALDECL { ann: mut i_ann, language: mut i_language, returnArg: mut i_returnArg, args: ref i_args, name: mut i_name }) => {
            ...
            l_func__str = fun_34(Tpl::emptyTxt.clone(), l_func__name__str.clone(), l_func__args__str.clone())?;
            l_ext__output__str = dumpExtArg(Tpl::emptyTxt.clone(), i_returnArg.clone())?;
            l_output__str = fun_35(Tpl::emptyTxt.clone(), l_ext__output__str.clone())?;
            l_lang__str = Tpl::writeStr(Tpl::emptyTxt.clone(), (i_language.clone()).clone())?;
            l_ann__str = fun_36(Tpl::emptyTxt.clone(), i_ann.clone())?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
...
pub fn dumpFinalPrefix(in_txt: Tpl::Text, in_a_varAttr: Arc<DAE::VariableAttributes>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_varAttr.clone())) {
        (txt, Deref @ DAE::VAR_ATTR_REAL { finalPrefix: Some(true), .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" final")).clone() }))?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_INT { finalPrefix: Some(true), .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" final")).clone() }))?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_BOOL { finalPrefix: Some(true), .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" final")).clone() }))?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_STRING { finalPrefix: Some(true), .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" final")).clone() }))?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_ENUMERATION { finalPrefix: Some(true), .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" final")).clone() }))?;
            txt.clone()
        },
...
pub fn dumpForEquation(in_txt: Tpl::Text, in_a_lst: Arc<DAE::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lst.clone())) {
        (txt, Deref @ DAE::FOR_EQUATION { iter: i_iter, source: i_source, equations: i_equations, range: i_range, .. }) => {
            let mut l_src__str: Tpl::Text;
            ...
            l_body__str = lm_167(l_body__str.clone(), i_equations.clone())?;
        ...
        (txt, Deref @ DAE::INITIAL_FOR_EQUATION { iter: i_iter, source: i_source, equations: i_equations, range: i_range, .. }) => {
            let mut l_src__str: Tpl::Text;
            let mut l_body__str: Tpl::Text;
            let mut l_range__str: Tpl::Text;
            let mut txt = (*txt).clone();
...
pub fn dumpForStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_FOR { iter: i_iter, source: i_source, statementLst: i_statementLst, range: i_range, .. }) => {
            let mut l_src__str: Tpl::Text;
            ...
            l_alg__str = lm_198(l_alg__str.clone(), i_statementLst.clone())?;
...
pub fn dumpFuncArg(in_txt: Tpl::Text, in_a_arg: Arc<DAE::FuncArg>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_arg.clone())) {
        (txt, Deref @ DAE::FUNCARG { name: i_name, defaultBinding: i_defaultBinding, par: i_par, r#const: i_const, ty: i_ty }) => {
            ...
            l_binding__str = fun_77(Tpl::emptyTxt.clone(), i_defaultBinding.clone())?;
            txt = Tpl::writeText(txt.clone(), l_ty__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
...
pub fn dumpFunction(in_txt: Tpl::Text, in_a_function: DAE::Function) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_function.clone())) {
        (txt, DAE::FUNCTION { isImpure: i_isImpure, comment: i_comment, path: i_path, functions: i_functions @ Deref @ metamodelica::List::Cons { head: DAE::FUNCTION_PARTIAL_DERIVATIVE { derivedFunction: _, .. }, tail: Deref @ metamodelica::List::Nil }, .. }) => {
            let mut i_type__: Arc<DAE::Type>;
            let mut ret_4: bool;
            ...
            l_cmt__str = dumpCommentOpt(Tpl::emptyTxt.clone(), i_comment.clone())?;
            l_ann__str = dumpClassAnnotation(Tpl::emptyTxt.clone(), i_comment.clone())?;
            l_impure__str = fun_24(Tpl::emptyTxt.clone(), i_isImpure.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_cmt__str.clone())?;
            txt = fun_25(txt.clone(), l_ann__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_ann__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(";")).clone() }))?;
            txt.clone()
        },
        (txt, DAE::FUNCTION { functions: i_functions, path: i_path, isImpure: i_isImpure, comment: i_comment, .. }) => {
            let mut i_type__: Arc<DAE::Type>;
            let mut ret_4: bool;
            let mut l_impure__str: Tpl::Text;
            let mut l_ann__str: Tpl::Text;
            ...
            l_cmt__str = dumpCommentOpt(Tpl::emptyTxt.clone(), i_comment.clone())?;
            l_ann__str = dumpClassAnnotation(Tpl::emptyTxt.clone(), i_comment.clone())?;
            l_impure__str = fun_26(Tpl::emptyTxt.clone(), i_isImpure.clone())?;
            txt = Tpl::writeText(txt.clone(), l_impure__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("function ")).clone() }))?;
            ...
            txt = dumpFunctionDefinitions(txt.clone(), i_functions.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = fun_27(txt.clone(), l_ann__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_ann__str.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("end ")).clone() }))?;
            txt = AbsynDumpTpl::dumpPathNoQual(txt.clone(), i_path.clone())?;
        ...
        (txt, DAE::RECORD_CONSTRUCTOR { type_: i_type__, path: i_path, .. }) => {
            let mut i_functions: Arc<metamodelica::List<DAE::FunctionDefinition>>;
            let mut i_isImpure: bool;
            let mut i_comment: Option<Arc<SCode::Comment>>;
            let mut ret_4: bool;
            let mut l_impure__str: Tpl::Text;
            let mut l_ann__str: Tpl::Text;
            let mut l_cmt__str: Tpl::Text;
            ...
            txt = fun_28(txt.clone(), ret_4.clone(), i_type__.clone(), i_path.clone())?;
            txt.clone()
        },
        (txt, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
...
pub fn dumpFunctionAlgorithm(in_txt: Tpl::Text, in_a_algorithm__: Arc<DAE::Algorithm>, in_a_label: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_algorithm__.clone(), in_a_label.clone())) {
        (txt, Deref @ DAE::ALGORITHM_STMTS { statementLst: i_statementLst }, a_label) => {
            let mut txt = (*txt).clone();
...
pub fn dumpFunctionAnnotation(in_txt: Tpl::Text, in_a_lst: Arc<DAE::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lst.clone())) {
        (txt, Deref @ DAE::COMMENT { cmt: i_cmt }) => {
            let mut l_x: Tpl::Text;
            let mut txt = (*txt).clone();
            l_x = dumpCommentAnnotationNoOpt(Tpl::emptyTxt.clone(), i_cmt.clone())?;
            txt = fun_52(txt.clone(), l_x.clone())?;
            txt.clone()
        },
        (txt, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
...
pub fn dumpFunctionBody(txt: Tpl::Text, a_dAElist: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_48(out_txt.clone(), a_dAElist.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    out_txt = lm_49(out_txt.clone(), a_dAElist.clone())?;
    Ok(out_txt)
}

pub fn dumpFunctionDefinition(in_txt: Tpl::Text, in_a_functions: DAE::FunctionDefinition) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_functions.clone()) {
        (mut txt, DAE::FUNCTION_DEF { body: ref i_body }) => {
            let mut i_derivedFunction: Arc<Absyn::Path>;
            let mut i_derivedVars: Arc<metamodelica::List<ArcStr>>;
            let mut i_externalDecl: DAE::ExternalDecl;
            let mut l_vars: Tpl::Text;
            txt = dumpFunctionBody(txt.clone(), i_body.clone())?;
            txt.clone()
        },
        (mut txt, DAE::FUNCTION_EXT { externalDecl: mut i_externalDecl, body: ref i_body }) => {
            let mut i_derivedFunction: Arc<Absyn::Path>;
            let mut i_derivedVars: Arc<metamodelica::List<ArcStr>>;
            let mut l_vars: Tpl::Text;
            txt = dumpFunctionBody(txt.clone(), i_body.clone())?;
        ...
        (mut txt, DAE::FUNCTION_DER_MAPPER { derivedFunction: _, .. }) => txt.clone(),
        (mut txt, DAE::FUNCTION_INVERSE { inputParam: _, .. }) => txt.clone(),
        (mut txt, DAE::FUNCTION_PARTIAL_DERIVATIVE { derivedFunction: ref i_derivedFunction, derivedVars: ref i_derivedVars }) => {
            let mut i_externalDecl: DAE::ExternalDecl;
            let mut i_body: Arc<metamodelica::List<Arc<DAE::Element>>>;
            let mut l_vars: Tpl::Text;
            ...
            l_vars = lm_32(l_vars.clone(), i_derivedVars.clone())?;
...
pub fn dumpFunctionDefinitions(txt: Tpl::Text, a_functions: Arc<metamodelica::List<DAE::FunctionDefinition>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_30(out_txt.clone(), a_functions.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpFunctionElement(in_txt: Tpl::Text, in_a_lst: Arc<DAE::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lst.clone())) {
        (txt, i_lst @ Deref @ DAE::VAR { componentRef: _, .. }) => {
            let mut i_algorithm__: Arc<DAE::Algorithm>;
            let mut txt = (*txt).clone();
            txt = dumpVar(txt.clone(), i_lst.clone(), true)?;
            txt.clone()
        },
        (txt, Deref @ DAE::INITIALALGORITHM { algorithm_: i_algorithm__, .. }) => {
            let mut i_lst: Arc<DAE::Element>;
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::COMMENT { cmt: _ }) => txt.clone(),
        (txt, _) => {
            let mut i_algorithm__: Arc<DAE::Algorithm>;
            let mut i_lst: Arc<DAE::Element>;
            let mut txt = (*txt).clone();
...
pub fn dumpFunctionType(in_txt: Tpl::Text, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone())) {
        (txt, Deref @ DAE::T_FUNCTION { funcResultType: i_funcResultType, path: i_path, funcArg: i_funcArg, .. }) => {
            ...
            l_args__str = lm_75(l_args__str.clone(), i_funcArg.clone())?;
...
pub fn dumpFunctions(txt: Tpl::Text, a_funcs: Arc<metamodelica::List<DAE::Function>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    out_txt = lm_22(out_txt.clone(), a_funcs.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpIfEquation(in_txt: Tpl::Text, in_a_conds: Arc<metamodelica::List<Arc<DAE::Exp>>>, in_a_branches: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Element>>>>>, in_a_else__branch: Arc<metamodelica::List<Arc<DAE::Element>>>, in_a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_conds.clone(), in_a_branches.clone(), in_a_else__branch.clone(), in_a_src.clone())) {
        (txt, Deref @ metamodelica::List::Cons { head: i_if__cond, tail: i_elseif__conds }, a_branches, a_else__branch, a_src) => {
            let mut txt = (*txt).clone();
            txt = fun_173(txt.clone(), a_branches.clone(), a_src.clone(), a_else__branch.clone(), i_elseif__conds.clone(), i_if__cond.clone())?;
            txt.clone()
        },
...
pub fn dumpIfStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_IF { source: i_source, else_: i_else__, statementLst: i_statementLst, exp: i_exp }) => {
            let mut l_src__str: Tpl::Text;
            ...
            l_true__branch__str = lm_193(l_true__branch__str.clone(), i_statementLst.clone())?;
...
pub fn dumpInitialAlgorithm(in_txt: Tpl::Text, in_a_alg: Arc<DAE::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_alg.clone())) {
        (txt, Deref @ DAE::INITIALALGORITHM { algorithm_: i_algorithm__, .. }) => {
            let mut txt = (*txt).clone();
...
pub fn dumpInitialAlgorithmSection(txt: Tpl::Text, a_ia: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_178(out_txt.clone(), a_ia.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpInitialEquationSection(in_txt: Tpl::Text, in_a_ie: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ie.clone())) {
        ...
        (txt, i_ie) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            txt = lm_148(txt.clone(), i_ie.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt.clone()
        },
...
pub fn dumpNoRetCall(txt: Tpl::Text, a_call__exp: Arc<DAE::Exp>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    l_src__str = dumpSource(Tpl::emptyTxt.clone(), a_src.clone())?;
    l_tail__str = fun_161(Tpl::emptyTxt.clone(), a_call__exp.clone())?;
...
pub fn dumpParForStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_PARFOR { iter: i_iter, source: i_source, statementLst: i_statementLst, range: i_range, .. }) => {
            let mut l_src__str: Tpl::Text;
            let mut l_alg__str: Tpl::Text;
            let mut l_range__str: Tpl::Text;
            let mut txt = (*txt).clone();
            l_range__str = dumpExp(Tpl::emptyTxt.clone(), i_range.clone())?;
            l_alg__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_alg__str = lm_200(l_alg__str.clone(), i_statementLst.clone())?;
            l_alg__str = Tpl::popIter(l_alg__str.clone())?;
            l_src__str = dumpSource(Tpl::emptyTxt.clone(), i_source.clone())?;
...
pub fn dumpPathLastIndent(in_txt: Tpl::Text, in_a_path: Arc<Absyn::Path>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_path.clone())) {
        (txt, Deref @ Absyn::FULLYQUALIFIED { path: i_path }) => {
            let mut i_name: ArcStr;
            let mut txt = (*txt).clone();
            txt = dumpPathLastIndent(txt.clone(), i_path.clone())?;
            txt.clone()
        },
        (txt, Deref @ Absyn::QUALIFIED { path: i_path, .. }) => {
            let mut i_name: ArcStr;
            let mut txt = (*txt).clone();
            txt = dumpPathLastIndent(txt.clone(), i_path.clone())?;
            txt.clone()
        },
        (txt, Deref @ Absyn::IDENT { name: i_name }) => {
...
pub fn dumpRecordConstructorBinding(in_txt: Tpl::Text, in_a_binding: Arc<DAE::Binding>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_binding.clone())) {
        (txt, Deref @ DAE::UNBOUND) => txt.clone(),
        (txt, Deref @ DAE::EQBOUND { exp: i_exp, .. }) => {
            let mut txt = (*txt).clone();
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
pub fn dumpRecordInputVarStr(in_txt: Tpl::Text, in_a_type__: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_type__.clone())) {
        (txt, Deref @ DAE::T_COMPLEX { varLst: i_varLst, .. }) => {
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut txt = (*txt).clone();
            txt = dumpRecordVars(txt.clone(), i_varLst.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::T_FUNCTION { funcResultType: i_funcResultType, .. }) => {
            let mut i_varLst: Arc<metamodelica::List<Arc<DAE::Var>>>;
            let mut txt = (*txt).clone();
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
pub fn dumpRecordType(in_txt: Tpl::Text, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone())) {
        (txt, Deref @ DAE::T_COMPLEX { varLst: i_varLst, complexClassType: i_complexClassType, .. }) => {
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut l_vars: Tpl::Text;
            let mut ret_1: Arc<Absyn::Path>;
            let mut l_name: Tpl::Text;
            let mut txt = (*txt).clone();
            ret_1 = ClassInf::getStateName(i_complexClassType.clone());
        ...
        (txt, Deref @ DAE::T_FUNCTION { funcResultType: i_funcResultType, .. }) => {
            let mut i_varLst: Arc<metamodelica::List<Arc<DAE::Var>>>;
            let mut i_complexClassType: ClassInf::State;
            let mut l_vars: Tpl::Text;
            let mut ret_1: Arc<Absyn::Path>;
            let mut l_name: Tpl::Text;
            let mut txt = (*txt).clone();
...
pub fn dumpRecordVar(in_txt: Tpl::Text, in_a_v: Arc<DAE::Var>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_v.clone())) {
        (txt, Deref @ DAE::TYPES_VAR { name: i_name, ty: i_ty, binding: i_binding, attributes: i_attributes, .. }) => {
            let mut l_ty__str: Tpl::Text;
            let mut l_attr: Tpl::Text;
            let mut l_binding__str: Tpl::Text;
...
pub fn dumpRecordVarBinding(in_txt: Tpl::Text, in_a_binding: Arc<DAE::Binding>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_binding.clone())) {
        (txt, Deref @ DAE::UNBOUND) => txt.clone(),
        (txt, Deref @ DAE::EQBOUND { exp: i_exp, .. }) => {
        ...
        (txt, Deref @ DAE::VALBOUND { valBound: _, .. }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut txt = (*txt).clone();
...
pub fn dumpRecordVars(txt: Tpl::Text, a_varLst: Arc<metamodelica::List<Arc<DAE::Var>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_42(out_txt.clone(), a_varLst.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpReinit(txt: Tpl::Text, a_cref: Arc<DAE::ComponentRef>, a_exp: Arc<DAE::Exp>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_src__str: Tpl::Text;
...
pub fn dumpReinitStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_REINIT { source: i_source, value: i_value, var: i_var }) => {
            let mut l_src__str: Tpl::Text;
...
pub fn dumpSource(in_txt: Tpl::Text, in_a_source: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_source.clone())) {
        (txt, Deref @ DAE::SOURCE { comment: i_comment, .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" + ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            txt = lm_229(txt.clone(), i_comment.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt.clone()
        },
        (txt, _) => txt.clone(),
...
pub fn dumpStartOriginAttrOpt(txt: Tpl::Text, a_startOrigin: Option<Arc<DAE::Exp>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_0: bool;
    ret_0 = Config::showStartOrigin()?;
    out_txt = fun_137(txt.clone(), ret_0.clone(), a_startOrigin.clone())?;
    Ok(out_txt)
}

pub fn dumpStateMachineComment(in_txt: Tpl::Text, in_a_cmt: Arc<SCode::Comment>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_cmt.clone())) {
        (txt, Deref @ SCode::COMMENT { comment: i_comment, .. }) => {
            let mut l_kind__str: Tpl::Text;
            let mut txt = (*txt).clone();
            l_kind__str = fun_211(Tpl::emptyTxt.clone(), i_comment.clone())?;
...
pub fn dumpStateMachineSection(in_txt: Tpl::Text, in_a_fixedDae: Arc<DAEDump::compWithSplitElements>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_fixedDae.clone())) {
        (txt, Deref @ DAEDump::COMP_WITH_SPLIT { spltElems: i_spltElems, name: i_name, comment: i_comment }) => {
            let mut l_kind: Tpl::Text;
            let mut txt = (*txt).clone();
            l_kind = fun_209(Tpl::emptyTxt.clone(), i_comment.clone())?;
...
pub fn dumpStateSelect(in_txt: Tpl::Text, in_a_stateSelect: DAE::StateSelect) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpStateSelectAttr(txt: Tpl::Text, a_stateSelect: DAE::StateSelect) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpStateSelectAttrOpt(in_txt: Tpl::Text, in_a_stateSelect: Option<DAE::StateSelect>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_stateSelect.clone()) {
...
pub fn dumpStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_ASSIGN { source: i_source, exp: i_exp, exp1: i_exp1, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_stmt: Arc<DAE::Statement>;
            let mut txt = (*txt).clone();
            txt = dumpAssignment(txt.clone(), i_exp1.clone(), i_exp.clone(), i_source.clone())?;
            txt.clone()
        },
        (txt, i_stmt @ Deref @ DAE::STMT_TUPLE_ASSIGN { expExpLst: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, i_stmt @ Deref @ DAE::STMT_ASSIGN_ARR { lhs: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, i_stmt @ Deref @ DAE::STMT_IF { exp: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, i_stmt @ Deref @ DAE::STMT_FOR { iterIsArray: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, i_stmt @ Deref @ DAE::STMT_PARFOR { iterIsArray: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, i_stmt @ Deref @ DAE::STMT_WHILE { exp: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, i_stmt @ Deref @ DAE::STMT_WHEN { exp: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, Deref @ DAE::STMT_ASSERT { source: i_source, level: i_level, msg: i_msg, cond: i_cond }) => {
            let mut i_stmt: Arc<DAE::Statement>;
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::STMT_TERMINATE { source: i_source, msg: i_msg }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_stmt: Arc<DAE::Statement>;
            let mut i_exp: Arc<DAE::Exp>;
        ...
        (txt, i_stmt @ Deref @ DAE::STMT_REINIT { var: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_source: Arc<DAE::ElementSource>;
        ...
        (txt, Deref @ DAE::STMT_NORETCALL { source: i_source, exp: i_exp }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_stmt: Arc<DAE::Statement>;
        ...
        (txt, Deref @ DAE::STMT_RETURN { source: _ }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_stmt: Arc<DAE::Statement>;
        ...
        (txt, Deref @ DAE::STMT_BREAK { source: _ }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_stmt: Arc<DAE::Statement>;
        ...
        (txt, Deref @ DAE::STMT_CONTINUE { source: _ }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_stmt: Arc<DAE::Statement>;
        ...
        (txt, Deref @ DAE::STMT_FAILURE { body: _, .. }) => {
            let mut i_level: Arc<DAE::Exp>;
            let mut i_msg: Arc<DAE::Exp>;
            let mut i_cond: Arc<DAE::Exp>;
            let mut i_stmt: Arc<DAE::Statement>;
        ...
        (txt, _) => {
            ...
            let mut i_exp1: Arc<DAE::Exp>;
            let mut txt = (*txt).clone();
            txt = errorMsg(txt.clone(), (literal!("DAEDump.dumpStatement: Unknown statement.")).clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub fn dumpStatements(txt: Tpl::Text, a_stmts: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_185(out_txt.clone(), a_stmts.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpSubscript(in_txt: Tpl::Text, in_a_subscript: Arc<DAE::Subscript>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_subscript.clone())) {
        (txt, Deref @ DAE::WHOLEDIM) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(":")).clone() }))?;
            txt.clone()
        },
        (txt, Deref @ DAE::SLICE { exp: i_exp }) => {
            let mut txt = (*txt).clone();
            txt = dumpExp(txt.clone(), i_exp.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::INDEX { exp: i_exp }) => {
            let mut txt = (*txt).clone();
            txt = dumpExp(txt.clone(), i_exp.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::WHOLE_NONEXP { exp: i_exp }) => {
            let mut txt = (*txt).clone();
...
pub fn dumpSubscripts(in_txt: Tpl::Text, in_a_subscriptLst: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_subscriptLst.clone())) {
        ...
        (txt, i_subscriptLst) => {
            ...
            let mut txt = (*txt).clone();
            ret_0 = Flags::getConfigBool(Flags::MODELICA_OUTPUT.clone())?;
            txt = fun_145(txt.clone(), ret_0.clone(), i_subscriptLst.clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub fn dumpTerminate(txt: Tpl::Text, a_msg: Arc<DAE::Exp>, a_src: Arc<DAE::ElementSource>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_src__str: Tpl::Text;
    let mut l_msg__str: Tpl::Text;
    l_msg__str = dumpExp(Tpl::emptyTxt.clone(), a_msg.clone())?;
...
pub fn dumpTupleAssignStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_TUPLE_ASSIGN { source: i_source, exp: i_exp, expExpLst: i_expExpLst, .. }) => {
            let mut l_src__str: Tpl::Text;
            let mut l_rhs__str: Tpl::Text;
            let mut l_lhs__str: Tpl::Text;
            let mut txt = (*txt).clone();
            ...
            l_lhs__str = lm_190(l_lhs__str.clone(), i_expExpLst.clone())?;
...
pub fn dumpTupleType(txt: Tpl::Text, a_tys: Arc<metamodelica::List<Arc<DAE::Type>>>, a_ty__begin: ArcStr, a_ty__end: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut l_attr: Tpl::Text;
    l_attr = Tpl::emptyTxt.clone();
    ...
    (out_txt, l_attr) = lm_73(out_txt.clone(), a_tys.clone(), l_attr.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    out_txt = Tpl::writeStr(out_txt.clone(), (a_ty__end.clone()).clone())?;
    Ok(out_txt)
}

pub fn dumpType(in_txt: Tpl::Text, in_a_ty: Arc<DAE::Type>, in_a_attributes: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_attributes: Tpl::Text;
    (out_txt, out_a_attributes) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone(), in_a_attributes.clone())) {
        (txt, Deref @ DAE::T_INTEGER { varLst: i_varLst }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
            let mut i_complexClassType: ClassInf::State;
            let mut i_rname: Arc<Absyn::Path>;
            let mut i_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>;
            let mut i_ty: Arc<DAE::Type>;
            let mut i_names: Arc<metamodelica::List<ArcStr>>;
        ...
        (txt, Deref @ DAE::T_REAL { varLst: i_varLst }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_STRING { varLst: i_varLst }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_BOOL { varLst: i_varLst }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_CLOCK { varLst: i_varLst }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_ENUMERATION { names: i_names, .. }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
            ...
            l_lit__str = lm_68(l_lit__str.clone(), i_names.clone())?;
        ...
        (txt, Deref @ DAE::T_ARRAY { dims: i_dims, ty: i_ty }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_COMPLEX { complexClassType: ClassInf::RECORD { path: i_rname }, .. }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_COMPLEX { complexClassType: i_complexClassType, .. }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
            ...
            let mut l_lit__str: Tpl::Text;
            let mut txt = (*txt).clone();
            ret_2 = ClassInf::getStateName(i_complexClassType.clone());
            txt = AbsynDumpTpl::dumpPath(txt.clone(), ret_2.clone())?;
            (txt.clone(), a_attributes.clone())
        },
        (txt, Deref @ DAE::T_SUBTYPE_BASIC { complexType: i_complexType, .. }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexClassType: ClassInf::State;
        ...
        (txt, i_ty @ Deref @ DAE::T_FUNCTION { funcArg: _, .. }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_TUPLE { types: i_types, .. }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_complexType: Arc<DAE::Type>;
            let mut i_complexClassType: ClassInf::State;
        ...
        (txt, Deref @ DAE::T_METATUPLE { types: i_types }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_complexType: Arc<DAE::Type>;
            let mut i_complexClassType: ClassInf::State;
        ...
        (txt, Deref @ DAE::T_METALIST { ty: i_ty }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METAARRAY { ty: i_ty }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METAPOLYMORPHIC { name: i_name }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
            let mut i_complexClassType: ClassInf::State;
        ...
        (txt, Deref @ DAE::T_METAUNIONTYPE { path: i_path, .. }, a_attributes) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
            let mut i_complexClassType: ClassInf::State;
        ...
        (txt, Deref @ DAE::T_METARECORD { path: i_path, .. }, a_attributes) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
            let mut i_complexClassType: ClassInf::State;
        ...
        (txt, Deref @ DAE::T_METABOXED { ty: i_ty }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METAOPTION { ty: Deref @ DAE::T_UNKNOWN }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METAOPTION { ty: i_ty }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METATYPE { ty: i_ty }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_NORETCALL, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_UNKNOWN, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_ANYTYPE { anyClassType: _ }, a_attributes) => {
            let mut i_path: Arc<Absyn::Path>;
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_complexType: Arc<DAE::Type>;
...
pub fn dumpTypeDimensions(in_txt: Tpl::Text, in_a_dimensionLst: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_dimensionLst.clone())) {
        ...
        (txt, i_dimensionLst) => {
            ...
            l_sub__str = lm_141(l_sub__str.clone(), i_dimensionLst.clone())?;
...
pub fn dumpUncertainty(in_txt: Tpl::Text, in_a_uncertainty: DAE::Uncertainty) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpUncertaintyAttr(txt: Tpl::Text, a_uncertainty: DAE::Uncertainty) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpUncertaintyAttrOpt(in_txt: Tpl::Text, in_a_uncertainty: Option<DAE::Uncertainty>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_uncertainty.clone()) {
...
pub fn dumpVar(in_txt: Tpl::Text, in_a_lst: Arc<DAE::Element>, in_a_printTypeDimension: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lst.clone(), in_a_printTypeDimension.clone())) {
        (txt, Deref @ DAE::VAR { comment: i_comment, binding: i_binding, componentRef: i_componentRef, dims: i_dims, ty: i_ty, direction: i_direction, kind: i_kind, parallelism: i_parallelism, protection: i_protection, variableAttributesOption: i_variableAttributesOption, .. }, a_printTypeDimension) => {
            let mut l_binding__str: Tpl::Text;
            let mut l_ann__str: Tpl::Text;
            let mut l_cmt__str: Tpl::Text;
            ...
            let mut txt = (*txt).clone();
            l_final = fun_57(Tpl::emptyTxt.clone(), i_variableAttributesOption.clone())?;
            ...
            l_dim__str = fun_58(Tpl::emptyTxt.clone(), a_printTypeDimension.clone(), i_dims.clone())?;
            l_varName = dumpCref(Tpl::emptyTxt.clone(), i_componentRef.clone())?;
            l_bindingExp = fun_59(Tpl::emptyTxt.clone(), i_binding.clone())?;
            l_varAttr = fun_60(Tpl::emptyTxt.clone(), i_variableAttributesOption.clone())?;
            l_cmt__str = dumpCommentOpt(Tpl::emptyTxt.clone(), i_comment.clone())?;
            l_ann__str = dumpCompAnnotation(Tpl::emptyTxt.clone(), i_comment.clone())?;
            l_binding__str = fun_61(Tpl::emptyTxt.clone(), l_bindingExp.clone())?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 1 }))?;
...
pub fn dumpVarAttribute(in_txt: Tpl::Text, in_a_var: Arc<DAE::Var>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_var.clone())) {
        (txt, Deref @ DAE::TYPES_VAR { name: i_name, binding: Deref @ DAE::EQBOUND { exp: i_e, .. }, .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeStr(txt.clone(), (i_name.clone()).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" = ")).clone() }))?;
            txt = dumpExp(txt.clone(), i_e.clone())?;
...
pub fn dumpVarAttributes(in_txt: Tpl::Text, in_a_literalVarLst: Arc<metamodelica::List<Arc<DAE::Var>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_literalVarLst.clone())) {
        ...
        (txt, i_literalVarLst) => {
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(")).clone() }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            txt = lm_82(txt.clone(), i_literalVarLst.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
            txt.clone()
        },
...
pub fn dumpVarDirection(in_txt: Tpl::Text, in_a_direction: DAE::VarDirection) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpVarKind(in_txt: Tpl::Text, in_a_kind: DAE::VarKind) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpVarParallelism(in_txt: Tpl::Text, in_a_parallelism: DAE::VarParallelism) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpVarVisibility(in_txt: Tpl::Text, in_a_protection: DAE::VarVisibility) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_protection.clone()) {
        (mut txt, DAE::PROTECTED) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" protected")).clone() }))?;
            txt.clone()
        },
        (mut txt, _) => txt.clone(),
...
pub fn dumpVariableAttributes(in_txt: Tpl::Text, in_a_variableAttributesOption: Arc<DAE::VariableAttributes>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_variableAttributesOption.clone())) {
        (txt, Deref @ DAE::VAR_ATTR_REAL { startOrigin: i_startOrigin, distributionOption: i_distributionOption, uncertainOption: i_uncertainOption, stateSelectOption: i_stateSelectOption, nominal: i_nominal, fixed: i_fixed, start: i_start, max: i_max, min: i_min, displayUnit: i_displayUnit, unit: i_unit, quantity: i_quantity, .. }) => {
            ...
            l_attrs__str = smf_88(l_attrs__str.clone(), l_quantity__str.clone())?;
            l_attrs__str = smf_89(l_attrs__str.clone(), l_unit__str.clone())?;
            l_attrs__str = smf_90(l_attrs__str.clone(), l_displayunit__str.clone())?;
            l_attrs__str = smf_91(l_attrs__str.clone(), l_min__str.clone())?;
            l_attrs__str = smf_92(l_attrs__str.clone(), l_max__str.clone())?;
            l_attrs__str = smf_93(l_attrs__str.clone(), l_start__str.clone())?;
            l_attrs__str = smf_94(l_attrs__str.clone(), l_fixed__str.clone())?;
            l_attrs__str = smf_95(l_attrs__str.clone(), l_nominal__str.clone())?;
            l_attrs__str = smf_96(l_attrs__str.clone(), l_statesel__str.clone())?;
            l_attrs__str = smf_97(l_attrs__str.clone(), l_uncert__str.clone())?;
            l_attrs__str = smf_98(l_attrs__str.clone(), l_dist__str.clone())?;
            l_attrs__str = smf_99(l_attrs__str.clone(), l_so__str.clone())?;
            l_attrs__str = Tpl::popIter(l_attrs__str.clone())?;
            txt = fun_100(txt.clone(), l_attrs__str.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_INT { startOrigin: i_startOrigin, distributionOption: i_distributionOption, uncertainOption: i_uncertainOption, fixed: i_fixed, start: i_start, max: i_max, min: i_min, quantity: i_quantity, .. }) => {
            let mut i_stateSelectOption: Option<DAE::StateSelect>;
            let mut i_nominal: Option<Arc<DAE::Exp>>;
            let mut i_displayUnit: Option<Arc<DAE::Exp>>;
            let mut i_unit: Option<Arc<DAE::Exp>>;
            let mut l_attrs__str: Tpl::Text;
            let mut l_so__str: Tpl::Text;
            let mut l_dist__str: Tpl::Text;
            let mut l_uncert__str: Tpl::Text;
            ...
            l_so__str = dumpStartOriginAttrOpt(Tpl::emptyTxt.clone(), i_startOrigin.clone())?;
            l_attrs__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_attrs__str = smf_101(l_attrs__str.clone(), l_quantity__str.clone())?;
            l_attrs__str = smf_102(l_attrs__str.clone(), l_min__str.clone())?;
            l_attrs__str = smf_103(l_attrs__str.clone(), l_max__str.clone())?;
            l_attrs__str = smf_104(l_attrs__str.clone(), l_start__str.clone())?;
            l_attrs__str = smf_105(l_attrs__str.clone(), l_fixed__str.clone())?;
            l_attrs__str = smf_106(l_attrs__str.clone(), l_uncert__str.clone())?;
            l_attrs__str = smf_107(l_attrs__str.clone(), l_dist__str.clone())?;
            l_attrs__str = smf_108(l_attrs__str.clone(), l_so__str.clone())?;
            l_attrs__str = Tpl::popIter(l_attrs__str.clone())?;
            txt = fun_109(txt.clone(), l_attrs__str.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_BOOL { startOrigin: i_startOrigin, fixed: i_fixed, start: i_start, quantity: i_quantity, .. }) => {
            let mut i_distributionOption: Option<Arc<DAE::Distribution>>;
            let mut i_uncertainOption: Option<DAE::Uncertainty>;
            let mut i_stateSelectOption: Option<DAE::StateSelect>;
            let mut i_nominal: Option<Arc<DAE::Exp>>;
            let mut i_max: Option<Arc<DAE::Exp>>;
            let mut i_min: Option<Arc<DAE::Exp>>;
            let mut i_displayUnit: Option<Arc<DAE::Exp>>;
            let mut i_unit: Option<Arc<DAE::Exp>>;
            let mut l_attrs__str: Tpl::Text;
            let mut l_so__str: Tpl::Text;
            ...
            l_so__str = dumpStartOriginAttrOpt(Tpl::emptyTxt.clone(), i_startOrigin.clone())?;
            l_attrs__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_attrs__str = smf_110(l_attrs__str.clone(), l_quantity__str.clone())?;
            l_attrs__str = smf_111(l_attrs__str.clone(), l_start__str.clone())?;
            l_attrs__str = smf_112(l_attrs__str.clone(), l_fixed__str.clone())?;
            l_attrs__str = smf_113(l_attrs__str.clone(), l_so__str.clone())?;
            l_attrs__str = Tpl::popIter(l_attrs__str.clone())?;
            txt = fun_114(txt.clone(), l_attrs__str.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_STRING { startOrigin: i_startOrigin, start: i_start, quantity: i_quantity, .. }) => {
            let mut i_distributionOption: Option<Arc<DAE::Distribution>>;
            let mut i_uncertainOption: Option<DAE::Uncertainty>;
            let mut i_stateSelectOption: Option<DAE::StateSelect>;
            let mut i_nominal: Option<Arc<DAE::Exp>>;
            let mut i_fixed: Option<Arc<DAE::Exp>>;
            let mut i_max: Option<Arc<DAE::Exp>>;
            let mut i_min: Option<Arc<DAE::Exp>>;
            let mut i_displayUnit: Option<Arc<DAE::Exp>>;
            let mut i_unit: Option<Arc<DAE::Exp>>;
            ...
            l_so__str = dumpStartOriginAttrOpt(Tpl::emptyTxt.clone(), i_startOrigin.clone())?;
            l_attrs__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_attrs__str = smf_115(l_attrs__str.clone(), l_quantity__str.clone())?;
            l_attrs__str = smf_116(l_attrs__str.clone(), l_start__str.clone())?;
            l_attrs__str = smf_117(l_attrs__str.clone(), l_so__str.clone())?;
            l_attrs__str = Tpl::popIter(l_attrs__str.clone())?;
            txt = fun_118(txt.clone(), l_attrs__str.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::VAR_ATTR_ENUMERATION { startOrigin: i_startOrigin, fixed: i_fixed, start: i_start, max: i_max, min: i_min, quantity: i_quantity, .. }) => {
            let mut i_distributionOption: Option<Arc<DAE::Distribution>>;
            let mut i_uncertainOption: Option<DAE::Uncertainty>;
            let mut i_stateSelectOption: Option<DAE::StateSelect>;
            let mut i_nominal: Option<Arc<DAE::Exp>>;
            ...
            l_so__str = dumpStartOriginAttrOpt(Tpl::emptyTxt.clone(), i_startOrigin.clone())?;
            l_attrs__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_attrs__str = smf_119(l_attrs__str.clone(), l_quantity__str.clone())?;
            l_attrs__str = smf_120(l_attrs__str.clone(), l_min__str.clone())?;
            l_attrs__str = smf_121(l_attrs__str.clone(), l_max__str.clone())?;
            l_attrs__str = smf_122(l_attrs__str.clone(), l_start__str.clone())?;
            l_attrs__str = smf_123(l_attrs__str.clone(), l_fixed__str.clone())?;
            l_attrs__str = smf_124(l_attrs__str.clone(), l_so__str.clone())?;
            l_attrs__str = Tpl::popIter(l_attrs__str.clone())?;
            txt = fun_125(txt.clone(), l_attrs__str.clone())?;
            txt.clone()
        },
        (txt, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
...
pub fn dumpVars(txt: Tpl::Text, a_v: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_55(out_txt.clone(), a_v.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpWhenEquation(in_txt: Tpl::Text, in_a_lst: Arc<DAE::Element>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lst.clone())) {
        (txt, Deref @ DAE::WHEN_EQUATION { source: i_source, elsewhen_: i_elsewhen__, equations: i_equations, condition: i_condition }) => {
            let mut l_src__str: Tpl::Text;
            ...
            l_body__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_body__str = lm_163(l_body__str.clone(), i_equations.clone())?;
            l_body__str = Tpl::popIter(l_body__str.clone())?;
            l_elsewhen__str = fun_164(Tpl::emptyTxt.clone(), i_elsewhen__.clone())?;
            l_src__str = dumpSource(Tpl::emptyTxt.clone(), i_source.clone())?;
            txt = fun_165(txt.clone(), l_elsewhen__str.clone(), l_src__str.clone(), l_body__str.clone(), l_when__cond__str.clone())?;
            txt.clone()
        },
        (txt, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
...
pub fn dumpWhenStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_WHEN { source: i_source, elseWhen: i_elseWhen, statementLst: i_statementLst, exp: i_exp, .. }) => {
            let mut l_src__str: Tpl::Text;
            let mut l_elsewhen__str: Tpl::Text;
            let mut l_body__str: Tpl::Text;
            let mut l_when__cond__str: Tpl::Text;
            ...
            l_body__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_body__str = lm_204(l_body__str.clone(), i_statementLst.clone())?;
            l_body__str = Tpl::popIter(l_body__str.clone())?;
            l_elsewhen__str = fun_205(Tpl::emptyTxt.clone(), i_elseWhen.clone())?;
            l_src__str = dumpSource(Tpl::emptyTxt.clone(), i_source.clone())?;
            txt = fun_206(txt.clone(), l_elsewhen__str.clone(), l_src__str.clone(), l_body__str.clone(), l_when__cond__str.clone())?;
            txt.clone()
        },
        (txt, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
...
pub fn dumpWhileStatement(in_txt: Tpl::Text, in_a_stmt: Arc<DAE::Statement>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone())) {
        (txt, Deref @ DAE::STMT_WHILE { source: i_source, statementLst: i_statementLst, exp: i_exp }) => {
            let mut l_src__str: Tpl::Text;
            let mut l_body__str: Tpl::Text;
            ...
            l_body__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_body__str = lm_202(l_body__str.clone(), i_statementLst.clone())?;
            l_body__str = Tpl::popIter(l_body__str.clone())?;
            l_src__str = dumpSource(Tpl::emptyTxt.clone(), i_source.clone())?;
...
fn fun_100(in_txt: Tpl::Text, in_a_attrs__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_109(in_txt: Tpl::Text, in_a_attrs__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_attrs__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, i_attrs__str) => {
...
fn fun_114(in_txt: Tpl::Text, in_a_attrs__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_attrs__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, i_attrs__str) => {
...
fn fun_118(in_txt: Tpl::Text, in_a_attrs__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_attrs__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, i_attrs__str) => {
...
fn fun_125(in_txt: Tpl::Text, in_a_attrs__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_attrs__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, i_attrs__str) => {
...
fn fun_137(in_txt: Tpl::Text, in_mArg: bool, in_a_startOrigin: Option<Arc<DAE::Exp>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_mArg.clone(), in_a_startOrigin.clone()) {
        (mut txt, false, _) => txt.clone(),
        (mut txt, _, mut a_startOrigin) => {
...
fn fun_139(in_txt: Tpl::Text, in_mArg: bool, in_a_componentRef: Arc<DAE::ComponentRef>, in_a_subscriptLst: Arc<metamodelica::List<Arc<DAE::Subscript>>>, in_a_ident: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_14(in_txt: Tpl::Text, in_a_funLists: DAEDump::functionList) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_funLists.clone()) {
        (mut txt, DAEDump::FUNCTION_LIST { funcs: ref i_funcs }) => {
...
fn fun_145(in_txt: Tpl::Text, in_mArg: bool, in_a_subscriptLst: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_subscriptLst.clone())) {
        (txt, false, a_subscriptLst) => {
            ...
            let mut txt = (*txt).clone();
            l_sub__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(",")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_sub__str = lm_143(l_sub__str.clone(), a_subscriptLst.clone())?;
            l_sub__str = Tpl::popIter(l_sub__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("[")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_sub__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("]")).clone() }))?;
...
fn fun_15(in_txt: Tpl::Text, in_a_fun__str: Tpl::Text, in_a_comp__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_fun__str.clone(), in_a_comp__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }, a_comp__str) => {
            let mut i_fun__str: Tpl::Text;
            let mut txt = (*txt).clone();
...
fn fun_153(in_txt: Tpl::Text, in_a_lhs: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lhs.clone())) {
        (txt, i_lhs @ Deref @ DAE::IFEXP { expCond: _, .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(")).clone() }))?;
...
fn fun_157(in_txt: Tpl::Text, in_a_lvl: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lvl.clone())) {
        (txt, Deref @ DAE::ENUM_LITERAL { index: 1, .. }) => {
            let mut txt = (*txt).clone();
...
fn fun_161(in_txt: Tpl::Text, in_a_call__exp: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_call__exp.clone())) {
        (txt, Deref @ DAE::CALL { attr: Deref @ DAE::CALL_ATTR { tailCall: DAE::TAIL { .. }, .. }, .. }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("return ")).clone() }))?;
            txt.clone()
        },
...
fn fun_164(in_txt: Tpl::Text, in_a_elsewhen__: Option<Arc<DAE::Element>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_elsewhen__.clone()) {
        (mut txt, Some(mut i_el)) => {
...
fn fun_165(in_txt: Tpl::Text, in_a_elsewhen__str: Tpl::Text, in_a_src__str: Tpl::Text, in_a_body__str: Tpl::Text, in_a_when__cond__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_elsewhen__str.clone(), in_a_src__str.clone(), in_a_body__str.clone(), in_a_when__cond__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }, a_src__str, a_body__str, a_when__cond__str) => {
            let mut i_elsewhen__str: Tpl::Text;
            let mut txt = (*txt).clone();
...
fn fun_17(in_txt: Tpl::Text, in_mArg: bool, in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_172(in_txt: Tpl::Text, in_a_else__branch: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_else__branch.clone())) {
        ...
        (txt, i_else__branch) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            txt = lm_171(txt.clone(), i_else__branch.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt.clone()
        },
...
fn fun_173(in_txt: Tpl::Text, in_a_branches: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Element>>>>>, in_a_src: Arc<DAE::ElementSource>, in_a_else__branch: Arc<metamodelica::List<Arc<DAE::Element>>>, in_a_elseif__conds: Arc<metamodelica::List<Arc<DAE::Exp>>>, in_a_if__cond: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_branches.clone(), in_a_src.clone(), in_a_else__branch.clone(), in_a_elseif__conds.clone(), in_a_if__cond.clone())) {
        (txt, Deref @ metamodelica::List::Cons { head: i_if__branch, tail: i_elseif__branches }, a_src, a_else__branch, a_elseif__conds, a_if__cond) => {
            ...
            l_if__branch__str = lm_170(l_if__branch__str.clone(), i_if__branch.clone())?;
            ...
            l_else__str = fun_172(Tpl::emptyTxt.clone(), a_else__branch.clone())?;
            l_src__str = dumpSource(Tpl::emptyTxt.clone(), a_src.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("if ")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_if__cond__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(" then\\n")).clone() }))?;
        ...
        (txt, _, _, _, _, _) => txt.clone(),
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
    Ok(out_txt)
}

fn fun_176(in_txt: Tpl::Text, in_a_equations: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Element>>>>>, in_a_rest__conds: Arc<metamodelica::List<Arc<DAE::Exp>>>, in_a_cond: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_equations.clone(), in_a_rest__conds.clone(), in_a_cond.clone())) {
        (txt, Deref @ metamodelica::List::Cons { head: i_branch, tail: i_rest__branches }, a_rest__conds, a_cond) => {
            ...
            l_branch__str = lm_175(l_branch__str.clone(), i_branch.clone())?;
...
fn fun_18(in_txt: Tpl::Text, in_a_ann__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_188(in_txt: Tpl::Text, in_a_lhs: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_lhs.clone())) {
        (txt, i_lhs @ Deref @ DAE::IFEXP { expCond: _, .. }) => {
            let mut txt = (*txt).clone();
...
fn fun_205(in_txt: Tpl::Text, in_a_elseWhen: Option<Arc<DAE::Statement>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_elseWhen.clone()) {
        (mut txt, Some(mut i_ew)) => {
...
fn fun_206(in_txt: Tpl::Text, in_a_elsewhen__str: Tpl::Text, in_a_src__str: Tpl::Text, in_a_body__str: Tpl::Text, in_a_when__cond__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_elsewhen__str.clone(), in_a_src__str.clone(), in_a_body__str.clone(), in_a_when__cond__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }, a_src__str, a_body__str, a_when__cond__str) => {
            let mut i_elsewhen__str: Tpl::Text;
...
fn fun_209(in_txt: Tpl::Text, in_a_comment: Option<Arc<SCode::Comment>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_comment.clone()) {
...
fn fun_211(in_txt: Tpl::Text, in_a_comment: Option<ArcStr>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_comment.clone()) {
        (mut txt, Some(mut i_co)) => {
...
fn fun_214(in_txt: Tpl::Text, in_a_cmt__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_216(in_txt: Tpl::Text, in_a_cmt__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_cmt__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, i_cmt__str) => {
...
fn fun_224(in_txt: Tpl::Text, in_a_ann__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ann__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, i_ann__str) => {
...
fn fun_226(in_txt: Tpl::Text, in_mArg: bool, in_a_ann__mod: Arc<SCode::Mod>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ann__mod.clone())) {
        (txt, false, a_ann__mod) => {
            ...
            txt = fun_225(txt.clone(), ret_0.clone(), a_ann__mod.clone())?;
            txt.clone()
        },
        (txt, _, a_ann__mod) => {
            let mut ret_0: bool;
...
fn fun_24(in_txt: Tpl::Text, in_a_isImpure: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_25(in_txt: Tpl::Text, in_a_ann__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ann__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_26(in_txt: Tpl::Text, in_a_isImpure: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_isImpure.clone()) {
        (mut txt, false) => txt.clone(),
        (mut txt, _) => {
...
fn fun_27(in_txt: Tpl::Text, in_a_ann__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ann__str.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_28(in_txt: Tpl::Text, in_mArg: bool, in_a_type__: Arc<DAE::Type>, in_a_path: Arc<Absyn::Path>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_34(in_txt: Tpl::Text, in_a_func__name__str: Tpl::Text, in_a_func__args__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_35(in_txt: Tpl::Text, in_a_ext__output__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_36(in_txt: Tpl::Text, in_a_ann: Option<Arc<SCode::Annotation>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_ann.clone()) {
        (mut txt, Some(mut i_annotation)) => {
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 1 }))?;
...
fn fun_52(in_txt: Tpl::Text, in_a_x: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_57(in_txt: Tpl::Text, in_a_variableAttributesOption: Option<Arc<DAE::VariableAttributes>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_variableAttributesOption.clone()) {
        (mut txt, Some(mut i_VariableAttributes)) => {
...
fn fun_58(in_txt: Tpl::Text, in_a_printTypeDimension: bool, in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_59(in_txt: Tpl::Text, in_a_binding: Option<Arc<DAE::Exp>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_60(in_txt: Tpl::Text, in_a_variableAttributesOption: Option<Arc<DAE::VariableAttributes>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_variableAttributesOption.clone()) {
        (mut txt, Some(mut i_VariableAttributes)) => {
...
fn fun_61(in_txt: Tpl::Text, in_a_bindingExp: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_70(in_txt: Tpl::Text, in_a_dims__accum: ArcStr, in_a_dims__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_dims__accum.clone(), in_a_dims__str.clone())) {
        (txt, Deref @ "", a_dims__str) => {
            let mut i_dims__accum: ArcStr;
            let mut txt = (*txt).clone();
...
fn fun_71(in_txt: Tpl::Text, in_a_dims__accum: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_77(in_txt: Tpl::Text, in_a_defaultBinding: Option<Arc<DAE::Exp>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_defaultBinding.clone()) {
        (mut txt, Some(mut i_bexp)) => {
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 1 }))?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(":= ")).clone() }))?;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_13(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAEDump::compWithSplitElements>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_141(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_s, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_141(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_143(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_s, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_143(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_144(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_s, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_148(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_150(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_163(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_163(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_167(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_168(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_170(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
            ...
            txt = dumpEquationElement(txt.clone(), i_e.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_170(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_171(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_175(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
            ...
            txt = dumpEquationElement(txt.clone(), i_e.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_175(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_178(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_181(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_alg, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_185(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_185(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_190(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_193(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_195(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_196(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_198(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_20(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAEDump::compWithSplitElements>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_flatSM, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_20(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_200(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_202(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_204(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_22(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<DAE::Function>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_func, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_22(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_229(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<SCode::Comment>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_c, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_229(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_30(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<DAE::FunctionDefinition>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_func, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_30(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_32(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_32(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_38(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<DAE::ExtArg>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_arg, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_38(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_42(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Var>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_48(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_49(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_lst, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_55(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_68(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
fn lm_73(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Type>>>, in_a_attr: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_attr: Tpl::Text;
    (out_txt, out_a_attr) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_attr.clone())) {
        (txt, Deref @ metamodelica::List::Nil, a_attr) => (txt.clone(), a_attr.clone()),
        (txt, Deref @ metamodelica::List::Cons { head: i_ty, tail: rest }, a_attr) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_attr) = lm_73(txt.clone(), rest.clone(), a_attr.clone())?;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_75(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::FuncArg>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_arg, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_82(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Var>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_85(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
fn smf_101(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn smf_102(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_103(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_104(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_105(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_106(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_107(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_108(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_110(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_111(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_112(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_113(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_115(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_116(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_117(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_119(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_120(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_121(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_122(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_123(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_124(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_88(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_89(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_90(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_91(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_92(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_93(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_94(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_95(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_96(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_97(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_98(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
...
fn smf_99(in_txt: Tpl::Text, in_it: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_it.clone()) {
        (mut txt, mut i_it) => {
            txt = Tpl::writeText(txt.clone(), i_it.clone())?;
