...
pub fn emptyHashTableSized(mut size: i32) -> HashTable {
    let mut hashTable: HashTable;
    hashTable = BaseHashTable::emptyHashTableWork(size.clone(), (Expression::hashExp, ExpressionBasics::expEqual, ExpressionBasics::printExpStr, ExpressionBasics::printExpStr));
    hashTable
}
