...
pub fn dumpBinOp(txt: Tpl::Text, a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_0: bool;
    ret_0 = Config::typeinfo()?;
    out_txt = fun_56(txt.clone(), ret_0.clone(), a_op.clone())?;
    Ok(out_txt)
}

pub fn dumpClassState(txt: Tpl::Text, a_state: ClassInf::State) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_0: Arc<Absyn::Path>;
    ret_0 = ClassInf::getStateName(a_state.clone());
    out_txt = AbsynDumpTpl::dumpPath(txt.clone(), ret_0.clone())?;
    Ok(out_txt)
}

pub fn dumpClockKind(in_txt: Tpl::Text, in_a_clk: Arc<DAE::ClockKind>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_clk.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ DAE::INFERRED_CLOCK, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_solverMethod: Arc<DAE::Exp>;
            let mut i_c: Arc<DAE::Exp>;
            let mut i_startInterval: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
            let mut i_interval: Arc<DAE::Exp>;
            let mut i_resolution: Arc<DAE::Exp>;
            let mut i_intervalCounter: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::RATIONAL_CLOCK { resolution: i_resolution, intervalCounter: i_intervalCounter }, a_stringDelimiter) => {
            let mut i_solverMethod: Arc<DAE::Exp>;
            let mut i_c: Arc<DAE::Exp>;
            let mut i_startInterval: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::REAL_CLOCK { interval: i_interval }, a_stringDelimiter) => {
            let mut i_solverMethod: Arc<DAE::Exp>;
            let mut i_c: Arc<DAE::Exp>;
            let mut i_startInterval: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::EVENT_CLOCK { startInterval: i_startInterval, condition: i_condition }, a_stringDelimiter) => {
            let mut i_solverMethod: Arc<DAE::Exp>;
            let mut i_c: Arc<DAE::Exp>;
            let mut i_interval: Arc<DAE::Exp>;
            let mut i_resolution: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::SOLVER_CLOCK { solverMethod: i_solverMethod, c: i_c }, a_stringDelimiter) => {
            let mut i_startInterval: Arc<DAE::Exp>;
            let mut i_condition: Arc<DAE::Exp>;
            let mut i_interval: Arc<DAE::Exp>;
            let mut i_resolution: Arc<DAE::Exp>;
...
pub fn dumpConstraints(txt: Tpl::Text, a_cons: Arc<metamodelica::List<Arc<DAE::Constraint>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    out_txt = lm_94(out_txt.clone(), a_cons.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpCref(in_txt: Tpl::Text, in_a_cref: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_cref.clone())) {
        (txt, Deref @ DAE::CREF_IDENT { ident: i_ident, subscriptLst: i_subscriptLst, .. }) => {
            let mut i_instant: ArcStr;
        ...
        (txt, Deref @ DAE::CREF_QUAL { ident: i_ident, componentRef: i_componentRef, subscriptLst: i_subscriptLst, .. }) => {
            let mut i_instant: ArcStr;
            let mut ret_2: bool;
            let mut l_cref__str: Tpl::Text;
            let mut l_sub__str: Tpl::Text;
            ...
            txt = fun_44(txt.clone(), ret_2.clone(), l_cref__str.clone(), l_sub__str.clone(), (i_ident.clone()).clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::WILD) => {
            let mut i_instant: ArcStr;
            ...
            let mut i_subscriptLst: Arc<metamodelica::List<Arc<DAE::Subscript>>>;
            let mut ret_2: bool;
            let mut l_cref__str: Tpl::Text;
            let mut l_sub__str: Tpl::Text;
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::OPTIMICA_ATTR_INST_CREF { instant: i_instant, componentRef: i_componentRef }) => {
            let mut i_ident: ArcStr;
            let mut i_subscriptLst: Arc<metamodelica::List<Arc<DAE::Subscript>>>;
            let mut ret_2: bool;
            let mut l_cref__str: Tpl::Text;
...
pub fn dumpDimensions(txt: Tpl::Text, a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_67(out_txt.clone(), a_dims.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpExp(in_txt: Tpl::Text, in_a_exp: Arc<DAE::Exp>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ DAE::ICONST { integer: i_integer }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            let mut i_args: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_listExp: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_cdr: Arc<DAE::Exp>;
            let mut i_car: Arc<DAE::Exp>;
            let mut i_valList: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_ri_iterType: Absyn::ReductionIterType;
            let mut i_iterators: Arc<metamodelica::List<Arc<DAE::ReductionIterator>>>;
            let mut i_expr: Arc<DAE::Exp>;
            let mut i_ri_path: Arc<Absyn::Path>;
            let mut i_tyStr: ArcStr;
            let mut i_scope: ArcStr;
            let mut i_name_1: Arc<DAE::ComponentRef>;
            let mut i_code: Arc<Absyn::CodeNode>;
            let mut i_sz: Option<Arc<DAE::Exp>>;
            let mut i_fieldName: ArcStr;
            let mut i_ix: i32;
            let mut i_sub: Arc<metamodelica::List<Arc<DAE::Subscript>>>;
            let mut i_PR: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_stop: Arc<DAE::Exp>;
            let mut i_step: Option<Arc<DAE::Exp>>;
            let mut i_start: Arc<DAE::Exp>;
            let mut i_matrix: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Exp>>>>>;
            let mut i_scalar: bool;
            let mut i_array: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_expList: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_exps: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_attr_ty: Arc<DAE::Type>;
            let mut i_expLst: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_path: Arc<Absyn::Path>;
            let mut i_expElse: Arc<DAE::Exp>;
            let mut i_expThen: Arc<DAE::Exp>;
            let mut i_expCond: Arc<DAE::Exp>;
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_operator: DAE::Operator;
            let mut i_exp2: Arc<DAE::Exp>;
            let mut i_e: Arc<DAE::Exp>;
            let mut i_exp1: Arc<DAE::Exp>;
            let mut i_componentRef: Arc<DAE::ComponentRef>;
            let mut i_ty: Arc<DAE::Type>;
            let mut i_name: Arc<Absyn::Path>;
            let mut i_index: i32;
            let mut i_clk: Arc<DAE::ClockKind>;
            let mut i_bool: bool;
        ...
        (txt, Deref @ DAE::RCONST { real: i_real }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::SCONST { string: i_string }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::BCONST { bool: i_bool }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::CLKCONST { clk: i_clk }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::ENUM_LITERAL { name: i_name, index: i_index }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            ...
            txt = fun_12(txt.clone(), ret_2.clone(), i_index.clone())?;
            txt = AbsynDumpTpl::dumpPath(txt.clone(), i_name.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::CREF { componentRef: i_componentRef, ty: i_ty }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            ...
            txt = fun_13(txt.clone(), ret_3.clone(), i_ty.clone())?;
            txt = dumpCref(txt.clone(), i_componentRef.clone())?;
            txt.clone()
        },
        (txt, i_e @ Deref @ DAE::BINARY { operator: i_operator, exp2: i_exp2, exp1: i_exp1 }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, i_e @ Deref @ DAE::UNARY { operator: i_operator, exp: i_exp }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, i_e @ Deref @ DAE::LBINARY { operator: i_operator, exp2: i_exp2, exp1: i_exp1 }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, i_e @ Deref @ DAE::LUNARY { operator: i_operator, exp: i_exp }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, i_e @ Deref @ DAE::RELATION { operator: i_operator, exp2: i_exp2, exp1: i_exp1, .. }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::IFEXP { expElse: i_expElse, expThen: i_expThen, expCond: i_expCond }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::CALL { expLst: i_expLst, path: i_path, attr: Deref @ DAE::CALL_ATTR { ty: i_attr_ty, builtin: true, .. } }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            txt = fun_14(txt.clone(), ret_13.clone(), i_attr_ty.clone())?;
        ...
        (txt, Deref @ DAE::CALL { expLst: i_expLst, path: i_path, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::RECORD { exps: i_exps, path: i_path, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::PARTEVALFUNCTION { expList: i_expList, path: i_path, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::ARRAY { ty: i_ty, scalar: i_scalar, array: i_array @ Deref @ metamodelica::List::Nil }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            txt = fun_17(txt.clone(), ret_14.clone(), i_ty.clone(), i_scalar.clone(), (a_stringDelimiter.clone()).clone(), i_array.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::ARRAY { ty: i_ty, scalar: i_scalar, array: i_array }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            txt = fun_19(txt.clone(), ret_16.clone(), i_ty.clone(), i_scalar.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("{")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_expl.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}")).clone() }))?;
            txt.clone()
        },
        (txt, Deref @ DAE::MATRIX { ty: i_ty, matrix: i_matrix, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            l_mat__str = lm_20(l_mat__str.clone(), i_matrix.clone(), (a_stringDelimiter.clone()).clone())?;
            l_mat__str = Tpl::popIter(l_mat__str.clone())?;
            ret_18 = Config::typeinfo()?;
            txt = fun_21(txt.clone(), ret_18.clone(), i_ty.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("{{")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_mat__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}}")).clone() }))?;
            txt.clone()
        },
        (txt, i_e @ Deref @ DAE::RANGE { stop: i_stop, step: i_step, start: i_start, .. }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            ...
            l_step__str = fun_22(Tpl::emptyTxt.clone(), i_step.clone(), i_e.clone())?;
        ...
        (txt, Deref @ DAE::TUPLE { PR: i_PR }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::CAST { ty: i_ty, exp: i_exp }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::ASUB { sub: i_sub, exp: i_exp }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            l_lparen = fun_23(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_rparen = fun_24(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            ...
            txt = fun_25(txt.clone(), ret_28.clone())?;
            txt = Tpl::writeText(txt.clone(), l_sub__str.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::TSUB { ix: i_ix, exp: i_exp, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            let mut txt = (*txt).clone();
            l_needs__paren = parenthesizeSubExp(Tpl::emptyTxt.clone(), i_exp.clone())?;
            l_lparen = fun_26(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_rparen = fun_27(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            txt = Tpl::writeText(txt.clone(), l_lparen.clone())?;
            txt = Tpl::writeText(txt.clone(), l_exp__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_rparen.clone())?;
        ...
        (txt, Deref @ DAE::RSUB { fieldName: i_fieldName, ty: i_ty, exp: i_exp, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            let mut txt = (*txt).clone();
            l_needs__paren = parenthesizeSubExp(Tpl::emptyTxt.clone(), i_exp.clone())?;
            l_lparen = fun_28(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_rparen = fun_29(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            ret_29 = Config::typeinfo()?;
            txt = fun_30(txt.clone(), ret_29.clone(), i_ty.clone())?;
            txt = Tpl::writeText(txt.clone(), l_lparen.clone())?;
            txt = Tpl::writeText(txt.clone(), l_exp__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_rparen.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".")).clone() }))?;
        ...
        (txt, Deref @ DAE::SIZE { sz: i_sz, exp: i_exp }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            let mut txt = (*txt).clone();
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            l_dim__str = fun_31(Tpl::emptyTxt.clone(), i_sz.clone(), (a_stringDelimiter.clone()).clone())?;
        ...
        (txt, Deref @ DAE::CODE { code: i_code, .. }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::EMPTY { tyStr: i_tyStr, scope: i_scope, name: i_name_1, .. }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::REDUCTION { iterators: i_iterators, expr: i_expr, reductionInfo: Deref @ DAE::REDUCTIONINFO { iterType: i_ri_iterType, path: i_ri_path, .. } }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            l_iter__str = lm_32(l_iter__str.clone(), i_iterators.clone(), (a_stringDelimiter.clone()).clone())?;
            ...
            txt = fun_33(txt.clone(), i_ri_iterType.clone())?;
            txt = Tpl::writeText(txt.clone(), l_iter__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
            txt.clone()
        },
        (txt, Deref @ DAE::LIST { valList: i_valList }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::CONS { cdr: i_cdr, car: i_car }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::META_TUPLE { listExp: i_listExp }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::META_OPTION { exp: Some(i_exp) }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::META_OPTION { exp: _ }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::METARECORDCALL { args: i_args, path: i_path, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::MATCHEXPRESSION { cases: i_cases, inputs: i_inputs, matchType: i_matchType, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_args: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_listExp: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_cdr: Arc<DAE::Exp>;
            ...
            l_case__str = lm_34(l_case__str.clone(), i_cases.clone())?;
        ...
        (txt, Deref @ DAE::BOX { exp: i_exp }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::UNBOX { exp: i_exp, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::SHARED_LITERAL { index: i_index, exp: i_exp }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            txt = fun_35(txt.clone(), ret_42.clone(), i_index.clone(), (a_stringDelimiter.clone()).clone(), i_exp.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::PATTERN { pattern: i_pattern }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            txt = fun_36(txt.clone(), ret_43.clone())?;
...
pub fn dumpExpCrefs(in_txt: Tpl::Text, in_a_exp: Arc<DAE::Exp>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ DAE::ICONST { integer: _ }, _) => txt.clone(),
        (txt, Deref @ DAE::RCONST { real: _ }, _) => txt.clone(),
        (txt, Deref @ DAE::SCONST { string: _ }, _) => txt.clone(),
        (txt, Deref @ DAE::BCONST { bool: _ }, _) => txt.clone(),
        (txt, Deref @ DAE::ENUM_LITERAL { name: i_name, .. }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::CREF { componentRef: i_componentRef, .. }, _) => {
            let mut a_stringDelimiter: ArcStr;
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::BINARY { exp2: i_exp2, exp1: i_exp1, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::LBINARY { exp2: i_exp2, exp1: i_exp1, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::LUNARY { exp: i_exp, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::RELATION { exp2: i_exp2, exp1: i_exp1, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::CALL { expLst: i_expLst, attr: Deref @ DAE::CALL_ATTR { builtin: true, .. }, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::CALL { expLst: i_expLst, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::ARRAY { scalar: i_scalar, array: i_array, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            txt = fun_79(txt.clone(), ret_10.clone(), i_scalar.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("{")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_expl.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}")).clone() }))?;
            txt.clone()
        ...
        (txt, Deref @ DAE::MATRIX { ty: i_ty, matrix: i_matrix, .. }, a_stringDelimiter) => {
            ...
            let mut txt = (*txt).clone();
            l_mat__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}, {")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_mat__str = lm_80(l_mat__str.clone(), i_matrix.clone(), (a_stringDelimiter.clone()).clone())?;
            l_mat__str = Tpl::popIter(l_mat__str.clone())?;
            ret_12 = Config::typeinfo()?;
            txt = fun_81(txt.clone(), ret_12.clone(), i_ty.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("{{")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_mat__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}}")).clone() }))?;
            txt.clone()
        ...
        (txt, i_e @ Deref @ DAE::RANGE { stop: i_stop, step: i_step, start: i_start, .. }, _) => {
            ...
            let mut txt = (*txt).clone();
            l_start__str = dumpOperand(Tpl::emptyTxt.clone(), i_start.clone(), i_e.clone(), false)?;
            l_step__str = fun_82(Tpl::emptyTxt.clone(), i_step.clone(), i_e.clone())?;
            l_stop__str = dumpOperand(Tpl::emptyTxt.clone(), i_stop.clone(), i_e.clone(), false)?;
            txt = Tpl::writeText(txt.clone(), l_start__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(":")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_step__str.clone())?;
        ...
        (txt, Deref @ DAE::TUPLE { PR: Deref @ metamodelica::List::Nil }, _) => txt.clone(),
        (txt, Deref @ DAE::TUPLE { PR: i_PR }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
        ...
        (txt, Deref @ DAE::CAST { exp: i_exp, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
        ...
        (txt, Deref @ DAE::ASUB { sub: i_sub, exp: i_exp }, a_stringDelimiter) => {
            ...
            let mut txt = (*txt).clone();
            l_needs__paren = parenthesizeSubExp(Tpl::emptyTxt.clone(), i_exp.clone())?;
            l_lparen = fun_83(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_rparen = fun_84(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            l_sub__str = dumpSubscripts(Tpl::emptyTxt.clone(), i_sub.clone())?;
            txt = Tpl::writeText(txt.clone(), l_lparen.clone())?;
            txt = Tpl::writeText(txt.clone(), l_exp__str.clone())?;
        ...
        (txt, Deref @ DAE::TSUB { ix: i_ix, exp: i_exp, .. }, a_stringDelimiter) => {
            ...
            let mut txt = (*txt).clone();
            l_needs__paren = parenthesizeSubExp(Tpl::emptyTxt.clone(), i_exp.clone())?;
            l_lparen = fun_85(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_rparen = fun_86(Tpl::emptyTxt.clone(), l_needs__paren.clone())?;
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            txt = Tpl::writeText(txt.clone(), l_lparen.clone())?;
            txt = Tpl::writeText(txt.clone(), l_exp__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_rparen.clone())?;
        ...
        (txt, Deref @ DAE::SIZE { sz: i_sz, exp: i_exp }, a_stringDelimiter) => {
            ...
            let mut txt = (*txt).clone();
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            l_dim__str = fun_87(Tpl::emptyTxt.clone(), i_sz.clone(), (a_stringDelimiter.clone()).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("size(")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_exp__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_dim__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
        ...
        (txt, Deref @ DAE::REDUCTION { iterators: i_iterators, expr: i_expr, reductionInfo: Deref @ DAE::REDUCTIONINFO { iterType: i_ri_iterType, path: i_name, .. } }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
            ...
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_expr.clone(), (a_stringDelimiter.clone()).clone())?;
            l_iter__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_iter__str = lm_88(l_iter__str.clone(), i_iterators.clone(), (a_stringDelimiter.clone()).clone())?;
            l_iter__str = Tpl::popIter(l_iter__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_name__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_exp__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" for ")).clone() }))?;
            txt = fun_89(txt.clone(), i_ri_iterType.clone())?;
            txt = Tpl::writeText(txt.clone(), l_iter__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
            txt.clone()
        },
        ...
        (txt, Deref @ DAE::MATCHEXPRESSION { cases: i_cases, inputs: i_inputs, matchType: i_matchType, .. }, a_stringDelimiter) => {
            ...
            l_inputs__str = dumpExpList(Tpl::emptyTxt.clone(), i_inputs.clone(), (a_stringDelimiter.clone()).clone(), (literal!(", ")).clone())?;
            l_case__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE)), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
            l_case__str = lm_90(l_case__str.clone(), i_cases.clone())?;
            l_case__str = Tpl::popIter(l_case__str.clone())?;
            txt = Tpl::writeText(txt.clone(), l_match__ty.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" (")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_inputs__str.clone())?;
        ...
        (txt, Deref @ DAE::SHARED_LITERAL { exp: i_exp, .. }, a_stringDelimiter) => {
            let mut i_pattern: Arc<DAE::Pattern>;
            let mut i_cases: Arc<metamodelica::List<Arc<DAE::MatchCase>>>;
            let mut i_inputs: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut i_matchType: DAE::MatchType;
...
pub fn dumpExpList(txt: Tpl::Text, a_expl: Arc<metamodelica::List<Arc<DAE::Exp>>>, a_stringDelimiter: ArcStr, a_expDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    ...
    out_txt = lm_39(out_txt.clone(), a_expl.clone(), (a_stringDelimiter.clone()).clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpExpListCrefs(txt: Tpl::Text, a_expl: Arc<metamodelica::List<Arc<DAE::Exp>>>, a_stringDelimiter: ArcStr, a_expDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (a_expDelimiter.clone()).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_41(out_txt.clone(), a_expl.clone(), (a_stringDelimiter.clone()).clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}
...
pub fn dumpLogicalBinOp(in_txt: Tpl::Text, in_a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_op.clone()) {
        (mut txt, DAE::AND { ty: _ }) => {
...
pub fn dumpLogicalUnaryOp(in_txt: Tpl::Text, in_a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_op.clone()) {
        (mut txt, DAE::NOT { ty: _ }) => {
...
pub fn dumpMatchCase(in_txt: Tpl::Text, in_a_mcase: Arc<DAE::MatchCase>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_mcase.clone())) {
        (txt, Deref @ DAE::CASE { patterns: i_patterns, result: Some(i_result), body: Deref @ metamodelica::List::Nil, .. }) => {
            let mut i_body: Arc<metamodelica::List<Arc<DAE::Statement>>>;
        ...
        (txt, Deref @ DAE::CASE { patterns: i_patterns, result: None, body: Deref @ metamodelica::List::Nil, .. }) => {
            let mut i_body: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut i_result: Arc<DAE::Exp>;
            let mut l_body__str: Tpl::Text;
            let mut l_res__str: Tpl::Text;
            let mut l_pat__str: Tpl::Text;
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::CASE { body: i_body, patterns: i_patterns, result: Some(i_result), .. }) => {
            let mut l_body__str: Tpl::Text;
            let mut l_res__str: Tpl::Text;
            let mut l_pat__str: Tpl::Text;
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::CASE { body: i_body, patterns: i_patterns, .. }) => {
            let mut i_result: Arc<DAE::Exp>;
            let mut l_body__str: Tpl::Text;
            let mut l_res__str: Tpl::Text;
            let mut l_pat__str: Tpl::Text;
...
pub fn dumpMatchType(in_txt: Tpl::Text, in_a_ty: DAE::MatchType) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_ty.clone()) {
        (mut txt, DAE::MATCHCONTINUE) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("matchcontinue")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::MATCH { switch: None }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("match")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::MATCH { switch: Some(_) }) => {
...
pub fn dumpNamedPattern(in_txt: Tpl::Text, in_a_pattern: (Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
pub fn dumpOperand(txt: Tpl::Text, a_operand: Arc<DAE::Exp>, a_operation: Arc<DAE::Exp>, a_lhs: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_1: bool;
    let mut l_op__str: Tpl::Text;
    l_op__str = dumpExp(Tpl::emptyTxt.clone(), a_operand.clone(), (literal!("\\\"")).clone())?;
    ret_1 = Expression::shouldParenthesize(a_operand.clone(), a_operation.clone(), a_lhs.clone())?;
    out_txt = fun_52(txt.clone(), ret_1.clone(), l_op__str.clone())?;
    Ok(out_txt)
}

// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
pub fn dumpPattern(in_txt: Tpl::Text, in_a_pattern: Arc<DAE::Pattern>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_pattern.clone())) {
        (txt, Deref @ DAE::PAT_WILD) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
            let mut i_name: Arc<Absyn::Path>;
            let mut i_patterns: Arc<metamodelica::List<Arc<DAE::Pattern>>>;
            let mut i_pat: Arc<DAE::Pattern>;
            let mut i_id: ArcStr;
            let mut l_pat__str: Tpl::Text;
            let mut l_name__str: Tpl::Text;
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::PAT_AS { id: i_id, pat: Deref @ DAE::PAT_WILD, .. }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
        ...
        (txt, Deref @ DAE::PAT_AS_FUNC_PTR { id: i_id, pat: Deref @ DAE::PAT_WILD }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
        ...
        (txt, Deref @ DAE::PAT_SOME { pat: i_pat }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
        ...
        (txt, Deref @ DAE::PAT_META_TUPLE { patterns: i_patterns }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
        ...
        (txt, Deref @ DAE::PAT_CALL_TUPLE { patterns: i_patterns }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
        ...
        (txt, Deref @ DAE::PAT_CALL { patterns: i_patterns, name: i_name, .. }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
        ...
        (txt, Deref @ DAE::PAT_CALL_NAMED { patterns: i_patterns_1, name: i_name }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns: Arc<metamodelica::List<Arc<DAE::Pattern>>>;
            ...
            l_pat__str = lm_75(l_pat__str.clone(), i_patterns_1.clone())?;
        ...
        (txt, Deref @ DAE::PAT_CONS { tail: i_tail, head: i_head }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
            let mut i_name: Arc<Absyn::Path>;
            let mut i_patterns: Arc<metamodelica::List<Arc<DAE::Pattern>>>;
        ...
        (txt, Deref @ DAE::PAT_CONSTANT { exp: i_exp, .. }) => {
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
            let mut i_name: Arc<Absyn::Path>;
        ...
        (txt, Deref @ DAE::PAT_AS { pat: i_pat, id: i_id, .. }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
        ...
        (txt, Deref @ DAE::PAT_AS_FUNC_PTR { pat: i_pat, id: i_id }) => {
            let mut i_exp: Arc<DAE::Exp>;
            let mut i_tail: Arc<DAE::Pattern>;
            let mut i_head: Arc<DAE::Pattern>;
            let mut i_patterns_1: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>;
...
pub fn dumpPatterns(txt: Tpl::Text, a_patterns: Arc<metamodelica::List<Arc<DAE::Pattern>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE), wrapWidth: 0, wrapSeparator: Arc::new(openmodelica_susan::Tpl::StringToken::ST_NEW_LINE) }))?;
    out_txt = lm_73(out_txt.clone(), a_patterns.clone())?;
    out_txt = Tpl::popIter(out_txt.clone())?;
    Ok(out_txt)
}

pub fn dumpReductionIterator(in_txt: Tpl::Text, in_a_iterator: Arc<DAE::ReductionIterator>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_iterator.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ DAE::REDUCTIONITER { id: i_id, exp: i_exp, guardExp: None, .. }, a_stringDelimiter) => {
            let mut i_gexp: Arc<DAE::Exp>;
        ...
        (txt, Deref @ DAE::REDUCTIONITER { id: i_id, exp: i_exp, guardExp: Some(i_gexp), .. }, a_stringDelimiter) => {
            let mut l_guard__str: Tpl::Text;
            let mut l_exp__str: Tpl::Text;
            let mut txt = (*txt).clone();
            l_exp__str = dumpExp(Tpl::emptyTxt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
...
pub fn dumpRelationOp(in_txt: Tpl::Text, in_a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_op.clone()) {
        (mut txt, DAE::LESS { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("<")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::LESSEQ { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("<=")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::GREATER { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(">")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::GREATEREQ { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(">=")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::EQUAL { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("==")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::NEQUAL { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("<>")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::USERDEFINED { fqName: _ }) => {
...
pub fn dumpSubscripts(in_txt: Tpl::Text, in_a_subscripts: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_subscripts.clone())) {
        ...
        (txt, i_subscripts) => {
            ...
            txt = fun_48(txt.clone(), ret_0.clone(), i_subscripts.clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
pub fn dumpType(in_txt: Tpl::Text, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone())) {
        (txt, Deref @ DAE::T_INTEGER { varLst: _ }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut i_funcArg: Arc<metamodelica::List<Arc<DAE::FuncArg>>>;
        ...
        (txt, Deref @ DAE::T_STRING { varLst: _ }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_ENUMERATION { path: i_path, .. }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_ARRAY { ty: i_ty, dims: i_dims }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_COMPLEX { complexClassType: i_complexClassType, .. }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_SUBTYPE_BASIC { complexClassType: i_complexClassType, .. }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_FUNCTION { funcResultType: i_funcResultType, funcArg: i_funcArg, .. }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_complexClassType: ClassInf::State;
            ...
            l_arg__str = lm_62(l_arg__str.clone(), i_funcArg.clone())?;
        ...
        (txt, Deref @ DAE::T_FUNCTION_REFERENCE_VAR { functionType: i_functionType }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut i_funcArg: Arc<metamodelica::List<Arc<DAE::FuncArg>>>;
        ...
        (txt, Deref @ DAE::T_FUNCTION_REFERENCE_FUNC { functionType: i_functionType, .. }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut i_funcArg: Arc<metamodelica::List<Arc<DAE::FuncArg>>>;
        ...
        (txt, Deref @ DAE::T_TUPLE { types: i_types, .. }) => {
            let mut i_name: ArcStr;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut i_funcArg: Arc<metamodelica::List<Arc<DAE::FuncArg>>>;
            ...
            l_ty__str = lm_63(l_ty__str.clone(), i_types.clone())?;
            l_ty__str = Tpl::popIter(l_ty__str.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_ty__str.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::T_CODE { ty: _ }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METALIST { ty: i_ty }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METATUPLE { types: i_types }) => {
            let mut i_name: ArcStr;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut i_funcArg: Arc<metamodelica::List<Arc<DAE::FuncArg>>>;
        ...
        (txt, Deref @ DAE::T_METAOPTION { ty: i_ty }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METAUNIONTYPE { path: i_path, .. }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METARECORD { path: i_path, .. }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METAARRAY { ty: i_ty }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METABOXED { ty: i_ty }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_METAPOLYMORPHIC { name: i_name }) => {
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
            let mut i_funcArg: Arc<metamodelica::List<Arc<DAE::FuncArg>>>;
        ...
        (txt, Deref @ DAE::T_METATYPE { ty: i_ty }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
        ...
        (txt, Deref @ DAE::T_ANYTYPE { anyClassType: _ }) => {
            let mut i_name: ArcStr;
            let mut i_types: Arc<metamodelica::List<Arc<DAE::Type>>>;
            let mut i_functionType: Arc<DAE::Type>;
            let mut i_funcResultType: Arc<DAE::Type>;
...
pub fn dumpUnaryOp(in_txt: Tpl::Text, in_a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_op.clone()) {
        (mut txt, DAE::UMINUS { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("-")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::UMINUS_ARR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("-")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::ADD { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("+")).clone() }))?;
            txt.clone()
        },
        (mut txt, _) => {
...
fn fun_12(in_txt: Tpl::Text, in_mArg: bool, in_a_index: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_13(in_txt: Tpl::Text, in_mArg: bool, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ty.clone())) {
        ...
        (txt, _, a_ty) => {
            ...
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/*")).clone() }))?;
            ret_0 = (Types::unparseType(a_ty.clone())?).clone();
...
fn fun_14(in_txt: Tpl::Text, in_mArg: bool, in_a_attr_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_attr_ty.clone())) {
        ...
        (txt, _, a_attr_ty) => {
            ...
            let mut txt = (*txt).clone();
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/*")).clone() }))?;
            ret_0 = (Types::unparseType(a_attr_ty.clone())?).clone();
            txt = Tpl::writeStr(txt.clone(), (ret_0.clone()).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("*/ ")).clone() }))?;
            txt.clone()
        },
...
fn fun_15(in_txt: Tpl::Text, in_a_scalar: bool, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_scalar.clone(), in_a_ty.clone())) {
        ...
        (txt, _, a_ty) => {
            ...
            ret_1 = (Types::unparseType(a_ty.clone())?).clone();
...
fn fun_16(in_txt: Tpl::Text, in_mArg: bool, in_a_ty: Arc<DAE::Type>, in_a_scalar: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ty.clone(), in_a_scalar.clone())) {
        (txt, false, _, _) => txt.clone(),
        (txt, _, a_ty, a_scalar) => {
            let mut txt = (*txt).clone();
            txt = fun_15(txt.clone(), a_scalar.clone(), a_ty.clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_17(in_txt: Tpl::Text, in_mArg: bool, in_a_ty: Arc<DAE::Type>, in_a_scalar: bool, in_a_stringDelimiter: ArcStr, in_a_array: Arc<metamodelica::List<Arc<DAE::Exp>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ty.clone(), in_a_scalar.clone(), in_a_stringDelimiter.clone(), in_a_array.clone())) {
        (txt, false, a_ty, a_scalar, a_stringDelimiter, a_array) => {
            ...
            txt = fun_16(txt.clone(), ret_1.clone(), a_ty.clone(), a_scalar.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("{")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_expl.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}")).clone() }))?;
            txt.clone()
        ...
        (txt, _, _, _, _, _) => {
            let mut a_ty: Arc<DAE::Type>;
            let mut a_scalar: bool;
            let mut a_stringDelimiter: ArcStr;
            let mut a_array: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut ret_1: bool;
            let mut l_expl: Tpl::Text;
            let mut txt = (*txt).clone();
...
fn fun_18(in_txt: Tpl::Text, in_a_scalar: bool, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_scalar.clone(), in_a_ty.clone())) {
        (txt, false, a_ty) => {
            let mut ret_1: ArcStr;
...
fn fun_19(in_txt: Tpl::Text, in_mArg: bool, in_a_ty: Arc<DAE::Type>, in_a_scalar: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ty.clone(), in_a_scalar.clone())) {
        (txt, false, _, _) => txt.clone(),
        (txt, _, a_ty, a_scalar) => {
            let mut txt = (*txt).clone();
            txt = fun_18(txt.clone(), a_scalar.clone(), a_ty.clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_21(in_txt: Tpl::Text, in_mArg: bool, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ty.clone())) {
        (txt, false, _) => txt.clone(),
        (txt, _, a_ty) => {
...
fn fun_22(in_txt: Tpl::Text, in_a_step: Option<Arc<DAE::Exp>>, in_a_e: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_23(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_24(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_25(in_txt: Tpl::Text, in_mArg: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_26(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_27(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_28(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_29(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_30(in_txt: Tpl::Text, in_mArg: bool, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ty.clone())) {
        (txt, false, _) => txt.clone(),
        (txt, _, a_ty) => {
...
fn fun_31(in_txt: Tpl::Text, in_a_sz: Option<Arc<DAE::Exp>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_sz.clone(), in_a_stringDelimiter.clone()) {
        (mut txt, Some(mut i_dim), mut a_stringDelimiter) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
...
fn fun_33(in_txt: Tpl::Text, in_a_ri_iterType: Absyn::ReductionIterType) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_35(in_txt: Tpl::Text, in_mArg: bool, in_a_index: i32, in_a_stringDelimiter: ArcStr, in_a_exp: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_36(in_txt: Tpl::Text, in_mArg: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_mArg.clone()) {
        (mut txt, false) => txt.clone(),
        (mut txt, _) => {
...
fn fun_44(in_txt: Tpl::Text, in_mArg: bool, in_a_cref__str: Tpl::Text, in_a_sub__str: Tpl::Text, in_a_ident: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_48(in_txt: Tpl::Text, in_mArg: bool, in_a_subscripts: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_subscripts.clone())) {
        (txt, false, a_subscripts) => {
            ...
            l_sub__str = lm_46(l_sub__str.clone(), a_subscripts.clone())?;
...
fn fun_52(in_txt: Tpl::Text, in_mArg: bool, in_a_op__str: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_54(in_txt: Tpl::Text, in_a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_op.clone()) {
        (mut txt, DAE::ADD { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("+")).clone() }))?;
        ...
        (mut txt, DAE::SUB { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("-")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::MUL { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("*")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::DIV { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::POW { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("^")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::ADD_ARR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("+")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::SUB_ARR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("-")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::MUL_ARR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".*")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::DIV_ARR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("./")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::POW_ARR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("^")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::POW_ARR2 { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".^")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::MUL_ARRAY_SCALAR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("*")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::ADD_ARRAY_SCALAR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".+")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::SUB_SCALAR_ARRAY { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".-")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::POW_SCALAR_ARRAY { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".^")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::POW_ARRAY_SCALAR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".^")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::MUL_SCALAR_PRODUCT { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("*")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::MUL_MATRIX_PRODUCT { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("*")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::DIV_SCALAR_ARRAY { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("./")).clone() }))?;
            txt.clone()
        },
        (mut txt, DAE::DIV_ARRAY_SCALAR { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/")).clone() }))?;
            txt.clone()
        },
        (mut txt, _) => {
...
fn fun_55(in_txt: Tpl::Text, in_a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_op.clone()) {
        (mut txt, DAE::ADD { ty: _ }) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("+")).clone() }))?;
...
fn fun_56(in_txt: Tpl::Text, in_mArg: bool, in_a_op: DAE::Operator) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_mArg.clone(), in_a_op.clone()) {
        (mut txt, false, mut a_op) => {
            txt = fun_54(txt.clone(), a_op.clone())?;
            txt.clone()
        },
        (mut txt, _, mut a_op) => {
...
fn fun_78(in_txt: Tpl::Text, in_a_scalar: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
fn fun_79(in_txt: Tpl::Text, in_mArg: bool, in_a_scalar: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_mArg.clone(), in_a_scalar.clone()) {
        (mut txt, false, _) => txt.clone(),
        (mut txt, _, mut a_scalar) => {
            txt = fun_78(txt.clone(), a_scalar.clone())?;
            txt.clone()
        },
    });
    Ok(out_txt)
...
fn fun_81(in_txt: Tpl::Text, in_mArg: bool, in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ty.clone())) {
        (txt, false, _) => txt.clone(),
        (txt, _, a_ty) => {
...
fn fun_82(in_txt: Tpl::Text, in_a_step: Option<Arc<DAE::Exp>>, in_a_e: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_step.clone(), in_a_e.clone())) {
        (txt, Some(i_step), a_e) => {
            let mut txt = (*txt).clone();
...
fn fun_83(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_84(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_85(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_86(in_txt: Tpl::Text, in_a_needs__paren: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_needs__paren.clone())) {
        (txt, Tpl::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }) => txt.clone(),
        (txt, _) => {
...
fn fun_87(in_txt: Tpl::Text, in_a_sz: Option<Arc<DAE::Exp>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_sz.clone(), in_a_stringDelimiter.clone()) {
        (mut txt, Some(mut i_dim), mut a_stringDelimiter) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
...
fn fun_89(in_txt: Tpl::Text, in_a_ri_iterType: Absyn::ReductionIterType) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt.clone(), in_a_ri_iterType.clone()) {
        (mut txt, Absyn::THREAD) => {
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("threaded ")).clone() }))?;
...
fn fun_93(in_txt: Tpl::Text, in_a_con: Arc<DAE::Constraint>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_con.clone())) {
        (txt, Deref @ DAE::CONSTRAINT_DT { localCon: true, constraint: i_c }) => {
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::CONSTRAINT_DT { localCon: false, constraint: i_c }) => {
            let mut txt = (*txt).clone();
            txt = dumpExp(txt.clone(), i_c.clone(), (literal!("\\\"")).clone())?;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_20(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Exp>>>>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_stringDelimiter.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_row, tail: rest }, a_stringDelimiter) => {
            ...
            txt = lm_20(txt.clone(), rest.clone(), (a_stringDelimiter.clone()).clone())?;
            txt.clone()
        },
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_32(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::ReductionIterator>>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ metamodelica::List::Nil, _) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_it, tail: rest }, a_stringDelimiter) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_32(txt.clone(), rest.clone(), (a_stringDelimiter.clone()).clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_34(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::MatchCase>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_39(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ metamodelica::List::Nil, _) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_exp, tail: rest }, a_stringDelimiter) => {
            ...
            txt = dumpExp(txt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_39(txt.clone(), rest.clone(), (a_stringDelimiter.clone()).clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_41(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ metamodelica::List::Nil, _) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_exp, tail: rest }, a_stringDelimiter) => {
            ...
            txt = dumpExpCrefs(txt.clone(), i_exp.clone(), (a_stringDelimiter.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_41(txt.clone(), rest.clone(), (a_stringDelimiter.clone()).clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_46(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_47(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_sub, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_62(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::FuncArg>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_63(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Type>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_64(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Type>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_ty, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_67(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_73(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Pattern>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_pat, tail: rest }) => {
            ...
            txt = dumpPattern(txt.clone(), i_pat.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_73(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_75(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<(Arc<DAE::Pattern>, ArcStr, Arc<DAE::Type>)>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_pat, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_80(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Exp>>>>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ metamodelica::List::Nil, _) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_row, tail: rest }, a_stringDelimiter) => {
            ...
            txt = dumpExpList(txt.clone(), i_row.clone(), (a_stringDelimiter.clone()).clone(), (literal!(", ")).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_80(txt.clone(), rest.clone(), (a_stringDelimiter.clone()).clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_88(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::ReductionIterator>>>, in_a_stringDelimiter: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_stringDelimiter.clone())) {
        (txt, Deref @ metamodelica::List::Nil, _) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_it, tail: rest }, a_stringDelimiter) => {
            ...
            txt = dumpReductionIterator(txt.clone(), i_it.clone(), (a_stringDelimiter.clone()).clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_88(txt.clone(), rest.clone(), (a_stringDelimiter.clone()).clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_90(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::MatchCase>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_c, tail: rest }) => {
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
fn lm_94(in_txt: Tpl::Text, in_items: Arc<metamodelica::List<Arc<DAE::Constraint>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        (txt, Deref @ metamodelica::List::Nil) => txt.clone(),
        (txt, Deref @ metamodelica::List::Cons { head: i_con, tail: rest }) => {
            let mut txt = (*txt).clone();
            txt = fun_93(txt.clone(), i_con.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
...
pub fn parenthesizeSubExp(in_txt: Tpl::Text, in_a_exp: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone())) {
        (txt, Deref @ DAE::ICONST { integer: _ }) => txt.clone(),
        (txt, Deref @ DAE::RCONST { real: _ }) => txt.clone(),
        (txt, Deref @ DAE::SCONST { string: _ }) => txt.clone(),
        (txt, Deref @ DAE::BCONST { bool: _ }) => txt.clone(),
        (txt, Deref @ DAE::ENUM_LITERAL { name: _, .. }) => txt.clone(),
        (txt, Deref @ DAE::CREF { componentRef: _, .. }) => txt.clone(),
        (txt, Deref @ DAE::CALL { path: _, .. }) => txt.clone(),
        (txt, Deref @ DAE::ARRAY { ty: _, .. }) => txt.clone(),
        (txt, Deref @ DAE::MATRIX { ty: _, .. }) => txt.clone(),
        (txt, Deref @ DAE::TUPLE { PR: _ }) => txt.clone(),
        (txt, Deref @ DAE::CAST { ty: _, .. }) => txt.clone(),
        (txt, Deref @ DAE::SIZE { exp: _, .. }) => txt.clone(),
        (txt, Deref @ DAE::REDUCTION { reductionInfo: _, .. }) => txt.clone(),
        (txt, _) => {
            let mut txt = (*txt).clone();
