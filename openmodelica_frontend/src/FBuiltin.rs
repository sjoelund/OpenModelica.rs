...
// Real arrays
thread_local! { static __T_REAL_ARRAY_DEFAULT_TLS: Arc<DAE::Type> = Arc::new(DAE::Type::T_ARRAY { ty: DAE::T_REAL_DEFAULT().clone(), dims: list![openmodelica_frontend_types::DAE::Dimension::interned_DIM_UNKNOWN()] }); }
pub(crate) fn T_REAL_ARRAY_DEFAULT() -> Arc<DAE::Type> { __T_REAL_ARRAY_DEFAULT_TLS.with(|__t| __t.clone()) }
...
pub(crate) fn T_REAL_ARRAY_1_DEFAULT() -> Arc<DAE::Type> { __T_REAL_ARRAY_1_DEFAULT_TLS.with(|__t| __t.clone()) }
...
thread_local! { static __startTimeVar_TLS: Arc<DAE::Var> = Arc::new(DAE::Var { name: (literal!("startTime")).clone(), attributes: DAE::dummyAttrInput().clone(), ty: DAE::T_REAL_DEFAULT().clone(), binding: openmodelica_frontend_types::DAE::Binding::interned_UNBOUND(), bind_from_outside: false, constOfForIteratorRange: None }); }
pub(crate) fn startTimeVar() -> Arc<DAE::Var> { __startTimeVar_TLS.with(|__t| __t.clone()) }

/* Optimica Extensions. The builtin variable finalTime. */
thread_local! { static __finalTimeVar_TLS: Arc<DAE::Var> = Arc::new(DAE::Var { name: (literal!("finalTime")).clone(), attributes: DAE::dummyAttrInput().clone(), ty: DAE::T_REAL_DEFAULT().clone(), binding: openmodelica_frontend_types::DAE::Binding::interned_UNBOUND(), bind_from_outside: false, constOfForIteratorRange: None }); }
pub(crate) fn finalTimeVar() -> Arc<DAE::Var> { __finalTimeVar_TLS.with(|__t| __t.clone()) }

/* Optimica Extensions. The builtin variable objectiveIntegrand. */
thread_local! { static __objectiveIntegrandVar_TLS: Arc<DAE::Var> = Arc::new(DAE::Var { name: (literal!("objectiveIntegrand")).clone(), attributes: DAE::dummyAttrInput().clone(), ty: DAE::T_REAL_DEFAULT().clone(), binding: openmodelica_frontend_types::DAE::Binding::interned_UNBOUND(), bind_from_outside: false, constOfForIteratorRange: None }); }
pub(crate) fn objectiveIntegrandVar() -> Arc<DAE::Var> { __objectiveIntegrandVar_TLS.with(|__t| __t.clone()) }

/* Optimica Extensions. The builtin variable objective. */
thread_local! { static __objectiveVar_TLS: Arc<DAE::Var> = Arc::new(DAE::Var { name: (literal!("objective")).clone(), attributes: DAE::dummyAttrInput().clone(), ty: DAE::T_REAL_DEFAULT().clone(), binding: openmodelica_frontend_types::DAE::Binding::interned_UNBOUND(), bind_from_outside: false, constOfForIteratorRange: None }); }
pub(crate) fn objectiveVar() -> Arc<DAE::Var> { __objectiveVar_TLS.with(|__t| __t.clone()) }
...
pub(crate) fn argRealX() -> Arc<DAE::FuncArg> { __argRealX_TLS.with(|__t| __t.clone()) }
...
pub(crate) fn argRealY() -> Arc<DAE::FuncArg> { __argRealY_TLS.with(|__t| __t.clone()) }
...
pub(crate) fn argRealZ() -> Arc<DAE::FuncArg> { __argRealZ_TLS.with(|__t| __t.clone()) }

thread_local! { static __argsRealX_TLS: Arc<metamodelica::List<Arc<DAE::FuncArg>>> = list![argRealX().clone()]; }
pub(crate) fn argsRealX() -> Arc<metamodelica::List<Arc<DAE::FuncArg>>> { __argsRealX_TLS.with(|__t| __t.clone()) }

thread_local! { static __argsRealXY_TLS: Arc<metamodelica::List<Arc<DAE::FuncArg>>> = list![argRealX().clone(), argRealY().clone()]; }
pub(crate) fn argsRealXY() -> Arc<metamodelica::List<Arc<DAE::FuncArg>>> { __argsRealXY_TLS.with(|__t| __t.clone()) }
...
pub(crate) fn argsRealXYZ() -> Arc<metamodelica::List<Arc<DAE::FuncArg>>> { __argsRealXYZ_TLS.with(|__t| __t.clone()) }

pub(crate) static timeComp: std::sync::LazyLock<Arc<SCode::Element>> = std::sync::LazyLock::new(|| { Arc::new(SCode::Element::COMPONENT { name: (literal!("time")).clone(), prefixes: SCode::defaultPrefixes.clone(), attributes: SCode::Attributes { arrayDims: metamodelica::nil(), connectorType: openmodelica_frontend_types::SCode::ConnectorType::POTENTIAL, parallelism: openmodelica_frontend_types::SCode::Parallelism::NON_PARALLEL, variability: openmodelica_frontend_types::SCode::Variability::VAR, direction: openmodelica_ast::Absyn::Direction::INPUT, isField: openmodelica_ast::Absyn::IsField::NONFIELD }, typeSpec: Arc::new(Absyn::TypeSpec::TPATH { path: Arc::new(Absyn::Path::IDENT { name: (literal!("Real")).clone() }), arrayDim: None }), modifications: openmodelica_frontend_types::SCode::Mod::interned_NOMOD(), comment: SCode::noComment.clone(), condition: None, info: Absyn::dummyInfo.clone() }) });

pub(crate) static startTimeComp: std::sync::LazyLock<Arc<SCode::Element>> = std::sync::LazyLock::new(|| { Arc::new(SCode::Element::COMPONENT { name: (literal!("startTime")).clone(), prefixes: SCode::defaultPrefixes.clone(), attributes: SCode::Attributes { arrayDims: metamodelica::nil(), connectorType: openmodelica_frontend_types::SCode::ConnectorType::POTENTIAL, parallelism: openmodelica_frontend_types::SCode::Parallelism::NON_PARALLEL, variability: openmodelica_frontend_types::SCode::Variability::VAR, direction: openmodelica_ast::Absyn::Direction::INPUT, isField: openmodelica_ast::Absyn::IsField::NONFIELD }, typeSpec: Arc::new(Absyn::TypeSpec::TPATH { path: Arc::new(Absyn::Path::IDENT { name: (literal!("Real")).clone() }), arrayDim: None }), modifications: openmodelica_frontend_types::SCode::Mod::interned_NOMOD(), comment: SCode::noComment.clone(), condition: None, info: Absyn::dummyInfo.clone() }) });

pub(crate) static finalTimeComp: std::sync::LazyLock<Arc<SCode::Element>> = std::sync::LazyLock::new(|| { Arc::new(SCode::Element::COMPONENT { name: (literal!("finalTime")).clone(), prefixes: SCode::defaultPrefixes.clone(), attributes: SCode::Attributes { arrayDims: metamodelica::nil(), connectorType: openmodelica_frontend_types::SCode::ConnectorType::POTENTIAL, parallelism: openmodelica_frontend_types::SCode::Parallelism::NON_PARALLEL, variability: openmodelica_frontend_types::SCode::Variability::VAR, direction: openmodelica_ast::Absyn::Direction::INPUT, isField: openmodelica_ast::Absyn::IsField::NONFIELD }, typeSpec: Arc::new(Absyn::TypeSpec::TPATH { path: Arc::new(Absyn::Path::IDENT { name: (literal!("Real")).clone() }), arrayDim: None }), modifications: openmodelica_frontend_types::SCode::Mod::interned_NOMOD(), comment: SCode::noComment.clone(), condition: None, info: Absyn::dummyInfo.clone() }) });

pub(crate) static objectiveIntegrandComp: std::sync::LazyLock<Arc<SCode::Element>> = std::sync::LazyLock::new(|| { Arc::new(SCode::Element::COMPONENT { name: (literal!("objectiveIntegrand")).clone(), prefixes: SCode::defaultPrefixes.clone(), attributes: SCode::Attributes { arrayDims: metamodelica::nil(), connectorType: openmodelica_frontend_types::SCode::ConnectorType::POTENTIAL, parallelism: openmodelica_frontend_types::SCode::Parallelism::NON_PARALLEL, variability: openmodelica_frontend_types::SCode::Variability::VAR, direction: openmodelica_ast::Absyn::Direction::INPUT, isField: openmodelica_ast::Absyn::IsField::NONFIELD }, typeSpec: Arc::new(Absyn::TypeSpec::TPATH { path: Arc::new(Absyn::Path::IDENT { name: (literal!("Real")).clone() }), arrayDim: None }), modifications: openmodelica_frontend_types::SCode::Mod::interned_NOMOD(), comment: SCode::noComment.clone(), condition: None, info: Absyn::dummyInfo.clone() }) });

pub(crate) static objectiveVarComp: std::sync::LazyLock<Arc<SCode::Element>> = std::sync::LazyLock::new(|| { Arc::new(SCode::Element::COMPONENT { name: (literal!("objectiveVar")).clone(), prefixes: SCode::defaultPrefixes.clone(), attributes: SCode::Attributes { arrayDims: metamodelica::nil(), connectorType: openmodelica_frontend_types::SCode::ConnectorType::POTENTIAL, parallelism: openmodelica_frontend_types::SCode::Parallelism::NON_PARALLEL, variability: openmodelica_frontend_types::SCode::Variability::VAR, direction: openmodelica_ast::Absyn::Direction::INPUT, isField: openmodelica_ast::Absyn::IsField::NONFIELD }, typeSpec: Arc::new(Absyn::TypeSpec::TPATH { path: Arc::new(Absyn::Path::IDENT { name: (literal!("Real")).clone() }), arrayDim: None }), modifications: openmodelica_frontend_types::SCode::Mod::interned_NOMOD(), comment: SCode::noComment.clone(), condition: None, info: Absyn::dummyInfo.clone() }) });

pub(crate) static basicTypes: std::sync::LazyLock<Arc<metamodelica::List<Arc<SCode::Element>>>> = std::sync::LazyLock::new(|| { list![clockType.clone(), rlType.clone(), intType.clone(), strType.clone(), boolType.clone(), enumType.clone(), ExternalObjectType.clone(), realType.clone(), integerType.clone(), stringType.clone(), booleanType.clone(), uncertaintyType.clone()] });

pub(crate) static basicTypesNF: std::sync::LazyLock<Arc<metamodelica::List<Arc<SCode::Element>>>> = std::sync::LazyLock::new(|| { list![rlType.clone(), intType.clone(), strType.clone(), boolType.clone(), enumType.clone(), realType.clone(), integerType.clone(), stringType.clone(), booleanType.clone()] });
...
pub(crate) fn initialGraphModelica(mut graph: FCore::Graph, mut mkTypeNode: Arc<dyn ::std::ops::Fn(Arc<metamodelica::List<Arc<DAE::Type>>>, metamodelica::Array<FCore::Node>, ArcStr, FCore::Graph) -> Result<FCore::Graph> + 'static>, mut mkCompNode: Arc<dyn ::std::ops::Fn(Arc<SCode::Element>, metamodelica::Array<FCore::Node>, FCore::Kind, FCore::Graph) -> Result<FCore::Graph> + 'static>) -> Result<FCore::Graph> {
    ...
    graph = mkCompNode(timeComp.clone(), FGraph::top(graph.clone())?, openmodelica_frontend_dump::FCore::Kind::BUILTIN, graph)?;
    graph = FGraph::updateComp(graph, timeVar().clone(), openmodelica_frontend_dump::FCore::Status::VAR_UNTYPED, FGraph::empty());
    graph = mkTypeNode(list![Arc::new(DAE::Type::T_FUNCTION { funcArg: list![Arc::new(DAE::FuncArg { name: (literal!("x")).clone(), ty: Arc::new(DAE::Type::T_ANYTYPE { anyClassType: Some(ClassInf::State::CONNECTOR { path: Arc::new(Absyn::Path::IDENT { name: (literal!("$dummy$")).clone() }), isExpandable: false }) }), r#const: openmodelica_frontend_types::DAE::Const::C_VAR, par: openmodelica_frontend_types::DAE::VarParallelism::NON_PARALLEL, defaultBinding: None })], funcResultType: DAE::T_INTEGER_DEFAULT().clone(), functionAttributes: DAE::FUNCTION_ATTRIBUTES_BUILTIN.clone(), path: Arc::new(Absyn::Path::IDENT { name: (literal!("cardinality")).clone() }) }), Arc::new(DAE::Type::T_FUNCTION { funcArg: list![Arc::new(DAE::FuncArg { name: (literal!("x")).clone(), ty: Arc::new(DAE::Type::T_ANYTYPE { anyClassType: Some(ClassInf::State::CONNECTOR { path: Arc::new(Absyn::Path::IDENT { name: (literal!("$dummy$")).clone() }), isExpandable: true }) }), r#const: openmodelica_frontend_types::DAE::Const::C_VAR, par: openmodelica_frontend_types::DAE::VarParallelism::NON_PARALLEL, defaultBinding: None })], funcResultType: DAE::T_INTEGER_DEFAULT().clone(), functionAttributes: DAE::FUNCTION_ATTRIBUTES_BUILTIN.clone(), path: Arc::new(Absyn::Path::IDENT { name: (literal!("cardinality")).clone() }) })], FGraph::top(graph.clone())?, (literal!("cardinality")).clone(), graph)?;
    graph = mkTypeNode(list![enumeration2int.clone()], FGraph::top(graph.clone())?, (literal!("Integer")).clone(), graph)?;
    graph = mkTypeNode(list![enumeration2int], FGraph::top(graph.clone())?, (literal!("EnumToInteger")).clone(), graph)?;
    graph = mkTypeNode(list![Arc::new(DAE::Type::T_FUNCTION { funcArg: argsRealX().clone(), funcResultType: DAE::T_REAL_DEFAULT().clone(), functionAttributes: DAE::FUNCTION_ATTRIBUTES_BUILTIN.clone(), path: Arc::new(Absyn::Path::IDENT { name: (literal!("noEvent")).clone() }) })], FGraph::top(graph.clone())?, (literal!("noEvent")).clone(), graph)?;
    graph = mkTypeNode(list![Arc::new(DAE::Type::T_FUNCTION { funcArg: argsRealX().clone(), funcResultType: DAE::T_REAL_DEFAULT().clone(), functionAttributes: DAE::FUNCTION_ATTRIBUTES_BUILTIN.clone(), path: Arc::new(Absyn::Path::IDENT { name: (literal!("actualStream")).clone() }) })], FGraph::top(graph.clone())?, (literal!("actualStream")).clone(), graph)?;
    graph = mkTypeNode(list![Arc::new(DAE::Type::T_FUNCTION { funcArg: argsRealX().clone(), funcResultType: DAE::T_REAL_DEFAULT().clone(), functionAttributes: DAE::FUNCTION_ATTRIBUTES_BUILTIN.clone(), path: Arc::new(Absyn::Path::IDENT { name: (literal!("inStream")).clone() }) })], FGraph::top(graph.clone())?, (literal!("inStream")).clone(), graph)?;
    Ok(graph)
}
...
pub(crate) fn initialGraphOptimica(mut graph: FCore::Graph, mut mkCompNode: Arc<dyn ::std::ops::Fn(Arc<SCode::Element>, metamodelica::Array<FCore::Node>, FCore::Kind, FCore::Graph) -> Result<FCore::Graph> + 'static>) -> Result<FCore::Graph> {
    ...
    graph = mkCompNode(objectiveVarComp.clone(), FGraph::top(graph.clone())?, openmodelica_frontend_dump::FCore::Kind::BUILTIN, graph)?;
    graph = FGraph::updateComp(graph, objectiveVar().clone(), openmodelica_frontend_dump::FCore::Status::VAR_UNTYPED, FGraph::empty());
    graph = mkCompNode(objectiveIntegrandComp.clone(), FGraph::top(graph.clone())?, openmodelica_frontend_dump::FCore::Kind::BUILTIN, graph)?;
    graph = FGraph::updateComp(graph, objectiveIntegrandVar().clone(), openmodelica_frontend_dump::FCore::Status::VAR_UNTYPED, FGraph::empty());
    graph = mkCompNode(startTimeComp.clone(), FGraph::top(graph.clone())?, openmodelica_frontend_dump::FCore::Kind::BUILTIN, graph)?;
    graph = FGraph::updateComp(graph, startTimeVar().clone(), openmodelica_frontend_dump::FCore::Status::VAR_UNTYPED, FGraph::empty());
    graph = mkCompNode(finalTimeComp.clone(), FGraph::top(graph.clone())?, openmodelica_frontend_dump::FCore::Kind::BUILTIN, graph)?;
    graph = FGraph::updateComp(graph, finalTimeVar().clone(), openmodelica_frontend_dump::FCore::Status::VAR_UNTYPED, FGraph::empty());
    Ok(graph)
}
