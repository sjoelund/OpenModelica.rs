...
fn basicFlatSmSemantics(mut ident: ArcStr, mut q: Arc<metamodelica::List<Arc<DAE::Element>>>, mut inTransitions: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<FlatSmSemantics> {
    ...
    for mut t1 in &*t.clone() {
        ...
        tFromVars = {let _arr = tFromVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(tFromRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()); _arr};
        tFromVars = {let _arr = tFromVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tFromVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: from.clone() }))); _arr};
        ...
        tToVars = {let _arr = tToVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(tToRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()); _arr};
        tToVars = {let _arr = tToVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tToVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: to.clone() }))); _arr};
        ...
        tImmediateVars = {let _arr = tImmediateVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(tImmediateRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr};
        tImmediateVars = {let _arr = tImmediateVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tImmediateVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: immediate.clone() }))); _arr};
        ...
        tResetVars = {let _arr = tResetVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(tResetRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr};
        tResetVars = {let _arr = tResetVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tResetVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: reset.clone() }))); _arr};
        ...
        tSynchronizeVars = {let _arr = tSynchronizeVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(tSynchronizeRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr};
        tSynchronizeVars = {let _arr = tSynchronizeVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tSynchronizeVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: synchronize.clone() }))); _arr};
        ...
        tPriorityVars = {let _arr = tPriorityVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(tPriorityRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()); _arr};
        tPriorityVars = {let _arr = tPriorityVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tPriorityVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: priority.clone() }))); _arr};
    ...
    for mut exp in &*cExps.clone() {
        ...
        cVars = {let _arr = cVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(cRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr};
        cImmediateVars = {let _arr = cImmediateVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithStartValue(metamodelica::arrayGet(cImmediateRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), Arc::new(DAE::Exp::BCONST { bool: false }), tDims.clone())?; _arr};
    ...
    for mut i in 1..=nStates.clone() {
        ...
        activeResetStatesVars = {let _arr = activeResetStatesVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(activeResetStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), nStatesDims.clone()); _arr};
    ...
    for mut i in 1..=nStates.clone() {
        ...
        nextResetStatesVars = {let _arr = nextResetStatesVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithStartValue(metamodelica::arrayGet(nextResetStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), Arc::new(DAE::Exp::BCONST { bool: false }), nStatesDims.clone())?; _arr};
    ...
    for mut i in 1..=nStates.clone() {
        ...
        finalStatesVars = {let _arr = finalStatesVars.clone(); _arr.borrow_mut()[(i.clone()-1) as usize] = createVarWithDefaults(metamodelica::arrayGet(finalStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), nStatesDims.clone()); _arr};
