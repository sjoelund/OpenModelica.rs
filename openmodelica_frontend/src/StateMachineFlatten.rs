...
fn elabXInStateOps(mut inFlatSmSemantics: FlatSmSemantics, mut inEnclosingStateCrefOption: Option<Arc<DAE::ComponentRef>>) -> Result<FlatSmSemantics> {
    ...
    for mut tc in &*List::zip(t.clone(), c.clone()) {
        ...
        let __pa17 = ::match_deref::match_deref! { match &(metamodelica::arrayGet(smComps.clone(), from.clone())?) {
        ...
        smeqsElab = if (found.clone()) {List::map5(smeqs.clone(), (std::sync::Arc::new(smeqsSubsXInState) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Element>, Arc<DAE::Element>, i32, i32, Arc<DAE::Exp>, ArcStr) -> Result<Arc<DAE::Element>> + 'static>), metamodelica::arrayGet(smComps.clone(), 1)?, i.clone(), (t.clone().len() as i32), substTimeExp.clone(), (literal!("timeInState")).clone())?} else {smeqs.clone()};
        smeqs = smeqsElab.clone();
...
fn basicFlatSmSemantics(mut ident: ArcStr, mut q: Arc<metamodelica::List<Arc<DAE::Element>>>, mut inTransitions: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<FlatSmSemantics> {
    ...
    for mut t1 in &*t.clone() {
        ...
        tFromRefs = {let _arr = tFromRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("tFrom")).clone(), tArrayInteger.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tFromVars = {let _arr = tFromVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(tFromRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tFromVars = {let _arr = tFromVars.clone(); let _idx = i.clone(); let _val = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tFromVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: from.clone() }))); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        knowns = metamodelica::cons(metamodelica::arrayGet(tFromVars.clone(), i.clone())?, knowns.clone());
        tToRefs = {let _arr = tToRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("tTo")).clone(), tArrayInteger.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tToVars = {let _arr = tToVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(tToRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tToVars = {let _arr = tToVars.clone(); let _idx = i.clone(); let _val = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tToVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: to.clone() }))); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        knowns = metamodelica::cons(metamodelica::arrayGet(tToVars.clone(), i.clone())?, knowns.clone());
        tImmediateRefs = {let _arr = tImmediateRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("tImmediate")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tImmediateVars = {let _arr = tImmediateVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(tImmediateRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tImmediateVars = {let _arr = tImmediateVars.clone(); let _idx = i.clone(); let _val = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tImmediateVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: immediate.clone() }))); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        knowns = metamodelica::cons(metamodelica::arrayGet(tImmediateVars.clone(), i.clone())?, knowns.clone());
        tResetRefs = {let _arr = tResetRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("tReset")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tResetVars = {let _arr = tResetVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(tResetRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tResetVars = {let _arr = tResetVars.clone(); let _idx = i.clone(); let _val = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tResetVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: reset.clone() }))); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        knowns = metamodelica::cons(metamodelica::arrayGet(tResetVars.clone(), i.clone())?, knowns.clone());
        tSynchronizeRefs = {let _arr = tSynchronizeRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("tSynchronize")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tSynchronizeVars = {let _arr = tSynchronizeVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(tSynchronizeRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tSynchronizeVars = {let _arr = tSynchronizeVars.clone(); let _idx = i.clone(); let _val = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tSynchronizeVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: synchronize.clone() }))); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        knowns = metamodelica::cons(metamodelica::arrayGet(tSynchronizeVars.clone(), i.clone())?, knowns.clone());
        tPriorityRefs = {let _arr = tPriorityRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("tPriority")).clone(), tArrayInteger.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tPriorityVars = {let _arr = tPriorityVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(tPriorityRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        tPriorityVars = {let _arr = tPriorityVars.clone(); let _idx = i.clone(); let _val = DAEUtil::setElementVarBinding(metamodelica::arrayGet(tPriorityVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: priority.clone() }))); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        knowns = metamodelica::cons(metamodelica::arrayGet(tPriorityVars.clone(), i.clone())?, knowns.clone());
    }
    ...
    for mut exp in &*cExps.clone() {
        ...
        i = i.clone() + 1;
        cRefs = {let _arr = cRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("c")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        cImmediateRefs = {let _arr = cImmediateRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("cImmediate")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        cVars = {let _arr = cVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(cRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        cImmediateVars = {let _arr = cImmediateVars.clone(); let _idx = i.clone(); let _val = createVarWithStartValue(metamodelica::arrayGet(cImmediateRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), Arc::new(DAE::Exp::BCONST { bool: false }), tDims.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        vars = metamodelica::cons(metamodelica::arrayGet(cVars.clone(), i.clone())?, vars.clone());
        vars = metamodelica::cons(metamodelica::arrayGet(cImmediateVars.clone(), i.clone())?, vars.clone());
    }
    activeRef = qCref((literal!("active")).clone(), DAE::T_BOOL_DEFAULT().clone(), metamodelica::nil(), preRef.clone())?;
    ...
    for mut i in 1..=nStates.clone() {
        activeResetStatesRefs = {let _arr = activeResetStatesRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("activeResetStates")).clone(), nStatesArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        activeResetStatesVars = {let _arr = activeResetStatesVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(activeResetStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), nStatesDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        vars = metamodelica::cons(metamodelica::arrayGet(activeResetStatesVars.clone(), i.clone())?, vars.clone());
    }
    ...
    for mut i in 1..=nStates.clone() {
        nextResetStatesRefs = {let _arr = nextResetStatesRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("nextResetStates")).clone(), nStatesArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        nextResetStatesVars = {let _arr = nextResetStatesVars.clone(); let _idx = i.clone(); let _val = createVarWithStartValue(metamodelica::arrayGet(nextResetStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), Arc::new(DAE::Exp::BCONST { bool: false }), nStatesDims.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        vars = metamodelica::cons(metamodelica::arrayGet(nextResetStatesVars.clone(), i.clone())?, vars.clone());
    }
    ...
    for mut i in 1..=nStates.clone() {
        finalStatesRefs = {let _arr = finalStatesRefs.clone(); let _idx = i.clone(); let _val = qCref((literal!("finalStates")).clone(), nStatesArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        finalStatesVars = {let _arr = finalStatesVars.clone(); let _idx = i.clone(); let _val = createVarWithDefaults(metamodelica::arrayGet(finalStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), nStatesDims.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        vars = metamodelica::cons(metamodelica::arrayGet(finalStatesVars.clone(), i.clone())?, vars.clone());
    }
    ...
    for mut cExp in &*cExps.clone() {
        ...
        i = i.clone() + 1;
        exp = Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(cImmediateRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() });
        ...
        exp1 = Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(cRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() });
        let __pa7 = ::match_deref::match_deref! { match &(metamodelica::arrayGet(tImmediateVars.clone(), i.clone())?) {
    ...
    for mut i in 1..=nStates.clone() {
        exp = Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(activeResetStatesRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() });
        expCond = Arc::new(DAE::Exp::CREF { componentRef: resetRef.clone(), ty: DAE::T_BOOL_DEFAULT().clone() });
        expThen = Arc::new(DAE::Exp::BCONST { bool: true });
        expElse = Arc::new(DAE::Exp::CALL { path: Arc::new(Absyn::Path::IDENT { name: (literal!("previous")).clone() }), expLst: list![Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(nextResetStatesRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() })], attr: DAE::callAttrBuiltinImpureBool().clone() });
        rhs = Arc::new(DAE::Exp::IFEXP { expCond: expCond.clone(), expThen: expThen.clone(), expElse: expElse.clone() });
    ...
    for mut i in 1..=nStates.clone() {
        exp = Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(nextResetStatesRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() });
        expCond = Arc::new(DAE::Exp::CREF { componentRef: activeRef.clone(), ty: DAE::T_BOOL_DEFAULT().clone() });
        ...
        expThen = Arc::new(DAE::Exp::IFEXP { expCond: exp1.clone(), expThen: Arc::new(DAE::Exp::BCONST { bool: false }), expElse: Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(activeResetStatesRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() }) });
        expElse = Arc::new(DAE::Exp::CALL { path: Arc::new(Absyn::Path::IDENT { name: (literal!("previous")).clone() }), expLst: list![Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(nextResetStatesRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() })], attr: DAE::callAttrBuiltinImpureBool().clone() });
        rhs = Arc::new(DAE::Exp::IFEXP { expCond: expCond.clone(), expThen: expThen.clone(), expElse: expElse.clone() });
        eqs = metamodelica::cons(Arc::new(DAE::Element::EQUATION { exp: exp.clone(), scalar: rhs.clone(), source: DAE::emptyElementSource().clone() }), eqs.clone());
    }
    for mut i in 1..=nStates.clone() {
        exp = Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(finalStatesRefs.clone(), i.clone())?, ty: DAE::T_BOOL_DEFAULT().clone() });
        expLst = metamodelica::nil();
        for mut j in 1..=nTransitions.clone() {
            expCond = Arc::new(DAE::Exp::RELATION { exp1: Arc::new(DAE::Exp::CREF { componentRef: metamodelica::arrayGet(tFromRefs.clone(), j.clone())?, ty: DAE::T_INTEGER_DEFAULT().clone() }), operator: DAE::Operator::EQUAL { ty: DAE::T_INTEGER_DEFAULT().clone() }, exp2: Arc::new(DAE::Exp::ICONST { integer: i.clone() }), index: -1, optionExpisASUB: None });
