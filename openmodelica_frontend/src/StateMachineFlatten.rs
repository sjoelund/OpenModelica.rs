...
fn basicFlatSmSemantics(mut ident: ArcStr, mut q: Arc<metamodelica::List<Arc<DAE::Element>>>, mut inTransitions: Arc<metamodelica::List<Arc<DAE::Element>>>) -> Result<FlatSmSemantics> {
    ...
    for mut t1 in &*t.clone() {
        ...
        tFromRefs = metamodelica::arrayUpdate(tFromRefs.clone(), i.clone(), qCref((literal!("tFrom")).clone(), tArrayInteger.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        tFromVars = metamodelica::arrayUpdate(tFromVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(tFromRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()))?;
        tFromVars = metamodelica::arrayUpdate(tFromVars.clone(), i.clone(), DAEUtil::setElementVarBinding(metamodelica::arrayGet(tFromVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: from.clone() }))))?;
        knowns = metamodelica::cons(metamodelica::arrayGet(tFromVars.clone(), i.clone())?, knowns.clone());
        tToRefs = metamodelica::arrayUpdate(tToRefs.clone(), i.clone(), qCref((literal!("tTo")).clone(), tArrayInteger.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        tToVars = metamodelica::arrayUpdate(tToVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(tToRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()))?;
        tToVars = metamodelica::arrayUpdate(tToVars.clone(), i.clone(), DAEUtil::setElementVarBinding(metamodelica::arrayGet(tToVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: to.clone() }))))?;
        knowns = metamodelica::cons(metamodelica::arrayGet(tToVars.clone(), i.clone())?, knowns.clone());
        tImmediateRefs = metamodelica::arrayUpdate(tImmediateRefs.clone(), i.clone(), qCref((literal!("tImmediate")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        tImmediateVars = metamodelica::arrayUpdate(tImmediateVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(tImmediateRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()))?;
        tImmediateVars = metamodelica::arrayUpdate(tImmediateVars.clone(), i.clone(), DAEUtil::setElementVarBinding(metamodelica::arrayGet(tImmediateVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: immediate.clone() }))))?;
        knowns = metamodelica::cons(metamodelica::arrayGet(tImmediateVars.clone(), i.clone())?, knowns.clone());
        tResetRefs = metamodelica::arrayUpdate(tResetRefs.clone(), i.clone(), qCref((literal!("tReset")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        tResetVars = metamodelica::arrayUpdate(tResetVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(tResetRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()))?;
        tResetVars = metamodelica::arrayUpdate(tResetVars.clone(), i.clone(), DAEUtil::setElementVarBinding(metamodelica::arrayGet(tResetVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: reset.clone() }))))?;
        knowns = metamodelica::cons(metamodelica::arrayGet(tResetVars.clone(), i.clone())?, knowns.clone());
        tSynchronizeRefs = metamodelica::arrayUpdate(tSynchronizeRefs.clone(), i.clone(), qCref((literal!("tSynchronize")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        tSynchronizeVars = metamodelica::arrayUpdate(tSynchronizeVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(tSynchronizeRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()))?;
        tSynchronizeVars = metamodelica::arrayUpdate(tSynchronizeVars.clone(), i.clone(), DAEUtil::setElementVarBinding(metamodelica::arrayGet(tSynchronizeVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::BCONST { bool: synchronize.clone() }))))?;
        knowns = metamodelica::cons(metamodelica::arrayGet(tSynchronizeVars.clone(), i.clone())?, knowns.clone());
        tPriorityRefs = metamodelica::arrayUpdate(tPriorityRefs.clone(), i.clone(), qCref((literal!("tPriority")).clone(), tArrayInteger.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        tPriorityVars = metamodelica::arrayUpdate(tPriorityVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(tPriorityRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::PARAM, DAE::T_INTEGER_DEFAULT().clone(), tDims.clone()))?;
        tPriorityVars = metamodelica::arrayUpdate(tPriorityVars.clone(), i.clone(), DAEUtil::setElementVarBinding(metamodelica::arrayGet(tPriorityVars.clone(), i.clone())?, Some(Arc::new(DAE::Exp::ICONST { integer: priority.clone() }))))?;
    ...
    for mut exp in &*cExps.clone() {
        ...
        i = i.clone() + 1;
        cRefs = metamodelica::arrayUpdate(cRefs.clone(), i.clone(), qCref((literal!("c")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        cImmediateRefs = metamodelica::arrayUpdate(cImmediateRefs.clone(), i.clone(), qCref((literal!("cImmediate")).clone(), tArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        cVars = metamodelica::arrayUpdate(cVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(cRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), tDims.clone()))?;
        cImmediateVars = metamodelica::arrayUpdate(cImmediateVars.clone(), i.clone(), createVarWithStartValue(metamodelica::arrayGet(cImmediateRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), Arc::new(DAE::Exp::BCONST { bool: false }), tDims.clone())?)?;
    ...
    for mut i in 1..=nStates.clone() {
        activeResetStatesRefs = metamodelica::arrayUpdate(activeResetStatesRefs.clone(), i.clone(), qCref((literal!("activeResetStates")).clone(), nStatesArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        activeResetStatesVars = metamodelica::arrayUpdate(activeResetStatesVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(activeResetStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), nStatesDims.clone()))?;
    ...
    for mut i in 1..=nStates.clone() {
        nextResetStatesRefs = metamodelica::arrayUpdate(nextResetStatesRefs.clone(), i.clone(), qCref((literal!("nextResetStates")).clone(), nStatesArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        nextResetStatesVars = metamodelica::arrayUpdate(nextResetStatesVars.clone(), i.clone(), createVarWithStartValue(metamodelica::arrayGet(nextResetStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), Arc::new(DAE::Exp::BCONST { bool: false }), nStatesDims.clone())?)?;
    ...
    for mut i in 1..=nStates.clone() {
        finalStatesRefs = metamodelica::arrayUpdate(finalStatesRefs.clone(), i.clone(), qCref((literal!("finalStates")).clone(), nStatesArrayBool.clone(), list![Arc::new(DAE::Subscript::INDEX { exp: Arc::new(DAE::Exp::ICONST { integer: i.clone() }) })], preRef.clone())?)?;
        finalStatesVars = metamodelica::arrayUpdate(finalStatesVars.clone(), i.clone(), createVarWithDefaults(metamodelica::arrayGet(finalStatesRefs.clone(), i.clone())?, openmodelica_frontend_types::DAE::VarKind::DISCRETE, DAE::T_BOOL_DEFAULT().clone(), nStatesDims.clone()))?;
