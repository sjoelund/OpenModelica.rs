...
pub fn isEqualOnTrue<T1: Clone + 'static, T2: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inCompFunc: Arc<dyn ::std::ops::Fn(T1, T2) -> Result<bool> + 'static>) -> bool {
    pub type CompFunc<T1: Clone, T2: Clone> = fn(T1, T2) -> Result<bool>;
...
pub fn allEqual<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inCompFunc: Arc<dyn ::std::ops::Fn(T, T) -> Result<bool> + 'static>) -> Result<bool> {
    pub type CompFunc<T: Clone> = fn(T, T) -> Result<bool>;
...
pub fn compare<T1: Clone + 'static, T2: Clone + 'static>(mut list1: Arc<metamodelica::List<T1>>, mut list2: Arc<metamodelica::List<T2>>, mut compareFn: Arc<dyn ::std::ops::Fn(T1, T2) -> Result<i32> + 'static>) -> Result<i32> {
    pub type CompFunc<T1: Clone, T2: Clone> = fn(T1, T2) -> Result<i32>;
...
pub fn appendLastList<T: Clone + 'static>(mut inListList: Arc<metamodelica::List<Arc<metamodelica::List<T>>>>, mut inList: Arc<metamodelica::List<T>>) -> Result<Arc<metamodelica::List<Arc<metamodelica::List<T>>>>> {
    ...
    outListList = (::match_deref::match_deref! { match &((inListList.clone(), inList.clone())) {
        (Deref @ metamodelica::List::Nil, _) => {
...
pub fn insertListSorted<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inList2: Arc<metamodelica::List<T>>, mut inCompFunc: Arc<dyn ::std::ops::Fn(T, T) -> Result<bool> + 'static>) -> Result<Arc<metamodelica::List<T>>> {
    pub type CompareFunc<T: Clone> = fn(T, T) -> Result<bool>;
...
pub fn splitOnTrue<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>) -> (Arc<metamodelica::List<T>>, Arc<metamodelica::List<T>>) {
    pub type PredicateFunc<T: Clone> = fn(T) -> Result<bool>;
...
pub fn split1OnTrue<T: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T, ArgT1) -> Result<bool> + 'static>, mut inArg1: ArgT1) -> (Arc<metamodelica::List<T>>, Arc<metamodelica::List<T>>) {
    pub type PredicateFunc<T: Clone, ArgT1: Clone> = fn(T, ArgT1) -> Result<bool>;
...
pub fn split2OnTrue<T: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, ArgT2) -> Result<bool> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> (Arc<metamodelica::List<T>>, Arc<metamodelica::List<T>>) {
    pub type PredicateFunc<T: Clone, ArgT1: Clone, ArgT2: Clone> = fn(T, ArgT1, ArgT2) -> Result<bool>;
...
pub fn splitOnFirstMatch<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>) -> Result<(Arc<metamodelica::List<T>>, Arc<metamodelica::List<T>>)> {
    pub type CompFunc<T: Clone> = fn(T) -> Result<bool>;
...
pub fn setDifference<T: Clone + 'static + PartialEq>(mut inList1: Arc<metamodelica::List<T>>, mut inList2: Arc<metamodelica::List<T>>) -> Result<Arc<metamodelica::List<T>>> {
    ...
    for mut e in &*inList2.clone() {
        let mut e = e.clone();
        (outDifference, _) = deleteMemberOnTrue(e.clone(), outDifference.clone(), Arc::new(fnptr!(valueEq, _, _)))?;
    }
    Ok(outDifference)
}
...
pub fn unionList<T: Clone + 'static + PartialEq>(mut inList: Arc<metamodelica::List<Arc<metamodelica::List<T>>>>) -> Result<Arc<metamodelica::List<T>>> {
    let mut outUnion: Arc<metamodelica::List<T>> = metamodelica::nil();
    outUnion = if (inList.clone().is_empty()) {metamodelica::nil()} else {reduce(inList.clone(), Arc::new(fnptr!(union, _, _)))?};
    Ok(outUnion)
}
...
pub fn map<TI: Clone + 'static, TO: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<TO> + 'static>) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, TO: Clone> = fn(TI) -> Result<TO>;
...
pub fn mapCheckReferenceEq<TI: Clone + 'static + PartialEq>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<TI> + 'static>) -> Arc<metamodelica::List<TI>> {
    pub type MapFunc<TI: Clone> = fn(TI) -> Result<TI>;
...
pub fn map_2<TI: Clone + 'static, TO1: Clone + 'static, TO2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<(TO1, TO2)> + 'static>) -> (Arc<metamodelica::List<TO1>>, Arc<metamodelica::List<TO2>>) {
    pub type MapFunc<TI: Clone, TO1: Clone, TO2: Clone> = fn(TI) -> Result<(TO1, TO2)>;
...
pub fn map_3<TI: Clone + 'static, TO1: Clone + 'static, TO2: Clone + 'static, TO3: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<(TO1, TO2, TO3)> + 'static>) -> (Arc<metamodelica::List<TO1>>, Arc<metamodelica::List<TO2>>, Arc<metamodelica::List<TO3>>) {
    pub type MapFunc<TI: Clone, TO1: Clone, TO2: Clone, TO3: Clone> = fn(TI) -> Result<(TO1, TO2, TO3)>;
...
pub fn map1Option<TI: Clone + 'static, TO: Clone + 'static, ArgT: Clone + 'static>(mut inList: Arc<metamodelica::List<Option<TI>>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT) -> Result<TO> + 'static>, mut inArg1: ArgT) -> Result<Arc<metamodelica::List<TO>>> {
    pub type MapFunc<TI: Clone, ArgT: Clone, TO: Clone> = fn(TI, ArgT) -> Result<TO>;
...
pub fn map2Option<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<Option<TI>>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> Result<Arc<metamodelica::List<TO>>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2) -> Result<TO>;
...
pub fn map_0<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T) -> Result<()> + 'static>) -> () {
    pub type MapFunc<T: Clone> = fn(T) -> Result<()>;
...
pub fn map1<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1) -> Result<TO> + 'static>, mut inArg1: ArgT1) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, TO: Clone> = fn(TI, ArgT1) -> Result<TO>;
...
pub fn map1r<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(ArgT1, TI) -> Result<TO> + 'static>, mut inArg1: ArgT1) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<ArgT1: Clone, TI: Clone, TO: Clone> = fn(ArgT1, TI) -> Result<TO>;
...
pub fn map1_0<TI: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1) -> Result<()> + 'static>, mut inArg1: ArgT1) -> () {
    pub type MapFunc<TI: Clone, ArgT1: Clone> = fn(TI, ArgT1) -> Result<()>;
...
pub fn map1_2<TI: Clone + 'static, TO1: Clone + 'static, TO2: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1) -> Result<(TO1, TO2)> + 'static>, mut inArg1: ArgT1) -> (Arc<metamodelica::List<TO1>>, Arc<metamodelica::List<TO2>>) {
    pub type MapFunc<TI: Clone, ArgT1: Clone, TO1: Clone, TO2: Clone> = fn(TI, ArgT1) -> Result<(TO1, TO2)>;
...
pub fn map2<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2) -> Result<TO>;
...
pub fn map2Reverse<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2) -> Result<TO>;
...
pub fn map2_0<TI: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2) -> Result<()> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> () {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone> = fn(TI, ArgT1, ArgT2) -> Result<()>;
...
pub fn map2_2<TI: Clone + 'static, TO1: Clone + 'static, TO2: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2) -> Result<(TO1, TO2)> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> (Arc<metamodelica::List<TO1>>, Arc<metamodelica::List<TO2>>) {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, TO1: Clone, TO2: Clone> = fn(TI, ArgT1, ArgT2) -> Result<(TO1, TO2)>;
...
pub fn map3<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2, ArgT3) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2, mut inArg3: ArgT3) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2, ArgT3) -> Result<TO>;
...
pub fn map4<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static, ArgT4: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2, ArgT3, ArgT4) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2, mut inArg3: ArgT3, mut inArg4: ArgT4) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, ArgT4: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2, ArgT3, ArgT4) -> Result<TO>;
...
pub fn map4_0<TI: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static, ArgT4: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2, ArgT3, ArgT4) -> Result<()> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2, mut inArg3: ArgT3, mut inArg4: ArgT4) -> () {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, ArgT4: Clone> = fn(TI, ArgT1, ArgT2, ArgT3, ArgT4) -> Result<()>;
...
pub fn map5<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static, ArgT4: Clone + 'static, ArgT5: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2, ArgT3, ArgT4, ArgT5) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2, mut inArg3: ArgT3, mut inArg4: ArgT4, mut inArg5: ArgT5) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, ArgT4: Clone, ArgT5: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2, ArgT3, ArgT4, ArgT5) -> Result<TO>;
...
pub fn map6<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static, ArgT4: Clone + 'static, ArgT5: Clone + 'static, ArgT6: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2, ArgT3, ArgT4, ArgT5, ArgT6) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2, mut inArg3: ArgT3, mut inArg4: ArgT4, mut inArg5: ArgT5, mut inArg6: ArgT6) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, ArgT4: Clone, ArgT5: Clone, ArgT6: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2, ArgT3, ArgT4, ArgT5, ArgT6) -> Result<TO>;
...
pub fn mapFlat<TI: Clone + 'static, TO: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<Arc<metamodelica::List<TO>>> + 'static>) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, TO: Clone> = fn(TI) -> Result<Arc<metamodelica::List<TO>>>;
...
pub fn mapMap<TI: Clone + 'static, TO1: Clone + 'static, TO2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inMapFunc1: Arc<dyn ::std::ops::Fn(TI) -> Result<TO1> + 'static>, mut inMapFunc2: Arc<dyn ::std::ops::Fn(TO1) -> Result<TO2> + 'static>) -> Arc<metamodelica::List<TO2>> {
    pub type MapFunc1<TI: Clone, TO1: Clone> = fn(TI) -> Result<TO1>;

    pub type MapFunc2<TO1: Clone, TO2: Clone> = fn(TO1) -> Result<TO2>;
...
pub fn foldAllValue<TI: Clone + 'static, TO: Clone + 'static + PartialEq, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1) -> Result<(TO, ArgT1)> + 'static>, mut inValue: TO, mut inArg1: ArgT1) -> Result<()> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, TO: Clone> = fn(TI, ArgT1) -> Result<(TO, ArgT1)>;
...
pub fn applyAndFold<TI: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(TO, FT) -> Result<FT> + 'static>, mut inApplyFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<TO> + 'static>, mut inFoldArg: FT) -> FT {
    pub type ApplyFunc<TI: Clone, TO: Clone> = fn(TI) -> Result<TO>;

    pub type FoldFunc<TO: Clone, FT: Clone> = fn(TO, FT) -> Result<FT>;
...
pub fn applyAndFold1<TI: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(TO, FT) -> Result<FT> + 'static>, mut inApplyFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1) -> Result<TO> + 'static>, mut inExtraArg: ArgT1, mut inFoldArg: FT) -> FT {
    pub type ApplyFunc<TI: Clone, ArgT1: Clone, TO: Clone> = fn(TI, ArgT1) -> Result<TO>;
...
pub fn mapMapBoolAnd<TI: Clone + 'static, TI2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<TI2> + 'static>, mut inBFunc: Arc<dyn ::std::ops::Fn(TI2) -> Result<bool> + 'static>) -> bool {
    pub type MapBFunc<TI2: Clone> = fn(TI2) -> Result<bool>;

    pub type MapFunc<TI: Clone, TI2: Clone> = fn(TI) -> Result<TI2>;
...
pub fn map1List<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static>(mut inListList: Arc<metamodelica::List<Arc<metamodelica::List<TI>>>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1) -> Result<TO> + 'static>, mut inArg1: ArgT1) -> Arc<metamodelica::List<Arc<metamodelica::List<TO>>>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, TO: Clone> = fn(TI, ArgT1) -> Result<TO>;
...
pub fn map2List<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inListList: Arc<metamodelica::List<Arc<metamodelica::List<TI>>>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> Arc<metamodelica::List<Arc<metamodelica::List<TO>>>> {
    pub type MapFunc<TI: Clone, ArgT1: Clone, ArgT2: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2) -> Result<TO>;
...
pub fn fold<T: Clone + 'static, FT: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, FT) -> Result<FT> + 'static>, mut inStartValue: FT) -> FT {
    pub type FoldFunc<T: Clone, FT: Clone> = fn(T, FT) -> Result<FT>;
...
pub fn foldr<T: Clone + 'static, FT: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(FT, T) -> Result<FT> + 'static>, mut inStartValue: FT) -> FT {
    pub type FoldFunc<FT: Clone, T: Clone> = fn(FT, T) -> Result<FT>;
...
pub fn fold1<T: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, FT) -> Result<FT> + 'static>, mut inExtraArg: ArgT1, mut inStartValue: FT) -> FT {
    pub type FoldFunc<T: Clone, ArgT1: Clone, FT: Clone> = fn(T, ArgT1, FT) -> Result<FT>;
...
pub fn fold1r<T: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(FT, T, ArgT1) -> Result<FT> + 'static>, mut inExtraArg: ArgT1, mut inStartValue: FT) -> FT {
    pub type FoldFunc<FT: Clone, T: Clone, ArgT1: Clone> = fn(FT, T, ArgT1) -> Result<FT>;
...
pub fn fold2<T: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, ArgT2, FT) -> Result<FT> + 'static>, mut inExtraArg1: ArgT1, mut inExtraArg2: ArgT2, mut inStartValue: FT) -> FT {
    pub type FoldFunc<T: Clone, ArgT1: Clone, ArgT2: Clone, FT: Clone> = fn(T, ArgT1, ArgT2, FT) -> Result<FT>;
...
pub fn fold22<T: Clone + 'static, FT1: Clone + 'static, FT2: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, ArgT2, FT1, FT2) -> Result<(FT1, FT2)> + 'static>, mut inExtraArg1: ArgT1, mut inExtraArg2: ArgT2, mut inStartValue1: FT1, mut inStartValue2: FT2) -> (FT1, FT2) {
    pub type FoldFunc<T: Clone, ArgT1: Clone, ArgT2: Clone, FT1: Clone, FT2: Clone> = fn(T, ArgT1, ArgT2, FT1, FT2) -> Result<(FT1, FT2)>;
...
pub fn fold2r<T: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(FT, T, ArgT1, ArgT2) -> Result<FT> + 'static>, mut inExtraArg1: ArgT1, mut inExtraArg2: ArgT2, mut inStartValue: FT) -> FT {
    pub type FoldFunc<FT: Clone, T: Clone, ArgT1: Clone, ArgT2: Clone> = fn(FT, T, ArgT1, ArgT2) -> Result<FT>;
...
pub fn fold3<T: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, ArgT2, ArgT3, FT) -> Result<FT> + 'static>, mut inExtraArg1: ArgT1, mut inExtraArg2: ArgT2, mut inExtraArg3: ArgT3, mut inStartValue: FT) -> FT {
    pub type FoldFunc<T: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, FT: Clone> = fn(T, ArgT1, ArgT2, ArgT3, FT) -> Result<FT>;
...
pub fn fold4<T: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static, ArgT4: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, ArgT2, ArgT3, ArgT4, FT) -> Result<FT> + 'static>, mut inExtraArg1: ArgT1, mut inExtraArg2: ArgT2, mut inExtraArg3: ArgT3, mut inExtraArg4: ArgT4, mut inStartValue: FT) -> FT {
    pub type FoldFunc<T: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, ArgT4: Clone, FT: Clone> = fn(T, ArgT1, ArgT2, ArgT3, ArgT4, FT) -> Result<FT>;
...
pub fn fold20<T: Clone + 'static, FT1: Clone + 'static, FT2: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, FT1, FT2) -> Result<(FT1, FT2)> + 'static>, mut inStartValue1: FT1, mut inStartValue2: FT2) -> (FT1, FT2) {
    pub type FoldFunc<T: Clone, FT1: Clone, FT2: Clone> = fn(T, FT1, FT2) -> Result<(FT1, FT2)>;
...
pub fn fold21<T: Clone + 'static, FT1: Clone + 'static, FT2: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, FT1, FT2) -> Result<(FT1, FT2)> + 'static>, mut inExtraArg1: ArgT1, mut inStartValue1: FT1, mut inStartValue2: FT2) -> (FT1, FT2) {
    pub type FoldFunc<T: Clone, ArgT1: Clone, FT1: Clone, FT2: Clone> = fn(T, ArgT1, FT1, FT2) -> Result<(FT1, FT2)>;
...
pub fn fold31<T: Clone + 'static, FT1: Clone + 'static, FT2: Clone + 'static, FT3: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, FT1, FT2, FT3) -> Result<(FT1, FT2, FT3)> + 'static>, mut inExtraArg1: ArgT1, mut inStartValue1: FT1, mut inStartValue2: FT2, mut inStartValue3: FT3) -> (FT1, FT2, FT3) {
    pub type FoldFunc<T: Clone, ArgT1: Clone, FT1: Clone, FT2: Clone, FT3: Clone> = fn(T, ArgT1, FT1, FT2, FT3) -> Result<(FT1, FT2, FT3)>;
...
pub fn mapFold<TI: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, FT) -> Result<(TO, FT)> + 'static>, mut inArg: FT) -> (Arc<metamodelica::List<TO>>, FT) {
    pub type FuncType<TI: Clone, FT: Clone, TO: Clone> = fn(TI, FT) -> Result<(TO, FT)>;
...
pub fn mapFold2<TI: Clone + 'static, TO: Clone + 'static, FT1: Clone + 'static, FT2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, FT1, FT2) -> Result<(TO, FT1, FT2)> + 'static>, mut inArg1: FT1, mut inArg2: FT2) -> (Arc<metamodelica::List<TO>>, FT1, FT2) {
    pub type FuncType<TI: Clone, FT1: Clone, FT2: Clone, TO: Clone> = fn(TI, FT1, FT2) -> Result<(TO, FT1, FT2)>;
...
pub fn mapFold3<TI: Clone + 'static, TO: Clone + 'static, FT1: Clone + 'static, FT2: Clone + 'static, FT3: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, FT1, FT2, FT3) -> Result<(TO, FT1, FT2, FT3)> + 'static>, mut inArg1: FT1, mut inArg2: FT2, mut inArg3: FT3) -> (Arc<metamodelica::List<TO>>, FT1, FT2, FT3) {
    pub type FuncType<TI: Clone, FT1: Clone, FT2: Clone, FT3: Clone, TO: Clone> = fn(TI, FT1, FT2, FT3) -> Result<(TO, FT1, FT2, FT3)>;
...
pub fn mapFold5<TI: Clone + 'static, TO: Clone + 'static, FT1: Clone + 'static, FT2: Clone + 'static, FT3: Clone + 'static, FT4: Clone + 'static, FT5: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, FT1, FT2, FT3, FT4, FT5) -> Result<(TO, FT1, FT2, FT3, FT4, FT5)> + 'static>, mut inArg1: FT1, mut inArg2: FT2, mut inArg3: FT3, mut inArg4: FT4, mut inArg5: FT5) -> (Arc<metamodelica::List<TO>>, FT1, FT2, FT3, FT4, FT5) {
    pub type FuncType<TI: Clone, FT1: Clone, FT2: Clone, FT3: Clone, FT4: Clone, FT5: Clone, TO: Clone> = fn(TI, FT1, FT2, FT3, FT4, FT5) -> Result<(TO, FT1, FT2, FT3, FT4, FT5)>;
...
pub fn map1Fold<TI: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, FT) -> Result<(TO, FT)> + 'static>, mut inConstArg: ArgT1, mut inArg: FT) -> (Arc<metamodelica::List<TO>>, FT) {
    pub type FuncType<TI: Clone, ArgT1: Clone, FT: Clone, TO: Clone> = fn(TI, ArgT1, FT) -> Result<(TO, FT)>;
...
pub fn map2Fold<TI: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2, FT) -> Result<(TO, FT)> + 'static>, mut inConstArg: ArgT1, mut inConstArg2: ArgT2, mut inArg: FT, mut inAccum: Arc<metamodelica::List<TO>>) -> (Arc<metamodelica::List<TO>>, FT) {
    pub type FuncType<TI: Clone, ArgT1: Clone, ArgT2: Clone, FT: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2, FT) -> Result<(TO, FT)>;
...
pub fn map3Fold<TI: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1, ArgT2, ArgT3, FT) -> Result<(TO, FT)> + 'static>, mut inConstArg: ArgT1, mut inConstArg2: ArgT2, mut inConstArg3: ArgT3, mut inArg: FT) -> (Arc<metamodelica::List<TO>>, FT) {
    pub type FuncType<TI: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, FT: Clone, TO: Clone> = fn(TI, ArgT1, ArgT2, ArgT3, FT) -> Result<(TO, FT)>;
...
pub fn mapFoldList<TI: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static>(mut inListList: Arc<metamodelica::List<Arc<metamodelica::List<TI>>>>, mut inFunc: Arc<dyn ::std::ops::Fn(TI, FT) -> Result<(TO, FT)> + 'static>, mut inArg: FT) -> (Arc<metamodelica::List<Arc<metamodelica::List<TO>>>>, FT) {
    pub type FuncType<TI: Clone, FT: Clone, TO: Clone> = fn(TI, FT) -> Result<(TO, FT)>;
...
pub fn reduce<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inReduceFunc: Arc<dyn ::std::ops::Fn(T, T) -> Result<T> + 'static>) -> Result<T> {
    pub type ReduceFunc<T: Clone> = fn(T, T) -> Result<T>;
...
pub fn threadMap<T1: Clone + 'static, T2: Clone + 'static, TO: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(T1, T2) -> Result<TO> + 'static>) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<T1: Clone, T2: Clone, TO: Clone> = fn(T1, T2) -> Result<TO>;
...
pub fn threadMap_2<T1: Clone + 'static, T2: Clone + 'static, TO1: Clone + 'static, TO2: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(T1, T2) -> Result<(TO1, TO2)> + 'static>) -> Result<(Arc<metamodelica::List<TO1>>, Arc<metamodelica::List<TO2>>)> {
    pub type MapFunc<T1: Clone, T2: Clone, TO1: Clone, TO2: Clone> = fn(T1, T2) -> Result<(TO1, TO2)>;
...
pub fn threadMap1<T1: Clone + 'static, T2: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(T1, T2, ArgT1) -> Result<TO> + 'static>, mut inArg1: ArgT1) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<T1: Clone, T2: Clone, ArgT1: Clone, TO: Clone> = fn(T1, T2, ArgT1) -> Result<TO>;
...
pub fn threadMap1_0<T1: Clone + 'static, T2: Clone + 'static, ArgT1: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(T1, T2, ArgT1) -> Result<()> + 'static>, mut inArg1: ArgT1) -> Result<()> {
    pub type MapFunc<T1: Clone, T2: Clone, ArgT1: Clone> = fn(T1, T2, ArgT1) -> Result<()>;
...
pub fn threadMap2<T1: Clone + 'static, T2: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(T1, T2, ArgT1, ArgT2) -> Result<TO> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<T1: Clone, T2: Clone, ArgT1: Clone, ArgT2: Clone, TO: Clone> = fn(T1, T2, ArgT1, ArgT2) -> Result<TO>;
...
pub fn thread3Map<T1: Clone + 'static, T2: Clone + 'static, T3: Clone + 'static, TO: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inList3: Arc<metamodelica::List<T3>>, mut inFunc: Arc<dyn ::std::ops::Fn(T1, T2, T3) -> Result<TO> + 'static>) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<T1: Clone, T2: Clone, T3: Clone, TO: Clone> = fn(T1, T2, T3) -> Result<TO>;
...
pub fn thread3MapFold<T1: Clone + 'static, T2: Clone + 'static, T3: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inList3: Arc<metamodelica::List<T3>>, mut inFunc: Arc<dyn ::std::ops::Fn(T1, T2, T3, ArgT1) -> Result<(TO, ArgT1)> + 'static>, mut inArg: ArgT1) -> Result<(Arc<metamodelica::List<TO>>, ArgT1)> {
    pub type MapFunc<T1: Clone, T2: Clone, T3: Clone, ArgT1: Clone, TO: Clone> = fn(T1, T2, T3, ArgT1) -> Result<(TO, ArgT1)>;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
pub fn threadFold1<T1: Clone + 'static, T2: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T1, T2, ArgT1, FT) -> Result<FT> + 'static>, mut inArg1: ArgT1, mut inFoldArg: FT) -> Result<FT> {
    pub type FoldFunc<T1: Clone, T2: Clone, ArgT1: Clone, FT: Clone> = fn(T1, T2, ArgT1, FT) -> Result<FT>;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
pub fn threadFold2<T1: Clone + 'static, T2: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T1, T2, ArgT1, ArgT2, FT) -> Result<FT> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2, mut inFoldArg: FT) -> Result<FT> {
    pub type FoldFunc<T1: Clone, T2: Clone, ArgT1: Clone, ArgT2: Clone, FT: Clone> = fn(T1, T2, ArgT1, ArgT2, FT) -> Result<FT>;
...
// NOTE: #[tailcall::tailcall] disabled: function body contains a `match_deref!{…}` match,
// and the tailcall rewriter cannot see arms hidden behind the macro's `Deref @` patterns.
pub fn threadFold3<T1: Clone + 'static, T2: Clone + 'static, FT: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static, ArgT3: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T1, T2, ArgT1, ArgT2, ArgT3, FT) -> Result<FT> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2, mut inArg3: ArgT3, mut inFoldArg: FT) -> Result<FT> {
    pub type FoldFunc<T1: Clone, T2: Clone, ArgT1: Clone, ArgT2: Clone, ArgT3: Clone, FT: Clone> = fn(T1, T2, ArgT1, ArgT2, ArgT3, FT) -> Result<FT>;
...
pub fn threadFold<T1: Clone + 'static, T2: Clone + 'static, FT: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inFoldFunc: Arc<dyn ::std::ops::Fn(T1, T2, FT) -> Result<FT> + 'static>, mut inFoldArg: FT) -> Result<FT> {
    pub type FoldFunc<T1: Clone, T2: Clone, FT: Clone> = fn(T1, T2, FT) -> Result<FT>;
...
pub fn threadMapFold<T1: Clone + 'static, T2: Clone + 'static, TO: Clone + 'static, FT: Clone + 'static>(mut inList1: Arc<metamodelica::List<T1>>, mut inList2: Arc<metamodelica::List<T2>>, mut inFunc: Arc<dyn ::std::ops::Fn(T1, T2, FT) -> Result<(TO, FT)> + 'static>, mut inArg: FT) -> Result<(Arc<metamodelica::List<TO>>, FT)> {
    pub type FuncType<T1: Clone, T2: Clone, FT: Clone, TO: Clone> = fn(T1, T2, FT) -> Result<(TO, FT)>;
...
pub fn positionOnTrue<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inPredFunc: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>) -> i32 {
    pub type PredFunc<T: Clone> = fn(T) -> Result<bool>;
...
pub fn position1OnTrue<T: Clone + 'static, ArgT: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inPredFunc: Arc<dyn ::std::ops::Fn(T, ArgT) -> Result<bool> + 'static>, mut inArg: ArgT) -> i32 {
    pub type PredFunc<T: Clone, ArgT: Clone> = fn(T, ArgT) -> Result<bool>;
...
pub fn getMemberOnTrue<T: Clone + 'static, VT: Clone + 'static>(mut inValue: VT, mut inList: Arc<metamodelica::List<T>>, mut inCompFunc: Arc<dyn ::std::ops::Fn(VT, T) -> Result<bool> + 'static>) -> Result<T> {
    pub type CompFunc<VT: Clone, T: Clone> = fn(VT, T) -> Result<bool>;
...
pub fn isMemberOnTrue<T: Clone + 'static, VT: Clone + 'static>(mut inValue: VT, mut inList: Arc<metamodelica::List<T>>, mut inCompFunc: Arc<dyn ::std::ops::Fn(VT, T) -> Result<bool> + 'static>) -> bool {
    pub type CompFunc<VT: Clone, T: Clone> = fn(VT, T) -> Result<bool>;
...
pub fn exist1<T: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFindFunc: Arc<dyn ::std::ops::Fn(T, ArgT1) -> Result<bool> + 'static>, mut inExtraArg: ArgT1) -> bool {
    pub type FindFunc<T: Clone, ArgT1: Clone> = fn(T, ArgT1) -> Result<bool>;
...
pub fn extractOnTrue<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>) -> (Arc<metamodelica::List<T>>, Arc<metamodelica::List<T>>) {
    pub type FilterFunc<T: Clone> = fn(T) -> Result<bool>;
...
pub fn extract1OnTrue<T: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T, ArgT1) -> Result<bool> + 'static>, mut inArg: ArgT1) -> (Arc<metamodelica::List<T>>, Arc<metamodelica::List<T>>) {
    pub type FilterFunc<T: Clone, ArgT1: Clone> = fn(T, ArgT1) -> Result<bool>;
...
pub fn filter<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T) -> Result<()> + 'static>) -> Arc<metamodelica::List<T>> {
    pub type FilterFunc<T: Clone> = fn(T) -> Result<()>;
...
pub fn filterMap<TI: Clone + 'static, TO: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFilterMapFunc: Arc<dyn ::std::ops::Fn(TI) -> Result<TO> + 'static>) -> Arc<metamodelica::List<TO>> {
    pub type FilterMapFunc<TI: Clone, TO: Clone> = fn(TI) -> Result<TO>;
...
pub fn filterMap1<TI: Clone + 'static, TO: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inFilterMapFunc: Arc<dyn ::std::ops::Fn(TI, ArgT1) -> Result<TO> + 'static>, mut inExtraArg: ArgT1) -> Arc<metamodelica::List<TO>> {
    pub type FilterMapFunc<TI: Clone, ArgT1: Clone, TO: Clone> = fn(TI, ArgT1) -> Result<TO>;
...
pub fn filter1OnTrueSync<T1: Clone + 'static, T2: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T1>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T1, ArgT1) -> Result<bool> + 'static>, mut inArg1: ArgT1, mut inSyncList: Arc<metamodelica::List<T2>>) -> Result<(Arc<metamodelica::List<T1>>, Arc<metamodelica::List<T2>>)> {
    pub type FilterFunc<T1: Clone, ArgT1: Clone> = fn(T1, ArgT1) -> Result<bool>;
...
pub fn filterOnTrueSync<T1: Clone + 'static, T2: Clone + 'static>(mut inList: Arc<metamodelica::List<T1>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T1) -> Result<bool> + 'static>, mut inSyncList: Arc<metamodelica::List<T2>>) -> Result<(Arc<metamodelica::List<T1>>, Arc<metamodelica::List<T2>>)> {
    pub type FilterFunc<T1: Clone> = fn(T1) -> Result<bool>;
...
pub fn filter1<T: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T, ArgT1) -> Result<()> + 'static>, mut inArg1: ArgT1) -> Arc<metamodelica::List<T>> {
    pub type FilterFunc<T: Clone, ArgT1: Clone> = fn(T, ArgT1) -> Result<()>;
...
pub fn filter1OnTrueAndUpdate<T: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T, ArgT1) -> Result<bool> + 'static>, mut inUpdateFunc: Arc<dyn ::std::ops::Fn(T, ArgT1) -> Result<T> + 'static>, mut inArg1: ArgT1) -> Arc<metamodelica::List<T>> {
    ...
    pub type UpdateFunc<T: Clone, ArgT1: Clone> = fn(T, ArgT1) -> Result<T>;
...
pub fn filter1rOnTrue<T: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(ArgT1, T) -> Result<bool> + 'static>, mut inArg1: ArgT1) -> Arc<metamodelica::List<T>> {
    pub type FilterFunc<ArgT1: Clone, T: Clone> = fn(ArgT1, T) -> Result<bool>;
...
pub fn filter2OnTrue<T: Clone + 'static, ArgT1: Clone + 'static, ArgT2: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFilterFunc: Arc<dyn ::std::ops::Fn(T, ArgT1, ArgT2) -> Result<bool> + 'static>, mut inArg1: ArgT1, mut inArg2: ArgT2) -> Arc<metamodelica::List<T>> {
    pub type FilterFunc<T: Clone, ArgT1: Clone, ArgT2: Clone> = fn(T, ArgT1, ArgT2) -> Result<bool>;
...
pub fn removeOnTrue<T: Clone + 'static, VT: Clone + 'static>(mut inValue: VT, mut inCompFunc: Arc<dyn ::std::ops::Fn(VT, T) -> Result<bool> + 'static>, mut inList: Arc<metamodelica::List<T>>) -> Arc<metamodelica::List<T>> {
    pub type CompFunc<VT: Clone, T: Clone> = fn(VT, T) -> Result<bool>;
...
pub fn find<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>) -> Result<T> {
    pub type SelectFunc<T: Clone> = fn(T) -> Result<bool>;
...
pub fn findOption<T: Clone + 'static>(mut lst: Arc<metamodelica::List<T>>, mut r#fn: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>) -> Option<T> {
    pub type Predicate<T: Clone> = fn(T) -> Result<bool>;
...
pub fn find1<T: Clone + 'static, ArgT1: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T, ArgT1) -> Result<bool> + 'static>, mut arg1: ArgT1) -> Result<T> {
    pub type SelectFunc<T: Clone, ArgT1: Clone> = fn(T, ArgT1) -> Result<bool>;
...
pub fn deleteMemberOnTrue<T: Clone + 'static, VT: Clone + 'static>(mut inValue: VT, mut inList: Arc<metamodelica::List<T>>, mut inCompareFunc: Arc<dyn ::std::ops::Fn(VT, T) -> Result<bool> + 'static>) -> Result<(Arc<metamodelica::List<T>>, Option<T>)> {
    pub type CompareFunc<VT: Clone, T: Clone> = fn(VT, T) -> Result<bool>;
...
pub fn deletePositions<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inPositions: Arc<metamodelica::List<i32>>, mut zeroBased: bool) -> Result<Arc<metamodelica::List<T>>> {
    ...
    sorted_pos = sortedUnique(sort(inPositions.clone(), Arc::new(fnptr!(intGt, i32, i32)))?, Arc::new(fnptr!(intEq, i32, i32)))?;
...
pub fn replaceOnTrue<T: Clone + 'static>(mut inReplacement: T, mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>) -> Result<(Arc<metamodelica::List<T>>, bool)> {
    pub type FuncType<T: Clone> = fn(T) -> Result<bool>;
...
pub fn accumulateMapAccum<TI: Clone + 'static, TO: Clone + 'static>(mut inList: Arc<metamodelica::List<TI>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(TI, Arc<metamodelica::List<TO>>) -> Result<Arc<metamodelica::List<TO>>> + 'static>) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, TO: Clone> = fn(TI, Arc<metamodelica::List<TO>>) -> Result<Arc<metamodelica::List<TO>>>;
...
pub fn findMap<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut inFunc: Arc<dyn ::std::ops::Fn(T) -> Result<(T, bool)> + 'static>) -> Result<(Arc<metamodelica::List<T>>, bool)> {
    pub type FuncType<T: Clone> = fn(T) -> Result<(T, bool)>;
...
pub fn findAndMap<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut pred: Arc<dyn ::std::ops::Fn(T) -> Result<bool> + 'static>, mut func: Arc<dyn ::std::ops::Fn(T) -> Result<T> + 'static>) -> Result<(Arc<metamodelica::List<T>>, bool)> {
    ...
    pub type Func<T: Clone> = fn(T) -> Result<T>;
...
pub fn findSome<T1: Clone + 'static, T2: Clone + 'static>(mut inList: Arc<metamodelica::List<T1>>, mut inFunc: Arc<dyn ::std::ops::Fn(T1) -> Result<Option<T2>> + 'static>) -> Option<T2> {
    pub type FuncType<T1: Clone, T2: Clone> = fn(T1) -> Result<Option<T2>>;
...
pub fn splitEqualPrefix<T1: Clone + 'static, T2: Clone + 'static>(mut inFullList: Arc<metamodelica::List<T1>>, mut inPrefixList: Arc<metamodelica::List<T2>>, mut inEqFunc: Arc<dyn ::std::ops::Fn(T1, T2) -> Result<bool> + 'static>, mut inAccum: Arc<metamodelica::List<T1>>) -> Result<(Arc<metamodelica::List<T1>>, Arc<metamodelica::List<T1>>)> {
    pub type EqFunc<T1: Clone, T2: Clone> = fn(T1, T2) -> Result<bool>;
...
pub fn combinationMap<TI: Clone + 'static, TO: Clone + 'static>(mut inElements: Arc<metamodelica::List<Arc<metamodelica::List<TI>>>>, mut inMapFunc: Arc<dyn ::std::ops::Fn(Arc<metamodelica::List<TI>>) -> Result<TO> + 'static>) -> Arc<metamodelica::List<TO>> {
    pub type MapFunc<TI: Clone, TO: Clone> = fn(Arc<metamodelica::List<TI>>) -> Result<TO>;
...
pub fn mapIndices<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut indices: Arc<metamodelica::List<i32>>, mut func: Arc<dyn ::std::ops::Fn(T) -> Result<T> + 'static>) -> Result<Arc<metamodelica::List<T>>> {
    pub type MapFunc<T: Clone> = fn(T) -> Result<T>;
...
pub fn allCombinations<T: Clone + 'static>(mut lst: Arc<metamodelica::List<Arc<metamodelica::List<T>>>>, mut maxTotalSize: Option<i32>, mut info: SourceInfo) -> Result<Arc<metamodelica::List<Arc<metamodelica::List<T>>>>> {
    ...
    out = (::match_deref::match_deref! { match &((lst.clone(), maxTotalSize.clone(), info.clone())) {
        (_, Some(maxSz), _) => {
            let mut sz: i32 = 0;
            sz = intMul((lst.clone().len() as i32), applyAndFold(lst.clone(), Arc::new(fnptr!(intMul, i32, i32)), Arc::new(fnptr!(listLength, _)), 1));
...
pub fn contains<T: Clone + 'static>(mut lst: Arc<metamodelica::List<T>>, mut elem: T, mut eqFunc: Arc<dyn ::std::ops::Fn(T, T) -> Result<bool> + 'static>) -> bool {
    pub type equalityFunc<T: Clone> = fn(T, T) -> Result<bool>;
...
pub fn minElement<T: Clone + 'static>(mut inList: Arc<metamodelica::List<T>>, mut lessFn: Arc<dyn ::std::ops::Fn(T, T) -> Result<bool> + 'static>) -> Result<T> {
    pub type LessFn<T: Clone> = fn(T, T) -> Result<bool>;
