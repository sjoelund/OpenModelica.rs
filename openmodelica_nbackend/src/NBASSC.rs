...
pub fn setMatrix(mut nv: i32, mut ne: i32, mut nz: i32, mut adj: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut val: metamodelica::Array<Arc<metamodelica::List<i32>>>) -> () {
    todo!(); // ExternalSection { decl: ExternalDecl { funcName: Some("ASSC_setMatrix"), lang: Some("C"), output_: None, args: Cons { head: CREF { componentRef: CREF_IDENT { name: "nv", subscripts: Nil } }, tail: Cons { head: CREF { componentRef: CREF_IDENT { name: "ne", subscripts: Nil } }, tail: Cons { head: CREF { componentRef: CREF_IDENT { name: "nz", subscripts: Nil } }, tail: Cons { head: CREF { componentRef: CREF_IDENT { name: "adj", subscripts: Nil } }, tail: Cons { head: CREF { componentRef: CREF_IDENT { name: "val", subscripts: Nil } }, tail: Nil } } } } }, annotation_: Some(Annotation { elementArgs: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "Library" }, modification: Some(Modification { elementArgLst: Nil, eqMod: EQMOD { exp: STRING { value: "omcruntime" }, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/NBackEnd/Util/NBASSC.mo", isReadOnly: false, lineNumberStart: 110, columnNumberStart: 70, lineNumberEnd: 110, columnNumberEnd: 84, lastModification: 0.0 } } }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/NBackEnd/Util/NBASSC.mo", isReadOnly: false, lineNumberStart: 110, columnNumberStart: 62, lineNumberEnd: 110, columnNumberEnd: 84, lastModification: 0.0 } }, tail: Nil } }) }, annotation: None }
    ()
}

pub fn freeMatrix() -> () {
    todo!(); // ExternalSection { decl: ExternalDecl { funcName: Some("ASSC_freeMatrix"), lang: Some("C"), output_: None, args: Nil, annotation_: Some(Annotation { elementArgs: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "Library" }, modification: Some(Modification { elementArgLst: Nil, eqMod: EQMOD { exp: STRING { value: "omcruntime" }, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/NBackEnd/Util/NBASSC.mo", isReadOnly: false, lineNumberStart: 114, columnNumberStart: 55, lineNumberEnd: 114, columnNumberEnd: 69, lastModification: 0.0 } } }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/NBackEnd/Util/NBASSC.mo", isReadOnly: false, lineNumberStart: 114, columnNumberStart: 47, lineNumberEnd: 114, columnNumberEnd: 69, lastModification: 0.0 } }, tail: Nil } }) }, annotation: None }
    ()
}

pub fn printMatrix() -> () {
    todo!(); // ExternalSection { decl: ExternalDecl { funcName: Some("ASSC_printMatrix"), lang: Some("C"), output_: None, args: Nil, annotation_: Some(Annotation { elementArgs: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "Library" }, modification: Some(Modification { elementArgLst: Nil, eqMod: EQMOD { exp: STRING { value: "omcruntime" }, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/NBackEnd/Util/NBASSC.mo", isReadOnly: false, lineNumberStart: 118, columnNumberStart: 56, lineNumberEnd: 118, columnNumberEnd: 70, lastModification: 0.0 } } }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/NBackEnd/Util/NBASSC.mo", isReadOnly: false, lineNumberStart: 118, columnNumberStart: 48, lineNumberEnd: 118, columnNumberEnd: 70, lastModification: 0.0 } }, tail: Nil } }) }, annotation: None }
    ()
}
