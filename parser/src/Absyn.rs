...
/// Forward declaration of uniontype Msg
    ...
    type ForIterators = List/* For Iterators -
       these are used in:
       * for loops where the expression part can be NONE() and then the range
         is taken from an array variable that the iterator is used to index,
         see 3.3.3.2 Several Iterators from Modelica Specification.
    ...
    type ArrayDim = List/* Component attributes are
    ...
    ;
      ...
      pub enum ElementSpec {
             ...
             EXTENDS{
                   ...
                   path: Path/* path */
                   ,
                   elementArg: List<ElementArg>/* elementArg */
                   ,
             ...
             COMPONENTS{
                   ...
                   ,
                   components: List<ComponentItem>/* components */
                   ,
            },
      }
    ...
    ;
      ...
      pub enum Equation {
             EQ_IF{
                   ...
                   ,
                   equationTrueItems: List<EquationItem>/* true branch */
                   ,
                   elseIfBranches: List<Tuple<Exp, List<EquationItem>>>/* elseIfBranches */
                   ,
                   equationElseItems: List<EquationItem>/* equationElseItems Standard 2-side eqn */
                   ,
            },
             ...
             EQ_FOR{
                   ...
                   forEquations: List<EquationItem>/* forEquations */
                   ,
            },
             ...
             EQ_WHEN_E{
                   ...
                   whenExp: Exp/* whenExp */
                   ,
                   whenEquations: List<EquationItem>/* whenEquations */
                   ,
                   elseWhenEquations: List<Tuple<Exp, List<EquationItem>>>/* elseWhenEquations */
                   ,
            },
      ...
      pub enum Algorithm {
             ...
             ALG_IF{
                   ...
                   ,
                   elseIfAlgorithmBranch: List<Tuple<Exp, List<AlgorithmItem>>>/* elseIfAlgorithmBranch */
                   ,
             ...
             ALG_WHEN_A{
                   ...
                   ,
                   elseWhenAlgorithmBranch: List<Tuple<Exp, List<AlgorithmItem>>>/* elseWhenAlgorithmBranch */
                   ,
            },
     ...
     const emptyMod: Modification = Modification::CLASSMOD(vec![], EqMod::NOMOD());
      ...
      pub enum Exp {
             ...
             IFEXP{
                   ...
                   ifExp: Exp/* ifExp */
                   ,
                   trueBranch: Exp/* trueBranch */
                   ,
                   elseBranch: Exp/* elseBranch */
                   ,
                   elseIfBranch: List<Tuple<Exp, Exp>>/* elseIfBranch Function calls */
                   ,
            },

             CALL{

                   function_: ComponentRef/* function */
                   ,
            ...
            // stefan
             ...
             TUPLE{
                   ...
                   expressions: List<Exp>/* comma-separated expressions */
                   ,
            },
            ...
            // MetaModelica expressions follow below!
             ...
             CONS{
                   ...
                   head: Exp/*  head of the list  */
                   ,
                   rest: Exp/*  rest of the list  */
                   ,
            },
             ...
             MATCHEXP{
                   ...
                   ,
                   inputExp: Exp/*  match expression of          */
                   ,
                   localDecls: List<ElementItem>/*  local declarations           */
                   ,
      ...
      pub enum Case {
             CASE{
                   ...
                   pattern: Exp/*  patterns to be matched  */
                   ,
                   patternGuard: Option<Exp>,
                   patternInfo: Info/* file information of the pattern */
                   ,
                   localDecls: List<ElementItem>/*  local decls  */
                   ,
      ...
      pub enum FunctionArgs {
             FUNCTIONARGS{
                   ...
                   args: List<Exp>/* args */
                   ,
                   argNames: List<NamedArg>/* argNames */
                   ,
            },
     ...
     const emptyFunctionArgs: FunctionArgs = FUNCTIONARGS(vec![], vec![]);
      ...
      pub enum ComponentRef {
             ...
             CREF_QUAL{
                   ...
                   name: Ident/* name */
                   ,
                   subscripts: List<Subscript>/* subscripts */
                   ,
      ...
      pub enum Annotation {
             ANNOTATION{
                   ...
                   elementArgs: List<ElementArg>/* elementArgs */
                   ,
            },
      }
      ...
      pub enum ExternalDecl {
             EXTERNALDECL{
                   ...
                   ,
                   args: List<Exp>/* only positional arguments, i.e. expression list */
                   ,
