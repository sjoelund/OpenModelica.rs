...
pub(crate) fn translateModel(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_FMUVersion: ArcStr, mut in_a_FMUType: ArcStr, mut in_a_sourceFiles: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_simCode, in_a_FMUVersion, in_a_FMUType, in_a_sourceFiles)) {
        (txt, i_simCode @ SimCode::SimCode { modelInfo: i_modelInfo @ SimCode::ModelInfo { name: _, .. }, fileNamePrefix: i_fileNamePrefix, .. }, a_FMUVersion, a_FMUType, a_sourceFiles) => {
            ...
            l_0__ = Tpl::writeStr(Tpl::emptyTxt.clone(), (Tpl::booleanString(ret_13)).clone())?;
            l_cpp = CodegenCppOMSI::translateModel(Tpl::emptyTxt.clone(), i_simCode.clone())?;
            (txt_15, l_extraFuncs, l_extraFuncsDecl, _) = fmuWriteOutputHeaderFile(Tpl::emptyTxt.clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })))?;
            txt_16 = Tpl::writeTok(Tpl::emptyTxt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("OMCpp")).clone() }))?;
            txt_16 = Tpl::writeStr(txt_16, (i_fileNamePrefix.clone()).clone())?;
            txt_16 = Tpl::writeTok(txt_16, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("WriteOutput.h")).clone() }))?;
            Tpl::textFile(txt_15, (Tpl::textString(txt_16)?).clone())?;
            (txt_17, l_extraFuncs, l_extraFuncsDecl, _) = fmuModelHeaderFile(Tpl::emptyTxt.clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), (Tpl::textString(l_guid.clone())?).clone(), (a_FMUVersion.clone()).clone())?;
            txt_18 = Tpl::writeTok(Tpl::emptyTxt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("OMCpp")).clone() }))?;
            txt_18 = Tpl::writeStr(txt_18, (i_fileNamePrefix.clone()).clone())?;
            txt_18 = Tpl::writeTok(txt_18, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("FMU.h")).clone() }))?;
            Tpl::textFile(txt_17, (Tpl::textString(txt_18)?).clone())?;
            (txt_19, l_extraFuncs, l_extraFuncsDecl, _) = fmuModelCppFile(Tpl::emptyTxt.clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), (Tpl::textString(l_guid.clone())?).clone(), (a_FMUVersion.clone()).clone())?;
            txt_20 = Tpl::writeTok(Tpl::emptyTxt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("OMCpp")).clone() }))?;
            txt_20 = Tpl::writeStr(txt_20, (i_fileNamePrefix.clone()).clone())?;
            txt_20 = Tpl::writeTok(txt_20, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("FMU.cpp")).clone() }))?;
            Tpl::textFile(txt_19, (Tpl::textString(txt_20)?).clone())?;
            ret_21 = FMI::isFMIVersion10((a_FMUVersion.clone()).clone());
            (txt_21, l_stateDerVectorName, l_complexStartExpressions) = fun_54(Tpl::emptyTxt.clone(), ret_21, l_stateDerVectorName, l_complexStartExpressions, l_numStringVars, l_numBoolVars, l_numIntVars, l_numRealVars, a_sourceFiles.clone(), (a_FMUType.clone()).clone(), (a_FMUVersion.clone()).clone(), l_guid, i_simCode.clone())?;
            Tpl::textFile(txt_21, (literal!("modelDescription.xml")).clone())?;
            ...
            txt_24 = Tpl::writeTok(txt_24, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".def")).clone() }))?;
            Tpl::textFile(txt_23, (Tpl::textString(txt_24)?).clone())?;
            (txt_25, l_extraFuncs, l_extraFuncsDecl, _) = fmuMakefile(Tpl::emptyTxt.clone(), (Tpl::textString(l_target)?).clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), (a_FMUVersion.clone()).clone(), (literal!("")).clone(), (literal!("")).clone(), (literal!("")).clone(), (literal!("")).clone())?;
            txt_26 = Tpl::writeStr(Tpl::emptyTxt.clone(), (i_fileNamePrefix.clone()).clone())?;
            txt_26 = Tpl::writeTok(txt_26, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_FMU.makefile")).clone() }))?;
            Tpl::textFile(txt_25, (Tpl::textString(txt_26)?).clone())?;
            ...
            txt_28 = Tpl::writeStr(txt_28, (i_fileNamePrefix.clone()).clone())?;
            txt_28 = Tpl::writeTok(txt_28, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("CalcHelperMain.cpp")).clone() }))?;
            Tpl::textFile(txt_27, (Tpl::textString(txt_28)?).clone())?;
            ret_30 = FlagsUtil::set(Flags::HARDCODED_START_VALUES.clone(), false)?;
            l_0___1 = Tpl::writeStr(Tpl::emptyTxt.clone(), (Tpl::booleanString(ret_30)).clone())?;
            txt.clone()
        },
        (txt, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn fmuCalcHelperMainfile(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { name: _, .. }, fileNamePrefix: mut i_fileNamePrefix, .. }) => {
            ...
            txt = fun_56(txt.clone(), ret_2, (i_fileNamePrefix.clone()).clone())?;
...
fn fun_60(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { name: ref i_modelInfo_name, .. }, .. }) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_modelShortName)?;
...
fn fun_66(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var, in_a_simCode)) {
        (txt, SimCodeVar::SimVar { name: i_name, type_: Deref @ DAE::Type::T_REAL { varLst: _ }, .. }, a_simCode) => {
            ...
            ret_1 = SimCodeUtil::getVariableIndex(ret_0);
...
fn fun_68(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var, in_a_simCode)) {
        ...
        (txt, SimCodeVar::SimVar { name: i_name, type_: Deref @ DAE::Type::T_REAL { varLst: _ }, causality: Some(SimCodeVar::Causality::OUTPUT { .. }), .. }, a_simCode) => {
            ...
            ret_4 = SimCodeUtil::getVariableIndex(ret_3);
            ret_5 = intSub(ret_4, 1);
...
pub(crate) fn fmuModelCppFile(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_extraFuncs: Tpl::Text, mut in_a_extraFuncsDecl: Tpl::Text, mut in_a_extraFuncsNamespace: Tpl::Text, mut in_a_guid: ArcStr, mut in_a_FMUVersion: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_extraFuncs, out_a_extraFuncsDecl, out_a_extraFuncsNamespace) = (match (in_txt, in_a_simCode, in_a_extraFuncs, in_a_extraFuncsDecl, in_a_extraFuncsNamespace, in_a_guid, in_a_FMUVersion) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: ref i_modelInfo @ SimCode::ModelInfo { vars: SimCodeVar::SimVars { inputVars: ref i_inputVars, outputVars: _, algVars: ref i_algVars, .. }, name: ref i_modelInfo_name, .. }, modelStructure: _, allEquations: ref i_allEquations, initialEquations: ref i_initialEquations, clockedPartitions: ref i_clockedPartitions, .. }, mut a_extraFuncs, mut a_extraFuncsDecl, mut a_extraFuncsNamespace, mut a_guid, mut a_FMUVersion) => {
            ...
            l_modelShortName = CodegenCppOMSI::lastIdentOfPath(Tpl::emptyTxt.clone(), i_modelInfo_name.clone())?;
            ret_3 = (System::stringReplace((Tpl::textString(l_modelName)?).clone(), (literal!(".")).clone(), (literal!("_")).clone())?).clone();
            l_modelLongName = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_3).clone())?;
            ...
            ret_7 = SimCodeUtil::getClockedEquations(ret_6);
            ret_8 = listAppend(ret_5, ret_7);
            ...
            (l_algloopfiles, a_extraFuncsNamespace, a_extraFuncsDecl, a_extraFuncs) = lm_62(l_algloopfiles, ret_8, l_modelShortName.clone(), a_extraFuncsNamespace.clone(), a_extraFuncsDecl.clone(), a_extraFuncs.clone(), i_simCode.clone())?;
            l_algloopfiles = Tpl::popIter(l_algloopfiles)?;
            str_10 = (Tpl::textString(l_algloopfiles)?).clone();
            l_solverFactory = fun_63(Tpl::emptyTxt.clone(), (str_10).clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_modelLongName)?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = fun_64(txt.clone(), ret_11)?;
            txt = Tpl::softNewLine(txt.clone())?;
            ret_12 = FMI::isFMIVersion10((a_FMUVersion.clone()).clone());
            txt = fun_65(txt.clone(), ret_12)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("\n")).clone(), (literal!("\n")).clone(), (literal!("// create instance of ")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_modelShortName.clone())?;
            ...
            txt = accessFunctions(txt.clone(), i_simCode.clone(), (literal!("set")).clone(), (Tpl::textString(l_modelShortName)?).clone(), i_modelInfo.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("\n")).clone(), (literal!("// Jacobian\n")).clone()], lastHasNewLine: true }))?;
...
fn fun_75(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_description: Tpl::Text, mut in_a_useFlatArrayNotation: bool, mut in_a_name: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_description, in_a_useFlatArrayNotation, in_a_name)) {
        (txt, false, a_description, a_useFlatArrayNotation, a_name) => {
            ...
            txt = fun_74(txt.clone(), ret_1, a_description.clone(), a_useFlatArrayNotation.clone(), a_name.clone())?;
            txt.clone()
        },
        (txt, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn DefineVariables(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_useFlatArrayNotation: bool) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simVar, in_a_useFlatArrayNotation) {
        (mut txt, SimCodeVar::SimVar { comment: mut i_comment, name: ref i_name, .. }, mut a_useFlatArrayNotation) => {
            ...
            txt = fun_75(txt.clone(), ret_2, l_description, a_useFlatArrayNotation.clone(), i_name.clone())?;
            txt.clone()
        },
        (mut txt, _, _) => {
            txt.clone()
...
fn lm_79(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_numStateVars: i32) -> Result<Tpl::Text> {
    ...
    for mut lstElt_79 in &*items {
        ...
        mut i_var => {
            txt = initValsDefault(txt.clone(), i_var.clone(), (literal!("realVars")).clone(), a_numStateVars)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn lm_80(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_numStateVars: i32) -> Result<Tpl::Text> {
    ...
    for mut lstElt_80 in &*items {
        ...
        mut i_var => {
            ...
            txt = initValsDefault(txt.clone(), i_var.clone(), (literal!("realVars")).clone(), ret_0)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn lm_81(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_numAlgVars: i32, mut a_numStateVars: i32) -> Result<Tpl::Text> {
    ...
    for mut lstElt_81 in &*items {
        ...
        mut i_var => {
            ...
            txt = initValsDefault(txt.clone(), i_var.clone(), (literal!("realVars")).clone(), ret_1)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn lm_91(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_numStateVars: i32) -> Result<Tpl::Text> {
    ...
    for mut lstElt_91 in &*items {
        ...
        mut i_var => {
            txt = initVals(txt.clone(), i_var.clone(), (literal!("realVars")).clone(), a_numStateVars)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn lm_92(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_numStateVars: i32) -> Result<Tpl::Text> {
    ...
    for mut lstElt_92 in &*items {
        ...
        mut i_var => {
            let mut ret_0: i32;
            ret_0 = intMul(2, a_numStateVars);
            txt = initVals(txt.clone(), i_var.clone(), (literal!("realVars")).clone(), ret_0)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn lm_93(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_numAlgVars: i32, mut a_numStateVars: i32) -> Result<Tpl::Text> {
    ...
    for mut lstElt_93 in &*items {
        ...
        mut i_var => {
            ...
            ret_0 = intMul(2, a_numStateVars);
            ret_1 = intAdd(ret_0, a_numAlgVars);
            txt = initVals(txt.clone(), i_var.clone(), (literal!("realVars")).clone(), ret_1)?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn fun_102(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_offset: i32, mut in_a_index: i32, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_mArg, in_a_offset, in_a_index, in_a_arrayName) {
        (mut txt, false, mut a_offset, mut a_index, mut a_arrayName) => {
            ...
            l_str = Tpl::writeStr(l_str, (a_arrayName.clone()).clone())?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("Data[")).clone() }))?;
            ret_1 = intAdd(a_index.clone(), a_offset.clone());
            l_str = Tpl::writeStr(l_str, (intString(ret_1)).clone())?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("].attribute.start")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
...
fn fun_103(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_offset: i32, mut in_a_index: i32, mut in_a_arrayName: ArcStr, mut in_a_name: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_offset, in_a_index, in_a_arrayName, in_a_name)) {
        (txt, false, a_offset, a_index, a_arrayName, a_name) => {
            ...
            txt_0 = CodegenUtil::crefStr(Tpl::emptyTxt.clone(), a_name.clone())?;
            ret_1 = stringEq((Tpl::textString(txt_0)?).clone(), (literal!("der($dummy)")).clone());
            txt = fun_102(txt.clone(), ret_1, a_offset.clone(), a_index.clone(), (a_arrayName.clone()).clone())?;
            txt.clone()
        },
        (txt, _, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn initVals(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr, mut in_a_offset: i32) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_var, in_a_arrayName, in_a_offset) {
        (mut txt, SimCodeVar::SimVar { name: ref i_name, index: mut i_index, .. }, mut a_arrayName, mut a_offset) => {
            ...
            txt = fun_103(txt.clone(), ret_1, a_offset.clone(), i_index.clone(), (a_arrayName.clone()).clone(), i_name.clone())?;
            txt.clone()
        },
        (mut txt, _, _, _) => {
            txt.clone()
...
pub(crate) fn initParams(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_var, in_a_arrayName) {
        (mut txt, SimCodeVar::SimVar { index: mut i_index, .. }, mut a_arrayName) => {
            ...
            l_str = Tpl::writeStr(l_str, (a_arrayName.clone()).clone())?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("Data[")).clone() }))?;
            l_str = Tpl::writeStr(l_str, (intString(i_index.clone())).clone())?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("].attribute.start")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_str)?;
...
pub(crate) fn initValsDefault(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr, mut in_a_offset: i32) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_var, in_a_arrayName, in_a_offset) {
        (mut txt, SimCodeVar::SimVar { index: mut i_index, type_: ref i_type__, initialValue: mut i_initialValue, .. }, mut a_arrayName, mut a_offset) => {
            ...
            l_str = Tpl::writeStr(l_str, (intString(ret_1)).clone())?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("].attribute.start")).clone() }))?;
            txt = fun_107(txt.clone(), i_initialValue.clone(), i_type__.clone(), l_str)?;
            txt.clone()
        },
        (mut txt, _, _, _) => {
            txt.clone()
...
pub(crate) fn initParamsDefault(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar, mut in_a_arrayName: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_var, in_a_arrayName) {
        (mut txt, SimCodeVar::SimVar { index: mut i_index, initialValue: mut i_initialValue, .. }, mut a_arrayName) => {
            ...
            l_str = Tpl::writeStr(l_str, (intString(i_index.clone())).clone())?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("].attribute.start")).clone() }))?;
            txt = fun_109(txt.clone(), i_initialValue.clone(), l_str)?;
            txt.clone()
        },
        (mut txt, _, _) => {
            txt.clone()
...
fn fun_117(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_simCode: SimCode::SimCode, mut in_a_direction: ArcStr, mut in_a_modelShortName: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_modelInfo, in_a_simCode, in_a_direction, in_a_modelShortName) {
        (mut txt, SimCode::ModelInfo { vars: SimCodeVar::SimVars { aliasVars: ref i_vars_aliasVars, intAlgVars: ref i_vars_intAlgVars, intParamVars: ref i_vars_intParamVars, intAliasVars: ref i_vars_intAliasVars, boolAlgVars: ref i_vars_boolAlgVars, boolParamVars: ref i_vars_boolParamVars, boolAliasVars: ref i_vars_boolAliasVars, stringAlgVars: ref i_vars_stringAlgVars, stringParamVars: ref i_vars_stringParamVars, stringAliasVars: ref i_vars_stringAliasVars, .. }, varInfo: SimCode::VarInfo { numStateVars: mut i_numStateVars, numAlgVars: mut i_numAlgVars, numDiscreteReal: mut i_numDiscreteReal, numParams: mut i_numParams, .. }, .. }, mut a_simCode, mut a_direction, mut a_modelShortName) => {
            ...
            ret_1 = intAdd(ret_0, i_numAlgVars.clone());
            ret_2 = intAdd(ret_1, i_numDiscreteReal.clone());
            ret_3 = intAdd(ret_2, i_numParams.clone());
            txt = accessVarsFunction(txt.clone(), a_simCode.clone(), (a_direction.clone()).clone(), (a_modelShortName.clone()).clone(), (literal!("Real")).clone(), (literal!("Real")).clone(), (literal!("double")).clone(), ret_3, i_vars_aliasVars.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ret_4 = (i_vars_intAlgVars.clone().len() as i32);
            ret_5 = (i_vars_intParamVars.clone().len() as i32);
            ret_6 = intAdd(ret_4, ret_5);
            txt = accessVarsFunction(txt.clone(), a_simCode.clone(), (a_direction.clone()).clone(), (a_modelShortName.clone()).clone(), (literal!("Integer")).clone(), (literal!("Int")).clone(), (literal!("int")).clone(), ret_6, i_vars_intAliasVars.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ret_7 = (i_vars_boolAlgVars.clone().len() as i32);
            ret_8 = (i_vars_boolParamVars.clone().len() as i32);
            ret_9 = intAdd(ret_7, ret_8);
            txt = accessVarsFunction(txt.clone(), a_simCode.clone(), (a_direction.clone()).clone(), (a_modelShortName.clone()).clone(), (literal!("Boolean")).clone(), (literal!("Bool")).clone(), (literal!("int")).clone(), ret_9, i_vars_boolAliasVars.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ret_10 = (i_vars_stringAlgVars.clone().len() as i32);
            ret_11 = (i_vars_stringParamVars.clone().len() as i32);
            ret_12 = intAdd(ret_10, ret_11);
            txt = accessVarsFunction(txt.clone(), a_simCode.clone(), (a_direction.clone()).clone(), (a_modelShortName.clone()).clone(), (literal!("String")).clone(), (literal!("String")).clone(), (literal!("string")).clone(), ret_12, i_vars_stringAliasVars.clone())?;
            txt.clone()
        },
        (mut txt, _, _, _, _) => {
            txt.clone()
...
fn lm_122(mut txt: Tpl::Text, mut items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_offset: i32, mut a_direction: ArcStr, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    for mut lstElt_122 in &*items {
        ...
        mut i_var => {
            txt = fun_121(txt.clone(), i_var.clone(), a_offset, (a_direction.clone()).clone(), a_simCode.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt.clone()
        },
    });
...
fn fun_126(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode, mut in_a_direction: ArcStr, mut in_a_offset: i32) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simVar, in_a_simCode, in_a_direction, in_a_offset) {
        (mut txt, ref i_simVar @ SimCodeVar::SimVar { name: ref i_name, comment: ref i_comment, index: ref i_index, .. }, mut a_simCode, mut a_direction, mut a_offset) => {
            ...
            ret_2 = (System::stringReplace((Tpl::textString(txt_1)?).clone(), (literal!("$")).clone(), (literal!("_D_")).clone())?).clone();
            l_descName = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_2).clone())?;
            l_description = fun_124(Tpl::emptyTxt.clone(), (i_comment.clone()).clone(), l_descName)?;
            ...
            txt = fun_125(txt.clone(), ret_6, l_cppSign, l_cppName, l_description, i_index.clone(), a_offset.clone())?;
            txt.clone()
        },
        (mut txt, _, _, _, _) => {
            txt.clone()
...
fn fun_129(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simVar, in_a_simCode) {
        (mut txt, SimCodeVar::SimVar { name: ref i_name, aliasvar: mut i_aliasvar, .. }, mut a_simCode) => {
            ...
            txt = fun_128(txt.clone(), i_aliasvar.clone(), l_actualName, a_simCode.clone())?;
            txt.clone()
        },
        (mut txt, _, _) => {
            txt.clone()
...
pub(crate) fn directionalDerivativeFunction(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { name: ref i_modelInfo_name, .. }, modelStructure: ref i_fmiModelStructure, .. }) => {
            ...
            txt = fun_137(txt.clone(), ret_2, l_dimDiscreteStates)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}")).clone() }))?;
            txt.clone()
        },
...
fn fun_145(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { directory: mut i_modelInfo_directory, .. }, makefileParams: SimCodeFunction::MakefileParams { libs: ref i_makefileParams_libs, omhome: mut i_makefileParams_omhome, platform: mut i_makefileParams_platform, .. }, simulationSettingsOpt: mut i_sopt, fileNamePrefix: mut i_fileNamePrefix, fmuTargetName: mut i_fmuTargetName, .. }) => {
            ...
            l_libsExtra = lm_140(l_libsExtra, i_makefileParams_libs.clone())?;
            l_libsExtra = Tpl::popIter(l_libsExtra)?;
            ret_3 = Config::acceptParModelicaGrammar()?;
            l_ParModelicaLibs = fun_141(Tpl::emptyTxt.clone(), ret_3)?;
            ...
            txt = fun_144(txt.clone(), ret_7, (i_makefileParams_omhome.clone()).clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_libsExtra)?;
            txt = Tpl::softNewLine(txt.clone())?;
...
fn fun_155(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_additionalLinkerFlags__GCC: ArcStr, mut in_a_additionalCFlags__GCC: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simCode, in_a_additionalLinkerFlags__GCC, in_a_additionalCFlags__GCC) {
        (mut txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { directory: mut i_modelInfo_directory, .. }, makefileParams: SimCodeFunction::MakefileParams { libs: ref i_makefileParams_libs, platform: mut i_makefileParams_platform, omhome: mut i_makefileParams_omhome, ccompiler: mut i_makefileParams_ccompiler, cxxcompiler: mut i_makefileParams_cxxcompiler, dllext: mut i_makefileParams_dllext, includes: ref i_makefileParams_includes, .. }, simulationSettingsOpt: mut i_sopt, fileNamePrefix: mut i_fileNamePrefix, fmuTargetName: mut i_fmuTargetName, .. }, mut a_additionalLinkerFlags__GCC, mut a_additionalCFlags__GCC) => {
            ...
            l_libsExtra = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            l_libsExtra = lm_147(l_libsExtra, i_makefileParams_libs.clone())?;
            l_libsExtra = Tpl::popIter(l_libsExtra)?;
            ...
            l_platformbins = fun_150(Tpl::emptyTxt.clone(), (str_6).clone(), l_omhome.clone())?;
            str_8 = (Tpl::textString(l_platformstr.clone())?).clone();
            l_lapackbins = fun_151(Tpl::emptyTxt.clone(), (str_8).clone(), l_omhome)?;
            ...
            txt = fun_153(txt.clone(), ret_12, (i_makefileParams_omhome.clone()).clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_platformstr)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_extraCflags)?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_lapackbins)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_platformbins)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(")\n")).clone() }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn fun_156(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_simCode: SimCode::SimCode, mut in_a_additionalLinkerFlags__GCC: ArcStr, mut in_a_additionalCFlags__GCC: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_simCode, in_a_additionalLinkerFlags__GCC, in_a_additionalCFlags__GCC)) {
...
pub(crate) fn fmuMakefile(mut txt: Tpl::Text, mut a_target: ArcStr, mut a_simCode: SimCode::SimCode, mut a_extraFuncs: Tpl::Text, mut a_extraFuncsDecl: Tpl::Text, mut a_extraFuncsNamespace: Tpl::Text, mut a_FMUVersion: ArcStr, mut a_additionalLinkerFlags__GCC: ArcStr, mut a_additionalLinkerFlags__MSVC: ArcStr, mut a_additionalCFlags__GCC: ArcStr, mut a_additionalCFlags__MSVC: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    out_txt = fun_156(txt, (str_1).clone(), a_simCode, (a_additionalLinkerFlags__GCC).clone(), (a_additionalCFlags__GCC).clone())?;
    out_a_extraFuncs = a_extraFuncs;
    out_a_extraFuncsDecl = a_extraFuncsDecl;
    out_a_extraFuncsNamespace = a_extraFuncsNamespace;
    Ok((out_txt, out_a_extraFuncs, out_a_extraFuncsDecl, out_a_extraFuncsNamespace))
