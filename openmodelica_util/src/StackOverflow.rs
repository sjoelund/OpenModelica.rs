...
pub fn getStacktraceMessages() -> Arc<metamodelica::List<ArcStr>> {
    let mut symbols: Arc<metamodelica::List<ArcStr>> = metamodelica::nil();
    todo!(); // ExternalSection { decl: ExternalDecl { funcName: Some("mmc_getStacktraceMessages_threadData"), lang: Some("C"), output_: Some(CREF_IDENT { name: "symbols", subscripts: Nil }), args: Cons { head: CALL { function_: CREF_QUAL { name: "OpenModelica", subscripts: Nil, componentRef: CREF_IDENT { name: "threadData", subscripts: Nil } }, functionArgs: FUNCTIONARGS { args: Nil, argNames: Nil }, typeVars: Nil }, tail: Nil }, annotation_: Some(Annotation { elementArgs: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "Documentation" }, modification: Some(Modification { elementArgLst: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "info" }, modification: Some(Modification { elementArgLst: Nil, eqMod: EQMOD { exp: STRING { value: "<html>\n<p>Returns a list of symbol names to print in error messages.</p>\n</html>" }, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 137, columnNumberStart: 116, lineNumberEnd: 139, columnNumberEnd: 8, lastModification: 0.0 } } }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 137, columnNumberStart: 112, lineNumberEnd: 139, columnNumberEnd: 8, lastModification: 0.0 } }, tail: Nil }, eqMod: NOMOD }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 137, columnNumberStart: 98, lineNumberEnd: 139, columnNumberEnd: 9, lastModification: 0.0 } }, tail: Nil } }) }, annotation: None }
    symbols
}

pub fn setStacktraceMessages(mut numSkip: i32, mut numFrames: i32) -> () {
    todo!(); // ExternalSection { decl: ExternalDecl { funcName: Some("mmc_setStacktraceMessages_threadData"), lang: Some("C"), output_: None, args: Cons { head: CALL { function_: CREF_QUAL { name: "OpenModelica", subscripts: Nil, componentRef: CREF_IDENT { name: "threadData", subscripts: Nil } }, functionArgs: FUNCTIONARGS { args: Nil, argNames: Nil }, typeVars: Nil }, tail: Cons { head: CREF { componentRef: CREF_IDENT { name: "numSkip", subscripts: Nil } }, tail: Cons { head: CREF { componentRef: CREF_IDENT { name: "numFrames", subscripts: Nil } }, tail: Nil } } }, annotation_: Some(Annotation { elementArgs: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "Documentation" }, modification: Some(Modification { elementArgLst: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "info" }, modification: Some(Modification { elementArgLst: Nil, eqMod: EQMOD { exp: STRING { value: "<html>\n<p>Generate a stacktrace at the current position of code.</p>\n</html>" }, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 145, columnNumberStart: 128, lineNumberEnd: 147, columnNumberEnd: 8, lastModification: 0.0 } } }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 145, columnNumberStart: 124, lineNumberEnd: 147, columnNumberEnd: 8, lastModification: 0.0 } }, tail: Nil }, eqMod: NOMOD }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 145, columnNumberStart: 110, lineNumberEnd: 147, columnNumberEnd: 9, lastModification: 0.0 } }, tail: Nil } }) }, annotation: None }
    ()
}

pub fn hasStacktraceMessages() -> bool {
    let mut b: bool = false;
    todo!(); // ExternalSection { decl: ExternalDecl { funcName: Some("mmc_hasStacktraceMessages"), lang: Some("C"), output_: Some(CREF_IDENT { name: "b", subscripts: Nil }), args: Cons { head: CALL { function_: CREF_QUAL { name: "OpenModelica", subscripts: Nil, componentRef: CREF_IDENT { name: "threadData", subscripts: Nil } }, functionArgs: FUNCTIONARGS { args: Nil, argNames: Nil }, typeVars: Nil }, tail: Nil }, annotation_: Some(Annotation { elementArgs: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "Documentation" }, modification: Some(Modification { elementArgLst: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "info" }, modification: Some(Modification { elementArgLst: Nil, eqMod: EQMOD { exp: STRING { value: "<html>\n<p>Returns true if a stack overflow has occurred.</p>\n</html>" }, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 152, columnNumberStart: 99, lineNumberEnd: 154, columnNumberEnd: 8, lastModification: 0.0 } } }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 152, columnNumberStart: 95, lineNumberEnd: 154, columnNumberEnd: 8, lastModification: 0.0 } }, tail: Nil }, eqMod: NOMOD }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 152, columnNumberStart: 81, lineNumberEnd: 154, columnNumberEnd: 9, lastModification: 0.0 } }, tail: Nil } }) }, annotation: None }
    b
}

pub fn clearStacktraceMessages() -> () {
    todo!(); // ExternalSection { decl: ExternalDecl { funcName: Some("mmc_clearStacktraceMessages"), lang: Some("C"), output_: None, args: Cons { head: CALL { function_: CREF_QUAL { name: "OpenModelica", subscripts: Nil, componentRef: CREF_IDENT { name: "threadData", subscripts: Nil } }, functionArgs: FUNCTIONARGS { args: Nil, argNames: Nil }, typeVars: Nil }, tail: Nil }, annotation_: Some(Annotation { elementArgs: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "Documentation" }, modification: Some(Modification { elementArgLst: Cons { head: MODIFICATION { finalPrefix: false, eachPrefix: NON_EACH, path: IDENT { name: "info" }, modification: Some(Modification { elementArgLst: Nil, eqMod: EQMOD { exp: STRING { value: "<html>\n<p>Clears the stacktrace from a stack overflow.</p>\n</html>" }, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 158, columnNumberStart: 99, lineNumberEnd: 160, columnNumberEnd: 8, lastModification: 0.0 } } }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 158, columnNumberStart: 95, lineNumberEnd: 160, columnNumberEnd: 8, lastModification: 0.0 } }, tail: Nil }, eqMod: NOMOD }), comment: None, info: SourceInfo { fileName: "/projects/OpenModelica/OMCompiler/Compiler/Util/StackOverflow.mo", isReadOnly: false, lineNumberStart: 158, columnNumberStart: 81, lineNumberEnd: 160, columnNumberEnd: 9, lastModification: 0.0 } }, tail: Nil } }) }, annotation: None }
    ()
}
