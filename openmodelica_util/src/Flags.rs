...
pub const collapseArrayExpressionsText: &'static str = "Simplifies {x[1],x[2],x[3]} → x for arrays of whole variable references (simplifies code generation).";
...
pub static TRANSFORMS_BEFORE_DUMP: DebugFlag = DebugFlag { index: 32, name: literal!("transformsbeforedump"), default: false, description: literal!("Applies transformations required for code generation before dumping flat code.") };

pub static DAE_DUMP_GRAPHV: DebugFlag = DebugFlag { index: 33, name: literal!("daedumpgraphv"), default: false, description: literal!("Dumps the DAE in graphviz format.") };

pub static INTERACTIVE_TCP: DebugFlag = DebugFlag { index: 34, name: literal!("interactive"), default: false, description: literal!("Starts omc as a server listening on the socket interface.") };

pub static INTERACTIVE_CORBA: DebugFlag = DebugFlag { index: 35, name: literal!("interactiveCorba"), default: false, description: literal!("Starts omc as a server listening on the Corba interface.") };
...
pub static DUMP_FP_REPL: DebugFlag = DebugFlag { index: 39, name: literal!("dumpFPrepl"), default: false, description: literal!("Dump the found replacements for final parameters.") };
...
pub static DUMP_EA_REPL: DebugFlag = DebugFlag { index: 42, name: literal!("dumpEArepl"), default: false, description: literal!("Dump the found replacements for evaluate annotations (evaluate=true) parameters.") };
...
pub static UNCERTAINTIES: DebugFlag = DebugFlag { index: 73, name: literal!("uncertainties"), default: false, description: literal!("Enables dumping of status when calling modelEquationsUC.") };
...
pub static INLINE_SOLVER: DebugFlag = DebugFlag { index: 84, name: literal!("inlineSolver"), default: false, description: literal!("Generates code for inline solver.") };
...
pub static IMPL_ODE: DebugFlag = DebugFlag { index: 98, name: literal!("implOde"), default: false, description: literal!("activates implicit codegen") };
...
pub static DUMP_EQ_UNIT: DebugFlag = DebugFlag { index: 109, name: literal!("dumpEqInUC"), default: false, description: literal!("Dumps all equations handled by the unit checker.") };
...
pub static SHOW_EXPANDABLE_INFO: DebugFlag = DebugFlag { index: 113, name: literal!("showExpandableInfo"), default: false, description: literal!("Show information about expandable connector handling.") };

pub static DUMP_HOMOTOPY: DebugFlag = DebugFlag { index: 114, name: literal!("dumpHomotopy"), default: false, description: literal!("Dumps the results of the postOptModule optimizeHomotopyCalls.") };
...
pub static NF_UNITCHECK: DebugFlag = DebugFlag { index: 157, name: literal!("frontEndUnitCheck"), default: false, description: literal!("Checks the consistency of units in equation.") };
...
pub static OLD_FE_UNITCHECK: DebugFlag = DebugFlag { index: 165, name: literal!("oldFrontEndUnitCheck"), default: false, description: literal!("Checks the consistency of units in equation (for the old front-end).") };

pub static EXEC_STAT_EXTRA_GC: DebugFlag = DebugFlag { index: 166, name: literal!("execstatGCcollect"), default: false, description: literal!("When running execstat, also perform an extra full garbage collection.") };
...
pub static HELP: ConfigFlag = ConfigFlag { index: 2, name: literal!("help"), shortname: Some(literal!("h")), visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::STRING_FLAG { data: literal!("") }, validOptions: None, description: literal!("Displays the help text. Use --help=topics for more information.") };

pub static RUNNING_TESTSUITE: ConfigFlag = ConfigFlag { index: 3, name: literal!("running-testsuite"), shortname: None, visibility: crate::Flags::FlagVisibility::INTERNAL, defaultValue: FlagData::STRING_FLAG { data: literal!("") }, validOptions: None, description: literal!("Used when running the testsuite.") };

pub static SHOW_VERSION: ConfigFlag = ConfigFlag { index: 4, name: literal!("version"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Print the version and exit.") };
...
pub static SHOW_ERROR_MESSAGES: ConfigFlag = ConfigFlag { index: 9, name: literal!("showErrorMessages"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Show error messages immediately when they happen.") };

pub static SHOW_ANNOTATIONS: ConfigFlag = ConfigFlag { index: 10, name: literal!("showAnnotations"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Show annotations in the flattened code.") };
...
pub const removeSimpleEquationDesc: &'static str = "Performs alias elimination and removes constant variables from the DAE, replacing all occurrences of the old variable reference with the new value (constants) or variable reference (alias elimination).";
...
pub static ORDER_CONNECTIONS: ConfigFlag = ConfigFlag { index: 18, name: literal!("orderConnections"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: true }, validOptions: None, description: literal!("Orders connect equations alphabetically if set.") };

pub static TYPE_INFO: ConfigFlag = ConfigFlag { index: 19, name: literal!("typeinfo"), shortname: Some(literal!("t")), visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Prints out extra type information if set.") };

pub static KEEP_ARRAYS: ConfigFlag = ConfigFlag { index: 20, name: literal!("keepArrays"), shortname: Some(literal!("a")), visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Sets whether to split arrays or not.") };
...
pub static SILENT: ConfigFlag = ConfigFlag { index: 22, name: literal!("silent"), shortname: Some(literal!("q")), visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Turns on silent mode.") };
...
pub static INST_CLASS: ConfigFlag = ConfigFlag { index: 25, name: literal!("instClass"), shortname: Some(literal!("i")), visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::STRING_FLAG { data: literal!("") }, validOptions: None, description: literal!("Instantiate the class given by the fully qualified path.") };
...
pub static SIMULATION_CG: ConfigFlag = ConfigFlag { index: 27, name: literal!("simulationCg"), shortname: Some(literal!("s")), visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Turns on simulation code generation.") };
...
pub static DEMO_MODE: ConfigFlag = ConfigFlag { index: 35, name: literal!("demoMode"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Disable Warning/Error Massages.") };

pub static LOCALE_FLAG: ConfigFlag = ConfigFlag { index: 36, name: literal!("locale"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::STRING_FLAG { data: literal!("") }, validOptions: None, description: literal!("Override the locale from the environment.") };
...
pub static SCALARIZE_MINMAX: ConfigFlag = ConfigFlag { index: 43, name: literal!("scalarizeMinMax"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Scalarizes the builtin min/max reduction operators if true.") };
...
pub static SCALARIZE_BINDINGS: ConfigFlag = ConfigFlag { index: 45, name: literal!("scalarizeBindings"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Always scalarizes bindings if set.") };
...
pub static INT_ENUM_CONVERSION: ConfigFlag = ConfigFlag { index: 53, name: literal!("intEnumConversion"), shortname: None, visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Allow Integer to enumeration conversion.") };
...
pub static GRAPHICS_EXP_MODE: ConfigFlag = ConfigFlag { index: 104, name: literal!("graphicsExpMode"), shortname: None, visibility: crate::Flags::FlagVisibility::INTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Sets whether we are in graphics exp mode (evaluating icons).") };
...
pub static SIMULATION: ConfigFlag = ConfigFlag { index: 148, name: literal!("simulation"), shortname: Some(literal!("u")), visibility: crate::Flags::FlagVisibility::EXTERNAL, defaultValue: FlagData::BOOL_FLAG { data: false }, validOptions: None, description: literal!("Simulates the last model in the given Modelica file.") };
