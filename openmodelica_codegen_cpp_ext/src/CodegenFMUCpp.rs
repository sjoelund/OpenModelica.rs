...
pub fn translateModel(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_FMUVersion: ArcStr, mut in_a_FMUType: ArcStr, mut in_a_sourceFiles: Arc<metamodelica::List<ArcStr>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_simCode, in_a_FMUVersion, in_a_FMUType, in_a_sourceFiles)) {
        (txt, i_simCode @ SimCode::SimCode { modelInfo: i_modelInfo @ SimCode::ModelInfo { name: _, .. }, fileNamePrefix: i_fileNamePrefix, .. }, a_FMUVersion, a_FMUType, a_sourceFiles) => {
            ...
            l_extraAnnotations = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_13).clone())?;
            ret_15 = FlagsUtil::set(Flags::HARDCODED_START_VALUES.clone(), true)?;
            l_0__ = Tpl::writeStr(Tpl::emptyTxt.clone(), (Tpl::booleanString(ret_15)).clone())?;
            l_cpp = CodegenCpp::translateModel(Tpl::emptyTxt.clone(), i_simCode.clone())?;
            (txt_17, l_extraFuncs, l_extraFuncsDecl, _) = fmuWriteOutputHeaderFile(Tpl::emptyTxt.clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })))?;
            ...
            txt_18 = Tpl::writeTok(txt_18, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("WriteOutput.h")).clone() }))?;
            Tpl::textFile(txt_17, (Tpl::textString(txt_18)?).clone())?;
            (txt_19, l_extraFuncs, l_extraFuncsDecl, _) = fmuModelHeaderFile(Tpl::emptyTxt.clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), (Tpl::textString(l_guid.clone())?).clone(), (a_FMUVersion.clone()).clone())?;
            ...
            txt_20 = Tpl::writeTok(txt_20, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("FMU.h")).clone() }))?;
            Tpl::textFile(txt_19, (Tpl::textString(txt_20)?).clone())?;
            (txt_21, l_extraFuncs, l_extraFuncsDecl, _) = fmuModelCppFile(Tpl::emptyTxt.clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), (Tpl::textString(l_guid.clone())?).clone(), (a_FMUVersion.clone()).clone())?;
            ...
            txt_22 = Tpl::writeTok(txt_22, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("FMU.cpp")).clone() }))?;
            Tpl::textFile(txt_21, (Tpl::textString(txt_22)?).clone())?;
            ret_23 = FMI::isFMIVersion10((a_FMUVersion.clone()).clone());
            (txt_23, l_stateDerVectorName, l_complexStartExpressions) = fun_54(Tpl::emptyTxt.clone(), ret_23, l_stateDerVectorName, l_complexStartExpressions, l_numStringVars, l_numBoolVars, l_numIntVars, l_numRealVars, a_sourceFiles.clone(), (a_FMUType.clone()).clone(), (a_FMUVersion.clone()).clone(), l_guid, i_simCode.clone())?;
            Tpl::textFile(txt_23, (literal!("modelDescription.xml")).clone())?;
            ...
            txt_26 = Tpl::writeTok(txt_26, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".def")).clone() }))?;
            Tpl::textFile(txt_25, (Tpl::textString(txt_26)?).clone())?;
            (txt_27, l_extraFuncs, l_extraFuncsDecl, _) = fmuMakefile(Tpl::emptyTxt.clone(), (Tpl::textString(l_target)?).clone(), i_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), (a_FMUVersion.clone()).clone(), (literal!("")).clone(), (literal!("")).clone(), (literal!("")).clone(), (literal!("")).clone(), (Tpl::textString(l_extraAnnotations)?).clone())?;
            txt_28 = Tpl::writeStr(Tpl::emptyTxt.clone(), (i_fileNamePrefix.clone()).clone())?;
            txt_28 = Tpl::writeTok(txt_28, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_FMU.makefile")).clone() }))?;
            ...
            txt_30 = Tpl::writeTok(txt_30, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("CalcHelperMain.cpp")).clone() }))?;
            Tpl::textFile(txt_29, (Tpl::textString(txt_30)?).clone())?;
            ret_32 = FlagsUtil::set(Flags::HARDCODED_START_VALUES.clone(), false)?;
            l_0___1 = Tpl::writeStr(Tpl::emptyTxt.clone(), (Tpl::booleanString(ret_32)).clone())?;
            txt.clone()
        },
        (txt, _, _, _, _) => {
            txt.clone()
...
pub(crate) fn fmuModelCppFile(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_extraFuncs: Tpl::Text, mut in_a_extraFuncsDecl: Tpl::Text, mut in_a_extraFuncsNamespace: Tpl::Text, mut in_a_guid: ArcStr, mut in_a_FMUVersion: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_extraFuncs, out_a_extraFuncsDecl, out_a_extraFuncsNamespace) = (match (in_txt, in_a_simCode, in_a_extraFuncs, in_a_extraFuncsDecl, in_a_extraFuncsNamespace, in_a_guid, in_a_FMUVersion) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: ref i_modelInfo @ SimCode::ModelInfo { vars: SimCodeVar::SimVars { inputVars: ref i_inputVars, algVars: ref i_algVars, .. }, name: ref i_modelInfo_name, .. }, modelStructure: _, allEquations: ref i_allEquations, initialEquations: ref i_initialEquations, clockedPartitions: ref i_clockedPartitions, .. }, mut a_extraFuncs, mut a_extraFuncsDecl, mut a_extraFuncsNamespace, mut a_guid, mut a_FMUVersion) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_solverFactory)?;
