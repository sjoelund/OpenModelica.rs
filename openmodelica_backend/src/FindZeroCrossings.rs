...
pub(crate) fn encapsulateWhenConditions(mut inDAE: Arc<BackendDAE::BackendDAE>) -> Result<Arc<BackendDAE::BackendDAE>> {
    ...
    let mut vars: DoubleEnded::MutableList<BackendDAE::Var>;
    let mut eqns: DoubleEnded::MutableList<Arc<BackendDAE::Equation>>;
    let mut vars_: BackendDAE::Variables;
    let mut eqns_: Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>;
    ...
    syst = BackendDAEUtil::createEqSystem(vars_, eqns_, metamodelica::nil(), openmodelica_backend_types::BackendDAE::BaseClockPartitionKind::UNSPECIFIED_PARTITION, BackendEquation::emptyEqns());
...
fn encapsulateWhenConditions_EqSystem(mut inEqSystem: Arc<BackendDAE::EqSystem>, mut inIndex: i32, mut inHT: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>))) -> Result<(Arc<BackendDAE::EqSystem>, i32, (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>)))> {
    ...
    outEqSystem = (::match_deref::match_deref! { match &(inEqSystem) {
        syst @ Deref @ BackendDAE::EqSystem { orderedVars, orderedEqs, .. } => {
            let mut removedEqs: Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>;
            let mut varLst: DoubleEnded::MutableList<BackendDAE::Var>;
...
fn encapsulateWhenConditions_Equation(mut inEq: Arc<BackendDAE::Equation>, mut inTpl: (Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, DoubleEnded::MutableList<BackendDAE::Var>, DoubleEnded::MutableList<Arc<BackendDAE::Equation>>, i32, (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>)))) -> Result<(Arc<BackendDAE::Equation>, (Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, DoubleEnded::MutableList<BackendDAE::Var>, DoubleEnded::MutableList<Arc<BackendDAE::Equation>>, i32, (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>))))> {
    ...
    (outEq, outTpl) = (::match_deref::match_deref! { match &((inEq.clone(), inTpl)) {
        ...
        (Deref @ BackendDAE::Equation::ALGORITHM { size: 0, alg: alg_, source, expand: crefExpand, attr }, (equationArray, vars, eqns, index, ht)) => {
            ...
            let mut preStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut allPreStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            ...
            alg_ = Arc::new(DAE::Algorithm { statementLst: stmts });
            eqn = Arc::new(BackendDAE::Equation::ALGORITHM { size: size, alg: alg_.clone(), source: source.clone(), expand: crefExpand.clone(), attr: attr.clone() });
            equationArray = BackendEquation::add(eqn.clone(), equationArray.clone())?;
            if sizePre > 0 {
                alg_ = Arc::new(DAE::Algorithm { statementLst: allPreStmts });
                eqn2 = Arc::new(BackendDAE::Equation::ALGORITHM { size: sizePre, alg: alg_.clone(), source: source.clone(), expand: crefExpand.clone(), attr: attr.clone() });
...
fn encapsulateWhenConditions_Equations(mut inWhenEquation: Arc<BackendDAE::WhenEquation>, mut inSource: Arc<DAE::ElementSource>, mut inIndex: i32, mut inHT: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>))) -> Result<(Arc<BackendDAE::WhenEquation>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<BackendDAE::Equation>>>, i32, (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>)))> {
    ...
    (outWhenEquation, outVars, outEqns, outIndex, outHT) = (::match_deref::match_deref! { match &(inWhenEquation) {
        Deref @ BackendDAE::WhenEquation { condition, whenStmtLst, elsewhenPart: None } => {
            ...
            (condition, vars, eqns, index, ht) = encapsulateWhenConditions_Equations1(condition.clone(), inSource, inIndex, inHT)?;
        ...
        Deref @ BackendDAE::WhenEquation { condition, whenStmtLst, elsewhenPart: Some(elsewhenPart) } => {
            ...
            (elsewhenPart, vars1, eqns1, index, ht) = encapsulateWhenConditions_Equations(elsewhenPart.clone(), inSource.clone(), inIndex, inHT)?;
            (condition, vars, eqns, index, ht) = encapsulateWhenConditions_Equations1(condition.clone(), inSource, index, ht)?;
...
fn encapsulateWhenConditions_Equations1(mut inCondition: Arc<DAE::Exp>, mut inSource: Arc<DAE::ElementSource>, mut inIndex: i32, mut inHT: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>))) -> Result<(Arc<DAE::Exp>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<BackendDAE::Equation>>>, i32, (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>)))> {
    ...
    (outCondition, outVars, outEqns, outIndex, outHT) = (::match_deref::match_deref! { match &(inCondition.clone()) {
        ...
        Deref @ DAE::Exp::ARRAY { ty, scalar, array } => {
            ...
            (array, vars, eqns, index, ht) = encapsulateWhenConditions_EquationsWithArrayConditions(array.clone(), inSource, inIndex, inHT.clone())?;
            (Arc::new(DAE::Exp::ARRAY { ty: ty.clone(), scalar: scalar.clone(), array: array.clone() }), vars, eqns, index, ht)
        },
        _ if (BaseHashTable::hasKey(inCondition.clone(), inHT.clone())?) => {
            ...
            crStr = ({ let mut __mm_s = String::new(); __mm_s.push_str(&*literal!("$whenCondition")); __mm_s.push_str(&*intString(localIndex)); ArcStr::from(__mm_s) }).clone();
            condition = Arc::new(DAE::Exp::CREF { componentRef: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (crStr).clone(), identType: DAE::T_BOOL_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), ty: DAE::T_BOOL_DEFAULT().clone() });
...
fn encapsulateWhenConditions_EquationsWithArrayConditions(mut inConditionList: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut inSource: Arc<DAE::ElementSource>, mut inIndex: i32, mut inHT: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>))) -> Result<(Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<BackendDAE::Equation>>>, i32, (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::Exp>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::Exp>, i32)>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<DAE::Exp>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn(i32) -> Result<ArcStr> + 'static>)))> {
    ...
    for mut condition in &*inConditionList {
        let mut condition = condition.clone();
        (condition, vars1, eqns1, outIndex, outHT) = encapsulateWhenConditions_Equations1(condition.clone(), inSource.clone(), outIndex, outHT.clone())?;
...
fn encapsulateWhenConditions_Algorithms(mut inStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut vars: DoubleEnded::MutableList<BackendDAE::Var>, mut inIndex: i32) -> Result<(Arc<metamodelica::List<Arc<DAE::Statement>>>, Arc<metamodelica::List<Arc<DAE::Statement>>>, i32)> {
    ...
    let mut outPreStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
    let mut outIndex: i32;
    (outStmts, outPreStmts, outIndex) = (::match_deref::match_deref! { match &(inStmts) {
        Deref @ metamodelica::List::Nil => {
            (metamodelica::nil(), metamodelica::nil(), inIndex)
        },
        Deref @ metamodelica::List::Cons { head: Deref @ DAE::Statement::STMT_WHEN { exp: condition, statementLst: stmts1, elseWhen: None, source, .. }, tail: rest } => {
            let mut stmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut stmts_: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut preStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut preStmts2: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut index: i32;
            let mut vars1: Arc<metamodelica::List<BackendDAE::Var>>;
            let mut conditions: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>;
            ...
            if CheckModel::algorithmStatementListOutputs(stmts1.clone(), openmodelica_frontend_types::DAE::Expand::EXPAND)?.is_empty() {
                (stmts, preStmts2, index) = encapsulateWhenConditions_Algorithms(rest.clone(), vars, index)?;
                preStmts = listAppend(preStmts, preStmts2);
                stmts = metamodelica::cons(Arc::new(DAE::Statement::STMT_WHEN { exp: condition.clone(), conditions: conditions, initialCall: initialCall, statementLst: stmts1.clone(), elseWhen: None, source: source.clone() }), stmts);
            } else {
                (stmts, stmts_, index) = encapsulateWhenConditions_Algorithms(rest.clone(), vars, index)?;
                stmts_ = metamodelica::cons(Arc::new(DAE::Statement::STMT_WHEN { exp: condition.clone(), conditions: conditions, initialCall: initialCall, statementLst: stmts1.clone(), elseWhen: None, source: source.clone() }), stmts_);
                stmts = listAppend(stmts_, stmts);
            }
            (stmts, preStmts, index)
        },
        Deref @ metamodelica::List::Cons { head: stmt @ Deref @ DAE::Statement::STMT_WHEN { exp: condition, statementLst: stmts1, elseWhen: Some(elseWhen), source, .. }, tail: rest } => {
            let mut stmt2: Arc<DAE::Statement>;
            let mut stmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut stmts_: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut preStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut preStmts2: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut elseWhenList: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut index: i32;
            let mut vars1: Arc<metamodelica::List<BackendDAE::Var>>;
            let mut conditions: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>;
            let mut initialCall: bool;
            ...
            if elseWhenList.clone().is_empty() {
                (stmts, preStmts, index) = encapsulateWhenConditions_Algorithms(rest.clone(), vars, inIndex)?;
                stmts_ = metamodelica::cons(stmt.clone(), listAppend(preStmts.clone(), stmts));
            } else {
                elseWhen = List::last(elseWhenList.clone())?;
                stmt2 = Arc::new(DAE::Statement::STMT_WHEN { exp: condition.clone(), conditions: conditions, initialCall: initialCall, statementLst: stmts1.clone(), elseWhen: Some(elseWhen.clone()), source: source.clone() });
...
fn encapsulateWhenConditions_Algorithms1(mut inCondition: Arc<DAE::Exp>, mut inSource: Arc<DAE::ElementSource>, mut inIndex: i32) -> Result<(Arc<DAE::Exp>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<DAE::Statement>>>, i32)> {
    ...
    (outCondition, outVars, outStmts, outIndex) = (::match_deref::match_deref! { match &(inCondition.clone()) {
        ...
        Deref @ DAE::Exp::ARRAY { array: Deref @ metamodelica::List::Cons { head: condition, tail: Deref @ metamodelica::List::Nil }, .. } => {
            ...
            var = BackendDAE::Var { varName: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (crStr.clone()).clone(), identType: DAE::T_BOOL_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), varKind: openmodelica_backend_types::BackendDAE::VarKind::DISCRETE, varDirection: openmodelica_frontend_types::DAE::VarDirection::BIDIR, varParallelism: openmodelica_frontend_types::DAE::VarParallelism::NON_PARALLEL, varType: DAE::T_BOOL_DEFAULT().clone(), bindExp: None, tplExp: None, arryDim: metamodelica::nil(), source: inSource.clone(), values: DAEUtil::setProtectedAttr(Some(DAE::emptyVarAttrBool().clone()), true)?, tearingSelectOption: None, hideResult: Some(Arc::new(DAE::Exp::BCONST { bool: true })), comment: Some(Arc::new(SCode::Comment { annotation_: None, comment: Some((ExpressionBasics::printExpStr(inCondition.clone())?).clone()) })), connectorType: openmodelica_frontend_types::DAE::ConnectorType::interned_NON_CONNECTOR(), innerOuter: openmodelica_frontend_types::DAE::VarInnerOuter::NOT_INNER_OUTER, unreplaceable: true, initNonlinear: false, encrypted: false };
            var = BackendVariable::setVarFixed(var, true)?;
            stmt = Arc::new(DAE::Statement::STMT_ASSIGN { type_: DAE::T_BOOL_DEFAULT().clone(), exp1: Arc::new(DAE::Exp::CREF { componentRef: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (crStr.clone()).clone(), identType: DAE::T_BOOL_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), ty: DAE::T_BOOL_DEFAULT().clone() }), exp: condition.clone(), source: inSource });
            condition = Arc::new(DAE::Exp::CREF { componentRef: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (crStr).clone(), identType: DAE::T_BOOL_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), ty: DAE::T_BOOL_DEFAULT().clone() });
        ...
        Deref @ DAE::Exp::ARRAY { ty, scalar, array } => {
            ...
            let mut stmts: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut array = (*array).clone();
            (array, vars, stmts, index) = encapsulateWhenConditions_AlgorithmsWithArrayConditions(array.clone(), inSource, inIndex)?;
            (Arc::new(DAE::Exp::ARRAY { ty: ty.clone(), scalar: scalar.clone(), array: array.clone() }), vars, stmts, index)
        },
        _ => {
            let mut var: BackendDAE::Var;
            let mut stmt: Arc<DAE::Statement>;
            ...
            var = BackendDAE::Var { varName: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (crStr.clone()).clone(), identType: DAE::T_BOOL_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), varKind: openmodelica_backend_types::BackendDAE::VarKind::DISCRETE, varDirection: openmodelica_frontend_types::DAE::VarDirection::BIDIR, varParallelism: openmodelica_frontend_types::DAE::VarParallelism::NON_PARALLEL, varType: DAE::T_BOOL_DEFAULT().clone(), bindExp: None, tplExp: None, arryDim: metamodelica::nil(), source: inSource.clone(), values: DAEUtil::setProtectedAttr(Some(DAE::emptyVarAttrBool().clone()), true)?, tearingSelectOption: None, hideResult: Some(Arc::new(DAE::Exp::BCONST { bool: true })), comment: Some(Arc::new(SCode::Comment { annotation_: None, comment: Some((ExpressionBasics::printExpStr(inCondition.clone())?).clone()) })), connectorType: openmodelica_frontend_types::DAE::ConnectorType::interned_NON_CONNECTOR(), innerOuter: openmodelica_frontend_types::DAE::VarInnerOuter::NOT_INNER_OUTER, unreplaceable: true, initNonlinear: false, encrypted: false };
            var = BackendVariable::setVarFixed(var, true)?;
            stmt = Arc::new(DAE::Statement::STMT_ASSIGN { type_: DAE::T_BOOL_DEFAULT().clone(), exp1: Arc::new(DAE::Exp::CREF { componentRef: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (crStr.clone()).clone(), identType: DAE::T_BOOL_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), ty: DAE::T_BOOL_DEFAULT().clone() }), exp: inCondition.clone(), source: inSource });
            condition = Arc::new(DAE::Exp::CREF { componentRef: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (crStr).clone(), identType: DAE::T_BOOL_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), ty: DAE::T_BOOL_DEFAULT().clone() });
            (condition.clone(), list![var], list![stmt], inIndex + 1)
        },
        _ => {
...
fn encapsulateWhenConditions_AlgorithmsWithArrayConditions(mut inConditionList: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut inSource: Arc<DAE::ElementSource>, mut inIndex: i32) -> Result<(Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<DAE::Statement>>>, i32)> {
    ...
    let mut outIndex: i32 = inIndex;
    let mut vars1: Arc<metamodelica::List<BackendDAE::Var>>;
    let mut stmt1: Arc<metamodelica::List<Arc<DAE::Statement>>>;
    for mut condition in &*inConditionList {
        let mut condition = condition.clone();
        (condition, vars1, stmt1, outIndex) = encapsulateWhenConditions_Algorithms1(condition.clone(), inSource.clone(), outIndex)?;
        outVars = List::append_reverse(vars1.clone(), outVars.clone());
...
pub fn findZeroCrossings(mut inDAE: Arc<BackendDAE::BackendDAE>) -> Result<Arc<BackendDAE::BackendDAE>> {
    let mut outDAE: Arc<BackendDAE::BackendDAE>;
    outDAE = BackendDAEUtil::mapEqSystem(inDAE, (std::sync::Arc::new(findZeroCrossings1) as std::sync::Arc<dyn ::std::ops::Fn(Arc<BackendDAE::EqSystem>, Arc<BackendDAE::Shared>) -> Result<(Arc<BackendDAE::EqSystem>, Arc<BackendDAE::Shared>)> + 'static>))?;
    Ok(outDAE)
}
...
fn findZeroCrossings1(mut inSyst: Arc<BackendDAE::EqSystem>, mut inShared: Arc<BackendDAE::Shared>) -> Result<(Arc<BackendDAE::EqSystem>, Arc<BackendDAE::Shared>)> {
    ...
    let (__pa0, __pa1, __pa2) = ::match_deref::match_deref! { match &(inSyst.clone()) {
        Deref @ BackendDAE::EqSystem { orderedVars: __pa0, orderedEqs: __pa1, matching: __pa2, .. } => (__pa0.clone(), __pa1.clone(), __pa2.clone()),
        _ => bail!("pattern mismatch"),
    } };
    vars = __pa0.clone();
    eqns = __pa1.clone();
    ...
    (outSyst, outShared) = (match BackendDAEUtil::getSubClock(inSyst.clone(), inShared.clone()) {
        ...
        _ => {
            ...
            let mut eqs_lst: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>;
            let mut eqs_lst1: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>;
            ...
            let mut relations: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>;
            let mut countMathFunctions: i32;
            let (__pa0, __pa1) = ::match_deref::match_deref! { match &(inShared.clone()) {
                Deref @ BackendDAE::Shared { globalKnownVars: __pa0, eventInfo: __pa1, .. } => (__pa0.clone(), __pa1.clone()),
                _ => bail!("pattern mismatch"),
            } };
            globalKnownVars = __pa0.clone();
            einfo = __pa1.clone();
            let BackendDAE::EVENT_INFO { timeEvents: __pa2, zeroCrossings: __pa3, samples: __pa4, relations: __pa5, numberMathEvents: __pa6 } = (einfo) else { bail!("pattern mismatch") };
            timeEvents = __pa2.clone();
            zero_crossings = __pa3.clone();
            sampleLst = __pa4.clone();
            relations = __pa5.clone();
            countMathFunctions = __pa6.clone();
            eqs_lst = BackendEquation::equationList(eqns)?;
            (zero_crossings, eqs_lst1, countMathFunctions, relations, sampleLst) = findZeroCrossings2(vars.clone(), globalKnownVars.clone(), eqs_lst, 0, countMathFunctions, zero_crossings, relations, sampleLst, metamodelica::nil())?;
            ...
            if '__try7: {
                let (__pa8, __pa9, __pa10) = ::match_deref::match_deref! { match &(matching.clone()) {
                    Deref @ BackendDAE::Matching::MATCHING { comps: __pa8, ass1: __pa9, ass2: __pa10 } => (__pa8.clone(), __pa9.clone(), __pa10.clone()),
            ...
            einfo = BackendDAE::EventInfo { timeEvents: timeEvents, zeroCrossings: zero_crossings, relations: relations, samples: sampleLst, numberMathEvents: countMathFunctions };
...
fn findZeroCrossings2(mut inVariables1: BackendDAE::Variables, mut globalKnownVars: BackendDAE::Variables, mut inEquationLst2: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>, mut inEqnCount: i32, mut inNumberOfMathFunctions: i32, mut inZeroCrossingLst: BackendDAE::ZeroCrossingSet, mut inRelationsLst: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut inSamplesLst: BackendDAE::ZeroCrossingSet, mut inEquationLstAccum: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>) -> Result<(BackendDAE::ZeroCrossingSet, Arc<metamodelica::List<Arc<BackendDAE::Equation>>>, i32, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet)> {
    '__tco: loop {
        ...
        Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::Equation::ALGORITHM { size, alg: Deref @ DAE::Algorithm { statementLst: stmts }, source: source_, expand, attr: eqAttr }, tail: xs } => {
            ...
            let mut countMathFunctions: i32;
            let mut eq_reslst: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>;
            let mut eqnsAccum: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>;
            let mut stmts_1: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            eq_count = inEqnCount + 1;
            let (__pa0, (_, _, _, (__pa1, __pa2, __pa3, __pa4), _)) = traverseStmtsExps(stmts.clone(), (Arc::new(DAE::Exp::SCONST { string: (literal!("$$$")).clone() }), metamodelica::nil(), Arc::new(DAE::Exp::RCONST { real: metamodelica::OrderedFloat(0.0_f64) }), (inZeroCrossingLst, inRelationsLst, inSamplesLst, inNumberOfMathFunctions), (eq_count, inVariables1.clone(), globalKnownVars.clone())), globalKnownVars.clone())?;
            stmts_1 = __pa0.clone();
            res = __pa1.clone();
            relationsLst = __pa2.clone();
            sampleLst = __pa3.clone();
            countMathFunctions = __pa4.clone();
            eqnsAccum = metamodelica::cons(Arc::new(BackendDAE::Equation::ALGORITHM { size: size.clone(), alg: Arc::new(DAE::Algorithm { statementLst: stmts_1 }), source: source_.clone(), expand: expand.clone(), attr: eqAttr.clone() }), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), eq_count, countMathFunctions, res, relationsLst, sampleLst, eqnsAccum); continue '__tco; }
        },
        Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::Equation::WHEN_EQUATION { size, whenEquation: weqn, source: source_, attr: eqAttr }, tail: xs } => {
            ...
            eq_count = inEqnCount + 1;
            (weqn, countMathFunctions, res, relationsLst, sampleLst) = findZeroCrossingsWhenEqns(weqn.clone(), inZeroCrossingLst, inRelationsLst, inSamplesLst, inNumberOfMathFunctions, eq_count, -1, inVariables1.clone(), globalKnownVars.clone())?;
            eqnsAccum = metamodelica::cons(Arc::new(BackendDAE::Equation::WHEN_EQUATION { size: size.clone(), whenEquation: weqn.clone(), source: source_.clone(), attr: eqAttr.clone() }), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), eq_count, countMathFunctions, res, relationsLst, sampleLst, eqnsAccum); continue '__tco; }
        },
        Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::Equation::EQUATION { exp: e1, scalar: e2, source: source_, attr: eqAttr }, tail: xs } => {
            ...
            let mut eq_reslst: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>;
            let mut eqnsAccum: Arc<metamodelica::List<Arc<BackendDAE::Equation>>>;
            let mut eres1: Arc<DAE::Exp>;
            let mut eres2: Arc<DAE::Exp>;
            eq_count = inEqnCount + 1;
            ...
            eqnsAccum = metamodelica::cons(Arc::new(BackendDAE::Equation::EQUATION { exp: eres1, scalar: eres2, source: source_.clone(), attr: eqAttr.clone() }), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), eq_count, countMathFunctions, res, relationsLst, sampleLst, eqnsAccum); continue '__tco; }
        },
        Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::Equation::COMPLEX_EQUATION { size, left: e1, right: e2, source, attr: eqAttr }, tail: xs } => {
            ...
            (eres1, countMathFunctions, zcs1, relationsLst, sampleLst) = findZeroCrossings3(e1.clone(), inZeroCrossingLst, inRelationsLst, inSamplesLst, inNumberOfMathFunctions, eq_count, -1, inVariables1.clone(), globalKnownVars.clone())?;
            (eres2, countMathFunctions, res, relationsLst, sampleLst) = findZeroCrossings3(e2.clone(), zcs1, relationsLst, sampleLst, countMathFunctions, eq_count, -1, inVariables1.clone(), globalKnownVars.clone())?;
            eqnsAccum = metamodelica::cons(Arc::new(BackendDAE::Equation::COMPLEX_EQUATION { size: size.clone(), left: eres1, right: eres2, source: source.clone(), attr: eqAttr.clone() }), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), eq_count, countMathFunctions, res, relationsLst, sampleLst, eqnsAccum); continue '__tco; }
        },
        Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::Equation::ARRAY_EQUATION { dimSize: dimsize, left: e1, right: e2, source, attr: eqAttr, recordSize }, tail: xs } => {
            ...
            (eres1, countMathFunctions, zcs1, relationsLst, sampleLst) = findZeroCrossings3(e1.clone(), inZeroCrossingLst, inRelationsLst, inSamplesLst, inNumberOfMathFunctions, eq_count, -1, inVariables1.clone(), globalKnownVars.clone())?;
            (eres2, countMathFunctions, res, relationsLst, sampleLst) = findZeroCrossings3(e2.clone(), zcs1, relationsLst, sampleLst, countMathFunctions, eq_count, -1, inVariables1.clone(), globalKnownVars.clone())?;
            eqnsAccum = metamodelica::cons(Arc::new(BackendDAE::Equation::ARRAY_EQUATION { dimSize: dimsize.clone(), left: eres1, right: eres2, source: source.clone(), attr: eqAttr.clone(), recordSize: recordSize.clone() }), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), eq_count, countMathFunctions, res, relationsLst, sampleLst, eqnsAccum); continue '__tco; }
        },
        Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::Equation::SOLVED_EQUATION { componentRef: cref, exp: e1, source: source_, attr: eqAttr }, tail: xs } => {
            ...
            eqnsAccum = metamodelica::cons(Arc::new(BackendDAE::Equation::SOLVED_EQUATION { componentRef: cref.clone(), exp: eres1, source: source_.clone(), attr: eqAttr.clone() }), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), inEqnCount, countMathFunctions, res, relationsLst, sampleLst, eqnsAccum); continue '__tco; }
        },
        Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::Equation::RESIDUAL_EQUATION { exp: e1, source: source_, attr: eqAttr }, tail: xs } => {
            ...
            eqnsAccum = metamodelica::cons(Arc::new(BackendDAE::Equation::RESIDUAL_EQUATION { exp: eres1, source: source_.clone(), attr: eqAttr.clone() }), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), eq_count, countMathFunctions, res, relationsLst, sampleLst, eqnsAccum); continue '__tco; }
        },
        Deref @ metamodelica::List::Cons { head: e @ Deref @ BackendDAE::Equation::IF_EQUATION { .. }, tail: xs } => {
            ...
            let mut e = (*e).clone();
            eq_count = inEqnCount + 1;
            (e, countMathFunctions, res, relationsLst, sampleLst) = findZeroCrossingsIfEqns(e.clone(), inZeroCrossingLst, inRelationsLst, inSamplesLst, inNumberOfMathFunctions, eq_count, -1, inVariables1.clone(), globalKnownVars.clone())?;
        ...
        Deref @ metamodelica::List::Cons { head: e, tail: xs } => {
            ...
            eq_count = inEqnCount + 1;
            eqnsAccum = metamodelica::cons(e.clone(), inEquationLstAccum);
            { (inVariables1, globalKnownVars, inEquationLst2, inEqnCount, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, inEquationLstAccum) = (inVariables1, globalKnownVars, xs.clone(), eq_count, inNumberOfMathFunctions, inZeroCrossingLst, inRelationsLst, inSamplesLst, eqnsAccum); continue '__tco; }
        },
...
fn findZeroCrossingsWhenEqns(mut inWhenEqn: Arc<BackendDAE::WhenEquation>, mut inZeroCrossings: BackendDAE::ZeroCrossingSet, mut inrelationsinZC: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut inSamplesLst: BackendDAE::ZeroCrossingSet, mut incountMathFunctions: i32, mut counteq: i32, mut countwc: i32, mut vars: BackendDAE::Variables, mut globalKnownVars: BackendDAE::Variables) -> Result<(Arc<BackendDAE::WhenEquation>, i32, BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet)> {
    let mut oWhenEqn: Arc<BackendDAE::WhenEquation>;
    let mut outCountMathFunctions: i32;
    let mut outZeroCrossings: BackendDAE::ZeroCrossingSet;
    let mut outrelationsinZC: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>;
    let mut outSamplesLst: BackendDAE::ZeroCrossingSet;
    (oWhenEqn, outCountMathFunctions, outZeroCrossings, outrelationsinZC, outSamplesLst) = (::match_deref::match_deref! { match &(inWhenEqn) {
        Deref @ BackendDAE::WhenEquation { condition: cond, whenStmtLst, elsewhenPart: oweelse } => {
            let mut we: Arc<BackendDAE::WhenEquation>;
            ...
            (cond, countMathFunctions, zc, relations, samples) = findZeroCrossings3(cond.clone(), inZeroCrossings, inrelationsinZC, inSamplesLst, incountMathFunctions, counteq, countwc, vars.clone(), globalKnownVars.clone())?;
            ...
            (Arc::new(BackendDAE::WhenEquation { condition: cond.clone(), whenStmtLst: whenStmtLst.clone(), elsewhenPart: oweelse.clone() }), countMathFunctions, zc, relations, samples)
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn findZeroCrossingsIfEqns(mut inIfEqn: Arc<BackendDAE::Equation>, mut inZeroCrossings: BackendDAE::ZeroCrossingSet, mut inrelationsinZC: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut inSamplesLst: BackendDAE::ZeroCrossingSet, mut incountMathFunctions: i32, mut counteq: i32, mut countwc: i32, mut vars: BackendDAE::Variables, mut globalKnownVars: BackendDAE::Variables) -> Result<(Arc<BackendDAE::Equation>, i32, BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet)> {
    let mut outIfEqn: Arc<BackendDAE::Equation>;
    let mut outCountMathFunctions: i32;
    let mut outZeroCrossings: BackendDAE::ZeroCrossingSet;
    let mut outrelationsinZC: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>;
    let mut outSamplesLst: BackendDAE::ZeroCrossingSet;
    (outIfEqn, outCountMathFunctions, outZeroCrossings, outrelationsinZC, outSamplesLst) = (::match_deref::match_deref! { match &(inIfEqn) {
        Deref @ BackendDAE::Equation::IF_EQUATION { conditions: Deref @ metamodelica::List::Nil, eqnstrue: Deref @ metamodelica::List::Nil, eqnsfalse: elseeqns, source: source_, attr: eqAttr } => {
            let mut zc: BackendDAE::ZeroCrossingSet;
            let mut samples: BackendDAE::ZeroCrossingSet;
            let mut relations: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>;
            let mut countMathFunctions: i32;
            let mut elseeqns = (*elseeqns).clone();
            (zc, elseeqns, countMathFunctions, relations, samples) = findZeroCrossings2(vars, globalKnownVars, elseeqns.clone(), counteq, incountMathFunctions, inZeroCrossings, inrelationsinZC, inSamplesLst, metamodelica::nil())?;
            elseeqns = elseeqns.clone().reverse();
            (Arc::new(BackendDAE::Equation::IF_EQUATION { conditions: metamodelica::nil(), eqnstrue: metamodelica::nil(), eqnsfalse: elseeqns.clone(), source: source_.clone(), attr: eqAttr.clone() }), countMathFunctions, zc, relations, samples)
        },
        Deref @ BackendDAE::Equation::IF_EQUATION { conditions: Deref @ metamodelica::List::Cons { head: condition, tail: restconditions }, eqnstrue: Deref @ metamodelica::List::Cons { head: eqnstrue, tail: resteqns }, eqnsfalse: elseeqns, source: source_, attr: eqAttr } => {
            let mut conditions: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut ifeqn: Arc<BackendDAE::Equation>;
            let mut eqnsTrueLst: Arc<metamodelica::List<Arc<metamodelica::List<Arc<BackendDAE::Equation>>>>>;
            let mut zc: BackendDAE::ZeroCrossingSet;
            let mut samples: BackendDAE::ZeroCrossingSet;
            let mut relations: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>;
            let mut countMathFunctions: i32;
            ...
            (condition, countMathFunctions, zc, relations, samples) = findZeroCrossings3(condition.clone(), inZeroCrossings, inrelationsinZC, inSamplesLst, incountMathFunctions, counteq, countwc, vars.clone(), globalKnownVars.clone())?;
            (zc, eqnstrue, countMathFunctions, relations, samples) = findZeroCrossings2(vars.clone(), globalKnownVars.clone(), eqnstrue.clone(), counteq, countMathFunctions, zc, relations, samples, metamodelica::nil())?;
            ...
            conditions = __pa0.clone();
            eqnsTrueLst = __pa1.clone();
            elseeqns = __pa2.clone();
            source_ = __pa3.clone();
            countMathFunctions = __pa4.clone();
            zc = __pa5.clone();
            ...
            (Arc::new(BackendDAE::Equation::IF_EQUATION { conditions: conditions, eqnstrue: eqnsTrueLst, eqnsfalse: elseeqns.clone(), source: source_.clone(), attr: eqAttr.clone() }), countMathFunctions, zc, relations, samples)
        },
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                comp @ Deref @ BackendDAE::StrongComponent::EQUATIONSYSTEM { jac: jacobian @ Deref @ BackendDAE::Jacobian::GENERIC_JACOBIAN { jacobian: Some(symJacobian), sparsePattern, coloring, nonlinearPattern }, .. } => {
                    ...
                    assign_variant_field!(comp => BackendDAE::StrongComponent::EQUATIONSYSTEM; jac = Arc::new(BackendDAE::Jacobian::GENERIC_JACOBIAN { jacobian: Some(symJacobian.clone()), sparsePattern: sparsePattern.clone(), coloring: coloring.clone(), nonlinearPattern: nonlinearPattern.clone() }));
                    Ok(comp.clone())
                }
                _ => bail!("nomatch"),
            }}
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                comp @ Deref @ BackendDAE::StrongComponent::TORNSYSTEM { strictTearingSet: tearingSet @ BackendDAE::TearingSet { jac: jacobian @ Deref @ BackendDAE::Jacobian::GENERIC_JACOBIAN { jacobian: Some(symJacobian), sparsePattern, coloring, nonlinearPattern }, .. }, .. } => {
                    ...
                    let mut symJacobian = (*symJacobian).clone();
                    symJacobian = replaceZCExpinSymJacobian(symJacobian.clone(), zeroCrossingLst.clone(), relationsLst.clone(), samplesLst.clone(), allVariables.clone(), globalKnownVars.clone())?;
                    tearingSet.jac = Arc::new(BackendDAE::Jacobian::GENERIC_JACOBIAN { jacobian: Some(symJacobian.clone()), sparsePattern: sparsePattern.clone(), coloring: coloring.clone(), nonlinearPattern: nonlinearPattern.clone() });
...
fn replaceZCExpinFullJacobian(mut fullJac: Option<Arc<metamodelica::List<(i32, i32, Arc<BackendDAE::Equation>)>>>, mut zeroCrossingLst: BackendDAE::ZeroCrossingSet, mut relationsLst: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut samplesLst: BackendDAE::ZeroCrossingSet, mut allVariables: BackendDAE::Variables, mut globalKnownVars: BackendDAE::Variables) -> Result<Option<Arc<metamodelica::List<(i32, i32, Arc<BackendDAE::Equation>)>>>> {
    let mut outFullJac: Option<Arc<metamodelica::List<(i32, i32, Arc<BackendDAE::Equation>)>>>;
    ...
    for mut element in &*jac {
        ...
        eqn = __pa0.clone();
        outJac = metamodelica::cons((i, j, eqn.clone()), outJac.clone());
    }
...
fn replaceZCExpinSymJacobian(mut symJac: (Arc<BackendDAE::BackendDAE>, ArcStr, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<DAE::ComponentRef>>>), mut zeroCrossingLst: BackendDAE::ZeroCrossingSet, mut relationsLst: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut samplesLst: BackendDAE::ZeroCrossingSet, mut allVariables: BackendDAE::Variables, mut globalKnownVars: BackendDAE::Variables) -> Result<(Arc<BackendDAE::BackendDAE>, ArcStr, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<DAE::ComponentRef>>>)> {
    let mut outSymJac: (Arc<BackendDAE::BackendDAE>, ArcStr, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<BackendDAE::Var>>, Arc<metamodelica::List<Arc<DAE::ComponentRef>>>);
    let mut jacBDAE: Arc<BackendDAE::BackendDAE>;
    let mut name: ArcStr;
    let mut seedVars: Arc<metamodelica::List<BackendDAE::Var>>;
    let mut tmpVars: Arc<metamodelica::List<BackendDAE::Var>>;
    let mut resultVars: Arc<metamodelica::List<BackendDAE::Var>>;
    let mut depCrefs: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>;
...
fn replaceZeroCrossingsJacBackend(mut inBackendDAE: Arc<BackendDAE::BackendDAE>, mut zeroCrossingLst: BackendDAE::ZeroCrossingSet, mut relationsLst: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut samplesLst: BackendDAE::ZeroCrossingSet, mut allVariables: BackendDAE::Variables, mut globalKnownVars: BackendDAE::Variables) -> Result<Arc<BackendDAE::BackendDAE>> {
    ...
    for mut system in &*eqs {
        ...
        let (__pa2, __pa3, __pa4) = ::match_deref::match_deref! { match &(system.matching.clone()) {
            Deref @ BackendDAE::Matching::MATCHING { comps: __pa2, ass1: __pa3, ass2: __pa4 } => (__pa2.clone(), __pa3.clone(), __pa4.clone()),
            _ => bail!("pattern mismatch"),
        } };
        comps = __pa2.clone();
        ass1 = __pa3.clone();
    ...
    outBackendDAE = Arc::new(BackendDAE::BackendDAE { eqs: outEqs, shared: shared });
    Ok(outBackendDAE)
}
...
fn findZeroCrossings3(mut e: Arc<DAE::Exp>, mut inZeroCrossings: BackendDAE::ZeroCrossingSet, mut inrelationsinZC: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut inSamplesLst: BackendDAE::ZeroCrossingSet, mut incountMathFunctions: i32, mut counteq: i32, mut countwc: i32, mut vars: BackendDAE::Variables, mut globalKnownVars: BackendDAE::Variables) -> Result<(Arc<DAE::Exp>, i32, BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet)> {
    ...
    let (__pa0, ((__pa1, __pa2, __pa3, __pa4), _, _)) = Expression::traverseExpTopDown(e, (std::sync::Arc::new(collectZC) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, ((BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables), Option<Arc<metamodelica::List<BackendDAE::SimIterator>>>)) -> Result<(Arc<DAE::Exp>, bool, ((BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables), Option<Arc<metamodelica::List<BackendDAE::SimIterator>>>))> + 'static>), ((inZeroCrossings, inrelationsinZC, inSamplesLst, incountMathFunctions), (counteq, vars, globalKnownVars), None))?;
    eres = __pa0.clone();
...
fn collectZC(mut inExp: Arc<DAE::Exp>, mut inTpl: ZCArgType) -> Result<(Arc<DAE::Exp>, bool, ZCArgType)> {
    ...
    (outExp, cont, outTpl) = (::match_deref::match_deref! { match &((inExp.clone(), inTpl.clone(), Config::simCodeTarget()?)) {
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sample" }, .. }, ((_, _, samples, _), (eq_count, _, _), iters), _) => {
            ...
            mergeZeroCrossings(zc, samples.clone())?;
            if Flags::isSet(Flags::RELIDX.clone())? {
        ...
        (__esc_outExp @ Deref @ DAE::Exp::REDUCTION { .. }, ((zeroCrossings, relations, samples, numMathFunctions), tp1, _), _) => {
            ...
            let mut iters: Option<Arc<metamodelica::List<BackendDAE::SimIterator>>>;
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "delay" }, expLst: Deref @ metamodelica::List::Cons { head: index, tail: Deref @ metamodelica::List::Cons { head: e, tail: Deref @ metamodelica::List::Cons { head: delay, tail: Deref @ metamodelica::List::Cons { head: delayMax, tail: Deref @ metamodelica::List::Nil } } } }, attr }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), Deref @ "C") => {
            ...
            (eres, relations, _) = zcIndexRelation(e_1, relations.clone(), DoubleEnded::length(relations.clone()), zc)?;
            zc = createZeroCrossing(eres.clone(), list![eq_count.clone()], iters.clone());
            let (__pa12, __pa13) = ::match_deref::match_deref! { match &(zcIndex(eres.clone(), zeroCrossings.clone(), DoubleEnded::length(relations.clone()), zc)?) {
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "spatialDistribution" }, expLst: Deref @ metamodelica::List::Cons { head: index, tail: Deref @ metamodelica::List::Cons { head: in0, tail: Deref @ metamodelica::List::Cons { head: in1, tail: Deref @ metamodelica::List::Cons { head: x, tail: Deref @ metamodelica::List::Cons { head: dir, tail: Deref @ metamodelica::List::Cons { head: initPnts, tail: Deref @ metamodelica::List::Cons { head: initVals, tail: Deref @ metamodelica::List::Nil } } } } } } }, attr }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), Deref @ "C") => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut eres1: Arc<DAE::Exp>;
            let mut itmp: i32;
            ...
            (eres, relations, _) = zcIndexRelation(e_1, relations.clone(), DoubleEnded::length(relations.clone()), zc)?;
            zc = createZeroCrossing(eres.clone(), list![eq_count.clone()], iters.clone());
            let (__pa25, __pa26) = ::match_deref::match_deref! { match &(zcIndex(eres.clone(), zeroCrossings.clone(), DoubleEnded::length(relations.clone()), zc)?) {
        ...
        (Deref @ DAE::Exp::LUNARY { exp: e1, operator: op }, ((zeroCrossings, relations, _, _), _, iters), _) => {
            ...
            if empty {
                ZeroCrossings::add(zeroCrossings.clone(), zc)?;
            }
            if Flags::isSet(Flags::RELIDX.clone())? {
        ...
        (Deref @ DAE::Exp::LBINARY { exp1: e1, operator: op, exp2: e2 }, ((zeroCrossings, relations, samples, numMathFunctions), tp1, iters), _) => {
            ...
            tp1 = __pa11.clone();
            iters = __pa12.clone();
            if intGt(DoubleEnded::length(relations.clone()), oldNumRelations) {
                e_1 = Arc::new(DAE::Exp::LBINARY { exp1: e_1, operator: op.clone(), exp2: e_2 });
                zc = createZeroCrossing(e_1.clone(), list![eq_count], iters.clone());
                empty = !(ZeroCrossings::contains(zeroCrossings.clone(), zc.clone())?);
                cont = false;
                if empty {
        ...
        (Deref @ DAE::Exp::RELATION { exp1: e1, operator: op, exp2: e2, .. }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), _) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            ...
            let mut relations = (*relations).clone();
            if Flags::isSet(Flags::RELIDX.clone())? {
                metamodelica::print(({ let mut __mm_s = String::new(); __mm_s.push_str(&*literal!("start collectZC (2): ")); __mm_s.push_str(&*ExpressionBasics::printExpStr(inExp)?); __mm_s.push_str(&*literal!(" numRelations: ")); __mm_s.push_str(&*intString(DoubleEnded::length(relations.clone()))); __mm_s.push_str(&*literal!("\n")); ArcStr::from(__mm_s) }).clone());
            }
            ...
            (eres, relations, _) = zcIndexRelation(e_1, relations.clone(), DoubleEnded::length(relations.clone()), zc)?;
            zc = createZeroCrossing(eres.clone(), list![eq_count.clone()], iters.clone());
            let (__pa0, __pa1) = ::match_deref::match_deref! { match &(zcIndex(eres.clone(), zeroCrossings.clone(), DoubleEnded::length(relations.clone()), zc)?) {
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "integer" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Nil }, attr }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), _) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "floor" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Nil }, attr }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), _) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "ceil" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Nil }, attr }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), _) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "div" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Cons { head: e2, tail: Deref @ metamodelica::List::Nil } }, attr }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), _) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "mod" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Cons { head: e2, tail: Deref @ metamodelica::List::Nil } }, attr: attr @ Deref @ DAE::CallAttributes { .. } }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), _) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "rem" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Cons { head: e2, tail: Deref @ metamodelica::List::Nil } }, attr: attr @ Deref @ DAE::CallAttributes { ty, .. } }, ((zeroCrossings, relations, samples, numMathFunctions), tp1 @ (eq_count, _, _), iters), _) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut e_2: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
...
fn collectZCAlgsFor(mut inExp: Arc<DAE::Exp>, mut inTpl: ForArgType) -> Result<(Arc<DAE::Exp>, bool, ForArgType)> {
    ...
    (outExp, cont, outTpl) = (::match_deref::match_deref! { match &((inExp.clone(), inTpl.clone())) {
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sample" }, .. }, (_, _, _, (_, _, samples, _), (alg_indx, _, _))) => {
            ...
            ZeroCrossings::add(samples.clone(), zc)?;
            if Flags::isSet(Flags::RELIDX.clone())? {
        ...
        (Deref @ DAE::Exp::LUNARY { exp: e1, operator: op }, (iterator, _, Deref @ DAE::Exp::RANGE { .. }, (zeroCrossings, relations, _, _), _)) if (Expression::expContains(inExp.clone(), iterator.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut inExpLst: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut explst: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut zc_lst: Arc<metamodelica::List<BackendDAE::ZeroCrossing>>;
            ...
            let (__pa0, ref __pa5 @ (ref __pa1, ref __pa2, _, (_, ref __pa3, _, _), (ref __pa4, _, _))) = Expression::traverseExpTopDown(e1.clone(), (std::sync::Arc::new(collectZCAlgsFor) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, (Arc<DAE::Exp>, Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<DAE::Exp>, (BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables))) -> Result<(Arc<DAE::Exp>, bool, (Arc<DAE::Exp>, Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<DAE::Exp>, (BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables)))> + 'static>), inTpl)?;
            e1 = __pa0.clone();
            ...
            ZeroCrossings::add_list(zeroCrossings.clone(), zc_lst)?;
            if Flags::isSet(Flags::RELIDX.clone())? {
        ...
        (Deref @ DAE::Exp::LBINARY { exp1: e1, operator: op, exp2: e2 }, (iterator, inExpLst, range, (zeroCrossings, relations, samples, numMathFunctions), tp1)) => {
            ...
            let mut zc: BackendDAE::ZeroCrossing;
            let mut tpl: ForArgType;
            let mut tp2: (BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32);
            ...
            tp2 = __pa3.clone();
            tp1 = __pa4.clone();
            let (__pa5, (_, __pa6, __pa7, (_, __pa8, __pa9, __pa10), ref __pa12 @ (ref __pa11, _, _))) = Expression::traverseExpTopDown(e2.clone(), (std::sync::Arc::new(collectZCAlgsFor) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, (Arc<DAE::Exp>, Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<DAE::Exp>, (BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables))) -> Result<(Arc<DAE::Exp>, bool, (Arc<DAE::Exp>, Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<DAE::Exp>, (BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables)))> + 'static>), (iterator.clone(), inExpLst.clone(), range.clone(), tp2, tp1.clone()))?;
            e_2 = __pa5.clone();
        ...
        (Deref @ DAE::Exp::RELATION { exp1: e1, operator: op, exp2: e2, .. }, (iterator, inExpLst, range @ Deref @ DAE::Exp::RANGE { start: startvalue, step: stepvalueopt, .. }, (zeroCrossings, relations, samples, numMathFunctions), tp1 @ (alg_indx, _, globalKnownVars))) if (if (Flags::isSet(Flags::EVENTS.clone())?) {if (Expression::expContains(e1.clone(), iterator.clone())?) {true} else {Expression::expContains(e2.clone(), iterator.clone())?}} else {false}) => {
            let mut eres: Arc<DAE::Exp>;
            let mut explst: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut zcLstNew: Arc<metamodelica::List<BackendDAE::ZeroCrossing>>;
            let mut itmp: i32;
            let mut stepvalue: Arc<DAE::Exp>;
            let mut istart: i32;
            let mut istep: i32;
            if Flags::isSet(Flags::RELIDX.clone())? {
            ...
            istep = BackendDAEUtil::expInt(stepvalue, globalKnownVars.clone())?;
            eres = Arc::new(DAE::Exp::RELATION { exp1: e1.clone(), operator: op.clone(), exp2: e2.clone(), index: DoubleEnded::length(relations.clone()), optionExpisASUB: Some((iterator.clone(), istart, istep)) });
            ...
            ZeroCrossings::add_list(zeroCrossings.clone(), zcLstNew)?;
            if Flags::isSet(Flags::RELIDX.clone())? {
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "integer" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Nil }, attr }, (iterator, le, range, (zeroCrossings, relations, samples, numMathFunctions), tp1 @ (alg_indx, _, _))) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "floor" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Nil }, attr }, (iterator, le, range, (zeroCrossings, relations, samples, numMathFunctions), tp1 @ (alg_indx, _, _))) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "ceil" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Nil }, attr }, (iterator, le, range, (zeroCrossings, relations, samples, numMathFunctions), tp1 @ (alg_indx, _, _))) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "div" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Cons { head: e2, tail: Deref @ metamodelica::List::Nil } }, attr }, (iterator, le, range, (zeroCrossings, relations, samples, numMathFunctions), tp1 @ (alg_indx, _, _))) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "mod" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Cons { head: e2, tail: Deref @ metamodelica::List::Nil } }, attr: attr @ Deref @ DAE::CallAttributes { .. } }, (iterator, le, range, (zeroCrossings, relations, samples, numMathFunctions), tp1 @ (alg_indx, _, _))) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
            let mut zeroCrossings = (*zeroCrossings).clone();
        ...
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "rem" }, expLst: Deref @ metamodelica::List::Cons { head: e1, tail: Deref @ metamodelica::List::Cons { head: e2, tail: Deref @ metamodelica::List::Nil } }, attr: attr @ Deref @ DAE::CallAttributes { ty, .. } }, (iterator, le, range, (zeroCrossings, relations, samples, numMathFunctions), tp1 @ (alg_indx, _, _))) if (Flags::isSet(Flags::EVENTS.clone())?) => {
            let mut e_1: Arc<DAE::Exp>;
            let mut e_2: Arc<DAE::Exp>;
            let mut eres: Arc<DAE::Exp>;
            let mut zc: BackendDAE::ZeroCrossing;
...
fn replaceIteratorWithStaticValues(mut inExp: Arc<DAE::Exp>, mut inIterator: Arc<DAE::Exp>, mut inExpLst: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut inIndex: i32) -> Result<(Arc<metamodelica::List<Arc<DAE::Exp>>>, i32)> {
    let mut outZeroCrossings: Arc<metamodelica::List<Arc<DAE::Exp>>>;
    let mut outIndex: i32;
    (outZeroCrossings, outIndex) = (::match_deref::match_deref! { match &((inExp.clone(), inExpLst)) {
        (_, Deref @ metamodelica::List::Nil) => {
            (metamodelica::nil(), inIndex)
        },
        (Deref @ DAE::Exp::RELATION { exp1: e1, operator: op, exp2: e2, .. }, Deref @ metamodelica::List::Cons { head: e, tail: rest }) => {
            let mut res1: Arc<DAE::Exp>;
            let mut e_1: Arc<DAE::Exp>;
            let mut res2: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut index: i32;
            e_1 = Arc::new(DAE::Exp::RELATION { exp1: e1.clone(), operator: op.clone(), exp2: e2.clone(), index: inIndex, optionExpisASUB: None });
            (res1, _) = Expression::replaceExpTpl(e_1, (inIterator.clone(), e.clone()))?;
            (res2, index) = replaceIteratorWithStaticValues(inExp, inIterator, rest.clone(), inIndex + 1)?;
            res2 = metamodelica::cons(res1, res2);
            (res2, index)
        },
        (Deref @ DAE::Exp::LUNARY { exp: e1, operator: op }, Deref @ metamodelica::List::Cons { head: e, tail: rest }) => {
            let mut res1: Arc<DAE::Exp>;
            let mut e_1: Arc<DAE::Exp>;
            let mut res2: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut index: i32;
        ...
        (Deref @ DAE::Exp::LBINARY { exp1: e1, operator: op, exp2: e2 }, Deref @ metamodelica::List::Cons { head: e, tail: rest }) => {
            let mut res1: Arc<DAE::Exp>;
            let mut e_1: Arc<DAE::Exp>;
            let mut res2: Arc<metamodelica::List<Arc<DAE::Exp>>>;
            let mut index: i32;
...
fn zcIndex(mut relation: Arc<DAE::Exp>, mut zeroCrossings: BackendDAE::ZeroCrossingSet, mut index: i32, mut zc: BackendDAE::ZeroCrossing) -> Result<(Arc<DAE::Exp>, BackendDAE::ZeroCrossingSet, i32)> {
    ...
    if ZeroCrossings::contains(zeroCrossings.clone(), zc.clone())? {
        let BackendDAE::ZERO_CROSSING { relation_: __pa0, .. } = (ZeroCrossings::get(zeroCrossings.clone(), zc)?) else { bail!("pattern mismatch") };
    ...
    (relation, index) = (::match_deref::match_deref! { match &(relation.clone()) {
        ...
        _ => {
            Error::addInternalError(({ let mut __mm_s = String::new(); __mm_s.push_str(&*literal!("FindZeroCrossings.zcIndex")); __mm_s.push_str(&*literal!(" failed for: ")); __mm_s.push_str(&*ExpressionBasics::printExpStr(relation)?); ArcStr::from(__mm_s) }).clone(), metamodelica::sourceInfo!("BackEnd/FindZeroCrossings.mo"))?;
            bail!("fail")
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn zcIndexRelation(mut relation: Arc<DAE::Exp>, mut zeroCrossings: DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, mut index: i32, mut zc: BackendDAE::ZeroCrossing) -> Result<(Arc<DAE::Exp>, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, i32)> {
    ...
    let mut index: i32 = index;
    let mut duplicate: Arc<metamodelica::List<BackendDAE::ZeroCrossing>>;
    ...
    (relation, index) = (::match_deref::match_deref! { match &((relation.clone(), duplicate)) {
        ...
        _ => {
            Error::addInternalError(({ let mut __mm_s = String::new(); __mm_s.push_str(&*literal!("FindZeroCrossings.zcIndexRelation")); __mm_s.push_str(&*literal!(" failed for: ")); __mm_s.push_str(&*ExpressionBasics::printExpStr(relation)?); ArcStr::from(__mm_s) }).clone(), metamodelica::sourceInfo!("BackEnd/FindZeroCrossings.mo"))?;
            bail!("fail")
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn mergeZeroCrossings(mut newZc: BackendDAE::ZeroCrossing, mut zcs: BackendDAE::ZeroCrossingSet) -> Result<()> {
    if !(ZeroCrossings::contains(zcs.clone(), newZc.clone())?) {
        ...
        DoubleEnded::mapNoCopy_1(zcs.zc.clone(), (std::sync::Arc::new(mergeZeroCrossingIfEqual) as std::sync::Arc<dyn ::std::ops::Fn(BackendDAE::ZeroCrossing, BackendDAE::ZeroCrossing) -> Result<BackendDAE::ZeroCrossing> + 'static>), newZc)?;
    }
    Ok(())
}
...
fn mergeZeroCrossingIfEqual(mut zc1: BackendDAE::ZeroCrossing, mut zc2: BackendDAE::ZeroCrossing) -> Result<BackendDAE::ZeroCrossing> {
    let mut zc: BackendDAE::ZeroCrossing;
    zc = if (ZeroCrossings::equals(zc1.clone(), zc2.clone())?) {mergeZeroCrossing(zc1, zc2)?} else {zc1};
    Ok(zc)
}
...
fn mergeZeroCrossing(mut inZeroCrossing1: BackendDAE::ZeroCrossing, mut inZeroCrossing2: BackendDAE::ZeroCrossing) -> Result<BackendDAE::ZeroCrossing> {
    ...
    let mut eq: Arc<metamodelica::List<i32>>;
    let mut eq1: Arc<metamodelica::List<i32>>;
    let mut eq2: Arc<metamodelica::List<i32>>;
    let mut e1: Arc<DAE::Exp>;
    let mut e2: Arc<DAE::Exp>;
    let mut res: Arc<DAE::Exp>;
    let BackendDAE::ZERO_CROSSING { relation_: __pa0, occurEquLst: __pa1, .. } = (inZeroCrossing1) else { bail!("pattern mismatch") };
    e1 = __pa0.clone();
    eq1 = __pa1.clone();
    let BackendDAE::ZERO_CROSSING { relation_: __pa2, occurEquLst: __pa3, .. } = (inZeroCrossing2) else { bail!("pattern mismatch") };
    e2 = __pa2.clone();
    eq2 = __pa3.clone();
    res = getMinZeroCrossings(e1, e2)?;
    eq = List::union(eq1, eq2);
    outZeroCrossing = BackendDAE::ZeroCrossing { index: 0, relation_: res, occurEquLst: eq, iter: None };
    Ok(outZeroCrossing)
}

fn getMinZeroCrossings(mut inZCexp1: Arc<DAE::Exp>, mut inZCexp2: Arc<DAE::Exp>) -> Result<Arc<DAE::Exp>> {
    let mut outMinZC: Arc<DAE::Exp>;
    outMinZC = (::match_deref::match_deref! { match &((inZCexp1.clone(), inZCexp2.clone())) {
        ...
        (Deref @ DAE::Exp::LBINARY { exp1: e1, operator: op, exp2: e2 }, Deref @ DAE::Exp::LBINARY { exp1: e3, exp2: e4, .. }) => {
            ...
            Arc::new(DAE::Exp::LBINARY { exp1: res, operator: op.clone(), exp2: res2 })
        },
        (Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sample" }, expLst: Deref @ metamodelica::List::Cons { head: _, tail: Deref @ metamodelica::List::Cons { head: _, tail: Deref @ metamodelica::List::Cons { head: _, tail: Deref @ metamodelica::List::Nil } } }, .. }, _) => {
            inZCexp1
        },
        (_, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sample" }, expLst: Deref @ metamodelica::List::Cons { head: _, tail: Deref @ metamodelica::List::Cons { head: _, tail: Deref @ metamodelica::List::Cons { head: _, tail: Deref @ metamodelica::List::Nil } } }, .. }) => {
            inZCexp2
        },
        _ => {
            Error::addInternalError(({ let mut __mm_s = String::new(); __mm_s.push_str(&*literal!("FindZeroCrossings.getMinZeroCrossings")); __mm_s.push_str(&*literal!(" failed for {")); __mm_s.push_str(&*ExpressionBasics::printExpStr(inZCexp1)?); __mm_s.push_str(&*literal!("} and {")); __mm_s.push_str(&*ExpressionBasics::printExpStr(inZCexp2)?); __mm_s.push_str(&*literal!("}")); ArcStr::from(__mm_s) }).clone(), metamodelica::sourceInfo!("BackEnd/FindZeroCrossings.mo"))?;
            bail!("fail")
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn traverseStmtsExps(mut inStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut inExtraArg: ForArgType, mut inKnvars: BackendDAE::Variables) -> Result<(Arc<metamodelica::List<Arc<DAE::Statement>>>, ForArgType)> {
    ...
    for mut stmt in &*inStmts {
        ...
        Deref @ DAE::Statement::STMT_FOR { type_: __esc_tp, iterIsArray: __esc_b1, iter: __esc_id1, range: __esc_e, statementLst: __esc_stmts, source: __esc_source } => {
            tp = (*__esc_tp).clone();
            b1 = (*__esc_b1).clone();
            id1 = (*__esc_id1).clone();
            e = (*__esc_e).clone();
...
fn traverseStmtsElseExps(mut inElse: Arc<DAE::Else>, mut inExtraArg: ForArgType, mut inKnvars: BackendDAE::Variables) -> Result<(Arc<DAE::Else>, ForArgType)> {
    ...
    (outElse, outTplStmtTypeA) = (::match_deref::match_deref! { match &(inElse) {
        Deref @ DAE::Else::NOELSE { .. } => {
            (openmodelica_frontend_types::DAE::Else::interned_NOELSE(), inExtraArg)
        },
        Deref @ DAE::Else::ELSEIF { exp: e, statementLst: st, else_: el } => {
            ...
            (el_1, extraArg) = traverseStmtsElseExps(el.clone(), inExtraArg, inKnvars.clone())?;
            (st_1, extraArg) = traverseStmtsExps(st.clone(), extraArg, inKnvars)?;
            (e_1, extraArg) = Expression::traverseExpTopDown(e.clone(), (std::sync::Arc::new(collectZCAlgsFor) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, (Arc<DAE::Exp>, Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<DAE::Exp>, (BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables))) -> Result<(Arc<DAE::Exp>, bool, (Arc<DAE::Exp>, Arc<metamodelica::List<Arc<DAE::Exp>>>, Arc<DAE::Exp>, (BackendDAE::ZeroCrossingSet, DoubleEnded::MutableList<BackendDAE::ZeroCrossing>, BackendDAE::ZeroCrossingSet, i32), (i32, BackendDAE::Variables, BackendDAE::Variables)))> + 'static>), extraArg)?;
            (Arc::new(DAE::Else::ELSEIF { exp: e_1, statementLst: st_1, else_: el_1 }), extraArg)
        },
        Deref @ DAE::Else::ELSE { statementLst: st } => {
            let mut st_1: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut extraArg: ForArgType;
            (st_1, extraArg) = traverseStmtsExps(st.clone(), inExtraArg, inKnvars)?;
            (Arc::new(DAE::Else::ELSE { statementLst: st_1 }), extraArg)
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn traverseStmtsForExps(mut inIteratorExp: Arc<DAE::Exp>, mut inExplst: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut inRange: Arc<DAE::Exp>, mut inStmts: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut inKnvars: BackendDAE::Variables, mut inExtraArg: ForArgType) -> Result<(Arc<metamodelica::List<Arc<DAE::Statement>>>, ForArgType)> {
    ...
    (outStatements, outTpl) = (::match_deref::match_deref! { match &((inExplst.clone(), inExtraArg.clone())) {
        ...
        (_, (_, _, _, tpl2, tpl3)) => {
            let mut statementLst: Arc<metamodelica::List<Arc<DAE::Statement>>>;
            let mut extraArg: ForArgType;
...
fn createZeroCrossings(mut inExpExpLst1: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut inOccurEquLst: Arc<metamodelica::List<i32>>) -> Result<Arc<metamodelica::List<BackendDAE::ZeroCrossing>>> {
    let mut outZeroCrossingLst: Arc<metamodelica::List<BackendDAE::ZeroCrossing>>;
    outZeroCrossingLst = List::map1(inExpExpLst1, (std::sync::Arc::new({ let __pe_b2 = None; move |__pe_a0, __pe_a1| Ok(createZeroCrossing(__pe_a0, __pe_a1, __pe_b2.clone())) }) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, Arc<metamodelica::List<i32>>) -> Result<BackendDAE::ZeroCrossing> + 'static>), inOccurEquLst)?;
...
fn createZeroCrossing(mut inRelation: Arc<DAE::Exp>, mut inOccurEquLst: Arc<metamodelica::List<i32>>, mut iters: Option<Arc<metamodelica::List<BackendDAE::SimIterator>>>) -> BackendDAE::ZeroCrossing {
    ...
    outZeroCrossing = (::match_deref::match_deref! { match &(inOccurEquLst.clone()) {
        Deref @ metamodelica::List::Cons { head: (-1), tail: Deref @ metamodelica::List::Nil } => BackendDAE::ZeroCrossing { index: 0, relation_: inRelation, occurEquLst: metamodelica::nil(), iter: iters },
...
fn createIterator(mut red_iter: Arc<DAE::ReductionIterator>) -> Result<BackendDAE::SimIterator> {
    ...
    iter = (::match_deref::match_deref! { match &(red_iter.exp.clone()) {
        exp @ Deref @ DAE::Exp::RANGE { .. } => {
            ...
            size = Arc::new(DAE::Exp::BINARY { exp1: size, operator: DAE::Operator::DIV { ty: ty.clone() }, exp2: step.clone() });
            size = Arc::new(DAE::Exp::BINARY { exp1: size, operator: DAE::Operator::ADD { ty: ty }, exp2: Arc::new(DAE::Exp::ICONST { integer: 1 }) });
            ...
            BackendDAE::SimIterator::SIM_ITERATOR_RANGE { name: Arc::new(DAE::ComponentRef::CREF_IDENT { ident: (red_iter.id.clone()).clone(), identType: DAE::T_INTEGER_DEFAULT().clone(), subscriptLst: metamodelica::nil() }), start: var_field!((**exp).start, DAE::Exp::RANGE).clone(), step: step, stop: var_field!((**exp).stop, DAE::Exp::RANGE).clone(), size: size, non_resizable_size: non_resizable_size, sub_iter: metamodelica::nil() }
        },
