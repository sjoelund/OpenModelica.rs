...
pub(crate) fn filterOnDirection(mut inputs: Arc<metamodelica::List<Arc<Absyn::ElementItem>>>, mut direction: Absyn::Direction) -> Arc<metamodelica::List<Arc<Absyn::ElementItem>>> {
