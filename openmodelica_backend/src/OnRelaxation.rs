...
fn relaxSystem1(mut isyst: Arc<BackendDAE::EqSystem>, mut ishared: Arc<BackendDAE::Shared>, mut inComps: Arc<metamodelica::List<Arc<BackendDAE::StrongComponent>>>) -> Result<(Arc<BackendDAE::EqSystem>, Arc<BackendDAE::Shared>, bool)> {
    ...
    (osyst, oshared, outRunMatching) = 'mc: {
        let __mc_input = (ishared.clone(), inComps.clone());
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (shared @ Deref @ BackendDAE::Shared { functionTree: funcs, .. }, Deref @ metamodelica::List::Cons { head: Deref @ BackendDAE::StrongComponent::EQUATIONSYSTEM { eqns: eindex, vars: vindx, jac: Deref @ BackendDAE::Jacobian::FULL_JACOBIAN { jacobian: Some(jac) }, jacType: BackendDAE::JacobianType::JAC_LINEAR { .. }, .. }, tail: comps }) => {
                    ...
                    let mut orowmarks: metamodelica::Array<i32> = Default::default();
                    let mut ocolummarks: metamodelica::Array<i32> = Default::default();
                    let mut size: i32 = 0;
                    let mut mark: i32 = 0;
                    let mut esize: i32 = 0;
                    ...
                    let mut teqns: Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> = <Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> as ::std::default::Default>::default();
                    ...
                    let mut mc: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
                    let mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
                    let mut mct: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
                    let mut beqs: Arc<metamodelica::List<Arc<DAE::Exp>>> = metamodelica::nil();
                    let mut matrix: metamodelica::Array<Arc<metamodelica::List<(i32, Arc<DAE::Exp>)>>> = Default::default();
                    let mut crefexps: metamodelica::Array<Arc<DAE::Exp>> = Default::default();
                    let mut crefexplst: Arc<metamodelica::List<Arc<DAE::Exp>>> = metamodelica::nil();
                    let mut vorphansarray1: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
                    let mut mapEqnIncRow: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
                    let mut ass22: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
                    let mut vec1: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                _ => {
                    ...
                    {let _arr = orphansarray.clone(); let _idx = orphan.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    Ok(())
                }
                _ => bail!("nomatch"),
            }}
...
fn replaceFinalParameter(mut itpl: (Arc<DAE::Exp>, BackendDAE::Variables)) -> Result<(Arc<DAE::Exp>, BackendDAE::Variables)> {
    let mut outTpl: (Arc<DAE::Exp>, BackendDAE::Variables) = (Arc::new(<DAE::Exp as ::std::default::Default>::default()), <BackendDAE::Variables as ::std::default::Default>::default());
...
fn transposeOrphanVec(mut c: i32, mut vec3: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut inId: i32) -> Result<i32> {
    let mut outId: i32 = 0;
    outId = 'mc: {
        let __mc_input = inId.clone();
        if let Ok(__v) = (|| -> Result<_> {
            let _ = __mc_input.clone() else { bail!("nomatch") };
            let mut lst: Arc<metamodelica::List<i32>> = metamodelica::nil();
            let true = (intGt(c.clone(), 0)) else { bail!("pattern mismatch") };
            lst = ({let __elt = vec3.borrow()[(c.clone()-1) as usize].clone(); __elt});
            {let _arr = vec3.clone(); let _idx = c.clone(); let _val = metamodelica::cons(inId.clone(), lst.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
            Ok(inId.clone() + 1)
        })() { break 'mc __v; }
        if let Ok(__v) = (|| -> Result<_> {
            let _ = __mc_input.clone() else { bail!("nomatch") };
...
fn markOrphans(mut o: i32, mut mark: i32, mut rowmark: metamodelica::Array<i32>) -> Result<metamodelica::Array<i32>> {
    let mut orowmark: metamodelica::Array<i32> = Default::default();
    orowmark = {let _arr = rowmark.clone(); let _idx = o.clone(); let _val = mark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
    Ok(orowmark)
}
        ...
        if let Ok((__v, __wb0)) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ metamodelica::List::Cons { head: o, tail: rest } => {
                    ...
                    {let _arr = colummarks.clone(); let _idx = o.clone(); let _val = mark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
    ...
    for mut r in &*rows.clone() {
        ...
        if !(intEq(({let __elt = rowmarks.borrow()[(r.clone()-1) as usize].clone(); __elt}), mark.clone())) {
            ...
            if next.clone().is_empty() {
                {let _arr = rowmarks.clone(); let _idx = r.clone(); let _val = mark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                e = ({let __elt = ass1.borrow()[(r.clone()-1) as usize].clone(); __elt});
                {let _arr = colummarks.clone(); let _idx = e.clone(); let _val = mark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn generateCliquesResidual2(mut eqns: Arc<metamodelica::List<i32>>, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut rowmarks: metamodelica::Array<i32>, mut colummarks: metamodelica::Array<i32>, mut orphan: Arc<metamodelica::List<i32>>) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(eqns.clone()) {
        Deref @ metamodelica::List::Nil => {
            ()
        },
...
fn prepairOrphansOrder(mut inOrphans: Arc<metamodelica::List<i32>>, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut rowmarks: metamodelica::Array<i32>, mut colummarks: metamodelica::Array<i32>, mut orphans: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut vars: BackendDAE::Variables, mut iroots: Arc<metamodelica::List<i32>>, mut iconstraints: Arc<metamodelica::List<i32>>) -> Result<(i32, Arc<metamodelica::List<i32>>, Arc<metamodelica::List<i32>>)> {
    ...
    let mut oconstraints: Arc<metamodelica::List<i32>> = metamodelica::nil();
    (omark, oroots, oconstraints) = (::match_deref::match_deref! { match &(inOrphans.clone()) {
        Deref @ metamodelica::List::Nil => {
        ...
        Deref @ metamodelica::List::Cons { head: o, tail: rest } if (!(intEq(({let __elt = rowmarks.borrow()[(o.clone()-1) as usize].clone(); __elt}), mark.clone()))) => {
            ...
            let mut vlst: Arc<metamodelica::List<BackendDAE::Var>> = metamodelica::nil();
            {let _arr = rowmarks.clone(); let _idx = o.clone(); let _val = mark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ metamodelica::List::Cons { head: o, tail: rest } => {
                    ...
                    {let _arr = rowmarks.clone(); let _idx = o.clone(); let _val = imark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn generateClique(mut r: i32, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut orphans: Arc<metamodelica::List<i32>>, mut e: i32) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(orphans.clone()) {
        Deref @ metamodelica::List::Nil => {
            ()
        },
        Deref @ metamodelica::List::Cons { head: orphan, tail: rest } => {
            ...
            {let _arr = mt.clone(); let _idx = r.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
            lst = ({let __elt = mt.borrow()[(orphan.clone()-1) as usize].clone(); __elt});
            lst = List::unique(metamodelica::cons(e.clone(), lst.clone()));
            {let _arr = mt.clone(); let _idx = orphan.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
            ...
            {let _arr = m.clone(); let _idx = e.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn generateResidualClique(mut r: i32, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut orphans: Arc<metamodelica::List<i32>>, mut e: i32) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(orphans.clone()) {
        ...
        Deref @ metamodelica::List::Cons { head: orphan, tail: rest } => {
            ...
            {let _arr = m.clone(); let _idx = orphan.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
            lst = ({let __elt = mt.borrow()[(r.clone()-1) as usize].clone(); __elt});
            lst = List::removeOnTrue(e.clone(), (std::sync::Arc::new(fnptr!(intEq, i32, i32)) as std::sync::Arc<dyn ::std::ops::Fn(i32, i32) -> Result<bool> + 'static>), lst.clone())?;
            lst = List::unique(metamodelica::cons(orphan.clone(), lst.clone()));
            {let _arr = mt.clone(); let _idx = r.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn addPreOrphan(mut orphan: i32, mut preorphan: i32, mut arr: metamodelica::Array<Arc<metamodelica::List<i32>>>) -> Result<()> {
    ...
    {let _arr = arr.clone(); let _idx = orphan.clone(); let _val = olst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
    Ok(())
}
...
fn addPreOrphans(mut orphan: i32, mut preorphans: Arc<metamodelica::List<i32>>, mut arr: metamodelica::Array<Arc<metamodelica::List<i32>>>) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(preorphans.clone()) {
        Deref @ metamodelica::List::Nil => {
            ()
        },
        Deref @ metamodelica::List::Cons { head: o, tail: rest } => {
...
fn getOrphansOrderEdvanced1(mut eqns: Arc<metamodelica::List<i32>>, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut rowmarks: metamodelica::Array<i32>, mut colummarks: metamodelica::Array<i32>, mut preorphan: i32, mut orphans: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut nextQueue: Arc<metamodelica::List<i32>>) -> Result<()> {
    let () = 'mc: {
        let __mc_input = (eqns.clone(), nextQueue.clone());
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
...
fn getLinkPosition1(mut orphans: Arc<metamodelica::List<i32>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut rowmarks: metamodelica::Array<i32>, mut preorphan: i32, mut iAcc: Arc<metamodelica::List<i32>>) -> Result<Arc<metamodelica::List<i32>>> {
    ...
    childs = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ metamodelica::List::Nil => {
                    Ok(metamodelica::cons(preorphan.clone(), iAcc.clone()))
                }
                _ => bail!("nomatch"),
            }}
        })() { break 'mc __v; }
...
fn getOrphansOrderEdvanced5(mut linklst: Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut imark: i32, mut rowmarks: metamodelica::Array<i32>, mut iAcc: Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>) -> Result<(Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>, i32)> {
    ...
    let mut omark: i32 = 0;
    (oAcc, omark) = (::match_deref::match_deref! { match &(linklst.clone()) {
        Deref @ metamodelica::List::Nil => {
        ...
        Deref @ metamodelica::List::Cons { head: links, tail: rest } => {
            ...
            (acc, mark) = getOrphansOrderEdvanced5(rest.clone(), m.clone(), mt.clone(), imark.clone() + 1, rowmarks.clone(), metamodelica::cons(childs.clone(), iAcc.clone()))?;
...
fn getOrphansOrderEdvanced6(mut linklst: Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>, mut childslst: Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>) -> Result<()> {
    let () = (::match_deref::match_deref! { match &((linklst.clone(), childslst.clone())) {
        (Deref @ metamodelica::List::Nil, _) => {
            ()
        },
...
fn getInvMap(mut orphan: i32, mut invmap: metamodelica::Array<i32>, mut index: i32) -> Result<i32> {
    ...
    {let _arr = invmap.clone(); let _idx = orphan.clone(); let _val = index.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn getOrder(mut comp: Arc<metamodelica::List<i32>>, mut inorder: (Arc<metamodelica::List<i32>>, Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>)) -> (Arc<metamodelica::List<i32>>, Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>) {
    let mut outorder: (Arc<metamodelica::List<i32>>, Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>) = (metamodelica::nil(), metamodelica::nil());
    outorder = (::match_deref::match_deref! { match &((comp.clone(), inorder.clone())) {
        ...
        (_, (order, links)) => {
            (order.clone(), metamodelica::cons(comp.clone(), links.clone()))
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
    outorder
...
fn getOrphansOrderEdvanced3(mut roots: Arc<metamodelica::List<i32>>, mut otherorphans: Arc<metamodelica::List<i32>>, mut constraints: Arc<metamodelica::List<i32>>, mut vorphans: Arc<metamodelica::List<i32>>, mut vorphansarray: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut rowmarks: metamodelica::Array<i32>) -> Result<(Arc<metamodelica::List<i32>>, i32)> {
    ...
    let mut invmap: metamodelica::Array<i32> = Default::default();
    let mut m: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
    let mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
...
fn reduceOrphancMatrix(mut comps: Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(comps.clone()) {
        Deref @ metamodelica::List::Nil => {
            ()
        },
...
fn reduceOrphancMatrix1(mut comps: Arc<metamodelica::List<i32>>, mut comps1: Arc<metamodelica::List<i32>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(comps.clone()) {
        ...
        Deref @ metamodelica::List::Cons { head: c, tail: rest } => {
            ...
            {let _arr = m.clone(); let _idx = c.clone(); let _val = lst.clone().reverse(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: (ca, ea), tail: resta }, Deref @ metamodelica::List::Cons { head: (cb, eb), tail: restb }) => {
                    ...
                    (elst, vars, eqns, tpl) = addRows(resta.clone(), restb.clone(), col.clone(), vars.clone(), eqns.clone(), tpl.clone(), metamodelica::cons((ca.clone(), e.clone()), inElst.clone()))?;
                    Ok((elst.clone(), vars.clone(), eqns.clone(), tpl.clone()))
                }
                _ => bail!("nomatch"),
            }}
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: (ca, _), tail: _ }, Deref @ metamodelica::List::Cons { head: (cb, eb), tail: restb }) => {
                    ...
                    let mut tpl: (i32, i32) = (0, 0);
                    let true = (intGt(ca.clone(), cb.clone())) else { bail!("pattern mismatch") };
                    (elst, vars, eqns, tpl) = addRows(inA.clone(), restb.clone(), col.clone(), inVars.clone(), inEqns.clone(), inTpl.clone(), metamodelica::cons((cb.clone(), eb.clone()), inElst.clone()))?;
                    Ok((elst.clone(), vars.clone(), eqns.clone(), tpl.clone()))
                }
                _ => bail!("nomatch"),
            }}
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: (ca, ea), tail: resta }, Deref @ metamodelica::List::Cons { head: (cb, _), tail: _ }) => {
                    ...
                    let mut tpl: (i32, i32) = (0, 0);
                    let true = (intLt(ca.clone(), cb.clone())) else { bail!("pattern mismatch") };
                    (elst, vars, eqns, tpl) = addRows(resta.clone(), inB.clone(), col.clone(), inVars.clone(), inEqns.clone(), inTpl.clone(), metamodelica::cons((ca.clone(), ea.clone()), inElst.clone()))?;
                    Ok((elst.clone(), vars.clone(), eqns.clone(), tpl.clone()))
                }
                _ => bail!("nomatch"),
            }}
...
fn mulRow(mut inTpl: (i32, Arc<DAE::Exp>), mut e1: Arc<DAE::Exp>) -> Result<(i32, Arc<DAE::Exp>)> {
    let mut outTpl: (i32, Arc<DAE::Exp>) = (0, Arc::new(<DAE::Exp as ::std::default::Default>::default()));
    let mut e: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
    let mut c: i32 = 0;
    (c, e) = inTpl.clone();
...
fn removeFromCol(mut i: i32, mut inTpl: Arc<metamodelica::List<(i32, Arc<DAE::Exp>)>>, mut inAcc: Arc<metamodelica::List<(i32, Arc<DAE::Exp>)>>) -> Arc<metamodelica::List<(i32, Arc<DAE::Exp>)>> {
    ...
    outAcc = (::match_deref::match_deref! { match &(inTpl.clone()) {
        ...
        Deref @ metamodelica::List::Cons { head: (c, _), tail: rest } if (intEq(i.clone(), c.clone())) => {
            listAppend(inAcc.clone().reverse(), rest.clone())
        },
        Deref @ metamodelica::List::Cons { head: (c, e), tail: rest } => {
            removeFromCol(i.clone(), rest.clone(), metamodelica::cons((c.clone(), e.clone()), inAcc.clone()))
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
    outAcc
...
fn gaussElimination1(mut col: i32, mut row: i32, mut size: i32, mut ce: Arc<DAE::Exp>, mut matrix: metamodelica::Array<Arc<metamodelica::List<(i32, Arc<DAE::Exp>)>>>, mut inVars: BackendDAE::Variables, mut inEqns: Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, mut inTpl: (i32, i32)) -> Result<(BackendDAE::Variables, Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, (i32, i32))> {
    ...
    (outVars, outEqns, outTpl) = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ...
            {let _arr = matrix.clone(); let _idx = row.clone(); let _val = elst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn transformJacToAdjacencyMatrix2(mut jac: Arc<metamodelica::List<(i32, i32, Arc<BackendDAE::Equation>)>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mapIncRowEqn: metamodelica::Array<i32>, mut eqns: Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<i32>, mut func: Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<bool> + 'static>) -> Result<()> {
    ...
    let () = (::match_deref::match_deref! { match &(jac.clone()) {
        ...
        Deref @ metamodelica::List::Cons { head: (r, c, Deref @ BackendDAE::Equation::RESIDUAL_EQUATION { exp: e, .. }), tail: rest } => {
            ...
            {let _arr = m.clone(); let _idx = r.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn transformJacToAdjacencyMatrix(mut jac: Arc<metamodelica::List<(i32, i32, Arc<BackendDAE::Equation>)>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mT: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut func: Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>) -> Result<bool> + 'static>) -> Result<()> {
    ...
    let () = (::match_deref::match_deref! { match &(jac.clone()) {
        ...
        Deref @ metamodelica::List::Cons { head: (r, c, Deref @ BackendDAE::Equation::RESIDUAL_EQUATION { exp: e, .. }), tail: rest } => {
            ...
            {let _arr = m.clone(); let _idx = r.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
            {let _arr = mT.clone(); let _idx = c.clone(); let _val = lst1.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn transformJacToMatrix(mut jac: Arc<metamodelica::List<(i32, i32, Arc<BackendDAE::Equation>)>>, mut row: i32, mut col: i32, mut size: i32, mut b: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut matrix: metamodelica::Array<Arc<metamodelica::List<(i32, Arc<DAE::Exp>)>>>) -> Result<()> {
    let () = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                _ => {
                    let mut be: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
                    ...
                    {let _arr = matrix.clone(); let _idx = row.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn getEqnsinOrder(mut indx: i32, mut inTpl: (Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, BackendDAE::Variables, metamodelica::Array<Arc<metamodelica::List<i32>>>, Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, BackendDAE::Variables)) -> Result<(Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, BackendDAE::Variables, metamodelica::Array<Arc<metamodelica::List<i32>>>, Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, BackendDAE::Variables)> {
    let mut outTpl: (Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, BackendDAE::Variables, metamodelica::Array<Arc<metamodelica::List<i32>>>, Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>>, BackendDAE::Variables) = (<Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> as ::std::default::Default>::default(), <BackendDAE::Variables as ::std::default::Default>::default(), Default::default(), <Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> as ::std::default::Default>::default(), <BackendDAE::Variables as ::std::default::Default>::default());
    let mut e: Arc<BackendDAE::Equation> = Arc::new(BackendDAE::Equation::DUMMY_EQUATION);
    let mut eqns: Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> = <Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> as ::std::default::Default>::default();
    let mut eqnssort: Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> = <Arc<ExpandableArray::ExpandableArray<Arc<BackendDAE::Equation>>> as ::std::default::Default>::default();
    let mut ass2: metamodelica::Array<Arc<metamodelica::List<i32>>> = Default::default();
    let mut vlst: Arc<metamodelica::List<BackendDAE::Var>> = metamodelica::nil();
    let mut vars: BackendDAE::Variables = <BackendDAE::Variables as ::std::default::Default>::default();
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ metamodelica::List::Cons { head: cr, tail: rest } => {
                    ...
                    {let _arr = vararray.clone(); let _idx = index.clone(); let _val = Some(v.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                _ => {
                    ...
                    v = __pa0.clone();
                    Ok(sortVarsforOrder2(index.clone() + 1, inVarLst.clone(), vararray.clone(), metamodelica::cons(v.clone(), iAcc.clone()))?)
                }
                _ => bail!("nomatch"),
            }}
        })() { break 'mc __v; }
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ metamodelica::List::Cons { head: v, tail: vlst } => {
                    Ok(sortVarsforOrder2(index.clone() + 1, vlst.clone(), vararray.clone(), metamodelica::cons(v.clone(), iAcc.clone()))?)
                }
                _ => bail!("nomatch"),
            }}
        })() { break 'mc __v; }
...
fn getOrphansPairs1(mut rows: Arc<metamodelica::List<i32>>, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut rowmarks: metamodelica::Array<i32>, mut colummarks: metamodelica::Array<i32>, mut orphan: i32, mut nextQueue: Arc<metamodelica::List<i32>>) -> Result<()> {
    let () = 'mc: {
        let __mc_input = (rows.clone(), nextQueue.clone());
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Nil, Deref @ metamodelica::List::Nil) => {
                    Ok(())
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: r, tail: _ }, _) => {
                    ...
                    {let _arr = ass1.clone(); let _idx = orphan.clone(); let _val = o.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    {let _arr = ass2.clone(); let _idx = o.clone(); let _val = list![orphan.clone()]; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    Ok(())
                }
                _ => bail!("nomatch"),
            }}
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: e, tail: _ }, _) => {
                    ...
                    {let _arr = ass2.clone(); let _idx = o.clone(); let _val = ass2lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    Ok(())
                }
                _ => bail!("nomatch"),
            }}
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ metamodelica::List::Cons { head: vorphan, tail: rest } => {
                    ...
                    {let _arr = vec1.clone(); let _idx = index1.clone(); let _val = vorphans.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    {let _arr = vec2.clone(); let _idx = index1.clone(); let _val = eorphan.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    {let _arr = queuemark.clone(); let _idx = eorphan.clone(); let _val = true; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    mark = mark.clone() + 1;
                    ...
                    {let _arr = m.clone(); let _idx = eorphan.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    ...
                    {let _arr = mT.clone(); let _idx = vorphan.clone(); let _val = lst.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    ...
                    {let _arr = ocolummarks.clone(); let _idx = eorphan.clone(); let _val = -1; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn getBorderElements(mut elements: Arc<metamodelica::List<i32>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut arr: metamodelica::Array<i32>, mut iAcc: Arc<metamodelica::List<i32>>) -> Result<Arc<metamodelica::List<i32>>> {
    ...
    oAcc = (::match_deref::match_deref! { match &(elements.clone()) {
        ...
        Deref @ metamodelica::List::Cons { head: elem, tail: rest } => {
            ...
            {let _arr = m.clone(); let _idx = elem.clone(); let _val = lst1.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn setBoarderElemts(mut elements: Arc<metamodelica::List<i32>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut arr: metamodelica::Array<i32>, mut orphan: i32) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(elements.clone()) {
        Deref @ metamodelica::List::Nil => {
            ()
        },
        Deref @ metamodelica::List::Cons { head: elem, tail: rest } => {
            ...
            {let _arr = m.clone(); let _idx = elem.clone(); let _val = metamodelica::cons(orphan.clone(), lst.clone()); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn setIndexQueue(mut col: i32, mut tpl: (metamodelica::Array<Arc<metamodelica::List<i32>>>, metamodelica::Array<i32>, metamodelica::Array<Arc<metamodelica::List<i32>>>, metamodelica::Array<bool>, metamodelica::Array<i32>, i32), mut itpl: (i32, Arc<metamodelica::List<i32>>, Arc<metamodelica::List<i32>>)) -> Result<(i32, Arc<metamodelica::List<i32>>, Arc<metamodelica::List<i32>>)> {
    let mut otpl: (i32, Arc<metamodelica::List<i32>>, Arc<metamodelica::List<i32>>) = (0, metamodelica::nil(), metamodelica::nil());
    otpl = 'mc: {
        let __mc_input = (tpl.clone(), itpl.clone());
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                ((vec1, vec2, ass2, queuemark, colummark, mark), (index, elst, rlst)) => {
                    ...
                    {let _arr = vec1.clone(); let _idx = index.clone(); let _val = r.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    {let _arr = vec2.clone(); let _idx = index.clone(); let _val = col.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    {let _arr = queuemark.clone(); let _idx = col.clone(); let _val = true; _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    {let _arr = colummark.clone(); let _idx = col.clone(); let _val = mark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    Ok((index.clone() + 1, metamodelica::cons(col.clone(), elst.clone()), listAppend(r.clone(), rlst.clone())))
                }
                _ => bail!("nomatch"),
            }}
        })() { break 'mc __v; }
...
fn getIndexQueque(mut colums: Arc<metamodelica::List<i32>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mT: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mark: i32, mut rowmarks: metamodelica::Array<i32>, mut colummarks: metamodelica::Array<i32>, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut vec2: metamodelica::Array<i32>, mut queuemark: metamodelica::Array<bool>, mut nextqueue: Arc<metamodelica::List<i32>>, mut iqueue: Arc<metamodelica::List<i32>>, mut iqueue1: Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>) -> Result<Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>> {
    ...
    oqueue = (::match_deref::match_deref! { match &((colums.clone(), nextqueue.clone())) {
        ...
        (Deref @ metamodelica::List::Nil, _) => {
            ...
            getIndexQueque(nextqueue.clone(), m.clone(), mT.clone(), mark.clone(), rowmarks.clone(), colummarks.clone(), ass1.clone(), ass2.clone(), vec2.clone(), queuemark.clone(), metamodelica::nil(), metamodelica::nil(), metamodelica::cons(queue.clone(), iqueue1.clone()))?
        },
...
fn doAssign(mut index: i32, mut arr: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut assign: Arc<metamodelica::List<i32>>) -> Result<()> {
    {let _arr = arr.clone(); let _idx = index.clone(); let _val = assign.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
    Ok(())
}

fn doMark(mut index: i32, mut arr: metamodelica::Array<i32>, mut mark: i32) -> Result<()> {
    {let _arr = arr.clone(); let _idx = index.clone(); let _val = mark.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
    Ok(())
}
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ metamodelica::List::Cons { head: r, tail: rest } => {
                    ...
                    getIndexSubGraph(rest.clone(), vorphan.clone(), m.clone(), mT.clone(), mark.clone(), rowmarks.clone(), colummarks.clone(), orowmarks.clone(), ocolummarks.clone(), ass1.clone(), ass2.clone(), false)?;
                    Ok(true)
                }
                _ => bail!("nomatch"),
            }}
...
fn getIndexesForEqnsRest(mut i: i32, mut size: i32, mut id: i32, mut mark: i32, mut colummarks: metamodelica::Array<i32>, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<i32>, mut vec1: metamodelica::Array<i32>, mut vec2: metamodelica::Array<i32>) -> Result<()> {
    let () = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ...
            {let _arr = vec2.clone(); let _idx = id.clone(); let _val = i.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn addCrefandParentsToSet(mut inCref: Arc<DAE::ComponentRef>, mut ihs: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<Arc<DAE::ComponentRef>>>), i32, i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>)), mut oprecr: Option<Arc<DAE::ComponentRef>>) -> Result<(metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<Arc<DAE::ComponentRef>>>), i32, i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>))> {
    ...
    ohs = (::match_deref::match_deref! { match &((inCref.clone(), oprecr.clone())) {
        (cr @ Deref @ DAE::ComponentRef::CREF_IDENT { .. }, None) => {
            ...
            set = List::fold(metamodelica::cons(cr.clone(), crlst.clone()), (std::sync::Arc::new(BaseHashSet::add) as std::sync::Arc<dyn ::std::ops::Fn(_, _) -> Result<_> + 'static>), ihs.clone())?;
            set.clone()
        },
        (cr @ Deref @ DAE::ComponentRef::CREF_IDENT { .. }, Some(precr)) => {
            ...
            let mut set: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<Arc<DAE::ComponentRef>>>), i32, i32, (HashSet::FuncHashCref, HashSet::FuncCrefEqual, HashSet::FuncCrefStr));
            crlst = ComponentReference::expandCref(cr.clone(), true)?;
            crlst = List::map1r(metamodelica::cons(cr.clone(), crlst.clone()), (std::sync::Arc::new(ComponentReference::joinCrefs) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<Arc<DAE::ComponentRef>> + 'static>), precr.clone())?;
...
fn assignLst(mut vlst: Arc<metamodelica::List<i32>>, mut e: i32, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<i32>) -> Result<()> {
    let () = (::match_deref::match_deref! { match &(vlst.clone()) {
        Deref @ metamodelica::List::Nil => {
            ()
        },
        Deref @ metamodelica::List::Cons { head: v, tail: rest } => {
            {let _arr = ass1.clone(); let _idx = v.clone(); let _val = e.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
            {let _arr = ass2.clone(); let _idx = e.clone(); let _val = v.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
...
fn onefreeMatchingBFS(mut queue: Arc<metamodelica::List<i32>>, mut m: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut mt: metamodelica::Array<Arc<metamodelica::List<i32>>>, mut size: i32, mut ass1: metamodelica::Array<i32>, mut ass2: metamodelica::Array<i32>, mut columark: metamodelica::Array<i32>, mut mark: i32, mut nextQeue: Arc<metamodelica::List<i32>>) -> Result<()> {
    let () = (::match_deref::match_deref! { match &((queue.clone(), nextQeue.clone())) {
        (Deref @ metamodelica::List::Nil, Deref @ metamodelica::List::Nil) => {
            ()
        },
        (Deref @ metamodelica::List::Nil, _) => {
...
fn vectorMatching1(mut e1: Arc<DAE::Exp>, mut e2: Arc<DAE::Exp>, mut size: i32, mut vars: BackendDAE::Variables, mut inTpl: (i32, metamodelica::Array<i32>, metamodelica::Array<i32>)) -> Result<(i32, metamodelica::Array<i32>, metamodelica::Array<i32>)> {
    let mut outTpl: (i32, metamodelica::Array<i32>, metamodelica::Array<i32>) = (0, Default::default(), Default::default());
    outTpl = 'mc: {
        let __mc_input = (e1.clone(), e2.clone(), inTpl.clone());
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (_, _, (id, vec1, vec2)) => {
                    ...
                    ::match_deref::match_deref! { match &(Expression::traverseExpTopDown(e2.clone(), (std::sync::Arc::new(expHasCreftraverser) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, ((metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<Arc<DAE::ComponentRef>>>), i32, i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>)), bool)) -> Result<(Arc<DAE::Exp>, bool, ((metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<Arc<DAE::ComponentRef>>>), i32, i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>)), bool))> + 'static>), (set.clone(), false))?) {
                        (_, (_, false)) => (),
                        _ => bail!("pattern mismatch"),
                    } };
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (_, _, (id, vec1, vec2)) => {
                    ...
                    set = addCrefandParentsToSet(crnosubs.clone(), set.clone(), None)?;
                    set = List::fold(crlst.clone(), (std::sync::Arc::new(BaseHashSet::add) as std::sync::Arc<dyn ::std::ops::Fn(_, _) -> Result<_> + 'static>), set.clone())?;
                    ::match_deref::match_deref! { match &(Expression::traverseExpTopDown(e1.clone(), (std::sync::Arc::new(expHasCreftraverser) as std::sync::Arc<dyn ::std::ops::Fn(Arc<DAE::Exp>, ((metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<Arc<DAE::ComponentRef>>>), i32, i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>)), bool)) -> Result<(Arc<DAE::Exp>, bool, ((metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<Arc<DAE::ComponentRef>>>), i32, i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>)), bool))> + 'static>), (set.clone(), false))?) {
                        (_, (_, false)) => (),
                        _ => bail!("pattern mismatch"),
                    } };
                    (_, ilst) = BackendVariable::getVarLst(crlst.clone(), vars.clone());
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ BackendDAE::Equation::EQUATION { exp: Deref @ DAE::Exp::CREF { componentRef: cr1, .. }, scalar: Deref @ DAE::Exp::CREF { componentRef: cr2, .. }, .. }, (id, vec1, vec2)) => {
                    ...
                    vec1 = {let _arr = vec1.clone(); let _idx = i.clone(); let _val = id.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
                    vec2 = {let _arr = vec2.clone(); let _idx = id.clone(); let _val = i.clone(); _arr.borrow_mut()[(_idx-1) as usize] = _val; _arr};
