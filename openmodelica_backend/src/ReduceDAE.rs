        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (eqns, modelInfo @ SimCode::ModelInfo { varInfo: varInfo @ SimCode::VarInfo { .. }, .. }, Deref @ Absyn::FunctionArgs::FUNCTIONARGS { args: Deref @ metamodelica::List::Cons { head: Deref @ Absyn::Exp::CREF { componentRef: _ }, tail: Deref @ metamodelica::List::Cons { head: Deref @ Absyn::Exp::ARRAY { arrayExp: exp_list }, tail: Deref @ metamodelica::List::Nil } }, .. }) => {
                    ...
                    if !({ let __refeq_sl = &(modelInfo.vars.clone()); let __refeq_sr = &(vars_1.clone()); referenceEq(&*(__refeq_sl.stateVars),&*(__refeq_sr.stateVars)) && referenceEq(&*(__refeq_sl.derivativeVars),&*(__refeq_sr.derivativeVars)) && referenceEq(&*(__refeq_sl.algVars),&*(__refeq_sr.algVars)) && referenceEq(&*(__refeq_sl.discreteAlgVars),&*(__refeq_sr.discreteAlgVars)) && referenceEq(&*(__refeq_sl.intAlgVars),&*(__refeq_sr.intAlgVars)) && referenceEq(&*(__refeq_sl.boolAlgVars),&*(__refeq_sr.boolAlgVars)) && referenceEq(&*(__refeq_sl.inputVars),&*(__refeq_sr.inputVars)) && referenceEq(&*(__refeq_sl.outputVars),&*(__refeq_sr.outputVars)) && referenceEq(&*(__refeq_sl.aliasVars),&*(__refeq_sr.aliasVars)) && referenceEq(&*(__refeq_sl.intAliasVars),&*(__refeq_sr.intAliasVars)) && referenceEq(&*(__refeq_sl.boolAliasVars),&*(__refeq_sr.boolAliasVars)) && referenceEq(&*(__refeq_sl.paramVars),&*(__refeq_sr.paramVars)) && referenceEq(&*(__refeq_sl.intParamVars),&*(__refeq_sr.intParamVars)) && referenceEq(&*(__refeq_sl.boolParamVars),&*(__refeq_sr.boolParamVars)) && referenceEq(&*(__refeq_sl.stringAlgVars),&*(__refeq_sr.stringAlgVars)) && referenceEq(&*(__refeq_sl.stringParamVars),&*(__refeq_sr.stringParamVars)) && referenceEq(&*(__refeq_sl.stringAliasVars),&*(__refeq_sr.stringAliasVars)) && referenceEq(&*(__refeq_sl.extObjVars),&*(__refeq_sr.extObjVars)) && referenceEq(&*(__refeq_sl.constVars),&*(__refeq_sr.constVars)) && referenceEq(&*(__refeq_sl.intConstVars),&*(__refeq_sr.intConstVars)) && referenceEq(&*(__refeq_sl.boolConstVars),&*(__refeq_sr.boolConstVars)) && referenceEq(&*(__refeq_sl.stringConstVars),&*(__refeq_sr.stringConstVars)) && referenceEq(&*(__refeq_sl.jacobianVars),&*(__refeq_sr.jacobianVars)) && referenceEq(&*(__refeq_sl.seedVars),&*(__refeq_sr.seedVars)) && referenceEq(&*(__refeq_sl.realOptimizeConstraintsVars),&*(__refeq_sr.realOptimizeConstraintsVars)) && referenceEq(&*(__refeq_sl.realOptimizeFinalConstraintsVars),&*(__refeq_sr.realOptimizeFinalConstraintsVars)) && referenceEq(&*(__refeq_sl.sensitivityVars),&*(__refeq_sr.sensitivityVars)) && referenceEq(&*(__refeq_sl.dataReconSetcVars),&*(__refeq_sr.dataReconSetcVars)) && referenceEq(&*(__refeq_sl.dataReconinputVars),&*(__refeq_sr.dataReconinputVars)) && referenceEq(&*(__refeq_sl.dataReconSetBVars),&*(__refeq_sr.dataReconSetBVars)) }) {
