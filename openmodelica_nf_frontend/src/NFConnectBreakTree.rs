...
pub mod EntryTree {
    ...
    pub(crate) fn keyStr(mut inKey: Key) -> Result<ArcStr> {
        ...
        outString = (Dump::printComponentRefStr(inKey)?).clone();
        Ok(outString)
    }
    ...
    pub(crate) fn add(mut inTree: Arc<Tree>, mut inKey: Key, mut inValue: Value, mut conflictFunc: Arc<dyn ::std::ops::Fn(Mutable::Mutable<Entry>, Mutable::Mutable<Entry>, Arc<Absyn::ComponentRef>) -> Result<Mutable::Mutable<Entry>> + 'static>) -> Result<Arc<Tree>> {
        ...
        Deref @ Tree::LEAF { .. } => {
            ...
            if key_comp == -1 {
                outTree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: Arc::new(Tree::LEAF { key: inKey, value: inValue }), right: crate::NFConnectBreakTree::EntryTree::Tree::interned_EMPTY() });
            } else if key_comp == 1 {
                outTree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: crate::NFConnectBreakTree::EntryTree::Tree::interned_EMPTY(), right: Arc::new(Tree::LEAF { key: inKey, value: inValue }) });
            } else {
    ...
    pub(crate) fn addList(mut tree: Arc<Tree>, mut inValues: Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>)>>, mut conflictFunc: Arc<dyn ::std::ops::Fn(Mutable::Mutable<Entry>, Mutable::Mutable<Entry>, Arc<Absyn::ComponentRef>) -> Result<Mutable::Mutable<Entry>> + 'static>) -> Result<Arc<Tree>> {
    ...
    pub(crate) fn addUpdate(mut tree: Arc<Tree>, mut key: Key, mut r#fn: Arc<dyn ::std::ops::Fn(Option<Mutable::Mutable<Entry>>) -> Result<Mutable::Mutable<Entry>> + 'static>) -> Result<Arc<Tree>> {
        ...
        Deref @ Tree::LEAF { .. } => {
            ...
            if key_comp == -1 {
                new_tree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: Arc::new(Tree::LEAF { key: key, value: r#fn(None)? }), right: crate::NFConnectBreakTree::EntryTree::Tree::interned_EMPTY() });
            } else if key_comp == 1 {
                new_tree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: crate::NFConnectBreakTree::EntryTree::Tree::interned_EMPTY(), right: Arc::new(Tree::LEAF { key: key, value: r#fn(None)? }) });
            } else {
    ...
    pub(crate) fn fold<FT: Clone + 'static + metamodelica::gc::MMTrace>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>, FT) -> Result<FT> + 'static>, mut inStartValue: FT) -> Result<FT> {
    ...
    pub(crate) fn foldCond<FT: Clone + 'static + metamodelica::gc::MMTrace>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>, FT) -> Result<(FT, bool)> + 'static>, mut value: FT) -> Result<FT> {
    ...
    pub(crate) fn fold_2<FT1: Clone + 'static + metamodelica::gc::MMTrace, FT2: Clone + 'static + metamodelica::gc::MMTrace>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>, FT1, FT2) -> Result<(FT1, FT2)> + 'static>, mut foldArg1: FT1, mut foldArg2: FT2) -> Result<(FT1, FT2)> {
    ...
    pub(crate) fn forEach(mut tree: Arc<Tree>, mut func: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>) -> Result<()> + 'static>) -> Result<()> {
    ...
    pub(crate) fn fromList(mut inValues: Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>)>>, mut conflictFunc: Arc<dyn ::std::ops::Fn(Mutable::Mutable<Entry>, Mutable::Mutable<Entry>, Arc<Absyn::ComponentRef>) -> Result<Mutable::Mutable<Entry>> + 'static>) -> Result<Arc<Tree>> {
    ...
    pub(crate) fn getOpt(mut tree: Arc<Tree>, mut key: Key) -> Result<Option<Mutable::Mutable<Entry>>> {
        '__tco: loop {
            let mut k: Key;
            k = (::match_deref::match_deref! { match &(tree.clone()) {
        Deref @ Tree::NODE { .. } => var_field!((*tree).key, Tree::NODE).clone(),
    ...
    pub(crate) fn join(mut tree: Arc<Tree>, mut treeToJoin: Arc<Tree>, mut conflictFunc: Arc<dyn ::std::ops::Fn(Mutable::Mutable<Entry>, Mutable::Mutable<Entry>, Arc<Absyn::ComponentRef>) -> Result<Mutable::Mutable<Entry>> + 'static>) -> Result<Arc<Tree>> {
        let mut tree: Arc<Tree> = tree;
    ...
    pub(crate) fn listKeys(mut tree: Arc<Tree>, mut lst: Arc<metamodelica::List<Arc<Absyn::ComponentRef>>>) -> Arc<metamodelica::List<Arc<Absyn::ComponentRef>>> {
    ...
    pub(crate) fn listKeysReverse(mut inTree: Arc<Tree>, mut lst: Arc<metamodelica::List<Arc<Absyn::ComponentRef>>>) -> Arc<metamodelica::List<Arc<Absyn::ComponentRef>>> {
        let mut lst: Arc<metamodelica::List<Arc<Absyn::ComponentRef>>> = lst;
    ...
    pub(crate) fn listValues(mut tree: Arc<Tree>, mut lst: Arc<metamodelica::List<Mutable::Mutable<Entry>>>) -> Arc<metamodelica::List<Mutable::Mutable<Entry>>> {
    ...
    pub(crate) fn map(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>) -> Result<Mutable::Mutable<Entry>> + 'static>) -> Result<Arc<Tree>> {
    ...
    pub(crate) fn mapFold<FT: Clone + 'static + metamodelica::gc::MMTrace>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>, FT) -> Result<(Mutable::Mutable<Entry>, FT)> + 'static>, mut inStartValue: FT) -> Result<(Arc<Tree>, FT)> {
    ...
    fn rotateLeft(mut inNode: Arc<Tree>) -> Result<Arc<Tree>> {
        ...
        Deref @ Tree::NODE { right: child @ Deref @ Tree::LEAF { .. }, .. } => {
            ...
            setTreeLeftRight(child.clone(), node, crate::NFConnectBreakTree::EntryTree::Tree::interned_EMPTY())?
        },
        _ => {
            inNode
        },
    ...
    fn rotateRight(mut inNode: Arc<Tree>) -> Result<Arc<Tree>> {
        ...
        Deref @ Tree::NODE { left: child @ Deref @ Tree::LEAF { .. }, .. } => {
            ...
            setTreeLeftRight(child.clone(), crate::NFConnectBreakTree::EntryTree::Tree::interned_EMPTY(), node)?
        },
        _ => {
            inNode
        },
    ...
    pub(crate) fn toList(mut inTree: Arc<Tree>, mut lst: Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>)>>) -> Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Mutable::Mutable<Entry>)>> {
...
pub(crate) fn appendBreaksInNode(mut node: Arc<InstNode::InstNode>, mut tree: Arc<Tree>) -> Result<(Arc<Tree>, Arc<metamodelica::List<Mutable::Mutable<Entry>>>)> {
    fn add_entry(mut name: Arc<Absyn::ComponentRef>, mut entry: Mutable::Mutable<Entry>, mut oldTree: Option<Arc<EntryTree::Tree>>) -> Result<Arc<EntryTree::Tree>> {
        let mut outTree: Arc<EntryTree::Tree>;
        if isSome(oldTree.clone()) {
            let __pa0 = ::match_deref::match_deref! { match &(oldTree) {
    ...
    let () = (::match_deref::match_deref! { match &(InstNode::extendsDefinition(node.clone())?) {
        ...
        Deref @ SCode::SubMod { r#mod: __esc_break_mod @ Deref @ SCode::Mod::BREAK_CONNECT { .. }, .. } => {
            break_mod = (*__esc_break_mod).clone();
...
pub(crate) fn isConnectBroken(mut lhs: Arc<Absyn::ComponentRef>, mut rhs: Arc<Absyn::ComponentRef>, mut scope: Arc<InstNode::InstNode>, mut connectBreaks: Arc<Tree>) -> Result<bool> {
    ...
    let mut opt_entry_tree: Option<Arc<EntryTree::Tree>>;
    let mut opt_entry_ptr: Option<Mutable::Mutable<Entry>>;
    ...
    if isSome(opt_entry_tree.clone()) {
        ...
        if isSome(opt_entry_ptr.clone()) && !(is_broken(lhs.clone(), scope.clone())) && !(is_broken(rhs.clone(), scope)) {
...
pub(crate) fn checkUnmatchedBreaks(mut entries: Arc<metamodelica::List<Mutable::Mutable<Entry>>>) -> Result<()> {
    let mut entry: Entry;
    let mut lhs: Arc<Absyn::ComponentRef>;
    let mut rhs: Arc<Absyn::ComponentRef>;
    ...
    for mut e in &*entries {
        ...
        if !(entry.hasMatch.clone()) {
            let (__pa0, __pa1, __pa2) = ::match_deref::match_deref! { match &(entry.r#mod.clone()) {
                Deref @ SCode::Mod::BREAK_CONNECT { lhs: __pa0, rhs: __pa1, info: __pa2 } => (__pa0.clone(), __pa1.clone(), __pa2.clone()),
                _ => bail!("pattern mismatch"),
            } };
            lhs = __pa0.clone();
            rhs = __pa1.clone();
...
pub(crate) fn add(mut inTree: Arc<Tree>, mut inKey: Key, mut inValue: Value, mut conflictFunc: Arc<dyn ::std::ops::Fn(Arc<EntryTree::Tree>, Arc<EntryTree::Tree>, Arc<Absyn::ComponentRef>) -> Result<Arc<EntryTree::Tree>> + 'static>) -> Result<Arc<Tree>> {
    let mut tree: Arc<Tree> = inTree.clone();
    tree = (::match_deref::match_deref! { match &(tree.clone()) {
        Deref @ Tree::EMPTY { .. } => {
            Arc::new(Tree::LEAF { key: inKey, value: inValue })
        ...
        Deref @ Tree::LEAF { .. } => {
            ...
            key_comp = keyCompare(inKey.clone(), var_field!((*tree).key, Tree::LEAF).clone())?;
            if key_comp == -1 {
                outTree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: Arc::new(Tree::LEAF { key: inKey, value: inValue }), right: crate::NFConnectBreakTree::Tree::interned_EMPTY() });
            } else if key_comp == 1 {
                outTree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: crate::NFConnectBreakTree::Tree::interned_EMPTY(), right: Arc::new(Tree::LEAF { key: inKey, value: inValue }) });
            } else {
                value = conflictFunc(inValue, var_field!((*tree).value, Tree::LEAF).clone(), var_field!((*tree).key, Tree::LEAF).clone())?;
...
pub(crate) fn addList(mut tree: Arc<Tree>, mut inValues: Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>)>>, mut conflictFunc: Arc<dyn ::std::ops::Fn(Arc<EntryTree::Tree>, Arc<EntryTree::Tree>, Arc<Absyn::ComponentRef>) -> Result<Arc<EntryTree::Tree>> + 'static>) -> Result<Arc<Tree>> {
    let mut tree: Arc<Tree> = tree;
    let mut key: Key;
    let mut value: Value;
    for mut t in &*inValues {
...
pub(crate) fn addUpdate(mut tree: Arc<Tree>, mut key: Key, mut r#fn: Arc<dyn ::std::ops::Fn(Option<Arc<EntryTree::Tree>>) -> Result<Arc<EntryTree::Tree>> + 'static>) -> Result<Arc<Tree>> {
    ...
    tree = (::match_deref::match_deref! { match &(tree.clone()) {
        ...
        Deref @ Tree::LEAF { .. } => {
            key_comp = keyCompare(key.clone(), var_field!((*tree).key, Tree::LEAF).clone())?;
            if key_comp == -1 {
                new_tree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: Arc::new(Tree::LEAF { key: key, value: r#fn(None)? }), right: crate::NFConnectBreakTree::Tree::interned_EMPTY() });
            } else if key_comp == 1 {
                new_tree = Arc::new(Tree::NODE { key: var_field!((*tree).key, Tree::LEAF).clone(), value: var_field!((*tree).value, Tree::LEAF).clone(), height: 2, left: crate::NFConnectBreakTree::Tree::interned_EMPTY(), right: Arc::new(Tree::LEAF { key: key, value: r#fn(None)? }) });
            } else {
                assign_variant_field!(tree => Tree::LEAF; value = r#fn(Some(var_field!((*tree).value, Tree::LEAF).clone()))?);
                new_tree = tree;
            }
...
pub(crate) fn fold<FT: Clone + 'static + metamodelica::gc::MMTrace>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>, FT) -> Result<FT> + 'static>, mut inStartValue: FT) -> Result<FT> {
    pub type FoldFunc<FT: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT) -> Result<FT> + 'static>;
...
pub(crate) fn foldCond<FT: Clone + 'static + metamodelica::gc::MMTrace>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>, FT) -> Result<(FT, bool)> + 'static>, mut value: FT) -> Result<FT> {
    pub type FoldFunc<FT: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT) -> Result<(FT, bool)> + 'static>;
...
pub(crate) fn fold_2<FT1: Clone + 'static + metamodelica::gc::MMTrace, FT2: Clone + 'static + metamodelica::gc::MMTrace>(mut tree: Arc<Tree>, mut foldFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>, FT1, FT2) -> Result<(FT1, FT2)> + 'static>, mut foldArg1: FT1, mut foldArg2: FT2) -> Result<(FT1, FT2)> {
    pub type FoldFunc<FT1: Clone + 'static, FT2: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT1, FT2) -> Result<(FT1, FT2)> + 'static>;
...
pub(crate) fn forEach(mut tree: Arc<Tree>, mut func: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>) -> Result<()> + 'static>) -> Result<()> {
    pub type EachFunc = std::sync::Arc<dyn ::std::ops::Fn(Key, Value) -> Result<()> + 'static>;
...
pub(crate) fn fromList(mut inValues: Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>)>>, mut conflictFunc: Arc<dyn ::std::ops::Fn(Arc<EntryTree::Tree>, Arc<EntryTree::Tree>, Arc<Absyn::ComponentRef>) -> Result<Arc<EntryTree::Tree>> + 'static>) -> Result<Arc<Tree>> {
...
pub(crate) fn getOpt(mut tree: Arc<Tree>, mut key: Key) -> Result<Option<Arc<EntryTree::Tree>>> {
    '__tco: loop {
        let mut k: Key;
        k = (::match_deref::match_deref! { match &(tree.clone()) {
        Deref @ Tree::NODE { .. } => var_field!((*tree).key, Tree::NODE).clone(),
...
pub(crate) fn join(mut tree: Arc<Tree>, mut treeToJoin: Arc<Tree>, mut conflictFunc: Arc<dyn ::std::ops::Fn(Arc<EntryTree::Tree>, Arc<EntryTree::Tree>, Arc<Absyn::ComponentRef>) -> Result<Arc<EntryTree::Tree>> + 'static>) -> Result<Arc<Tree>> {
    let mut tree: Arc<Tree> = tree;
    tree = (::match_deref::match_deref! { match &(treeToJoin.clone()) {
        Deref @ Tree::EMPTY { .. } => tree,
        Deref @ Tree::NODE { .. } => {
...
pub(crate) fn listValues(mut tree: Arc<Tree>, mut lst: Arc<metamodelica::List<Arc<EntryTree::Tree>>>) -> Arc<metamodelica::List<Arc<EntryTree::Tree>>> {
...
pub(crate) fn map(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>) -> Result<Arc<EntryTree::Tree>> + 'static>) -> Result<Arc<Tree>> {
    pub type MapFunc = std::sync::Arc<dyn ::std::ops::Fn(Key, Value) -> Result<Value> + 'static>;
...
pub(crate) fn mapFold<FT: Clone + 'static + metamodelica::gc::MMTrace>(mut inTree: Arc<Tree>, mut inFunc: Arc<dyn ::std::ops::Fn(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>, FT) -> Result<(Arc<EntryTree::Tree>, FT)> + 'static>, mut inStartValue: FT) -> Result<(Arc<Tree>, FT)> {
    pub type MapFunc<FT: Clone + 'static> = std::sync::Arc<dyn ::std::ops::Fn(Key, Value, FT) -> Result<Value> + 'static>;
...
fn rotateLeft(mut inNode: Arc<Tree>) -> Result<Arc<Tree>> {
    ...
    outNode = (::match_deref::match_deref! { match &(outNode.clone()) {
        ...
        Deref @ Tree::NODE { right: child @ Deref @ Tree::LEAF { .. }, .. } => {
            ...
            setTreeLeftRight(child.clone(), node, crate::NFConnectBreakTree::Tree::interned_EMPTY())?
        },
        _ => {
            inNode
        },
...
fn rotateRight(mut inNode: Arc<Tree>) -> Result<Arc<Tree>> {
    ...
    outNode = (::match_deref::match_deref! { match &(outNode.clone()) {
        ...
        Deref @ Tree::NODE { left: child @ Deref @ Tree::LEAF { .. }, .. } => {
            ...
            setTreeLeftRight(child.clone(), crate::NFConnectBreakTree::Tree::interned_EMPTY(), node)?
        },
        _ => {
            inNode
        },
...
pub(crate) fn toList(mut inTree: Arc<Tree>, mut lst: Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>)>>) -> Arc<metamodelica::List<(Arc<Absyn::ComponentRef>, Arc<EntryTree::Tree>)>> {
