...
pub(crate) fn multiIntervalFromDimensions(mut dims: Arc<metamodelica::List<Arc<Dimension::NFDimension>>>, mut vCount: Arc<Vector::Vector<i32>>) -> Result<Arc<SBMultiInterval::SBMultiInterval>> {
...
pub(crate) fn multiIntervalFromSubscripts(mut subs: Arc<metamodelica::List<Arc<Subscript::NFSubscript>>>, mut vCount: Arc<Vector::Vector<i32>>, mut multiInt: Arc<SBMultiInterval::SBMultiInterval>) -> Result<Arc<SBMultiInterval::SBMultiInterval>> {
...
pub(crate) fn evalCrefs(mut e: Arc<Expression::NFExpression>) -> Result<Arc<Expression::NFExpression>> {
...
pub(crate) fn intervalFromExp(mut e: Arc<Expression::NFExpression>) -> Result<Arc<SBInterval::SBInterval>> {
...
pub(crate) fn intervalFromBinaryExp(mut lhs: Arc<Expression::NFExpression>, mut op: Arc<Operator::NFOperator>, mut rhs: Arc<Expression::NFExpression>) -> Result<Arc<SBInterval::SBInterval>> {
...
pub(crate) fn intervalFromRange(mut e: Arc<Expression::NFExpression>) -> Result<Arc<SBInterval::SBInterval>> {
    let mut i: Arc<SBInterval::SBInterval>;
    let mut start: Arc<Expression::NFExpression>;
    let mut stop: Arc<Expression::NFExpression>;
    let mut ostep: Option<Arc<Expression::NFExpression>>;
    let mut lo: i32;
    let mut step: i32;
    let mut hi: i32;
...
pub(crate) fn linearMapFromIntervals(mut d1: i32, mut d2: i32, mut mi1: Arc<SBMultiInterval::SBMultiInterval>, mut mi2: Arc<SBMultiInterval::SBMultiInterval>, mut eCount: Arc<Vector::Vector<i32>>) -> Result<(ArcStr, Arc<SBPWLinearMap::SBPWLinearMap>, Arc<SBPWLinearMap::SBPWLinearMap>)> {
    let mut name: ArcStr;
