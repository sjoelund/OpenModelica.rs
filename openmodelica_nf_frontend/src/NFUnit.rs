...
// Type: Arc<ComponentRef::NFComponentRef>
// Expr: Constructor { name: 'NFComponentRef.CREF', args: [Constructor { name: 'NFInstNode.InstNode.NAME_NODE', args: [Lit(Str('jhagemann'))], named_args: [], ty: RustStruct('NFInstNode.InstNode.NAME_NODE'), field_names: ['name'] }, Array { elems: [], ty: List(Unknown) }, Constructor { name: 'NFType.UNKNOWN', args: [], named_args: [], ty: RustUnitVariant, field_names: [] }, Var { name: 'NFComponentRef.Origin.CREF', segments: [CrefSegment { name: 'NFComponentRef', subscripts: [] }, CrefSegment { name: 'Origin', subscripts: [] }, CrefSegment { name: 'CREF', subscripts: [] }], ty: Enumeration('NFComponentRef.Origin') }, Constructor { name: 'NFComponentRef.EMPTY', args: [], named_args: [], ty: RustUnitVariant, field_names: [] }], named_args: [], ty: RustStruct('NFComponentRef.CREF'), field_names: ['node', 'subscripts', 'ty', 'origin', 'restCref'] }
pub fn UPDATECREF() -> Arc<ComponentRef::NFComponentRef> { todo!("non-Sync, non-const-emittable constant UPDATECREF — extend codegen") }

/* from https://www.bipm.org/documents/d/guest/si-brochure-9-en-pdf */
// TODO: non-Sync, non-const-emittable constant — needs new emission path.
// Type: Arc<metamodelica::List<(ArcStr, Unit)>>
// Expr: Array { elems: [Tuple([Lit(Str('1')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('s')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('m')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('g')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('A')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('K')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('mol')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('cd')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('rad')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('Hz')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('N')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-2)), Lit(Int(1)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('Pa')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-2)), Lit(Int(-1)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('J')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-2)), Lit(Int(2)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('W')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-3)), Lit(Int(2)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('C')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('V')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-3)), Lit(Int(2)), Lit(Int(1)), Lit(Int(-1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('F')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(4)), Lit(Int(-2)), Lit(Int(-1)), Lit(Int(2)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e-3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('Ohm')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-3)), Lit(Int(2)), Lit(Int(1)), Lit(Int(-2)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('S')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(3)), Lit(Int(-2)), Lit(Int(-1)), Lit(Int(2)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e-3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('Wb')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-2)), Lit(Int(2)), Lit(Int(1)), Lit(Int(-1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('T')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-2)), Lit(Int(0)), Lit(Int(1)), Lit(Int(-1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('H')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-2)), Lit(Int(2)), Lit(Int(1)), Lit(Int(-2)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('degC')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('kat')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Int(0)), Lit(Real('1e0'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('min')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(60))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('h')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(3600))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('d')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(86400))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('l')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(3)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e-3'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('bar')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(-2)), Lit(Int(-1)), Lit(Int(1)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Real('1e8'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }]), Tuple([Lit(Str('degF')), Constructor { name: 'NFUnit.Unit.UNIT', args: [Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(0)), Lit(Int(1)), Lit(Real('0.5555555555555556'))], named_args: [], ty: RustStruct('NFUnit.Unit.UNIT'), field_names: ['s', 'm', 'g', 'A', 'K', 'mol', 'cd', 'factor'] }])], ty: List(Tuple([Str, RustStruct('NFUnit.Unit.UNIT')])) }
pub fn LU_COMPLEXUNITS() -> Arc<metamodelica::List<(ArcStr, Unit)>> { todo!("non-Sync, non-const-emittable constant LU_COMPLEXUNITS — extend codegen") }

pub fn getKnownUnits() -> Result<StringToUnitTable> {
    let mut outKnownUnits: StringToUnitTable;
    let mut s: ArcStr = arcstr::literal!("");
    let mut ut: Unit;
    outKnownUnits = UnorderedMap::new(fnptr!(stringHashDjb2, ArcStr), fnptr!(stringEq, ArcStr, ArcStr), Util::nextPrime((LU_COMPLEXUNITS().clone().len() as i32)));
...
pub fn getKnownUnitsInverse() -> Result<UnitToStringTable> {
    ...
    let mut s: ArcStr = arcstr::literal!("");
    let mut ut: Unit;
    outKnownUnitsInverse = UnorderedMap::new(fnptr!(hash, Unit), fnptr!(isEqual, Unit, Unit), Util::nextPrime((LU_COMPLEXUNITS().clone().len() as i32)));
    for mut unit in &*LU_COMPLEXUNITS().clone() {
        let mut unit = unit.clone();
        (s, ut) = unit.clone();
...
pub fn newCrefUnitTable(mut size: i32) -> CrefToUnitTable {
    ...
    table = UnorderedMap::new(fnptr!(ComponentRef::hash, Arc<ComponentRef::NFComponentRef>), ComponentRef::isEqual, size.clone());
    table
}
...
pub fn unit2string(mut unit: Unit) -> Result<ArcStr> {
    ...
    outString = ((match unit.clone() {
        ...
        Unit::MASTER { .. } => {
            List::toString(var_field!(unit.varList, Unit::MASTER).clone(), Arc::new(ComponentRef::toString), (literal!("MASTER")).clone(), (literal!("(")).clone(), (literal!(", ")).clone(), (literal!(")")).clone(), true, 0)?
        },
        Unit::UNKNOWN { .. } => {
...
pub fn unitString(mut inUnit: Unit, mut inHtU2S: UnitToStringTable) -> Result<ArcStr> {
    ...
    if isSome(opt_s.clone()) {
        let Some(__pa0) = (opt_s.clone()) else { bail!("pattern mismatch") };
...
fn parser3(mut inMul: Arc<metamodelica::List<bool>>, mut inTokenList: Arc<metamodelica::List<Token>>, mut inUnit: Unit, mut inHtS2U: StringToUnitTable) -> Result<Unit> {
    let mut outUnit: Unit;
    outUnit = 'mc: {
        let __mc_input = (inMul.clone(), inTokenList.clone(), inUnit.clone(), inHtS2U.clone());
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: true, tail: Deref @ metamodelica::List::Nil }, Deref @ metamodelica::List::Nil, _, _) => {
                    Ok(inUnit.clone())
                }
                _ => bail!("nomatch"),
            }}
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: bMul, tail: bRest }, Deref @ metamodelica::List::Cons { head: Token::T_NUMBER { number: 1 }, tail: tokens }, _, _) => {
                    let mut ut: Unit;
                    ut = ONE().clone();
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: bMul, tail: bRest }, Deref @ metamodelica::List::Cons { head: Token::T_UNIT { unit: s }, tail: Deref @ metamodelica::List::Cons { head: Token::T_NUMBER { number: exponent }, tail: tokens } }, _, _) => {
                    let mut ut: Unit;
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: bMul, tail: bRest }, Deref @ metamodelica::List::Cons { head: Token::T_UNIT { unit: s }, tail: tokens }, _, _) => {
                    let mut ut: Unit;
                    ut = unitToken2unit((s.clone()).clone(), inHtS2U.clone())?;
                    ut = if (bMul.clone()) {unitMul(inUnit.clone(), ut.clone())?} else {unitDiv(inUnit.clone(), ut.clone())?};
                    ut = parser3(bRest.clone(), tokens.clone(), ut.clone(), inHtS2U.clone())?;
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: bMul, tail: _ }, Deref @ metamodelica::List::Cons { head: Token::T_MUL { .. }, tail: Deref @ metamodelica::List::Cons { head: Token::T_LPAREN { .. }, tail: tokens } }, _, _) => {
                    let mut ut: Unit;
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: bMul, tail: _ }, Deref @ metamodelica::List::Cons { head: Token::T_DIV { .. }, tail: Deref @ metamodelica::List::Cons { head: Token::T_LPAREN { .. }, tail: tokens } }, _, _) => {
                    let mut ut: Unit;
                    let mut b: bool = false;
                    b = !(bMul.clone());
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: _, tail: bRest }, Deref @ metamodelica::List::Cons { head: Token::T_RPAREN { .. }, tail: tokens }, _, _) => {
                    let mut ut: Unit;
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: bMul, tail: _ }, Deref @ metamodelica::List::Cons { head: Token::T_MUL { .. }, tail: tokens }, _, _) => {
                    let mut ut: Unit;
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ metamodelica::List::Cons { head: bMul, tail: _ }, Deref @ metamodelica::List::Cons { head: Token::T_DIV { .. }, tail: tokens }, _, _) => {
                    let mut ut: Unit;
                    let mut b: bool = false;
                    b = !(bMul.clone());
...
fn unitToken2unit(mut inS: ArcStr, mut inHtS2U: StringToUnitTable) -> Result<Unit> {
    ...
    if isSome(opt_unit.clone()) {
        let Some(__pa0) = (opt_unit.clone()) else { bail!("pattern mismatch") };
        outUnit = __pa0.clone();
    } else {
...
fn getPrefix(mut inS: ArcStr, mut inS2: ArcStr) -> Result<(metamodelica::Real, ArcStr)> {
    ...
    (outR, outUnit) = 'mc: {
        let __mc_input = (inS.clone(), inS2.clone());
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                (Deref @ "y", _) => {
