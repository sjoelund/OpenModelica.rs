...
static ERROR_VAL_NOT_IMPL: ErrorTypes::Message = ErrorTypes::Message {
    ...
    ty: ErrorTypes::MessageType::SCRIPTING,
    severity: ErrorTypes::Severity::ERROR,
    message: Gettext::TranslatableContent::gettext { msgid: literal!("val() not implemented for plot format: %s\n") },
};
static ERROR_VAL_NOT_DEFINED_PLT: ErrorTypes::Message = ErrorTypes::Message {
    id: -1,
    ty: ErrorTypes::MessageType::SCRIPTING,
    severity: ErrorTypes::Severity::ERROR,
    message: Gettext::TranslatableContent::gettext { msgid: literal!("%s not defined at time %s\n") },
};
static ERROR_READ_SIZE_FAILED: ErrorTypes::Message = ErrorTypes::Message {
    id: -1,
    ty: ErrorTypes::MessageType::SCRIPTING,
    severity: ErrorTypes::Severity::ERROR,
    message: Gettext::TranslatableContent::gettext { msgid: literal!("Failed to read readSimulationResultSize from file: %s\n") },
};
static ERROR_PLT_VAR_NOT_FOUND: ErrorTypes::Message = ErrorTypes::Message {
    id: -1,
    ty: ErrorTypes::MessageType::SCRIPTING,
    severity: ErrorTypes::Severity::ERROR,
    message: Gettext::TranslatableContent::notrans { r#str: literal!("Variable %s not found in simulation result.") },
};
static ERROR_PLT_INTERVAL_READ: ErrorTypes::Message = ErrorTypes::Message {
    id: -1,
    ty: ErrorTypes::MessageType::SCRIPTING,
    severity: ErrorTypes::Severity::ERROR,
    message: Gettext::TranslatableContent::notrans { r#str: literal!("could not read interval size.") },
};
