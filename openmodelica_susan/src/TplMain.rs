        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ "a" => {
                    ...
                    chars = __pa3.clone();
                    expB = __pa4.clone();
                    tequal = expB.clone() == Arc::new(TplAbsyn::ExpressionBase::STR_TOKEN { value: crate::Tpl::StringToken::interned_ST_NEW_LINE() });
