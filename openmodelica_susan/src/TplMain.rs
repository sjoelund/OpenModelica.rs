...
pub(crate) fn translateFile(mut inFile: ArcStr) -> Result<()> {
    let () = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ...
            metamodelica::print((Print::getErrorString()?).clone());
...
pub(crate) fn testStringEquality(mut inStringReturned: ArcStr, mut inStringShouldBe: ArcStr, mut inPrintResult: bool, mut inPrintErrorBuffer: bool, mut inTestLabel: ArcStr, mut inNotPassedCnt: i32) -> Result<i32> {
    ...
    outNotPassedCnt = 'mc: {
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ...
            metamodelica::print((strRes.clone()).clone());
            strErrBuf = (Print::getErrorString()?).clone();
        ...
        if let Ok(__v) = (|| -> Result<_> {
            ::match_deref::match_deref! { match &__mc_input {
                Deref @ "a" => {
                    ...
                    txt = emptyTxt.clone();
                    txt = TplCodegen::typedIdents(txt.clone(), list![(literal!("Hej"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE()), (literal!("Susan"), Arc::new(TplAbsyn::TypeSignature::LIST_TYPE { ofType: Arc::new(TplAbsyn::TypeSignature::NAMED_TYPE { name: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Pa")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("Li")).clone() }) }) }) }))])?;
                    r#str = (Tpl::textString(txt.clone())?).clone();
                    ...
                    txt = emptyTxt.clone();
                    txt = TplCodegen::typedIdentsEx(txt.clone(), list![(literal!("Hej"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE()), (literal!("Susan"), Arc::new(TplAbsyn::TypeSignature::NAMED_TYPE { name: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Pa")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("Li")).clone() }) }) }))], (literal!("input")).clone(), (literal!("in")).clone())?;
                    r#str = (Tpl::textString(txt.clone())?).clone();
                    ...
                    txt = emptyTxt.clone();
                    txt = TplCodegen::mmPackage(txt.clone(), TplAbsyn::MMPackage { name: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("Susan")).clone() }), mmDeclarations: list![TplAbsyn::MMDeclaration::MM_IMPORT { isPublic: true, packageName: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Pa")).clone(), path: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Li")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("Ko")).clone() }) }) }) }, TplAbsyn::MMDeclaration::MM_STR_TOKEN_DECL { isPublic: true, name: (literal!("strTokConst")).clone(), value: Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("Susan")).clone(), (literal!("is")).clone(), (literal!("beautiful\n")).clone()], lastHasNewLine: true }) }, TplAbsyn::MMDeclaration::MM_LITERAL_DECL { isPublic: false, name: (literal!("c_literalValueConst")).clone(), value: (literal!("123")).clone(), litType: crate::TplAbsyn::TypeSignature::interned_INTEGER_TYPE() }, TplAbsyn::MMDeclaration::MM_FUN { isPublic: true, name: (literal!("MuchFun")).clone(), inArgs: list![(literal!("txt"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE()), (literal!("laughLevel"), crate::TplAbsyn::TypeSignature::interned_INTEGER_TYPE()), (literal!("jokes"), Arc::new(TplAbsyn::TypeSignature::LIST_TYPE { ofType: crate::TplAbsyn::TypeSignature::interned_STRING_TYPE() }))], outArgs: list![(literal!("txt"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE())], locals: list![(literal!("txt"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE()), (literal!("laughLevel"), crate::TplAbsyn::TypeSignature::interned_INTEGER_TYPE()), (literal!("jokes"), Arc::new(TplAbsyn::TypeSignature::LIST_TYPE { ofType: crate::TplAbsyn::TypeSignature::interned_STRING_TYPE() }))], statements: list![Arc::new(TplAbsyn::MMExp::MM_ASSIGN { lhsArgs: list![(literal!("out_txt")).clone()], rhs: Arc::new(TplAbsyn::MMExp::MM_FN_CALL { fnName: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Tpl")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("writeStr")).clone() }) }), args: list![Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("txt")).clone() }) }), Arc::new(TplAbsyn::MMExp::MM_STRING { value: (literal!("Susan")).clone() })] }) }), Arc::new(TplAbsyn::MMExp::MM_ASSIGN { lhsArgs: list![(literal!("out_txt")).clone()], rhs: Arc::new(TplAbsyn::MMExp::MM_FN_CALL { fnName: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Tpl")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("writeTok")).clone() }) }), args: list![Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("out_txt")).clone() }) }), Arc::new(TplAbsyn::MMExp::MM_STR_TOKEN { value: Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("Susan is cosmic!\n")).clone() }) })] }) })], genInfoOpt: crate::TplAbsyn::GenInfo::GI_TEMPL_FUN }, TplAbsyn::MMDeclaration::MM_FUN { isPublic: true, name: (literal!("MoreFun")).clone(), inArgs: list![(literal!("txt"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE()), (literal!("v_laughLevel"), Arc::new(TplAbsyn::TypeSignature::OPTION_TYPE { ofType: crate::TplAbsyn::TypeSignature::interned_STRING_TYPE() })), (literal!("v_jokes"), Arc::new(TplAbsyn::TypeSignature::LIST_TYPE { ofType: crate::TplAbsyn::TypeSignature::interned_STRING_TYPE() }))], outArgs: list![(literal!("txt"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE())], locals: list![(literal!("txt"), crate::TplAbsyn::TypeSignature::interned_TEXT_TYPE())], statements: list![Arc::new(TplAbsyn::MMExp::MM_MATCH { matchCases: list![(list![Arc::new(TplAbsyn::MatchingExp::BIND_MATCH { bindIdent: (literal!("txt")).clone() }), Arc::new(TplAbsyn::MatchingExp::SOME_MATCH { value: Arc::new(TplAbsyn::MatchingExp::BIND_AS_MATCH { bindIdent: (literal!("v_hej")).clone(), matchingExp: Arc::new(TplAbsyn::MatchingExp::STRING_MATCH { value: (literal!("Hej")).clone() }) }) }), Arc::new(TplAbsyn::MatchingExp::BIND_MATCH { bindIdent: (literal!("v_jokes")).clone() })], list![Arc::new(TplAbsyn::MMExp::MM_ASSIGN { lhsArgs: list![(literal!("txt")).clone()], rhs: Arc::new(TplAbsyn::MMExp::MM_FN_CALL { fnName: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Tpl")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("writeStr")).clone() }) }), args: list![Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("txt")).clone() }) }), Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("v_hej")).clone() }) })] }) })]), (list![Arc::new(TplAbsyn::MatchingExp::BIND_MATCH { bindIdent: (literal!("txt")).clone() }), Arc::new(TplAbsyn::MatchingExp::SOME_MATCH { value: Arc::new(TplAbsyn::MatchingExp::BIND_MATCH { bindIdent: (literal!("v_hej")).clone() }) }), crate::TplAbsyn::MatchingExp::interned_REST_MATCH()], list![Arc::new(TplAbsyn::MMExp::MM_ASSIGN { lhsArgs: list![(literal!("txt")).clone()], rhs: Arc::new(TplAbsyn::MMExp::MM_FN_CALL { fnName: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Tpl")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("writeStr")).clone() }) }), args: list![Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("txt")).clone() }) }), Arc::new(TplAbsyn::MMExp::MM_STRING { value: (literal!("Not hej:")).clone() })] }) }), Arc::new(TplAbsyn::MMExp::MM_ASSIGN { lhsArgs: list![(literal!("txt")).clone()], rhs: Arc::new(TplAbsyn::MMExp::MM_FN_CALL { fnName: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Tpl")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("writeStr")).clone() }) }), args: list![Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("txt")).clone() }) }), Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("v_hej")).clone() }) })] }) })]), (list![Arc::new(TplAbsyn::MatchingExp::BIND_MATCH { bindIdent: (literal!("txt")).clone() }), crate::TplAbsyn::MatchingExp::interned_NONE_MATCH(), crate::TplAbsyn::MatchingExp::interned_REST_MATCH()], list![Arc::new(TplAbsyn::MMExp::MM_ASSIGN { lhsArgs: list![(literal!("txt")).clone()], rhs: Arc::new(TplAbsyn::MMExp::MM_FN_CALL { fnName: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Tpl")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("writeStr")).clone() }) }), args: list![Arc::new(TplAbsyn::MMExp::MM_IDENT { ident: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("txt")).clone() }) }), Arc::new(TplAbsyn::MMExp::MM_STRING { value: (literal!("NONE at all")).clone() })] }) })])] })], genInfoOpt: crate::TplAbsyn::GenInfo::GI_TEMPL_FUN }], annotationFooter: (literal!("")).clone() })?;
                    r#str = (Tpl::textString(txt.clone())?).clone();
                    ...
                    chars = stringListStringChar((r#str.clone()).clone());
                    (chars, _, ts) = TplParser::typeSig(chars.clone(), TplParser::makeStartLineInfo(chars.clone(), (literal!("in memory test")).clone())?)?;
                    tequal = ts.clone() == Arc::new(TplAbsyn::TypeSignature::LIST_TYPE { ofType: Arc::new(TplAbsyn::TypeSignature::TUPLE_TYPE { ofTypes: list![Arc::new(TplAbsyn::TypeSignature::NAMED_TYPE { name: Arc::new(TplAbsyn::PathIdent::PATH_IDENT { ident: (literal!("Hej")).clone(), path: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("Susan")).clone() }) }) }), Arc::new(TplAbsyn::TypeSignature::LIST_TYPE { ofType: crate::TplAbsyn::TypeSignature::interned_STRING_TYPE() }), Arc::new(TplAbsyn::TypeSignature::OPTION_TYPE { ofType: crate::TplAbsyn::TypeSignature::interned_INTEGER_TYPE() })] }) });
                    txt = emptyTxt.clone();
                    txt = TplCodegen::typeSig(txt.clone(), ts.clone())?;
                    ident = (Tpl::textString(txt.clone())?).clone();
                    strOut = ({ let mut __mm_s = String::new(); __mm_s.push_str(&*Tpl::booleanString(tequal.clone())); __mm_s.push_str(&*literal!("*")); __mm_s.push_str(&*ident.clone()); __mm_s.push_str(&*literal!("*")); __mm_s.push_str(&*stringCharListString(chars.clone())); ArcStr::from(__mm_s) }).clone();
                    ...
                    chars = stringListStringChar((r#str.clone()).clone());
                    (chars, _, pid, astDefs) = TplParser::interfacePackage(chars.clone(), TplParser::makeStartLineInfo(chars.clone(), (literal!("in memory test")).clone())?, metamodelica::nil())?;
                    tequal = astDefs.clone() == list![TplAbsyn::ASTDef { importPackage: Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("builtin")).clone() }), isDefault: true, types: list![(literal!("stringListStringChar"), TplAbsyn::TypeInfo::TI_FUN_TYPE { inArgs: list![(literal!("inString"), crate::TplAbsyn::TypeSignature::interned_STRING_TYPE())], outArgs: list![(literal!("outStringList"), Arc::new(TplAbsyn::TypeSignature::LIST_TYPE { ofType: crate::TplAbsyn::TypeSignature::interned_STRING_TYPE() }))], tyVars: metamodelica::nil() })] }] && pid.clone() == Arc::new(TplAbsyn::PathIdent::IDENT { ident: (literal!("Susan")).clone() });
                    txt = emptyTxt.clone();
                    txt = TplCodegen::pathIdent(txt.clone(), pid.clone())?;
                    ...
                    chars = __pa3.clone();
                    expB = __pa4.clone();
                    tequal = expB.clone() == Arc::new(TplAbsyn::ExpressionBase::STR_TOKEN { value: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() });
                    ...
                    chars = __pa15.clone();
                    expB = __pa16.clone();
                    tequal = expB.clone() == Arc::new(TplAbsyn::ExpressionBase::LITERAL { value: (literal!("1234567")).clone(), litType: crate::TplAbsyn::TypeSignature::interned_INTEGER_TYPE() });
                    ...
                    chars = __pa21.clone();
                    expB = __pa22.clone();
                    tequal = expB.clone() == Arc::new(TplAbsyn::ExpressionBase::LITERAL { value: (literal!("-1234567.0123e-12")).clone(), litType: crate::TplAbsyn::TypeSignature::interned_REAL_TYPE() });
                    ...
                    chars = __pa24.clone();
                    expB = __pa25.clone();
                    tequal = expB.clone() == Arc::new(TplAbsyn::ExpressionBase::LITERAL { value: (literal!(".0123E12")).clone(), litType: crate::TplAbsyn::TypeSignature::interned_REAL_TYPE() });
                    ...
                    chars = __pa27.clone();
                    expB = __pa28.clone();
                    tequal = expB.clone() == Arc::new(TplAbsyn::ExpressionBase::LITERAL { value: (literal!("true")).clone(), litType: crate::TplAbsyn::TypeSignature::interned_BOOLEAN_TYPE() });
                    ...
                    chars = __pa30.clone();
                    expB = __pa31.clone();
                    tequal = expB.clone() == Arc::new(TplAbsyn::ExpressionBase::LITERAL { value: (literal!("false")).clone(), litType: crate::TplAbsyn::TypeSignature::interned_BOOLEAN_TYPE() });
                    ...
                    metamodelica::print(({ let mut __mm_s = String::new(); __mm_s.push_str(&*literal!("All tests took ")); __mm_s.push_str(&*realString(clock() - tstart.clone())); __mm_s.push_str(&*literal!(" seconds.\n")); ArcStr::from(__mm_s) }).clone());
