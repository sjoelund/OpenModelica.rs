...
fn fun_52(mut in_txt: Tpl::Text, mut in_a_generateFMUModelDescription: bool) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_generateFMUModelDescription) {
        (mut txt, false) => {
...
fn fun_53(mut in_txt: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_FMUGuid: ArcStr, mut in_a_FMUType: ArcStr, mut in_a_FMUVersion: ArcStr, mut in_a_simCode: SimCode::SimCode, mut in_a_modelInfo_name: Arc<Absyn::Path>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_generateFMUModelDescription, in_a_FMUGuid, in_a_FMUType, in_a_FMUVersion, in_a_simCode, in_a_modelInfo_name)) {
...
fn fun_54(mut in_txt: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_FMUVersion: ArcStr, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_generateFMUModelDescription, in_a_FMUVersion, in_a_simCode) {
        (mut txt, false, _, _) => {
            txt.clone()
        },
...
fn fun_55(mut in_txt: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_FMUVersion: ArcStr, mut in_a_simulationSettingsOpt: Option<SimCode::SimulationSettings>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_generateFMUModelDescription, in_a_FMUVersion, in_a_simulationSettingsOpt) {
        (mut txt, false, _, _) => {
            txt.clone()
        },
...
pub fn modelInitXMLFile(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_numRealVars: ArcStr, mut in_a_numIntVars: ArcStr, mut in_a_numBoolVars: ArcStr, mut in_a_numStringVars: ArcStr, mut in_a_FMUVersion: ArcStr, mut in_a_FMUType: ArcStr, mut in_a_FMUGuid: ArcStr, mut in_a_generateFMUModelDescription: bool, mut in_a_generatorComments: ArcStr, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = (match (in_txt, in_a_simCode, in_a_numRealVars, in_a_numIntVars, in_a_numBoolVars, in_a_numStringVars, in_a_FMUVersion, in_a_FMUType, in_a_FMUGuid, in_a_generateFMUModelDescription, in_a_generatorComments, in_a_complexStartExpressions, in_a_stateDerVectorName) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: ref i_modelInfo @ SimCode::ModelInfo { name: ref i_modelInfo_name, .. }, varToArrayIndexMapping: ref i_varToArrayIndexMapping, simulationSettingsOpt: ref i_simulationSettingsOpt, .. }, mut a_numRealVars, mut a_numIntVars, mut a_numBoolVars, mut a_numStringVars, mut a_FMUVersion, mut a_FMUType, mut a_FMUGuid, mut a_generateFMUModelDescription, mut a_generatorComments, mut a_complexStartExpressions, mut a_stateDerVectorName) => {
            ...
            txt_2 = Tpl::writeTok(txt_2, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" - 1")).clone() }))?;
            txt_3 = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_numBoolVars.clone()).clone())?;
            txt_3 = Tpl::writeTok(txt_3, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" - 1")).clone() }))?;
            txt_4 = Tpl::writeStr(Tpl::emptyTxt.clone(), (a_numStringVars.clone()).clone())?;
            txt_4 = Tpl::writeTok(txt_4, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" - 1")).clone() }))?;
            (l_variables, a_complexStartExpressions, a_stateDerVectorName) = modelVariablesXML(Tpl::emptyTxt.clone(), i_simCode.clone(), i_modelInfo.clone(), i_varToArrayIndexMapping.clone(), (Tpl::textString(txt_1)?).clone(), (Tpl::textString(txt_2)?).clone(), (Tpl::textString(txt_3)?).clone(), (Tpl::textString(txt_4)?).clone(), a_generateFMUModelDescription.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())?;
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_fmiDescriptionAttributes)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_fmiTypeDefinitions)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_fmiDefaultExperiment)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<ModelVariables>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_variables)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("</ModelVariables>\n")).clone() }))?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_descriptionTag)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(">")).clone() }))?;
...
fn fun_57(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_simCode: SimCode::SimCode, mut in_a_FMUGuid: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_simCode, in_a_FMUGuid) {
...
pub(crate) fn fmiDescriptionAttributes(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_FMUVersion: ArcStr, mut a_FMUType: ArcStr, mut a_FMUGuid: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    let mut ret_0: bool;
    ret_0 = FMI::isFMIVersion20((a_FMUVersion).clone())?;
    out_txt = fun_57(txt, ret_0, a_simCode, (a_FMUGuid).clone())?;
    Ok(out_txt)
}
...
pub(crate) fn fmiModelDescriptionAttributes(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_guid: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode, in_a_guid) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { varInfo: SimCode::VarInfo { numStateVars: ref i_vi_numStateVars, .. }, vars: SimCodeVar::SimVars { stateVars: _, .. }, name: ref i_modelInfo_name, .. }, fileNamePrefix: ref i_fileNamePrefix, .. }, mut a_guid) => {
            ...
            l_modelName = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_3).clone())?;
            ret_5 = (System::stringReplace((i_fileNamePrefix.clone()).clone(), (literal!(".")).clone(), (literal!("_")).clone())?).clone();
            l_modelIdentifier = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_5).clone())?;
            ...
            l_generationTool = Tpl::writeStr(l_generationTool, (ret_10).clone())?;
            ret_12 = Util::getCurrentDateTime();
            l_generationDateAndTime = CodegenFMUCommon::xsdateTime(Tpl::emptyTxt.clone(), ret_12)?;
...
fn lm_60(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_indexForUndefinedReferencesReal: ArcStr, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut in_a_simCode: SimCode::SimCode) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesReal, in_a_varToArrayIndexMapping, in_a_simCode)) {
        (txt, Deref @ metamodelica::List::Nil, a_stateDerVectorName, a_complexStartExpressions, _, _, _, _) => {
            return Ok((txt.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }, a_stateDerVectorName, a_complexStartExpressions, a_generateFMUModelDescription, a_indexForUndefinedReferencesReal, a_varToArrayIndexMapping, a_simCode) => {
            ...
            { (in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesReal, in_a_varToArrayIndexMapping, in_a_simCode) = (txt.clone(), rest.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone(), a_generateFMUModelDescription.clone(), (a_indexForUndefinedReferencesReal.clone()).clone(), a_varToArrayIndexMapping.clone(), a_simCode.clone()); continue '__tco; }
        },
...
fn lm_66(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_indexForUndefinedReferencesInt: ArcStr, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut in_a_simCode: SimCode::SimCode) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesInt, in_a_varToArrayIndexMapping, in_a_simCode)) {
        (txt, Deref @ metamodelica::List::Nil, a_stateDerVectorName, a_complexStartExpressions, _, _, _, _) => {
            return Ok((txt.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }, a_stateDerVectorName, a_complexStartExpressions, a_generateFMUModelDescription, a_indexForUndefinedReferencesInt, a_varToArrayIndexMapping, a_simCode) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesInt, in_a_varToArrayIndexMapping, in_a_simCode) = (txt.clone(), rest.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone(), a_generateFMUModelDescription.clone(), (a_indexForUndefinedReferencesInt.clone()).clone(), a_varToArrayIndexMapping.clone(), a_simCode.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn lm_69(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_indexForUndefinedReferencesBool: ArcStr, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut in_a_simCode: SimCode::SimCode) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesBool, in_a_varToArrayIndexMapping, in_a_simCode)) {
        (txt, Deref @ metamodelica::List::Nil, a_stateDerVectorName, a_complexStartExpressions, _, _, _, _) => {
            return Ok((txt.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }, a_stateDerVectorName, a_complexStartExpressions, a_generateFMUModelDescription, a_indexForUndefinedReferencesBool, a_varToArrayIndexMapping, a_simCode) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesBool, in_a_varToArrayIndexMapping, in_a_simCode) = (txt.clone(), rest.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone(), a_generateFMUModelDescription.clone(), (a_indexForUndefinedReferencesBool.clone()).clone(), a_varToArrayIndexMapping.clone(), a_simCode.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn lm_72(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_indexForUndefinedReferencesString: ArcStr, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut in_a_simCode: SimCode::SimCode) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesString, in_a_varToArrayIndexMapping, in_a_simCode)) {
        (txt, Deref @ metamodelica::List::Nil, a_stateDerVectorName, a_complexStartExpressions, _, _, _, _) => {
            return Ok((txt.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }, a_stateDerVectorName, a_complexStartExpressions, a_generateFMUModelDescription, a_indexForUndefinedReferencesString, a_varToArrayIndexMapping, a_simCode) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferencesString, in_a_varToArrayIndexMapping, in_a_simCode) = (txt.clone(), rest.clone(), a_stateDerVectorName.clone(), a_complexStartExpressions.clone(), a_generateFMUModelDescription.clone(), (a_indexForUndefinedReferencesString.clone()).clone(), a_varToArrayIndexMapping.clone(), a_simCode.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn modelVariablesXML(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_modelInfo: SimCode::ModelInfo, mut a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut a_indexForUndefinedReferencesReal: ArcStr, mut a_indexForUndefinedReferencesInt: ArcStr, mut a_indexForUndefinedReferencesBool: ArcStr, mut a_indexForUndefinedReferencesString: ArcStr, mut a_generateFMUModelDescription: bool, mut a_complexStartExpressions: Tpl::Text, mut a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = fun_75(txt, a_modelInfo, a_simCode, a_varToArrayIndexMapping, (a_indexForUndefinedReferencesReal).clone(), (a_indexForUndefinedReferencesInt).clone(), (a_indexForUndefinedReferencesBool).clone(), (a_indexForUndefinedReferencesString).clone(), a_generateFMUModelDescription, a_complexStartExpressions, a_stateDerVectorName)?;
    Ok((out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName))
}
...
fn fun_77(mut in_txt: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_type__: Arc<DAE::Type>, mut in_a_isFixed: bool, mut in_a_nominalValue: Option<Arc<DAE::Exp>>, mut in_a_initialValue: Option<Arc<DAE::Exp>>, mut in_a_maxValue: Option<Arc<DAE::Exp>>, mut in_a_minValue: Option<Arc<DAE::Exp>>, mut in_a_displayUnit: ArcStr, mut in_a_unit: ArcStr, mut in_a_aliasvar: SimCodeVar::AliasVariable, mut in_a_name: Arc<DAE::ComponentRef>, mut in_a_simCode: SimCode::SimCode) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_stateDerVectorName: Tpl::Text;
    let mut out_a_complexStartExpressions: Tpl::Text;
    (out_txt, out_a_stateDerVectorName, out_a_complexStartExpressions) = (::match_deref::match_deref! { match &((in_txt, in_a_generateFMUModelDescription, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_type__, in_a_isFixed, in_a_nominalValue, in_a_initialValue, in_a_maxValue, in_a_minValue, in_a_displayUnit, in_a_unit, in_a_aliasvar, in_a_name, in_a_simCode)) {
...
fn lm_78(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_complexStartExpressionsForScalarsUnused: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_indexForUndefinedReferences: ArcStr, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut in_a_simCode: SimCode::SimCode) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressionsForScalarsUnused, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferences, in_a_varToArrayIndexMapping, in_a_simCode)) {
        (txt, Deref @ metamodelica::List::Nil, a_stateDerVectorName, a_complexStartExpressionsForScalarsUnused, _, _, _, _) => {
            return Ok((txt.clone(), a_stateDerVectorName.clone(), a_complexStartExpressionsForScalarsUnused.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_var, tail: rest }, a_stateDerVectorName, a_complexStartExpressionsForScalarsUnused, a_generateFMUModelDescription, a_indexForUndefinedReferences, a_varToArrayIndexMapping, a_simCode) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_stateDerVectorName, in_a_complexStartExpressionsForScalarsUnused, in_a_generateFMUModelDescription, in_a_indexForUndefinedReferences, in_a_varToArrayIndexMapping, in_a_simCode) = (txt.clone(), rest.clone(), a_stateDerVectorName.clone(), a_complexStartExpressionsForScalarsUnused.clone(), a_generateFMUModelDescription.clone(), (a_indexForUndefinedReferences.clone()).clone(), a_varToArrayIndexMapping.clone(), a_simCode.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_79(mut in_txt: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_type__: Arc<DAE::Type>, mut in_a_isFixed: bool, mut in_a_nominalValue: Option<Arc<DAE::Exp>>, mut in_a_initialValue: Option<Arc<DAE::Exp>>, mut in_a_maxValue: Option<Arc<DAE::Exp>>, mut in_a_minValue: Option<Arc<DAE::Exp>>, mut in_a_displayUnit: ArcStr, mut in_a_unit: ArcStr, mut in_a_aliasvar: SimCodeVar::AliasVariable, mut in_a_name: Arc<DAE::ComponentRef>, mut in_a_simCode: SimCode::SimCode) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_stateDerVectorName: Tpl::Text;
    let mut out_a_complexStartExpressions: Tpl::Text;
    (out_txt, out_a_stateDerVectorName, out_a_complexStartExpressions) = (::match_deref::match_deref! { match &((in_txt, in_a_generateFMUModelDescription, in_a_simVar, in_a_stateDerVectorName, in_a_complexStartExpressions, in_a_type__, in_a_isFixed, in_a_nominalValue, in_a_initialValue, in_a_maxValue, in_a_minValue, in_a_displayUnit, in_a_unit, in_a_aliasvar, in_a_name, in_a_simCode)) {
...
fn fun_80(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut in_a_indexForUndefinedReferences: ArcStr, mut in_a_generateFMUModelDescription: bool, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = (::match_deref::match_deref! { match &((in_txt, in_a_simVar, in_a_simCode, in_a_varToArrayIndexMapping, in_a_indexForUndefinedReferences, in_a_generateFMUModelDescription, in_a_complexStartExpressions, in_a_stateDerVectorName)) {
        (txt, i_simVar @ SimCodeVar::SimVar { type_: i_type__ @ Deref @ DAE::Type::T_ARRAY { ty: _, .. }, name: i_name, aliasvar: i_aliasvar, unit: i_unit, displayUnit: i_displayUnit, minValue: i_minValue, maxValue: i_maxValue, initialValue: i_initialValue, nominalValue: i_nominalValue, isFixed: i_isFixed, .. }, a_simCode, a_varToArrayIndexMapping, a_indexForUndefinedReferences, a_generateFMUModelDescription, a_complexStartExpressions, a_stateDerVectorName) => {
            ...
            (txt, a_stateDerVectorName, l_complexStartExpressionsForScalarsUnused) = lm_78(txt.clone(), ret_2, a_stateDerVectorName.clone(), l_complexStartExpressionsForScalarsUnused, a_generateFMUModelDescription.clone(), (a_indexForUndefinedReferences.clone()).clone(), a_varToArrayIndexMapping.clone(), a_simCode.clone())?;
            txt = Tpl::popIter(txt.clone())?;
            (txt.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())
        },
        (txt, i_simVar @ SimCodeVar::SimVar { name: i_name, aliasvar: i_aliasvar, unit: i_unit, displayUnit: i_displayUnit, minValue: i_minValue, maxValue: i_maxValue, initialValue: i_initialValue, nominalValue: i_nominalValue, isFixed: i_isFixed, type_: i_type__, .. }, a_simCode, _, a_indexForUndefinedReferences, a_generateFMUModelDescription, a_complexStartExpressions, a_stateDerVectorName) => {
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(">\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_variableCode)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</ScalarVariable>")).clone() }))?;
            (txt.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())
...
pub(crate) fn scalarVariableXML(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVar: SimCodeVar::SimVar, mut a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut a_indexForUndefinedReferences: ArcStr, mut a_generateFMUModelDescription: bool, mut a_complexStartExpressions: Tpl::Text, mut a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = fun_80(txt, a_simVar, a_simCode, a_varToArrayIndexMapping, (a_indexForUndefinedReferences).clone(), a_generateFMUModelDescription, a_complexStartExpressions, a_stateDerVectorName)?;
    Ok((out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName))
}
...
fn fun_83(mut in_txt: Tpl::Text, mut in_a_hideResult: Option<bool>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_hideResult) {
...
fn fun_84(mut in_txt: Tpl::Text, mut in_a_generateFMUModelDescription: bool, mut in_a_isValueChangeable: bool, mut in_a_isDiscrete: bool, mut in_a_hr: Tpl::Text, mut in_a_isProtected: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_generateFMUModelDescription, in_a_isValueChangeable, in_a_isDiscrete, in_a_hr, in_a_isProtected) {
...
fn fun_85(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar, mut in_a_simCode: SimCode::SimCode, mut in_a_generateFMUModelDescription: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_simVar, in_a_simCode, in_a_generateFMUModelDescription)) {
        (txt, i_simVar @ SimCodeVar::SimVar { source: Deref @ DAE::ElementSource { info: _, .. }, aliasvar: i_aliasvar, causality: i_causality, varKind: i_varKind, comment: i_comment, hideResult: i_hideResult, isProtected: i_isProtected, isDiscrete: i_isDiscrete, isValueChangeable: i_isValueChangeable, name: i_name, .. }, a_simCode, a_generateFMUModelDescription) => {
            ...
            l_valueReference = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_1).clone())?;
            ...
            l_additionalAttributes = fun_84(Tpl::emptyTxt.clone(), a_generateFMUModelDescription.clone(), i_isValueChangeable.clone(), i_isDiscrete.clone(), l_hr, i_isProtected.clone())?;
            ...
            ret_9 = (Util::escapeModelicaStringToXmlString((Tpl::textString(txt_8)?).clone())?).clone();
            ret_10 = (System::stringReplace((ret_9).clone(), (literal!("$")).clone(), (literal!("_D_")).clone())?).clone();
            txt = Tpl::writeStr(txt.clone(), (ret_10).clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_causalityAtt)?;
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\" ")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_additionalAttributes)?;
            txt.clone()
        },
        (txt, _, _, _) => {
            txt.clone()
...
pub(crate) fn scalarVariableAttributeXML(mut txt: Tpl::Text, mut a_simVar: SimCodeVar::SimVar, mut a_simCode: SimCode::SimCode, mut a_indexForUndefinedReferences: ArcStr, mut a_generateFMUModelDescription: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_85(txt, a_simVar, a_simCode, a_generateFMUModelDescription)?;
    Ok(out_txt)
}
...
fn fun_88(mut in_txt: Tpl::Text, mut in_a_type__: Arc<DAE::Type>, mut in_a_simCode: SimCode::SimCode, mut in_a_simVarCref: Arc<DAE::ComponentRef>, mut in_a_simVarAlias: SimCodeVar::AliasVariable, mut in_a_unit: ArcStr, mut in_a_displayUnit: ArcStr, mut in_a_minValue: Option<Arc<DAE::Exp>>, mut in_a_maxValue: Option<Arc<DAE::Exp>>, mut in_a_startValue: Option<Arc<DAE::Exp>>, mut in_a_nominalValue: Option<Arc<DAE::Exp>>, mut in_a_isFixed: bool, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = (::match_deref::match_deref! { match &((in_txt, in_a_type__, in_a_simCode, in_a_simVarCref, in_a_simVarAlias, in_a_unit, in_a_displayUnit, in_a_minValue, in_a_maxValue, in_a_startValue, in_a_nominalValue, in_a_isFixed, in_a_complexStartExpressions, in_a_stateDerVectorName)) {
        (txt, Deref @ DAE::Type::T_INTEGER { varLst: _ }, a_simCode, a_simVarCref, a_simVarAlias, a_unit, a_displayUnit, a_minValue, a_maxValue, a_startValue, _, a_isFixed, a_complexStartExpressions, a_stateDerVectorName) => {
            ...
            l_fixed__ = Tpl::writeTok(l_fixed__, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("fixed=\"")).clone() }))?;
            l_fixed__ = Tpl::writeStr(l_fixed__, (Tpl::booleanString(a_isFixed.clone())).clone())?;
            l_fixed__ = Tpl::writeTok(l_fixed__, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\"")).clone() }))?;
            l_fixed__ = Tpl::popBlock(l_fixed__)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_start__)?;
            txt = Tpl::writeText(txt.clone(), l_fixed__)?;
            txt = Tpl::writeText(txt.clone(), l_min__)?;
            txt = Tpl::writeText(txt.clone(), l_max__)?;
            txt = Tpl::writeText(txt.clone(), l_unit__)?;
            txt = Tpl::writeText(txt.clone(), l_disp__)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" />")).clone() }))?;
            (txt.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())
        },
        (txt, Deref @ DAE::Type::T_REAL { varLst: _ }, a_simCode, a_simVarCref, a_simVarAlias, a_unit, a_displayUnit, a_minValue, a_maxValue, a_startValue, a_nominalValue, a_isFixed, a_complexStartExpressions, a_stateDerVectorName) => {
            ...
            l_nom__ = Tpl::writeTok(l_nom__, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("useNominal=\"")).clone() }))?;
            ret_7 = isSome(a_nominalValue.clone());
            l_nom__ = Tpl::writeStr(l_nom__, (Tpl::booleanString(ret_7)).clone())?;
            l_nom__ = Tpl::writeTok(l_nom__, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\"")).clone() }))?;
            l_nom__ = attributeOptionString(l_nom__, a_nominalValue.clone(), (literal!("nominal")).clone())?;
            l_nom__ = Tpl::popBlock(l_nom__)?;
            l_min__ = attributeOptionString(Tpl::emptyTxt.clone(), a_minValue.clone(), (literal!("min")).clone())?;
            l_max__ = attributeOptionString(Tpl::emptyTxt.clone(), a_maxValue.clone(), (literal!("max")).clone())?;
            l_unit__ = unitString(Tpl::emptyTxt.clone(), (a_unit.clone()).clone(), (literal!("unit")).clone())?;
            l_disp__ = unitString(Tpl::emptyTxt.clone(), (a_displayUnit.clone()).clone(), (literal!("displayUnit")).clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_start__)?;
            txt = Tpl::writeText(txt.clone(), l_fixed__)?;
            txt = Tpl::writeText(txt.clone(), l_nom__)?;
            txt = Tpl::writeText(txt.clone(), l_min__)?;
            txt = Tpl::writeText(txt.clone(), l_max__)?;
            txt = Tpl::writeText(txt.clone(), l_unit__)?;
            txt = Tpl::writeText(txt.clone(), l_disp__)?;
        ...
        (txt, Deref @ DAE::Type::T_COMPLEX { complexClassType: ClassInf::State::EXTERNAL_OBJ { path: i_ci_path }, .. }, _, _, _, _, _, _, _, _, _, _, a_complexStartExpressions, a_stateDerVectorName) => {
            ...
            ret_9 = (Util::escapeModelicaStringToXmlString((Tpl::textString(txt_8)?).clone())?).clone();
            txt = Tpl::writeStr(txt.clone(), (ret_9).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\" />")).clone() }))?;
            (txt.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())
        },
        (txt, i_type__, _, _, _, _, _, _, _, _, _, _, a_complexStartExpressions, a_stateDerVectorName) => {
            ...
            txt_10 = Tpl::writeStr(txt_10, (ret_10).clone())?;
            txt = CodegenUtil::error(txt.clone(), Tpl::sourceInfo((literal!("CodegenCppInit.tpl")).clone(), 243, 16), (Tpl::textString(txt_10)?).clone())?;
            (txt.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub(crate) fn ScalarVariableType(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVarCref: Arc<DAE::ComponentRef>, mut a_simVarAlias: SimCodeVar::AliasVariable, mut a_unit: ArcStr, mut a_displayUnit: ArcStr, mut a_minValue: Option<Arc<DAE::Exp>>, mut a_maxValue: Option<Arc<DAE::Exp>>, mut a_startValue: Option<Arc<DAE::Exp>>, mut a_nominalValue: Option<Arc<DAE::Exp>>, mut a_isFixed: bool, mut a_type__: Arc<DAE::Type>, mut a_complexStartExpressions: Tpl::Text, mut a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = fun_88(txt, a_type__, a_simCode, a_simVarCref, a_simVarAlias, (a_unit).clone(), (a_displayUnit).clone(), a_minValue, a_maxValue, a_startValue, a_nominalValue, a_isFixed, a_complexStartExpressions, a_stateDerVectorName)?;
    Ok((out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName))
}
...
fn fun_91(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_array: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_attr__name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_array, in_a_attr__name)) {
        (txt, false, _, _) => {
            txt.clone()
        },
...
fn fun_92(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_attr__name: ArcStr, mut in_a_expr: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_attr__name, in_a_expr)) {
        (txt, false, _, _) => {
            txt.clone()
        },
...
pub(crate) fn attributeString(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_attr__name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_attr__name)) {
        ...
        (txt, i_exp @ Deref @ DAE::Exp::ARRAY { array: i_array, .. }, a_attr__name) => {
            ...
            txt = fun_91(txt.clone(), ret_0, i_array.clone(), (a_attr__name.clone()).clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::Exp::REDUCTION { expr: i_expr, .. }, a_attr__name) => {
            ...
            txt = fun_92(txt.clone(), ret_1, (a_attr__name.clone()).clone(), i_expr.clone())?;
            txt.clone()
        },
        (txt, _, _) => {
            txt.clone()
...
pub(crate) fn attributeOptionString(mut in_txt: Tpl::Text, mut in_a_exp__opt: Option<Arc<DAE::Exp>>, mut in_a_attr__name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_exp__opt, in_a_attr__name)) {
...
pub(crate) fn unitString(mut in_txt: Tpl::Text, mut in_a_unit: ArcStr, mut in_a_attr__name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_unit, in_a_attr__name)) {
        (txt, Deref @ "", _) => {
            txt.clone()
        },
...
fn fun_96(mut in_txt: Tpl::Text, mut in_a_simVarAlias: SimCodeVar::AliasVariable, mut in_a_type: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_simVarCref: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = (::match_deref::match_deref! { match &((in_txt, in_a_simVarAlias, in_a_type, in_a_complexStartExpressions, in_a_exp, in_a_stateDerVectorName, in_a_simCode, in_a_simVarCref)) {
        (txt, SimCodeVar::AliasVariable::NOALIAS { .. }, a_type, a_complexStartExpressions, a_exp, a_stateDerVectorName, a_simCode, a_simVarCref) => {
            ...
            (l_crefStr, l_extraFuncs, l_extraFuncsDecl, _, l_varDecls, a_stateDerVectorName) = CodegenCppCommon::cref1(Tpl::emptyTxt.clone(), a_simVarCref.clone(), a_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), SimCodeFunction::contextOther().clone(), l_varDecls, a_stateDerVectorName.clone(), false)?;
            (l_expression, l_complexPreExpression, l_varDecls, l_extraFuncs, l_extraFuncsDecl, _, a_stateDerVectorName) = CodegenCppCommon::daeExp(Tpl::emptyTxt.clone(), a_exp.clone(), SimCodeFunction::contextOther().clone(), l_complexPreExpression, l_varDecls, a_simCode.clone(), l_extraFuncs, l_extraFuncsDecl, Tpl::strTokText(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), a_stateDerVectorName.clone(), false)?;
            a_complexStartExpressions = Tpl::writeText(a_complexStartExpressions.clone(), l_varDecls)?;
            a_complexStartExpressions = Tpl::writeText(a_complexStartExpressions.clone(), l_complexPreExpression)?;
            ...
            a_complexStartExpressions = Tpl::writeText(a_complexStartExpressions.clone(), l_crefStr)?;
            ...
            a_complexStartExpressions = Tpl::writeText(a_complexStartExpressions.clone(), l_expression)?;
            a_complexStartExpressions = Tpl::writeTok(a_complexStartExpressions.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
            a_complexStartExpressions = Tpl::writeTok(a_complexStartExpressions.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            (txt.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())
        },
...
fn fun_97(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_startString: Tpl::Text, mut in_a_type: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_stateDerVectorName: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_simVarCref: Arc<DAE::ComponentRef>, mut in_a_simVarAlias: SimCodeVar::AliasVariable) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_startString, in_a_type, in_a_complexStartExpressions, in_a_exp, in_a_stateDerVectorName, in_a_simCode, in_a_simVarCref, in_a_simVarAlias)) {
...
fn fun_98(mut in_txt: Tpl::Text, mut in_a_startValue: Option<Arc<DAE::Exp>>, mut in_a_simCode: SimCode::SimCode, mut in_a_simVarCref: Arc<DAE::ComponentRef>, mut in_a_simVarAlias: SimCodeVar::AliasVariable, mut in_a_type: Tpl::Text, mut in_a_complexStartExpressions: Tpl::Text, mut in_a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = (::match_deref::match_deref! { match &((in_txt, in_a_startValue, in_a_simCode, in_a_simVarCref, in_a_simVarAlias, in_a_type, in_a_complexStartExpressions, in_a_stateDerVectorName)) {
        (txt, Some(i_exp), a_simCode, a_simVarCref, a_simVarAlias, a_type, a_complexStartExpressions, a_stateDerVectorName) => {
            ...
            (txt, a_complexStartExpressions, a_stateDerVectorName) = fun_97(txt.clone(), (str_1).clone(), l_startString, a_type.clone(), a_complexStartExpressions.clone(), i_exp.clone(), a_stateDerVectorName.clone(), a_simCode.clone(), a_simVarCref.clone(), a_simVarAlias.clone())?;
            (txt.clone(), a_complexStartExpressions.clone(), a_stateDerVectorName.clone())
        },
...
pub(crate) fn ScalarVariableTypeStartAttribute(mut txt: Tpl::Text, mut a_simCode: SimCode::SimCode, mut a_simVarCref: Arc<DAE::ComponentRef>, mut a_simVarAlias: SimCodeVar::AliasVariable, mut a_startValue: Option<Arc<DAE::Exp>>, mut a_type: Tpl::Text, mut a_complexStartExpressions: Tpl::Text, mut a_stateDerVectorName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_complexStartExpressions: Tpl::Text;
    let mut out_a_stateDerVectorName: Tpl::Text;
    (out_txt, out_a_complexStartExpressions, out_a_stateDerVectorName) = fun_98(txt, a_startValue, a_simCode, a_simVarCref, a_simVarAlias, a_type.clone(), a_complexStartExpressions, a_stateDerVectorName)?;
    out_a_type = a_type;
...
fn lm_101(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut in_a_indexForUndefinedReferences: ArcStr, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>))) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_indexForUndefinedReferences, in_a_varToArrayIndexMapping)) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: SimCodeVar::SimVar { name: i_v_name, .. }, tail: rest }, a_indexForUndefinedReferences, a_varToArrayIndexMapping) => {
            ...
            txt = lm_100(txt.clone(), ret_0)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\" />")).clone() }))?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_indexForUndefinedReferences, in_a_varToArrayIndexMapping) = (txt.clone(), rest.clone(), (a_indexForUndefinedReferences.clone()).clone(), a_varToArrayIndexMapping.clone()); continue '__tco; }
        },
...
fn fun_104(mut in_txt: Tpl::Text, mut in_a_eqs: Arc<SimCode::SimEqSystem>, mut in_a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut in_a_indexForUndefinedReferences: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_eqs, in_a_varToArrayIndexMapping, in_a_indexForUndefinedReferences)) {
...
pub(crate) fn algLoopXML(mut txt: Tpl::Text, mut a_eqs: Arc<SimCode::SimEqSystem>, mut a_simCode: SimCode::SimCode, mut a_varToArrayIndexMapping: (metamodelica::Array<Arc<metamodelica::List<(Arc<DAE::ComponentRef>, i32)>>>, (i32, i32, metamodelica::Array<Option<(Arc<DAE::ComponentRef>, (Arc<metamodelica::List<i32>>, metamodelica::Array<i32>))>>), i32, (Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<i32> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>, Arc<DAE::ComponentRef>) -> Result<bool> + 'static>, Arc<dyn ::std::ops::Fn(Arc<DAE::ComponentRef>) -> Result<ArcStr> + 'static>, Arc<dyn ::std::ops::Fn((Arc<metamodelica::List<i32>>, metamodelica::Array<i32>)) -> Result<ArcStr> + 'static>)), mut a_indexForUndefinedReferences: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_104(txt, a_eqs, a_varToArrayIndexMapping, (a_indexForUndefinedReferences).clone())?;
    Ok(out_txt)
}
...
fn lm_106(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::JacobianMatrix>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ SimCode::JacobianMatrix { columns: i_mat, seedVars: i_vars, matrixName: i_name, sparsity: i_sparsepattern, coloredCols: i_colorList, maxColorCols: i_maxColor, jacobianIndex: i_jacIndex, .. }, tail: rest }) => {
            let mut txt = (*txt).clone();
...
pub(crate) fn jacobianMatricesXML(mut txt: Tpl::Text, mut a_JacobianMatrices: Arc<metamodelica::List<Arc<SimCode::JacobianMatrix>>>) -> Result<Tpl::Text> {
    ...
    l_jacMats = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    l_jacMats = lm_106(l_jacMats, a_JacobianMatrices)?;
...
fn fun_109(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_i__index: i32, mut in_a_index: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_i__index, in_a_index)) {
...
fn lm_110(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<i32>>, mut in_a_index: i32, mut in_a_indexColumn: Tpl::Text) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_index, in_a_indexColumn)) {
        (txt, Deref @ metamodelica::List::Nil, _, _) => {
            return Ok(txt.clone())
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_i__index, tail: rest }, a_index, a_indexColumn) => {
            ...
            txt = fun_109(txt.clone(), (str_0).clone(), i_i__index.clone(), a_index.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_index, in_a_indexColumn) = (txt.clone(), rest.clone(), a_index.clone(), a_indexColumn.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn lm_111(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<(i32, Arc<metamodelica::List<i32>>)>>, mut in_a_indexColumn: Tpl::Text) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_indexColumn)) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: (i_index, i_indexes), tail: rest }, a_indexColumn) => {
            ...
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_indexColumn) = (txt.clone(), rest.clone(), a_indexColumn.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn jacobianMatrixXML(mut txt: Tpl::Text, mut a_indexJacobian: i32, mut a_jacobianColumn: Arc<metamodelica::List<Arc<SimCode::JacobianColumn>>>, mut a_seedVars: Arc<metamodelica::List<SimCodeVar::SimVar>>, mut a_matrixName: ArcStr, mut a_sparsepattern: Arc<metamodelica::List<(i32, Arc<metamodelica::List<i32>>)>>, mut a_colorList: Arc<metamodelica::List<Arc<metamodelica::List<i32>>>>, mut a_maxColor: i32) -> Result<Tpl::Text> {
    ...
    l_indexColumn = lm_108(l_indexColumn, a_jacobianColumn)?;
    l_indexColumn = Tpl::popIter(l_indexColumn)?;
    l_jacvals = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    l_jacvals = lm_111(l_jacvals, a_sparsepattern, l_indexColumn)?;
    l_jacvals = Tpl::popIter(l_jacvals)?;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("<Matrix name=\"")).clone() }))?;
    out_txt = Tpl::writeStr(out_txt, (a_matrixName).clone())?;
    ...
    out_txt = Tpl::writeText(out_txt, l_jacvals)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("  </Column>\n")).clone(), (literal!("</Matrix>")).clone()], lastHasNewLine: false }))?;
    Ok(out_txt)
}
