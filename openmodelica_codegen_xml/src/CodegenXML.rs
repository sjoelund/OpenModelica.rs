...
pub fn generateXml(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt.clone(), in_a_simCode.clone()) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: ref i_modelInfo @ SimCode::ModelInfo { functions: ref i_modelInfo_functions, .. }, simulationSettingsOpt: ref i_simulationSettingsOpt, allEquations: ref i_allEquations, initialEquations: ref i_initialEquations, recordDecls: ref i_recordDecls, classAttributes: ref i_classAttributes, .. }) => {
            let mut l_prefix: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
pub fn ScalarVariableAttributesXml(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt.clone(), in_a_simVar.clone()) {
        (mut txt, SimCodeVar::SimVar { varKind: mut i_varKind, comment: mut i_comment, aliasvar: mut i_aliasvar, causality: mut i_causality, name: ref i_name, type_: ref i_type__, unit: mut i_unit, displayUnit: mut i_displayUnit, minValue: mut i_minValue, maxValue: mut i_maxValue, initialValue: mut i_initialValue, isFixed: mut i_isFixed, .. }) => {
            let mut l_variableCategory: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
pub fn qualifiedNamePartXml(mut in_txt: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_cr.clone())) {
        (txt, Deref @ DAE::ComponentRef::CREF_IDENT { subscriptLst: i_subscriptLst, ident: i_ident, .. }) => {
            let mut l_arrayTest: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            l_arrayTest = arraysubscriptsStrXml(Tpl::emptyTxt.clone(), i_subscriptLst.clone())?;
            txt = fun_93(txt.clone(), l_arrayTest.clone(), i_subscriptLst.clone(), (i_ident.clone()).clone())?;
            txt.clone()
        },
        ...
        (txt, Deref @ DAE::ComponentRef::CREF_QUAL { subscriptLst: i_subscriptLst, ident: i_ident, componentRef: i_componentRef, .. }) => {
            ...
            let mut txt = (*txt).clone();
            l_arrayTest = arraysubscriptsStrXml(Tpl::emptyTxt.clone(), i_subscriptLst.clone())?;
            txt = fun_94(txt.clone(), l_arrayTest.clone(), i_subscriptLst.clone(), i_componentRef.clone(), (i_ident.clone()).clone())?;
            txt.clone()
        },
        (txt, _) => {
            let mut txt = (*txt).clone();
...
fn lm_121(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_tmp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_tmp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_tmp.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_eq, tail: rest }, a_tmp, a_varDecls) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_tmp, a_varDecls) = lm_121(txt.clone(), rest.clone(), a_tmp.clone(), a_varDecls.clone())?;
            (txt.clone(), a_tmp.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn equationsXml(mut txt: Tpl::Text, mut a_allEquationsPlusWhen: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_eqs: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_tmp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_jens: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    l_varDecls = Tpl::emptyTxt.clone();
...
fn lm_123(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_eq, tail: rest }, a_varDecls) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_123(txt.clone(), rest.clone(), a_varDecls.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn algorithmicEquationsXml(mut txt: Tpl::Text, mut a_allEquations: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_algs: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    l_varDecls = Tpl::emptyTxt.clone();
    l_algs = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_125(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_125(txt.clone(), rest.clone(), a_varDecls.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn fun_126(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_eq.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ SimCode::SimEqSystem::SES_ALGORITHM { statements: i_statements, .. }, a_varDecls) => {
            ...
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_alg = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_128(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_tmp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_tmp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_tmp.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_eq, tail: rest }, a_tmp, a_varDecls) => {
            ...
            (txt, a_varDecls, a_tmp) = equation_Xml(txt.clone(), i_eq.clone(), SimCodeFunction::contextSimulationDiscrete().clone(), a_varDecls.clone(), a_tmp.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_tmp, a_varDecls) = lm_128(txt.clone(), rest.clone(), a_tmp.clone(), a_varDecls.clone())?;
            (txt.clone(), a_tmp.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn initialEquationXml(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt.clone(), in_a_var.clone()) {
        (mut txt, SimCodeVar::SimVar { name: ref i_name, initialValue: mut i_initialValue, .. }) => {
            let mut l_identName: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn fun_139(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_varD: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varD: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
pub fn equation_Xml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text, mut in_a_eqs: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_eqs: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    (out_txt, out_a_varDecls, out_a_eqs) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_eq.clone(), in_a_context.clone(), in_a_varDecls.clone(), in_a_eqs.clone())) {
        ...
        (txt, i_eq, a_context, a_varDecls, a_eqs) => {
            ...
            let mut l_varD: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_tmp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut ret_1: i32 = 0;
            ...
            a_eqs = Tpl::writeTok(a_eqs.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            (txt.clone(), a_varDecls.clone(), a_eqs.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub fn equationSimpleAssignXml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_eq.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ SimCode::SimEqSystem::SES_SIMPLE_ASSIGN { exp: i_exp, cref: i_cref, .. }, a_context, a_varDecls) => {
            let mut l_result: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_147(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<(i32, i32, Arc<SimCode::SimEqSystem>)>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: (_, _, Deref @ SimCode::SimEqSystem::SES_RESIDUAL { exp: i_eq_exp, .. }), tail: rest }, a_varDecls, a_context) => {
            ...
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_147(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
...
fn lm_150(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_tmp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_tmp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_tmp.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_eq2, tail: rest }, a_tmp, a_varDecls) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_tmp, a_varDecls) = lm_150(txt.clone(), rest.clone(), a_tmp.clone(), a_varDecls.clone())?;
            (txt.clone(), a_tmp.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_151(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ SimCode::SimEqSystem::SES_RESIDUAL { exp: i_eq2_exp, .. }, tail: rest }, a_varDecls) => {
            ...
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_151(txt.clone(), rest.clone(), a_varDecls.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
...
fn fun_152(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_eq.clone())) {
        (txt, Deref @ SimCode::SimEqSystem::SES_NONLINEAR { nlSystem: Deref @ SimCode::NonlinearSystem { eqs: i_nls_eqs, .. }, .. }) => {
            ...
            let mut l_prebody: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_tmp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            l_varDecls = Tpl::emptyTxt.clone();
            l_tmp = Tpl::emptyTxt.clone();
            l_prebody = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_155(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_helpInits: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    (out_txt, out_a_helpInits) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_helpInits.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_helpInits) => {
            let mut l_helpInit: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            ...
            a_helpInits = Tpl::writeTok(a_helpInits.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_helpInits) = lm_155(txt.clone(), rest.clone(), a_helpInits.clone())?;
            (txt.clone(), a_helpInits.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_157(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_helpInits) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_helpInits.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_helpInits) => {
            ...
            a_helpInits = Tpl::writeTok(a_helpInits.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_helpInits) = lm_157(txt.clone(), rest.clone(), a_helpInits.clone())?;
            (txt.clone(), a_helpInits.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn equationWhenXml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_eq.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ SimCode::SimEqSystem::SES_WHEN { whenStmtLst: i_whenStmtLst, conditions: i_conditions, elseWhen: None, .. }, a_context, a_varDecls) => {
            let mut l_cond: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_body: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_helpIf: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_helpInits: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            l_helpInits = Tpl::emptyTxt.clone();
            l_helpIf = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
        ...
        (txt, Deref @ SimCode::SimEqSystem::SES_WHEN { whenStmtLst: i_whenStmtLst, conditions: i_conditions, elseWhen: Some(i_elseWhenEq), .. }, a_context, a_varDecls) => {
            let mut l_elseWhen: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_cond: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_body: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_helpIf: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_helpInits: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_160(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_helpInits) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_helpInits.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_helpInits) => {
            ...
            a_helpInits = Tpl::writeTok(a_helpInits.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_helpInits) = lm_160(txt.clone(), rest.clone(), a_helpInits.clone())?;
            (txt.clone(), a_helpInits.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_162(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_helpInits) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_helpInits.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_helpInits) => {
            ...
            a_helpInits = Tpl::writeTok(a_helpInits.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_helpInits) = lm_162(txt.clone(), rest.clone(), a_helpInits.clone())?;
            (txt.clone(), a_helpInits.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn fun_165(mut in_txt: Tpl::Text, mut in_a_whenOp: BackendDAE::WhenOperator, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_whenOp.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, BackendDAE::WhenOperator::TERMINATE { message: i_message, .. }, a_varDecls, _) => {
            let mut l_msgVar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
...
fn lm_166(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<BackendDAE::WhenOperator>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_whenOp, tail: rest }, a_varDecls, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_166(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn regularFunctionXml(mut in_txt: Tpl::Text, mut in_a_fn: Arc<SimCodeFunction::Function::Function>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_fn.clone())) {
        (txt, Deref @ SimCodeFunction::Function::FUNCTION { name: i_name, body: i_body, outVars: i_outVars, functionArguments: i_functionArguments, .. }) => {
            ...
            let mut l_varInits: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
pub fn externalFunctionXml(mut in_txt: Tpl::Text, mut in_a_fn: Arc<SimCodeFunction::Function::Function>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_fn.clone())) {
        (txt, i_efn @ Deref @ SimCodeFunction::Function::EXTERNAL_FUNCTION { name: i_name, outVars: i_outVars, funArgs: i_funArgs, .. }) => {
            let mut l_callPart: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_fname: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
...
pub fn extTypeXml(mut txt: Tpl::Text, mut a_type: Arc<DAE::Type>, mut a_isInput: bool, mut a_isArray: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_s: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_205(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::SimExtArg::SimExtArg>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_arg, tail: rest }, a_varDecls, a_preExp) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_205(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_208(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::SimExtArg::SimExtArg>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_arg, tail: rest }, a_varDecls, a_preExp) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_208(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn extArgCXml(mut in_txt: Tpl::Text, mut in_a_extArg: Arc<SimCodeFunction::SimExtArg::SimExtArg>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_extArg.clone(), in_a_preExp.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ SimCodeFunction::SimExtArg::SIMEXTARGSIZE { cref: i_c, exp: i_exp, .. }, a_preExp, a_varDecls) => {
            let mut l_dim: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
pub fn extArgF77Xml(mut in_txt: Tpl::Text, mut in_a_extArg: Arc<SimCodeFunction::SimExtArg::SimExtArg>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_extArg.clone(), in_a_preExp.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ SimCodeFunction::SimExtArg::SIMEXTARGEXP { exp: i_exp, type_: Deref @ DAE::Type::T_STRING { varLst: _ } }, a_preExp, a_varDecls) => {
            let mut l_texp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn lm_213(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ClassAttributes>>>, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_simCode.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_classAttribute, tail: rest }, a_simCode) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_213(txt.clone(), rest.clone(), a_simCode.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn classAttributesXml(mut in_txt: Tpl::Text, mut in_a_classAttribute: Arc<DAE::ClassAttributes>, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_classAttribute.clone(), in_a_simCode.clone())) {
        (txt, Deref @ DAE::ClassAttributes { objetiveE: i_objetiveE, objectiveIntegrandE: i_objectiveIntegrandE, startTimeE: i_startTimeE, finalTimeE: i_finalTimeE }, a_simCode) => {
            let mut l_constraints: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_timePointValue: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_timePointIndex: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_finalTime: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_startTime: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_objectiveIntegrand: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_objectiveFunction: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            l_varDecls = Tpl::emptyTxt.clone();
...
fn lm_223(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Constraint>>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_constraint, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_223(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_225(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_constraint, tail: rest }, a_varDecls, a_preExp) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_225(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn constraintXml(mut in_txt: Tpl::Text, mut in_a_cons: Arc<DAE::Constraint>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_cons.clone())) {
        (txt, Deref @ DAE::Constraint::CONSTRAINT_EXPS { constraintLst: i_constraintLst }) => {
            let mut l_constrain: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            l_varDecls = Tpl::emptyTxt.clone();
            l_preExp = Tpl::emptyTxt.clone();
            l_constrain = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_227(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls) => {
            ...
            (txt, a_varDecls) = algStatementXml(txt.clone(), i_stmt.clone(), SimCodeFunction::contextFunction().clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_227(txt.clone(), rest.clone(), a_varDecls.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn fun_231(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_val: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_val.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        (txt, Deref @ DAE::Exp::ASUB { exp: i_arr, sub: Deref @ metamodelica::List::Cons { head: i_idx, tail: Deref @ metamodelica::List::Nil } }, a_val, a_varDecls, a_context) => {
            let mut l_val1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_idx1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_arr1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
...
fn fun_232(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_exp1: Arc<DAE::Exp>, mut in_a_val: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_exp: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_exp1.clone(), in_a_val.clone(), in_a_varDecls.clone(), in_a_context.clone(), in_a_exp.clone())) {
        ...
        (txt, _, a_exp1, a_val, a_varDecls, a_context, _) => {
            let mut l_expPart: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_varPart: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
...
pub fn algStmtAssignXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ DAE::Statement::STMT_ASSIGN { exp1: i_exp1, exp: i_exp, .. }, a_context, a_varDecls) => {
            let mut l_expPart2: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_expPart1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
...
pub fn algStmtAssignArrXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Statement::STMT_ASSIGN_ARR { exp: i_e, lhs: Deref @ DAE::Exp::CREF { componentRef: i_cr, .. }, type_: i_t, .. }, a_context, a_varDecls) => {
            let mut l_ispec: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_expPart: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
pub fn indexedAssignXml(mut txt: Tpl::Text, mut a_ty: Arc<DAE::Type>, mut a_exp: ArcStr, mut a_cr: Arc<DAE::ComponentRef>, mut a_ispec: ArcStr, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_cref: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_240(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_240(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_241(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_retStruct: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_afterExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_afterExp.clone(), in_a_context.clone(), in_a_retStruct.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_cr, tail: rest }, a_varDecls, a_afterExp, a_context, a_retStruct) => {
            let mut x_i1: i32 = 0;
            let mut l_rhsStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_afterExp) = lm_241(txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone(), a_retStruct.clone())?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_242(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_prefix: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_afterExp.clone(), in_a_context.clone(), in_a_prefix.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_cr, tail: rest }, a_varDecls, a_afterExp, a_context, a_prefix) => {
            ...
            (txt, a_afterExp, a_varDecls) = writeLhsCrefXml(txt.clone(), i_cr.clone(), (Tpl::textString(l_rhsStr.clone())?).clone(), a_context.clone(), a_afterExp.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_afterExp) = lm_242(txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone(), a_prefix.clone())?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_245(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_prefix: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_prefix.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_cr, tail: rest }, a_varDecls, a_prefix) => {
            ...
            let mut l_addRoot: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut str_3: ArcStr = arcstr::literal!("");
            let mut l_initVar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_typ: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_rhsStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            x_i1 = Tpl::getIteri_i0(txt.clone())?;
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_245(txt.clone(), rest.clone(), a_varDecls.clone(), a_prefix.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn algStmtTupleAssignXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Statement::STMT_TUPLE_ASSIGN { exp: i_exp @ Deref @ DAE::Exp::CALL { path: _, .. }, expExpLst: i_expExpLst, .. }, a_context, a_varDecls) => {
            ...
            let mut l_crefs: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_afterExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            ...
            l_preExp = Tpl::writeTok(l_preExp.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            ...
            l_afterExp = Tpl::writeTok(l_afterExp.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            (l_retStruct, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp.clone(), a_varDecls.clone())?;
            l_lhsCrefs = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 1, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
        ...
        (txt, Deref @ DAE::Statement::STMT_TUPLE_ASSIGN { exp: Deref @ DAE::Exp::MATCHEXPRESSION { matchType: _, .. }, expExpLst: i_expExpLst, .. }, a_context, a_varDecls) => {
            ...
            l_lhsCrefs = Tpl::popIter(l_lhsCrefs.clone())?;
            txt = Tpl::pushIter(txt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 1, empty: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("")).clone() })), separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_250(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_250(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn algStmtIfXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Statement::STMT_IF { exp: i_exp, statementLst: i_statementLst, else_: i_else__, .. }, a_context, a_varDecls) => {
            let mut l_condExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
...
fn lm_253(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls, a_context) => {
            ...
            (txt, a_varDecls) = algStatementXml(txt.clone(), i_stmt.clone(), a_context.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_253(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn algStmtForRangeXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Statement::STMT_FOR { range: i_rng @ Deref @ DAE::Exp::RANGE { ty: _, .. }, type_: i_type__, iterIsArray: i_iterIsArray, statementLst: i_statementLst, iter: i_iter, .. }, a_context, a_varDecls) => {
            let mut l_stmtStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_identTypeShort: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_identType: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn fun_256(mut in_txt: Tpl::Text, mut in_a_range: Arc<DAE::Exp>, mut in_a_iterator: ArcStr, mut in_a_body: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_range.clone(), in_a_iterator.clone(), in_a_body.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Exp::RANGE { start: i_start, step: i_step, stop: i_stop, .. }, a_iterator, a_body, a_context, a_varDecls) => {
            let mut l_stopValue: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_stepValue: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_startValue: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_iterName: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn lm_258(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls, a_context) => {
            ...
            (txt, a_varDecls) = algStatementXml(txt.clone(), i_stmt.clone(), a_context.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_258(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn algStmtForGenericXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Statement::STMT_FOR { type_: i_type__, iterIsArray: i_iterIsArray, statementLst: i_statementLst, range: i_range, iter: i_iter, .. }, a_context, a_varDecls) => {
            ...
            let mut l_iterType: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
pub fn algStmtForGeneric_implXml(mut txt: Tpl::Text, mut a_exp: Arc<DAE::Exp>, mut a_iterator: ArcStr, mut a_type: ArcStr, mut a_arrayType: ArcStr, mut a_iterIsArray: bool, mut a_body: Tpl::Text, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_body: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_evar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_iterName: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    l_iterName = contextIteratorNameXml(Tpl::emptyTxt.clone(), (a_iterator.clone()).clone(), a_context.clone())?;
    l_preExp = Tpl::emptyTxt.clone();
...
fn lm_261(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls, a_context) => {
            ...
            (txt, a_varDecls) = algStatementXml(txt.clone(), i_stmt.clone(), a_context.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_261(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_267(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls, a_context) => {
            ...
            (txt, a_varDecls) = algStatementXml(txt.clone(), i_stmt.clone(), a_context.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_267(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn algStmtWhenXml(mut in_txt: Tpl::Text, mut in_a_when: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_when.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Statement::STMT_WHEN { conditions: i_conditions, statementLst: i_statementLst, elseWhen: i_elseWhen, .. }, a_context, a_varDecls) => {
            let mut l_else: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_statements: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_cond: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_cond = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_269(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_269(txt.clone(), rest.clone(), a_varDecls.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_270(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }) => {
            ...
            txt = crefToXmlStr(txt.clone(), i_e.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_270(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn algStatementWhenElseXml(mut in_txt: Tpl::Text, mut in_a_stmt: Option<Arc<DAE::Statement>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_stmt.clone(), in_a_varDecls.clone())) {
        (txt, Some(Deref @ DAE::Statement::STMT_WHEN { statementLst: i_when_statementLst, elseWhen: i_when_elseWhen, conditions: i_when_conditions, .. }), a_varDecls) => {
            let mut l_elseCondStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_else: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_statements: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn lm_274(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_stmt, tail: rest }, a_varDecls, a_context) => {
            ...
            (txt, a_varDecls) = algStatementXml(txt.clone(), i_stmt.clone(), a_context.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls) = lm_274(txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpXml(mut txt: Tpl::Text, mut a_exp: Arc<DAE::Exp>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut ret_3: i32 = 0;
    let mut l_eStr2: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_eStr1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_291(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ DAE::Subscript::INDEX { exp: i_exp }, tail: rest }, a_varDecls, a_preExp, a_context) => {
            ...
            (txt, a_preExp, a_varDecls) = daeExpXml(txt.clone(), i_exp.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_291(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
...
fn fun_294(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_arrName: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_context.clone(), in_a_ecr.clone(), in_a_arrName.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_cr.clone())) {
        (txt, i_context @ SimCodeFunction::Context::FUNCTION_CONTEXT { cref_prefix: _, .. }, _, a_arrName, a_varDecls, a_preExp, a_cr) => {
            ...
            let mut l_dimsValuesStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            let mut a_preExp = (*a_preExp).clone();
...
fn fun_296(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_ecr.clone(), in_a_preExp.clone(), in_a_varDecls.clone(), in_a_ty.clone(), in_a_context.clone(), in_a_cr.clone())) {
        (txt, false, _, a_preExp, a_varDecls, a_ty, a_context, a_cr) => {
            ...
            let mut l_spec1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_tmp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_arrayType: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
        ...
        (txt, _, a_ecr, a_preExp, a_varDecls, a_ty, a_context, a_cr) => {
            ...
            let mut l_dimsLenStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_301(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_dim, tail: rest }) => {
            ...
            txt = lm_301(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn fun_303(mut in_txt: Tpl::Text, mut in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut in_a_subrest: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_sub_exp: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_dims.clone(), in_a_subrest.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone(), in_a_sub_exp.clone())) {
        (txt, Deref @ metamodelica::List::Cons { head: _, tail: i_dimrest }, a_subrest, a_varDecls, a_preExp, a_context, a_sub_exp) => {
            let mut l_estr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            let mut a_preExp = (*a_preExp).clone();
...
fn lm_307(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_sub, tail: rest }, a_varDecls, a_preExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_307(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpCrefRhsIndexSpecXml(mut txt: Tpl::Text, mut a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_tmp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_idx__str: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut ret_1: i32 = 0;
    let mut l_nridx__str: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_309(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_dim, tail: rest }) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_309(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn fun_310(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_ecr_componentRef: Arc<DAE::ComponentRef>, mut in_a_preExp: Tpl::Text, mut in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut in_a_varDecls: Tpl::Text, mut in_a_aty: Arc<DAE::Type>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_context.clone(), in_a_ecr_componentRef.clone(), in_a_preExp.clone(), in_a_dims.clone(), in_a_varDecls.clone(), in_a_aty.clone())) {
        ...
        (txt, _, a_ecr_componentRef, a_preExp, a_dims, a_varDecls, a_aty) => {
            ...
            let mut l_dimsLenStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt_1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_tmpArr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn lm_312(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Var>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone(), in_a_cr.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_v, tail: rest }, a_varDecls, a_preExp, a_context, a_cr) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_312(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone(), a_cr.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_316(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_afterExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ DAE::Subscript::INDEX { exp: i_exp }, tail: rest }, a_varDecls, a_afterExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_afterExp) = lm_316(txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
...
fn fun_318(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_afterExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_mArg.clone(), in_a_varDecls.clone(), in_a_ty.clone(), in_a_context.clone(), in_a_cr.clone(), in_a_ecr.clone(), in_a_afterExp.clone())) {
        (txt, false, a_varDecls, a_ty, a_context, a_cr, a_ecr, a_afterExp) => {
            ...
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
            l_arrName = contextArrayCrefXml(Tpl::emptyTxt.clone(), a_cr.clone(), a_context.clone())?;
            l_arrayType = expTypeArrayXml(Tpl::emptyTxt.clone(), a_ty.clone())?;
            (l_tmp, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(l_arrayType.clone())?).clone(), a_varDecls.clone())?;
            ret_4 = ComponentReferenceBasics::crefSubs(a_cr.clone())?;
        ...
        (txt, _, a_varDecls, a_ty, a_context, a_cr, a_ecr, a_afterExp) => {
            ...
            l_dimsValuesStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_323(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_afterExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_sub, tail: rest }, a_varDecls, a_afterExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_afterExp) = lm_323(txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpCrefLhsIndexSpecXml(mut txt: Tpl::Text, mut a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut a_context: SimCodeFunction::Context, mut a_afterExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    out_a_afterExp = Tpl::writeTok(out_a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
    out_a_afterExp = Tpl::writeTok(out_a_afterExp.clone(), openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE())?;
    out_txt = Tpl::writeText(txt.clone(), l_tmp.clone())?;
    Ok((out_txt, out_a_afterExp, out_a_varDecls))
}
...
fn lm_325(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_dim, tail: rest }) => {
            ...
            txt = dimensionXml(txt.clone(), i_dim.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_325(txt.clone(), rest.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn lm_328(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Var>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_afterExp.clone(), in_a_context.clone(), in_a_cr.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_v, tail: rest }, a_varDecls, a_afterExp, a_context, a_cr) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_afterExp) = lm_328(txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone(), a_cr.clone())?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpRecordCrefLhsXml(mut in_txt: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_context: SimCodeFunction::Context, mut in_a_afterExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_afterExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone(), in_a_cr.clone(), in_a_context.clone(), in_a_afterExp.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Type::T_COMPLEX { complexClassType: i_record__state, varLst: i_var__lst, .. }, a_cr, a_context, a_afterExp, a_varDecls) => {
            ...
            let mut l_record__type__name: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_vars: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_afterExp = (*a_afterExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn fun_336(mut in_txt: Tpl::Text, mut in_a_operator: DAE::Operator, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_exp: Arc<DAE::Exp>, mut in_a_e2: Tpl::Text, mut in_a_e1: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_operator.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone(), in_a_exp.clone(), in_a_e2.clone(), in_a_e1.clone())) {
        ...
        (txt, DAE::Operator::MUL_MATRIX_PRODUCT { ty: i_ty }, a_varDecls, a_preExp, _, _, a_e2, a_e1) => {
            let mut l_typeShort: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_var: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_type: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
pub fn daeExpRelationXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_context.clone(), in_a_preExp.clone(), in_a_varDecls.clone())) {
        (txt, i_rel @ Deref @ DAE::Exp::RELATION { exp1: i_rel_exp1, exp2: i_rel_exp2, operator: i_rel_operator, .. }, a_context, a_preExp, a_varDecls) => {
            let mut l_simRel: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn fun_349(mut in_txt: Tpl::Text, mut in_a_rel_optionExpisASUB: Option<(Arc<DAE::Exp>, i32, i32)>, mut in_a_rel_operator: DAE::Operator, mut in_a_rel_exp2: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_rel_exp1: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_rel_optionExpisASUB.clone(), in_a_rel_operator.clone(), in_a_rel_exp2.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone(), in_a_rel_exp1.clone())) {
        ...
        (txt, Some((i_exp, _, _)), a_rel_operator, a_rel_exp2, a_varDecls, a_preExp, a_context, a_rel_exp1) => {
            let mut l_iterator: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_res: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_e2: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_e1: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
...
pub fn daeExpIfXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_context.clone(), in_a_preExp.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Exp::IFEXP { expCond: i_expCond, expThen: i_expThen, expElse: i_expElse }, a_context, a_preExp, a_varDecls) => {
            let mut l_eElse: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExpElse: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_eThen: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExpThen: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_resVar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_condExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExpCond: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn lm_362(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_dim, tail: rest }, a_varDecls, a_preExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_362(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpCallXml(mut in_txt: Tpl::Text, mut in_a_call: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_call.clone(), in_a_context.clone(), in_a_preExp.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sum" }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. }, expLst: Deref @ metamodelica::List::Cons { head: i_e, tail: Deref @ metamodelica::List::Nil } }, a_context, a_preExp, a_varDecls) => {
            ...
            let mut l_arr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sqrt" }, expLst: Deref @ metamodelica::List::Cons { head: i_e1, tail: Deref @ metamodelica::List::Nil }, attr: Deref @ DAE::CallAttributes { ty: _, .. } }, a_context, a_preExp, a_varDecls) => {
            ...
            let mut ret_15: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut ret_14: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut l_retPre: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "fill" }, expLst: Deref @ metamodelica::List::Cons { head: i_val, tail: i_dims }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. } }, a_context, a_preExp, a_varDecls) => {
            ...
            let mut l_dimsExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_valExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_tvar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_ty__str: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "cat" }, expLst: Deref @ metamodelica::List::Cons { head: i_dim, tail: i_arrays }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. } }, a_context, a_preExp, a_varDecls) => {
            ...
            let mut l_dim__exp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_tvar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_ty__str: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
        ...
        (txt, i_exp @ Deref @ DAE::Exp::CALL { attr: Deref @ DAE::CallAttributes { builtin: i_attr_builtin, ty: i_attr_ty, .. }, expLst: i_expLst, path: i_path }, a_context, a_preExp, a_varDecls) => {
            ...
            let mut l_builtinFunctionName: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_result: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_argStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            l_argStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_378(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_varDecls, a_preExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_378(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpArrayXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_context.clone(), in_a_preExp.clone(), in_a_varDecls.clone())) {
        (txt, Deref @ DAE::Exp::ARRAY { array: i_array, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            l_params = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_susan::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
...
fn lm_380(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Exp>>>>>, mut in_a_vars2: Tpl::Text, mut in_a_promote: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text, mut in_a_arrayTypeStr: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_vars2: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_promote: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    (out_txt, out_a_vars2, out_a_promote, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_vars2.clone(), in_a_promote.clone(), in_a_context.clone(), in_a_varDecls.clone(), in_a_arrayTypeStr.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_row, tail: rest }, a_vars2, a_promote, a_context, a_varDecls, a_arrayTypeStr) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_vars2, a_promote, a_varDecls) = lm_380(txt.clone(), rest.clone(), a_vars2.clone(), a_promote.clone(), a_context.clone(), a_varDecls.clone(), a_arrayTypeStr.clone())?;
            (txt.clone(), a_vars2.clone(), a_promote.clone(), a_varDecls.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpMatrixXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_context.clone(), in_a_preExp.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ DAE::Exp::MATRIX { ty: i_m_ty, matrix: i_m_matrix, .. }, a_context, a_preExp, a_varDecls) => {
            let mut l_tmp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_catAlloc: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_promote: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_vars2: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_382(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varLstStr: Tpl::Text, mut in_a_arrayTypeStr: ArcStr, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varLstStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    (out_txt, out_a_varLstStr, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varLstStr.clone(), in_a_arrayTypeStr.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_varLstStr, a_arrayTypeStr, a_varDecls, a_preExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varLstStr, a_varDecls, a_preExp) = lm_382(txt.clone(), rest.clone(), a_varLstStr.clone(), (a_arrayTypeStr.clone()).clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            (txt.clone(), a_varLstStr.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn daeExpMatrixRowXml(mut txt: Tpl::Text, mut a_row: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut a_arrayTypeStr: ArcStr, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_preExp2: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_varLstStr: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn fun_386(mut in_txt: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_preExp: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_expVar: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone(), in_a_preExp.clone(), in_a_exp.clone(), in_a_varDecls.clone(), in_a_expVar.clone())) {
        ...
        (txt, Deref @ DAE::Type::T_ARRAY { ty: i_ty, .. }, a_preExp, a_exp, a_varDecls, a_expVar) => {
            let mut l_from: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn lm_390(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_res: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_res.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_res, a_context) => {
            let mut x_i1: i32 = 0;
            let mut l_v: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_casePreExp: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut l_caseVarDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            x_i1 = Tpl::getIteri_i0(txt.clone())?;
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}")).clone() }))?;
            txt = Tpl::nextIter(txt.clone())?;
            txt = lm_390(txt.clone(), rest.clone(), a_res.clone(), a_context.clone())?;
            txt.clone()
        },
        _ => bail!("match: no arm matched"),
    } });
...
fn fun_392(mut in_txt: Tpl::Text, mut in_a_inExp: Arc<DAE::Exp>, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_inExp.clone(), in_a_preExp.clone(), in_a_context.clone(), in_a_varDecls.clone())) {
        ...
        (txt, Deref @ DAE::Exp::ASUB { exp: i_ecr @ Deref @ DAE::Exp::CREF { ty: i_ecr_ty, .. }, sub: i_subs }, a_preExp, a_context, a_varDecls) => {
            let mut ret_7: Arc<DAE::Exp> = Arc::new(<DAE::Exp as ::std::default::Default>::default());
            let mut l_arrName: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_preExp = (*a_preExp).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
fn lm_403(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt.clone(), in_items.clone(), in_a_varDecls.clone(), in_a_preExp.clone(), in_a_context.clone())) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_sub, tail: rest }, a_varDecls, a_preExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            (txt, a_varDecls, a_preExp) = lm_403(txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => bail!("match: no arm matched"),
    } });
...
pub fn outDeclXml(mut txt: Tpl::Text, mut a_ty: ArcStr, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_newVar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
...
fn fun_407(mut in_txt: Tpl::Text, mut in_a_ty: ArcStr, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_ty.clone(), in_a_varDecls.clone())) {
        ...
        (txt, i_ty, a_varDecls) => {
            let mut ret_4: i32 = 0;
            let mut l_newVarIx: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
...
pub fn expTypeShortXml(mut in_txt: Tpl::Text, mut in_a_type: Arc<DAE::Type>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_type.clone())) {
        ...
        (txt, Deref @ DAE::Type::T_STRING { varLst: _ }) => {
            ...
            txt = fun_414(txt.clone(), ret_0.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::Type::T_BOOL { varLst: _ }) => {
            let mut txt = (*txt).clone();
...
pub fn expTypeFromExpFlagXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_flag: i32) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt.clone(), in_a_exp.clone(), in_a_flag.clone())) {
        (txt, Deref @ DAE::Exp::ICONST { integer: _ }, a_flag) => {
            let mut txt = (*txt).clone();
            txt = fun_430(txt.clone(), a_flag.clone())?;
            txt.clone()
        },
        ...
        (txt, Deref @ DAE::Exp::SCONST { string: _ }, a_flag) => {
            ...
            let mut txt = (*txt).clone();
            ret_0 = Config::acceptMetaModelicaGrammar()?;
            txt = fun_434(txt.clone(), ret_0.clone(), a_flag.clone())?;
            txt.clone()
        },
        (txt, Deref @ DAE::Exp::BCONST { bool: _ }, a_flag) => {
            let mut txt = (*txt).clone();
            txt = fun_435(txt.clone(), a_flag.clone())?;
            txt.clone()
        },
...
pub fn assertCommonXml(mut txt: Tpl::Text, mut a_condition: Arc<DAE::Exp>, mut a_message: Arc<DAE::Exp>, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text, mut a_info: SourceInfo) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_msgVar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_condVar: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_preExpMsg: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    let mut l_preExpCond: Tpl::Text = <Tpl::Text as ::std::default::Default>::default();
    l_preExpCond = Tpl::emptyTxt.clone();
