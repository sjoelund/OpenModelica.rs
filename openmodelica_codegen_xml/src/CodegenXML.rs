...
pub fn translateModel(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: SimCode::ModelInfo { name: ref i_modelInfo_name, .. }, .. }) => {
            ...
            txt_1 = Tpl::writeTok(txt_1, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".xml")).clone() }))?;
...
pub(crate) fn generateXml(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, ref i_simCode @ SimCode::SimCode { modelInfo: ref i_modelInfo @ SimCode::ModelInfo { functions: ref i_modelInfo_functions, .. }, simulationSettingsOpt: ref i_simulationSettingsOpt, allEquations: ref i_allEquations, initialEquations: ref i_initialEquations, recordDecls: ref i_recordDecls, classAttributes: ref i_classAttributes, .. }) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_prefix)?;
            ...
            txt = modelDescriptionXml(txt.clone(), i_simCode.clone(), (Tpl::textString(l_guid)?).clone())?;
...
pub(crate) fn vendorAnnotationsXml(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode) {
        (mut txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { varInfo: SimCode::VarInfo { numZeroCrossings: _, .. }, .. }, .. }) => {
            ...
            l_generationTool = Tpl::writeStr(l_generationTool, (ret_1).clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_generationTool)?;
...
pub(crate) fn modelDescriptionXml(mut in_txt: Tpl::Text, mut in_a_simCode: SimCode::SimCode, mut in_a_guid: ArcStr) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simCode, in_a_guid) {
        (mut txt, SimCode::SimCode { modelInfo: SimCode::ModelInfo { varInfo: SimCode::VarInfo { numStateVars: mut i_modelInfo_varInfo_numStateVars, numZeroCrossings: mut i_modelInfo_varInfo_numZeroCrossings, .. }, name: ref i_modelInfo_name, .. }, fileNamePrefix: mut i_fileNamePrefix, .. }, mut a_guid) => {
            ...
            l_modelIdentifier = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_3).clone())?;
            l_description = Tpl::emptyTxt.clone();
            l_author = Tpl::emptyTxt.clone();
            l_version = Tpl::emptyTxt.clone();
            ret_8 = Util::getCurrentDateTime();
            l_generationDateAndTime = xsdateTimeXml(Tpl::emptyTxt.clone(), ret_8)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_fmiVersion)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("\"\n")).clone(), (literal!("modelName=\"")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_modelName)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("\"\n")).clone(), (literal!("modelIdentifier=\"")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_modelIdentifier)?;
            ...
            txt = Tpl::writeText(txt.clone(), l_generationDateAndTime)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("\"\n")).clone(), (literal!("variableNamingConvention=\"")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_variableNamingConvention)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("\"\n")).clone(), (literal!("numberOfContinuousStates=\"")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_numberOfContinuousStates)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("\"\n")).clone(), (literal!("numberOfEventIndicators=\"")).clone()], lastHasNewLine: false }))?;
            txt = Tpl::writeText(txt.clone(), l_numberOfEventIndicators)?;
...
pub(crate) fn defaultExperiment(mut in_txt: Tpl::Text, mut in_a_simulationSettingsOpt: Option<SimCode::SimulationSettings>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_simulationSettingsOpt) {
...
fn lm_49(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    '__tco: loop {
...
pub(crate) fn ScalarVariableAttributesXml(mut in_txt: Tpl::Text, mut in_a_simVar: SimCodeVar::SimVar) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_simVar) {
        (mut txt, SimCodeVar::SimVar { varKind: mut i_varKind, comment: mut i_comment, aliasvar: mut i_aliasvar, causality: mut i_causality, name: ref i_name, type_: ref i_type__, unit: mut i_unit, displayUnit: mut i_displayUnit, minValue: mut i_minValue, maxValue: mut i_maxValue, initialValue: mut i_initialValue, isFixed: mut i_isFixed, .. }) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_variableCategory)?;
...
pub(crate) fn getVariablityXml(mut in_txt: Tpl::Text, mut in_a_varKind: BackendDAE::VarKind) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_varKind) {
...
pub(crate) fn getAliasVarXml(mut in_txt: Tpl::Text, mut in_a_aliasvar: SimCodeVar::AliasVariable) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_aliasvar) {
...
pub(crate) fn ScalarVariableTypeXml(mut in_txt: Tpl::Text, mut in_a_type__: Arc<DAE::Type>, mut in_a_unit: ArcStr, mut in_a_displayUnit: ArcStr, mut in_a_minValue: Option<Arc<DAE::Exp>>, mut in_a_maxValue: Option<Arc<DAE::Exp>>, mut in_a_initialValue: Option<Arc<DAE::Exp>>, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_type__, in_a_unit, in_a_displayUnit, in_a_minValue, in_a_maxValue, in_a_initialValue, in_a_isFixed)) {
...
fn fun_79(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_isFixed: bool, mut in_a_exp: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_isFixed, in_a_exp)) {
        (txt, false, _, _) => {
            txt.clone()
        },
...
pub(crate) fn ScalarVariableTypeCommonAttributeXml(mut in_txt: Tpl::Text, mut in_a_initialValue: Option<Arc<DAE::Exp>>, mut in_a_isFixed: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_initialValue, in_a_isFixed)) {
        (txt, Some(i_exp), a_isFixed) => {
            ...
            txt = fun_79(txt.clone(), ret_2, a_isFixed.clone(), i_exp.clone())?;
            txt.clone()
        },
        (txt, _, _) => {
            txt.clone()
...
pub(crate) fn ScalarVariableTypeMinAttribute(mut in_txt: Tpl::Text, mut in_a_minValue: Option<Arc<DAE::Exp>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_minValue)) {
        (txt, Some(i_exp)) => {
            let mut txt = (*txt).clone();
...
pub(crate) fn ScalarVariableTypeMaxAttribute(mut in_txt: Tpl::Text, mut in_a_maxValue: Option<Arc<DAE::Exp>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_maxValue)) {
        (txt, Some(i_exp)) => {
            let mut txt = (*txt).clone();
...
fn fun_85(mut in_txt: Tpl::Text, mut in_a_unit: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_unit)) {
        (txt, Deref @ "") => {
            txt.clone()
        },
        (txt, i_unit) => {
...
fn fun_86(mut in_txt: Tpl::Text, mut in_a_displayUnit: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_displayUnit)) {
        (txt, Deref @ "") => {
            txt.clone()
        },
        (txt, i_displayUnit) => {
...
pub(crate) fn ScalarVariableTypeRealAttributeXml(mut txt: Tpl::Text, mut a_unit: ArcStr, mut a_displayUnit: ArcStr) -> Result<Tpl::Text> {
    ...
    l_unit__ = fun_85(Tpl::emptyTxt.clone(), (a_unit).clone())?;
    l_displayUnit__ = fun_86(Tpl::emptyTxt.clone(), (a_displayUnit).clone())?;
...
fn fun_88(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_cr)) {
        (txt, SimCodeFunction::Context::FUNCTION_CONTEXT { cref_prefix: _, .. }, a_cr) => {
            let mut ret_1: ArcStr;
            let mut txt_0: Tpl::Text;
            let mut txt = (*txt).clone();
            txt_0 = crefStrXml(Tpl::emptyTxt.clone(), a_cr.clone())?;
            ret_1 = (System::unquoteIdentifier((Tpl::textString(txt_0)?).clone())).clone();
            txt = Tpl::writeStr(txt.clone(), (ret_1).clone())?;
            txt.clone()
        },
        (txt, _, a_cr) => {
...
pub(crate) fn contextIteratorNameXml(mut txt: Tpl::Text, mut a_name: ArcStr, mut a_context: SimCodeFunction::Context) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_90(txt, a_context, (a_name).clone())?;
    Ok(out_txt)
}

pub(crate) fn crefXml(mut in_txt: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_cr)) {
...
fn fun_93(mut in_txt: Tpl::Text, mut in_a_arrayTest: Tpl::Text, mut in_a_subscriptLst: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_ident: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_arrayTest, in_a_subscriptLst, in_a_ident)) {
...
fn fun_94(mut in_txt: Tpl::Text, mut in_a_arrayTest: Tpl::Text, mut in_a_subscriptLst: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_componentRef: Arc<DAE::ComponentRef>, mut in_a_ident: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_arrayTest, in_a_subscriptLst, in_a_componentRef, in_a_ident)) {
...
pub(crate) fn qualifiedNamePartXml(mut in_txt: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_a_cr)) {
        (txt, Deref @ DAE::ComponentRef::CREF_IDENT { subscriptLst: i_subscriptLst, ident: i_ident, .. }) => {
            ...
            return Ok(fun_93(txt.clone(), l_arrayTest, i_subscriptLst.clone(), (i_ident.clone()).clone())?)
        },
        ...
        (txt, Deref @ DAE::ComponentRef::CREF_QUAL { subscriptLst: i_subscriptLst, ident: i_ident, componentRef: i_componentRef, .. }) => {
            ...
            let mut txt = (*txt).clone();
            l_arrayTest = arraysubscriptsStrXml(Tpl::emptyTxt.clone(), i_subscriptLst.clone())?;
            return Ok(fun_94(txt.clone(), l_arrayTest, i_subscriptLst.clone(), i_componentRef.clone(), (i_ident.clone()).clone())?)
        },
        (txt, _) => {
            let mut txt = (*txt).clone();
...
fn lm_96(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn contextArrayCrefXml(mut txt: Tpl::Text, mut a_cr: Arc<DAE::ComponentRef>, mut a_context: SimCodeFunction::Context) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_101(txt, a_context, a_cr)?;
    Ok(out_txt)
}
...
fn lm_106(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn expCrefXml(mut in_txt: Tpl::Text, mut in_a_ecr: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_ecr)) {
        (txt, Deref @ DAE::Exp::CREF { componentRef: i_componentRef, .. }) => {
            let mut txt = (*txt).clone();
...
pub(crate) fn crefFunctionNameXml(mut in_txt: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<Tpl::Text> {
    '__tco: loop {
        ...
        (txt, Deref @ DAE::ComponentRef::CREF_IDENT { ident: i_ident, .. }) => {
            ...
            let mut txt = (*txt).clone();
            ret_0 = (System::unquoteIdentifier((i_ident.clone()).clone())).clone();
            ret_1 = (System::stringReplace((ret_0).clone(), (literal!("_")).clone(), (literal!("__")).clone())?).clone();
            return Ok(Tpl::writeStr(txt.clone(), (ret_1).clone())?)
        },
        (txt, Deref @ DAE::ComponentRef::CREF_QUAL { ident: i_ident, componentRef: i_componentRef, .. }) => {
            let mut ret_3: ArcStr;
            let mut ret_2: ArcStr;
            ...
            ret_3 = (System::stringReplace((ret_2).clone(), (literal!("_")).clone(), (literal!("__")).clone())?).clone();
            txt = Tpl::writeStr(txt.clone(), (ret_3).clone())?;
...
fn lm_114(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn fun_119(mut in_txt: Tpl::Text, mut in_a_initialValue: Option<Arc<DAE::Exp>>, mut in_a_varName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_initialValue, in_a_varName)) {
        (txt, Some(i_exp), a_varName) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            (txt, l_preExp, l_varDecls) = daeExpXml(txt.clone(), i_exp.clone(), SimCodeFunction::contextOther().clone(), l_preExp, l_varDecls)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn bindingEquationXml(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_var) {
        (mut txt, SimCodeVar::SimVar { name: ref i_name, initialValue: mut i_initialValue, .. }) => {
            ...
            txt = fun_119(txt.clone(), i_initialValue.clone(), l_varName)?;
            txt.clone()
        },
        (mut txt, _) => {
            txt.clone()
...
fn lm_121(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_tmp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_tmp, in_a_varDecls)) {
        (txt, Deref @ metamodelica::List::Nil, a_tmp, a_varDecls) => {
            return Ok((txt.clone(), a_tmp.clone(), a_varDecls.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_eq, tail: rest }, a_tmp, a_varDecls) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_tmp, in_a_varDecls) = (txt.clone(), rest.clone(), a_tmp.clone(), a_varDecls.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn equationsXml(mut txt: Tpl::Text, mut a_allEquationsPlusWhen: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>) -> Result<Tpl::Text> {
    ...
    (l_eqs, l_tmp, l_varDecls) = lm_121(l_eqs, a_allEquationsPlusWhen, l_tmp, l_varDecls)?;
    l_eqs = Tpl::popIter(l_eqs)?;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<equ:DynamicEquations>\n")).clone() }))?;
    ...
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</equ:DynamicEquations>")).clone() }))?;
    Ok(out_txt)
}

fn lm_123(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls)) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_eq, tail: rest }, a_varDecls) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls) = (txt.clone(), rest.clone(), a_varDecls.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn algorithmicEquationsXml(mut txt: Tpl::Text, mut a_allEquations: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>) -> Result<Tpl::Text> {
    ...
    (l_algs, l_varDecls) = lm_123(l_algs, a_allEquations, l_varDecls)?;
    l_algs = Tpl::popIter(l_algs)?;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:Algorithm>\n")).clone() }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
    out_txt = Tpl::writeText(out_txt, l_algs)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</fun:Algorithm>")).clone() }))?;
    Ok(out_txt)
}

fn lm_125(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
fn fun_126(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_varDecls)) {
        (txt, Deref @ SimCode::SimEqSystem::SES_ALGORITHM { statements: i_statements, .. }, a_varDecls) => {
            ...
            (l_alg, a_varDecls) = lm_125(l_alg, i_statements.clone(), a_varDecls.clone())?;
            l_alg = Tpl::popIter(l_alg)?;
            txt = Tpl::writeText(txt.clone(), l_alg)?;
...
pub(crate) fn equationAlgorithmXml(mut txt: Tpl::Text, mut a_eq: Arc<SimCode::SimEqSystem>, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = fun_126(txt, a_eq, a_varDecls)?;
    Ok((out_txt, out_a_varDecls))
}

fn lm_128(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_tmp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_tmp, in_a_varDecls)) {
        (txt, Deref @ metamodelica::List::Nil, a_tmp, a_varDecls) => {
            return Ok((txt.clone(), a_tmp.clone(), a_varDecls.clone()))
...
fn lm_129(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeVar::SimVar>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn initialEquationsXml(mut in_txt: Tpl::Text, mut in_a_modelInfo: SimCode::ModelInfo, mut in_a_initialEqs: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_modelInfo, in_a_initialEqs)) {
        (txt, SimCode::ModelInfo { varInfo: SimCode::VarInfo { numStateVars: _, .. }, vars: SimCodeVar::SimVars { stateVars: i_vars_stateVars, derivativeVars: i_vars_derivativeVars, algVars: i_vars_algVars, discreteAlgVars: i_vars_discreteAlgVars, intAlgVars: i_vars_intAlgVars, boolAlgVars: i_vars_boolAlgVars, stringAlgVars: i_vars_stringAlgVars, .. }, .. }, a_initialEqs) => {
            ...
            l_tmp = Tpl::emptyTxt.clone();
            l_eqs = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            (l_eqs, l_tmp, l_varDecls) = lm_128(l_eqs, a_initialEqs.clone(), l_tmp, l_varDecls)?;
            l_eqs = Tpl::popIter(l_eqs)?;
            ...
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_tmp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_eqs)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn fun_137(mut in_txt: Tpl::Text, mut in_a_initialValue: Option<Arc<DAE::Exp>>, mut in_a_identName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_initialValue, in_a_identName)) {
...
pub(crate) fn initialEquationXml(mut in_txt: Tpl::Text, mut in_a_var: SimCodeVar::SimVar) -> Result<Tpl::Text> {
    ...
    out_txt = (match (in_txt, in_a_var) {
        (mut txt, SimCodeVar::SimVar { name: ref i_name, initialValue: mut i_initialValue, .. }) => {
            ...
            txt = fun_137(txt.clone(), i_initialValue.clone(), l_identName)?;
            txt.clone()
        },
        (mut txt, _) => {
            txt.clone()
...
fn fun_139(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_varD: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varD) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_varD, in_a_context)) {
...
pub(crate) fn equation_Xml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text, mut in_a_eqs: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_eqs) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_context, in_a_varDecls, in_a_eqs)) {
        ...
        (txt, i_eq, a_context, a_varDecls, a_eqs) => {
            ...
            l_ix = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_1)).clone())?;
            l_tmp = Tpl::emptyTxt.clone();
            l_varD = Tpl::emptyTxt.clone();
            (l_x, l_varD) = fun_139(Tpl::emptyTxt.clone(), i_eq.clone(), l_varD, a_context.clone())?;
            ...
            a_eqs = Tpl::writeText(a_eqs.clone(), l_x)?;
...
pub(crate) fn old_equation_Xml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_context, in_a_varDecls)) {
...
fn fun_142(mut in_txt: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_expPart: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_preExp, in_a_expPart)) {
...
pub(crate) fn equationSimpleAssignXml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_context, in_a_varDecls)) {
        (txt, Deref @ SimCode::SimEqSystem::SES_SIMPLE_ASSIGN { exp: i_exp, cref: i_cref, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            l_result = fun_142(Tpl::emptyTxt.clone(), l_preExp, l_expPart)?;
            txt = crefXml(txt.clone(), i_cref.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_result)?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, Deref @ SimCode::SimEqSystem::SES_SIMPLE_ASSIGN_CONSTRAINTS { exp: i_exp, cref: i_cref, .. }, a_context, a_varDecls) => {
            ...
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            l_result = fun_143(Tpl::emptyTxt.clone(), l_preExp, l_expPart)?;
            txt = crefXml(txt.clone(), i_cref.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_result)?;
            (txt.clone(), a_varDecls.clone())
...
fn fun_145(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_eqn_exp: Arc<DAE::Exp>, mut in_a_lhs_componentRef: Arc<DAE::ComponentRef>, mut in_a_expPart: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_eqn_exp, in_a_lhs_componentRef, in_a_expPart)) {
        ...
        (txt, _, a_eqn_exp, _, _) => {
            ...
            txt_0 = ExpressionDumpTpl::dumpExp(txt_0, a_eqn_exp.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 850, 14), (Tpl::textString(txt_0)?).clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub(crate) fn equationArrayCallAssignXml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_context, in_a_varDecls)) {
        (txt, Deref @ SimCode::SimEqSystem::SES_ARRAY_CALL_ASSIGN { lhs: Deref @ DAE::Exp::CREF { componentRef: i_lhs_componentRef, .. }, exp: i_eqn_exp @ i_exp, .. }, a_context, a_varDecls) => {
            ...
            str_3 = (Tpl::textString(txt_2)?).clone();
            txt = fun_145(txt.clone(), (str_3).clone(), i_eqn_exp.clone(), i_lhs_componentRef.clone(), l_expPart)?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_varDecls) => {
            (txt.clone(), a_varDecls.clone())
...
fn lm_147(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<(i32, i32, Arc<SimCode::SimEqSystem>)>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: (_, _, Deref @ SimCode::SimEqSystem::SES_RESIDUAL { exp: i_eq_exp, .. }), tail: rest }, a_varDecls, a_context) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_eq_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            ...
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_context) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_context.clone()); continue '__tco; }
        },
...
fn lm_148(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
fn lm_150(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_tmp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_tmp, in_a_varDecls)) {
        (txt, Deref @ metamodelica::List::Nil, a_tmp, a_varDecls) => {
            return Ok((txt.clone(), a_tmp.clone(), a_varDecls.clone()))
...
fn lm_151(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCode::SimEqSystem>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls) => {
            return Ok((txt.clone(), a_varDecls.clone()))
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ SimCode::SimEqSystem::SES_RESIDUAL { exp: i_eq2_exp, .. }, tail: rest }, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_eq2_exp.clone(), SimCodeFunction::contextSimulationDiscrete().clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeText(txt.clone(), l_preExp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_expPart)?;
...
fn fun_152(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_eq)) {
        (txt, Deref @ SimCode::SimEqSystem::SES_NONLINEAR { nlSystem: Deref @ SimCode::NonlinearSystem { eqs: i_nls_eqs, .. }, .. }) => {
            ...
            (l_prebody, l_tmp, l_varDecls) = lm_150(l_prebody, i_nls_eqs.clone(), l_tmp, l_varDecls)?;
            ...
            (l_body, l_varDecls) = lm_151(l_body, i_nls_eqs.clone(), l_varDecls)?;
            l_body = Tpl::popIter(l_body)?;
            txt = Tpl::writeText(txt.clone(), l_tmp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_prebody)?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn functionExtraResidualsPreBody(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_varDecls: Tpl::Text, mut in_a_eqs: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_eqs: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_eqs) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_varDecls, in_a_eqs)) {
...
fn lm_155(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_helpInits)) {
        (txt, Deref @ metamodelica::List::Nil, a_helpInits) => {
            return Ok((txt.clone(), a_helpInits.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_helpInits) => {
            ...
            a_helpInits = Tpl::writeText(a_helpInits.clone(), l_helpInit)?;
            a_helpInits = Tpl::writeTok(a_helpInits.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_helpInits) = (txt.clone(), rest.clone(), a_helpInits.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_156(mut in_txt: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_helpInits: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_preExp, in_a_helpInits)) {
...
fn lm_157(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_helpInits)) {
        (txt, Deref @ metamodelica::List::Nil, a_helpInits) => {
            return Ok((txt.clone(), a_helpInits.clone()))
...
pub(crate) fn equationWhenXml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_context, in_a_varDecls)) {
        (txt, Deref @ SimCode::SimEqSystem::SES_WHEN { whenStmtLst: i_whenStmtLst, conditions: i_conditions, elseWhen: None, .. }, a_context, a_varDecls) => {
            ...
            (l_helpIf, l_helpInits) = lm_155(l_helpIf, i_conditions.clone(), l_helpInits)?;
            ...
            l_cond = fun_156(Tpl::emptyTxt.clone(), l_preExp, l_helpInits)?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::writeText(txt.clone(), l_cond)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
        ...
        (txt, Deref @ SimCode::SimEqSystem::SES_WHEN { whenStmtLst: i_whenStmtLst, conditions: i_conditions, elseWhen: Some(i_elseWhenEq), .. }, a_context, a_varDecls) => {
            ...
            (l_helpIf, l_helpInits) = lm_157(l_helpIf, i_conditions.clone(), l_helpInits)?;
            l_helpIf = Tpl::popIter(l_helpIf)?;
            (l_body, a_varDecls) = whenOps(Tpl::emptyTxt.clone(), i_whenStmtLst.clone(), a_context.clone(), a_varDecls.clone())?;
            (l_elseWhen, l_preExp, l_helpInits, a_varDecls) = equationElseWhenXml(Tpl::emptyTxt.clone(), i_elseWhenEq.clone(), a_context.clone(), l_preExp, l_helpInits, a_varDecls.clone())?;
            l_cond = fun_158(Tpl::emptyTxt.clone(), l_preExp, l_helpInits)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("<equ:When>\n")).clone(), (literal!("  <equ:Condition>\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::writeText(txt.clone(), l_cond)?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_elseWhen)?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_varDecls) => {
            (txt.clone(), a_varDecls.clone())
...
fn lm_160(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_helpInits)) {
        (txt, Deref @ metamodelica::List::Nil, a_helpInits) => {
            return Ok((txt.clone(), a_helpInits.clone()))
...
fn lm_162(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>, mut in_a_helpInits: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_helpInits)) {
        (txt, Deref @ metamodelica::List::Nil, a_helpInits) => {
            return Ok((txt.clone(), a_helpInits.clone()))
...
pub(crate) fn equationElseWhenXml(mut in_txt: Tpl::Text, mut in_a_eq: Arc<SimCode::SimEqSystem>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_helpInits: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_helpInits, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_eq, in_a_context, in_a_preExp, in_a_helpInits, in_a_varDecls)) {
        (txt, Deref @ SimCode::SimEqSystem::SES_WHEN { whenStmtLst: i_whenStmtLst, conditions: i_conditions, elseWhen: None, .. }, a_context, a_preExp, a_helpInits, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_helpIf = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" || ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            (l_helpIf, a_helpInits) = lm_160(l_helpIf, i_conditions.clone(), a_helpInits.clone())?;
            l_helpIf = Tpl::popIter(l_helpIf)?;
            (l_body, a_varDecls) = whenOps(Tpl::emptyTxt.clone(), i_whenStmtLst.clone(), a_context.clone(), a_varDecls.clone())?;
        ...
        (txt, Deref @ SimCode::SimEqSystem::SES_WHEN { whenStmtLst: i_whenStmtLst, conditions: i_conditions, elseWhen: Some(i_elseWhenEq), .. }, a_context, a_preExp, a_helpInits, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_helpIf = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" || ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            (l_helpIf, a_helpInits) = lm_162(l_helpIf, i_conditions.clone(), a_helpInits.clone())?;
            l_helpIf = Tpl::popIter(l_helpIf)?;
            (l_body, a_varDecls) = whenOps(Tpl::emptyTxt.clone(), i_whenStmtLst.clone(), a_context.clone(), a_varDecls.clone())?;
...
fn fun_165(mut in_txt: Tpl::Text, mut in_a_whenOp: BackendDAE::WhenOperator, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_whenOp, in_a_varDecls, in_a_context)) {
        (txt, BackendDAE::WhenOperator::ASSIGN { left: Deref @ DAE::Exp::CREF { componentRef: i_cr, .. }, right: i_right, .. }, a_varDecls, a_context) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_exp, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_right.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("  <exp:Sub>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = crefXml(txt.clone(), i_cr.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_exp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
        ...
        (txt, BackendDAE::WhenOperator::REINIT { value: i_value, stateVar: i_stateVar, .. }, a_varDecls, _) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_val, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_value.clone(), SimCodeFunction::contextSimulationDiscrete().clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<exp:Reinit>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = crefXml(txt.clone(), i_stateVar.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_val)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
        ...
        (txt, BackendDAE::WhenOperator::TERMINATE { message: i_message, .. }, a_varDecls, _) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_msgVar, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_message.clone(), SimCodeFunction::contextSimulationDiscrete().clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 1 }))?;
            txt = Tpl::writeText(txt.clone(), l_preExp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_msgVar)?;
            txt = Tpl::popBlock(txt.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
...
fn lm_166(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<BackendDAE::WhenOperator>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn whenOps(mut txt: Tpl::Text, mut a_whenOps: Arc<metamodelica::List<BackendDAE::WhenOperator>>, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    let mut l_body: Tpl::Text;
    l_body = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    (l_body, out_a_varDecls) = lm_166(l_body, a_whenOps, a_varDecls, a_context)?;
    l_body = Tpl::popIter(l_body)?;
    out_txt = Tpl::writeText(txt, l_body)?;
    Ok((out_txt, out_a_varDecls))
}

fn lm_168(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<SimCodeFunction::RecordDeclaration>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn recordsXml(mut txt: Tpl::Text, mut a_recordDecls: Arc<metamodelica::List<SimCodeFunction::RecordDeclaration>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:RecordsList>\n")).clone() }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
    ...
    out_txt = lm_168(out_txt, a_recordDecls)?;
    out_txt = Tpl::popIter(out_txt)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</fun:RecordsList>")).clone() }))?;
    Ok(out_txt)
}

fn lm_170(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::Variable::Variable>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn recordDeclarationXml(mut in_txt: Tpl::Text, mut in_a_recDecl: SimCodeFunction::RecordDeclaration) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_recDecl) {
...
pub(crate) fn recordBodyXml(mut in_txt: Tpl::Text, mut in_a_var: Arc<SimCodeFunction::Variable::Variable>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_var)) {
...
fn lm_173(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::Function::Function>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn functionsXml(mut txt: Tpl::Text, mut a_functions: Arc<metamodelica::List<Arc<SimCodeFunction::Function::Function>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:FunctionsList>\n")).clone() }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
    out_txt = Tpl::pushIter(out_txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    out_txt = lm_173(out_txt, a_functions)?;
    out_txt = Tpl::popIter(out_txt)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</fun:FunctionsList>")).clone() }))?;
    Ok(out_txt)
}
...
fn lm_176(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::Variable::Variable>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn regularFunctionXml(mut in_txt: Tpl::Text, mut in_a_fn: Arc<SimCodeFunction::Function::Function>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_fn)) {
        (txt, Deref @ SimCodeFunction::Function::FUNCTION { name: i_name, body: i_body, outVars: i_outVars, functionArguments: i_functionArguments, .. }) => {
            ...
            (l_bodyPart, l_varDecls) = funStatementXml(Tpl::emptyTxt.clone(), i_body.clone(), l_varDecls)?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_bodyPart)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("</fun:Algorithm>\n")).clone() }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn lm_179(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::Variable::Variable>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn externalFunctionXml(mut in_txt: Tpl::Text, mut in_a_fn: Arc<SimCodeFunction::Function::Function>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_fn)) {
        (txt, i_efn @ Deref @ SimCodeFunction::Function::EXTERNAL_FUNCTION { name: i_name, outVars: i_outVars, funArgs: i_funArgs, .. }) => {
            ...
            l_varDecls = Tpl::emptyTxt.clone();
            l_fname = underscorePathXml(Tpl::emptyTxt.clone(), i_name.clone())?;
            (l_callPart, l_preExp, l_varDecls) = extFunCallXml(Tpl::emptyTxt.clone(), i_efn.clone(), l_preExp, l_varDecls)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("<fun:Function>\n")).clone(), (literal!("  <fun:Name>\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::writeText(txt.clone(), l_fname)?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:Algorithm>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_callPart)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("</fun:Algorithm>\n")).clone() }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn fun_186(mut in_txt: Tpl::Text, mut in_a_language: ArcStr, mut in_a_name: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_language, in_a_name)) {
        (txt, Deref @ "C", a_name) => {
            let mut txt = (*txt).clone();
        ...
        (txt, i_language, _) => {
            ...
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 1250, 14), (Tpl::textString(txt_0)?).clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub(crate) fn extFunctionNameXml(mut txt: Tpl::Text, mut a_name: ArcStr, mut a_language: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_186(txt, (a_language).clone(), (a_name).clone())?;
    Ok(out_txt)
}

fn fun_188(mut in_txt: Tpl::Text, mut in_a_type: Arc<DAE::Type>, mut in_a_isInput: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_type, in_a_isInput)) {
        ...
        (txt, i_type, _) => {
            ...
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 1268, 14), (Tpl::textString(txt_0)?).clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_190(mut in_txt: Tpl::Text, mut in_a_isArray: bool, mut in_a_s: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_isArray, in_a_s) {
        ...
        (mut txt, _, mut a_s) => {
            ...
            txt = fun_189(txt.clone(), (str_0).clone())?;
            txt = Tpl::writeText(txt.clone(), a_s.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("*")).clone() }))?;
            txt.clone()
        },
...
fn fun_191(mut in_txt: Tpl::Text, mut in_a_isInput: bool, mut in_a_isArray: bool, mut in_a_s: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_isInput, in_a_isArray, in_a_s) {
...
fn fun_192(mut in_txt: Tpl::Text, mut in_a_type: Arc<DAE::Type>, mut in_a_isArray: bool, mut in_a_isInput: bool, mut in_a_s: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_type, in_a_isArray, in_a_isInput, in_a_s)) {
...
pub(crate) fn extTypeXml(mut txt: Tpl::Text, mut a_type: Arc<DAE::Type>, mut a_isInput: bool, mut a_isArray: bool) -> Result<Tpl::Text> {
    ...
    l_s = fun_188(Tpl::emptyTxt.clone(), a_type.clone(), a_isInput)?;
    out_txt = fun_192(txt, a_type, a_isArray, a_isInput, l_s)?;
    Ok(out_txt)
}

fn fun_194(mut in_txt: Tpl::Text, mut in_a_type: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_type)) {
        ...
        (txt, i_type) => {
            ...
            ret_0 = (TypesDump::unparseType(i_type.clone())?).clone();
            txt_0 = Tpl::writeStr(txt_0, (ret_0).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 1287, 14), (Tpl::textString(txt_0)?).clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_195(mut in_txt: Tpl::Text, mut in_a_isReference: bool, mut in_a_s: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_isReference, in_a_s) {
        (mut txt, false, mut a_s) => {
            txt = Tpl::writeText(txt.clone(), a_s.clone())?;
            txt.clone()
        },
...
fn fun_196(mut in_txt: Tpl::Text, mut in_a_type: Arc<DAE::Type>, mut in_a_isReference: bool, mut in_a_s: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_type, in_a_isReference, in_a_s)) {
...
pub(crate) fn extTypeF77Xml(mut txt: Tpl::Text, mut a_type: Arc<DAE::Type>, mut a_isReference: bool) -> Result<Tpl::Text> {
    ...
    out_txt = fun_196(txt, a_type, a_isReference, l_s)?;
    Ok(out_txt)
}

fn fun_198(mut in_txt: Tpl::Text, mut in_a_dotPath: bool, mut in_a_name: Arc<Absyn::Path>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_dotPath, in_a_name)) {
        (txt, false, a_name) => {
            let mut txt = (*txt).clone();
...
pub(crate) fn functionNameXml(mut in_txt: Tpl::Text, mut in_a_fn: Arc<SimCodeFunction::Function::Function>, mut in_a_dotPath: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_fn, in_a_dotPath)) {
...
fn fun_203(mut in_txt: Tpl::Text, mut in_a_language: ArcStr, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_fun: Arc<SimCodeFunction::Function::Function>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_language, in_a_varDecls, in_a_preExp, in_a_fun)) {
...
pub(crate) fn extFunCallXml(mut in_txt: Tpl::Text, mut in_a_fun: Arc<SimCodeFunction::Function::Function>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_fun, in_a_preExp, in_a_varDecls)) {
...
fn lm_205(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::SimExtArg::SimExtArg>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_arg, tail: rest }, a_varDecls, a_preExp) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_preExp) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_206(mut in_txt: Tpl::Text, mut in_a_extReturn: Arc<SimCodeFunction::SimExtArg::SimExtArg>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_extReturn)) {
...
pub(crate) fn extFunCallCXml(mut in_txt: Tpl::Text, mut in_a_fun: Arc<SimCodeFunction::Function::Function>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_fun, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ SimCodeFunction::Function::EXTERNAL_FUNCTION { extArgs: i_extArgs, extReturn: i_extReturn, extName: i_extName, .. }, a_preExp, a_varDecls) => {
            ...
            (l_args, a_varDecls, a_preExp) = lm_205(l_args, i_extArgs.clone(), a_varDecls.clone(), a_preExp.clone())?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_returnAssign)?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::writeText(txt.clone(), l_args)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn lm_208(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<SimCodeFunction::SimExtArg::SimExtArg>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
...
pub(crate) fn extFunCallF77Xml(mut in_txt: Tpl::Text, mut in_a_fun: Arc<SimCodeFunction::Function::Function>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_fun, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ SimCodeFunction::Function::EXTERNAL_FUNCTION { extArgs: i_extArgs, extReturn: i_extReturn, extName: i_extName, .. }, a_preExp, a_varDecls) => {
            ...
            (l_args, a_varDecls, a_preExp) = lm_208(l_args, i_extArgs.clone(), a_varDecls.clone(), a_preExp.clone())?;
            l_args = Tpl::popIter(l_args)?;
...
pub(crate) fn extArgCXml(mut in_txt: Tpl::Text, mut in_a_extArg: Arc<SimCodeFunction::SimExtArg::SimExtArg>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_extArg, in_a_preExp, in_a_varDecls)) {
        ...
        (txt, Deref @ SimCodeFunction::SimExtArg::SIMEXTARGSIZE { cref: i_c, exp: i_exp, .. }, a_preExp, a_varDecls) => {
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_name)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_dim)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn extArgF77Xml(mut in_txt: Tpl::Text, mut in_a_extArg: Arc<SimCodeFunction::SimExtArg::SimExtArg>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_extArg, in_a_preExp, in_a_varDecls)) {
        ...
        (txt, Deref @ SimCodeFunction::SimExtArg::SIMEXTARGEXP { exp: i_exp, type_: Deref @ DAE::Type::T_STRING { varLst: _ } }, a_preExp, a_varDecls) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_texp)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ SimCodeFunction::SimExtArg::SIMEXTARGSIZE { cref: i_c, exp: i_exp, .. }, a_preExp, a_varDecls) => {
            let mut l_name: Tpl::Text;
...
fn lm_213(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ClassAttributes>>>, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    '__tco: loop {
...
pub(crate) fn objectiveFunctionXml(mut txt: Tpl::Text, mut a_classAttributes: Arc<metamodelica::List<Arc<DAE::ClassAttributes>>>, mut a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    ...
    out_txt = lm_213(out_txt, a_classAttributes, a_simCode)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}
...
fn fun_215(mut in_txt: Tpl::Text, mut in_a_objetiveE: Option<Arc<DAE::Exp>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_objetiveE, in_a_varDecls, in_a_preExp)) {
...
fn fun_216(mut in_txt: Tpl::Text, mut in_a_objectiveIntegrandE: Option<Arc<DAE::Exp>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_objectiveIntegrandE, in_a_varDecls, in_a_preExp)) {
        (txt, Some(i_exp), a_varDecls, a_preExp) => {
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            let mut a_preExp = (*a_preExp).clone();
...
fn fun_217(mut in_txt: Tpl::Text, mut in_a_startTimeE: Option<Arc<DAE::Exp>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_startTimeE, in_a_varDecls, in_a_preExp)) {
        (txt, Some(i_exp), a_varDecls, a_preExp) => {
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            let mut a_preExp = (*a_preExp).clone();
...
fn fun_218(mut in_txt: Tpl::Text, mut in_a_finalTimeE: Option<Arc<DAE::Exp>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_finalTimeE, in_a_varDecls, in_a_preExp)) {
        (txt, Some(i_exp), a_varDecls, a_preExp) => {
            let mut txt = (*txt).clone();
            let mut a_varDecls = (*a_varDecls).clone();
            let mut a_preExp = (*a_preExp).clone();
...
pub(crate) fn classAttributesXml(mut in_txt: Tpl::Text, mut in_a_classAttribute: Arc<DAE::ClassAttributes>, mut in_a_simCode: SimCode::SimCode) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_classAttribute, in_a_simCode)) {
        (txt, Deref @ DAE::ClassAttributes { objetiveE: i_objetiveE, objectiveIntegrandE: i_objectiveIntegrandE, startTimeE: i_startTimeE, finalTimeE: i_finalTimeE }, a_simCode) => {
            ...
            l_varDecls = Tpl::emptyTxt.clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_objectiveFunction, l_varDecls, l_preExp) = fun_215(Tpl::emptyTxt.clone(), i_objetiveE.clone(), l_varDecls, l_preExp)?;
            (l_objectiveIntegrand, l_varDecls, l_preExp) = fun_216(Tpl::emptyTxt.clone(), i_objectiveIntegrandE.clone(), l_varDecls, l_preExp)?;
            (l_startTime, l_varDecls, l_preExp) = fun_217(Tpl::emptyTxt.clone(), i_startTimeE.clone(), l_varDecls, l_preExp)?;
            (l_finalTime, l_varDecls, l_preExp) = fun_218(Tpl::emptyTxt.clone(), i_finalTimeE.clone(), l_varDecls, l_preExp)?;
            (l_timePointIndex, l_varDecls, l_preExp) = fun_219(Tpl::emptyTxt.clone(), i_startTimeE.clone(), l_varDecls, l_preExp)?;
            (l_timePointValue, l_varDecls, l_preExp) = fun_220(Tpl::emptyTxt.clone(), i_finalTimeE.clone(), l_varDecls, l_preExp)?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_objectiveFunction)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_objectiveIntegrand)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_startTime)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_finalTime)?;
            txt = Tpl::softNewLine(txt.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_timePointIndex)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_timePointValue)?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::writeText(txt.clone(), l_constraints)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn lm_223(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Constraint>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn constraintsXml(mut txt: Tpl::Text, mut a_constraints: Arc<metamodelica::List<Arc<DAE::Constraint>>>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = Tpl::pushIter(txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    out_txt = lm_223(out_txt, a_constraints)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok(out_txt)
}

fn lm_225(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
...
pub(crate) fn constraintXml(mut in_txt: Tpl::Text, mut in_a_cons: Arc<DAE::Constraint>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_cons)) {
        (txt, Deref @ DAE::Constraint::CONSTRAINT_EXPS { constraintLst: i_constraintLst }) => {
            ...
            (l_constrain, l_varDecls, l_preExp) = lm_225(l_constrain, i_constraintLst.clone(), l_varDecls, l_preExp)?;
            l_constrain = Tpl::popIter(l_constrain)?;
            txt = Tpl::writeText(txt.clone(), l_constrain)?;
            txt.clone()
        },
        (txt, _) => {
            let mut txt = (*txt).clone();
...
fn lm_227(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn funStatementXml(mut txt: Tpl::Text, mut a_statementLst: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    out_txt = Tpl::pushIter(txt, Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    (out_txt, out_a_varDecls) = lm_227(out_txt, a_statementLst, a_varDecls)?;
    out_txt = Tpl::popIter(out_txt)?;
    Ok((out_txt, out_a_varDecls))
}
...
fn fun_229(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_varDecls, in_a_context)) {
...
pub(crate) fn algStatementXml(mut txt: Tpl::Text, mut a_stmt: Arc<DAE::Statement>, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (l_res, out_a_varDecls) = fun_229(Tpl::emptyTxt.clone(), a_stmt, a_varDecls, a_context)?;
...
fn fun_231(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_val: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_val, in_a_varDecls, in_a_context)) {
        (txt, Deref @ DAE::Exp::ASUB { exp: i_arr, sub: Deref @ metamodelica::List::Cons { head: i_idx, tail: Deref @ metamodelica::List::Nil } }, a_val, a_varDecls, a_context) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_arr1, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_arr.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_idx1, l_preExp, a_varDecls) = daeSubscriptXML(Tpl::emptyTxt.clone(), i_idx.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_val1, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), a_val.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeText(txt.clone(), l_preExp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_arr1)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_idx1)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_val1)?;
            (txt.clone(), a_varDecls.clone())
        },
...
fn fun_232(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_exp1: Arc<DAE::Exp>, mut in_a_val: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_exp: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_exp1, in_a_val, in_a_varDecls, in_a_context, in_a_exp)) {
        ...
        (txt, _, a_exp1, a_val, a_varDecls, a_context, _) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_varPart, l_preExp, a_varDecls) = daeExpAsubXml(Tpl::emptyTxt.clone(), a_exp1.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), a_val.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:Assign>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_varPart)?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn algStmtAssignXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_ASSIGN { exp1: Deref @ DAE::Exp::CREF { componentRef: Deref @ DAE::ComponentRef::WILD { .. }, .. }, exp: i_e, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_e.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
        ...
        (txt, Deref @ DAE::Statement::STMT_ASSIGN { exp1: i_exp1 @ Deref @ DAE::Exp::CREF { ty: Deref @ DAE::Type::T_FUNCTION_REFERENCE_VAR { functionType: _ }, .. }, exp: i_exp, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_varPart, l_preExp, a_varDecls) = scalarLhsCrefXml(Tpl::emptyTxt.clone(), i_exp1.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:Assign>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_varPart)?;
        ...
        (txt, Deref @ DAE::Statement::STMT_ASSIGN { exp1: i_exp1 @ Deref @ DAE::Exp::ASUB { exp: _, .. }, exp: i_exp @ i_val, .. }, a_context, a_varDecls) => {
            ...
            str_4 = (Tpl::textString(txt_3)?).clone();
            (txt, a_varDecls) = fun_232(txt.clone(), (str_4).clone(), i_exp1.clone(), i_val.clone(), a_varDecls.clone(), a_context.clone(), i_exp.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Statement::STMT_ASSIGN { exp1: i_exp1, exp: i_exp, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart1, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp1.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_expPart2, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:Assign>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_expPart1)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<fun:Expression>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_expPart2)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("</fun:Expression>\n")).clone() }))?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn fun_234(mut in_txt: Tpl::Text, mut in_a_ispec: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_expPart: Tpl::Text, mut in_a_t: Arc<DAE::Type>) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ispec, in_a_varDecls, in_a_preExp, in_a_context, in_a_cr, in_a_expPart, in_a_t)) {
...
pub(crate) fn algStmtAssignArrXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_ASSIGN_ARR { exp: i_e, lhs: Deref @ DAE::Exp::CREF { componentRef: i_cr, .. }, type_: i_t, .. }, a_context, a_varDecls) => {
            ...
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_e.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_ispec, l_preExp, a_varDecls) = indexSpecFromCrefXml(Tpl::emptyTxt.clone(), i_cr.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (txt, a_varDecls) = fun_234(txt.clone(), l_ispec, a_varDecls.clone(), l_preExp, a_context.clone(), i_cr.clone(), l_expPart, i_t.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_varDecls) => {
            (txt.clone(), a_varDecls.clone())
...
fn fun_236(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_ispec: ArcStr, mut in_a_exp: ArcStr, mut in_a_cref: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_context, in_a_ispec, in_a_exp, in_a_cref) {
...
pub(crate) fn indexedAssignXml(mut txt: Tpl::Text, mut a_ty: Arc<DAE::Type>, mut a_exp: ArcStr, mut a_cr: Arc<DAE::ComponentRef>, mut a_ispec: ArcStr, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    l_type = expTypeArrayXml(Tpl::emptyTxt.clone(), a_ty)?;
    l_cref = contextArrayCrefXml(Tpl::emptyTxt.clone(), a_cr, a_context.clone())?;
    out_txt = fun_236(txt, a_context, (a_ispec).clone(), (a_exp).clone(), l_cref)?;
    out_a_varDecls = a_varDecls;
    Ok((out_txt, out_a_varDecls))
}
...
fn fun_238(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cref: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_context, in_a_cref) {
...
pub(crate) fn copyArrayDataXml(mut txt: Tpl::Text, mut a_ty: Arc<DAE::Type>, mut a_exp: ArcStr, mut a_cr: Arc<DAE::ComponentRef>, mut a_context: SimCodeFunction::Context) -> Result<Tpl::Text> {
    ...
    l_type = expTypeArrayXml(Tpl::emptyTxt.clone(), a_ty)?;
    l_cref = contextArrayCrefXml(Tpl::emptyTxt.clone(), a_cr, a_context.clone())?;
    out_txt = fun_238(txt, a_context, l_cref)?;
    Ok(out_txt)
}

fn lm_240(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn lm_241(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_retStruct: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context, in_a_retStruct)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_afterExp, _, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_afterExp.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_cr, tail: rest }, a_varDecls, a_afterExp, a_context, a_retStruct) => {
            ...
            l_rhsStr = Tpl::writeTok(l_rhsStr, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".targ")).clone() }))?;
            l_rhsStr = Tpl::writeStr(l_rhsStr, (intString(x_i1)).clone())?;
            (txt, a_afterExp, a_varDecls) = writeLhsCrefXml(txt.clone(), i_cr.clone(), (Tpl::textString(l_rhsStr)?).clone(), a_context.clone(), a_afterExp.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context, in_a_retStruct) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone(), a_retStruct.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn lm_242(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_prefix: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context, in_a_prefix)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_afterExp, _, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_afterExp.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_cr, tail: rest }, a_varDecls, a_afterExp, a_context, a_prefix) => {
            ...
            l_rhsStr = Tpl::writeTok(l_rhsStr, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_targ")).clone() }))?;
            l_rhsStr = Tpl::writeStr(l_rhsStr, (intString(x_i1)).clone())?;
            (txt, a_afterExp, a_varDecls) = writeLhsCrefXml(txt.clone(), i_cr.clone(), (Tpl::textString(l_rhsStr)?).clone(), a_context.clone(), a_afterExp.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context, in_a_prefix) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone(), a_prefix.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_244(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_rhsStr: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_rhsStr)) {
...
fn lm_245(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_prefix: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_prefix)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_cr, tail: rest }, a_varDecls, a_prefix) => {
            ...
            l_initVar = fun_243(Tpl::emptyTxt.clone(), (str_3).clone())?;
            str_5 = (Tpl::textString(l_typ.clone())?).clone();
            l_addRoot = fun_244(Tpl::emptyTxt.clone(), (str_5).clone(), l_rhsStr.clone())?;
            a_varDecls = Tpl::writeText(a_varDecls.clone(), l_typ)?;
            a_varDecls = Tpl::writeTok(a_varDecls.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
            a_varDecls = Tpl::writeText(a_varDecls.clone(), l_rhsStr)?;
            a_varDecls = Tpl::writeText(a_varDecls.clone(), l_initVar)?;
            a_varDecls = Tpl::writeTok(a_varDecls.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(";")).clone() }))?;
            a_varDecls = Tpl::writeText(a_varDecls.clone(), l_addRoot)?;
            a_varDecls = Tpl::writeTok(a_varDecls.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_prefix) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_prefix.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn algStmtTupleAssignXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_TUPLE_ASSIGN { exp: i_exp @ Deref @ DAE::Exp::CALL { path: _, .. }, expExpLst: i_expExpLst, .. }, a_context, a_varDecls) => {
            ...
            l_crefs = lm_240(l_crefs, i_expExpLst.clone())?;
            ...
            l_marker = Tpl::writeTok(l_marker, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(") = ")).clone() }))?;
            l_marker = ExpressionDumpTpl::dumpExp(l_marker, i_exp.clone(), (literal!("\"")).clone())?;
            l_preExp = Tpl::writeTok(l_preExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/* algStmtTupleAssign: preExp buffer created for ")).clone() }))?;
            l_preExp = Tpl::writeText(l_preExp, l_marker.clone())?;
            l_preExp = Tpl::writeTok(l_preExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" */")).clone() }))?;
            l_preExp = Tpl::writeTok(l_preExp, openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            l_afterExp = Tpl::writeTok(l_afterExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("/* algStmtTupleAssign: afterExp buffer created for ")).clone() }))?;
            l_afterExp = Tpl::writeText(l_afterExp, l_marker)?;
            l_afterExp = Tpl::writeTok(l_afterExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" */")).clone() }))?;
            l_afterExp = Tpl::writeTok(l_afterExp, openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            (l_retStruct, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            ...
            (l_lhsCrefs, a_varDecls, l_afterExp) = lm_241(l_lhsCrefs, i_expExpLst.clone(), a_varDecls.clone(), l_afterExp, a_context.clone(), l_retStruct.clone())?;
        ...
        (txt, Deref @ DAE::Statement::STMT_TUPLE_ASSIGN { exp: Deref @ DAE::Exp::MATCHEXPRESSION { matchType: _, .. }, expExpLst: i_expExpLst, .. }, a_context, a_varDecls) => {
            ...
            l_prefix = Tpl::writeStr(l_prefix, (intString(ret_7)).clone())?;
            l_lhsCrefs = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 1, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            (l_lhsCrefs, a_varDecls, l_afterExp) = lm_242(l_lhsCrefs, i_expExpLst.clone(), a_varDecls.clone(), l_afterExp, a_context.clone(), l_prefix.clone())?;
            l_lhsCrefs = Tpl::popIter(l_lhsCrefs)?;
            ...
            (txt, a_varDecls) = lm_245(txt.clone(), i_expExpLst.clone(), a_varDecls.clone(), l_prefix)?;
            txt = Tpl::popIter(txt.clone())?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_preExp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_lhsCrefs)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_afterExp)?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_varDecls) => {
            let mut txt = (*txt).clone();
...
fn fun_247(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_lhsStr: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_context, in_a_lhsStr) {
...
fn fun_248(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_lhsStr: Tpl::Text, mut in_a_rhsStr: ArcStr) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_context, in_a_lhsStr, in_a_rhsStr) {
...
pub(crate) fn writeLhsCrefXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_rhsStr: ArcStr, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_rhsStr, in_a_context, in_a_preExp, in_a_varDecls)) {
        ...
        (txt, i_exp @ Deref @ DAE::Exp::CREF { ty: Deref @ DAE::Type::T_ARRAY { ty: _, .. }, .. }, _, a_context, a_preExp, a_varDecls) => {
            ...
            txt = fun_247(txt.clone(), a_context.clone(), l_lhsStr)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::UNARY { exp: i_e @ Deref @ DAE::Exp::CREF { ty: Deref @ DAE::Type::T_ARRAY { ty: _, .. }, .. }, .. }, a_rhsStr, a_context, a_preExp, a_varDecls) => {
            ...
            txt = fun_248(txt.clone(), a_context.clone(), l_lhsStr, (a_rhsStr.clone()).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, i_exp @ Deref @ DAE::Exp::CREF { componentRef: _, .. }, _, a_context, a_preExp, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            (l_lhsStr, a_preExp, a_varDecls) = scalarLhsCrefXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            txt = Tpl::writeText(txt.clone(), l_lhsStr)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
...
fn lm_250(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn algStmtIfXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_IF { exp: i_exp, statementLst: i_statementLst, else_: i_else__, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_condExp, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("<fun:If>\n")).clone(), (literal!("  <fun:Condition>\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::writeText(txt.clone(), l_condExp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
fn lm_253(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn algStmtForRangeXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_FOR { range: i_rng @ Deref @ DAE::Exp::RANGE { ty: _, .. }, type_: i_type__, iterIsArray: i_iterIsArray, statementLst: i_statementLst, iter: i_iter, .. }, a_context, a_varDecls) => {
            ...
            (l_stmtStr, a_varDecls) = lm_253(l_stmtStr, i_statementLst.clone(), a_varDecls.clone(), a_context.clone())?;
            l_stmtStr = Tpl::popIter(l_stmtStr)?;
            (txt, l_stmtStr, a_varDecls) = algStmtForRange_implXml(txt.clone(), i_rng.clone(), (i_iter.clone()).clone(), (Tpl::textString(l_identType)?).clone(), (Tpl::textString(l_identTypeShort)?).clone(), l_stmtStr, a_context.clone(), a_varDecls.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_varDecls) => {
            (txt.clone(), a_varDecls.clone())
...
fn fun_255(mut in_txt: Tpl::Text, mut in_a_step: Option<Arc<DAE::Exp>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_step, in_a_varDecls, in_a_preExp, in_a_context)) {
...
fn fun_256(mut in_txt: Tpl::Text, mut in_a_range: Arc<DAE::Exp>, mut in_a_iterator: ArcStr, mut in_a_body: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_range, in_a_iterator, in_a_body, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::RANGE { start: i_start, step: i_step, stop: i_stop, .. }, a_iterator, a_body, a_context, a_varDecls) => {
            ...
            l_preExp = Tpl::emptyTxt.clone();
            (l_startValue, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_start.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_stepValue, a_varDecls, l_preExp) = fun_255(Tpl::emptyTxt.clone(), i_step.clone(), a_varDecls.clone(), l_preExp, a_context.clone())?;
            (l_stopValue, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_stop.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("<exp:QualifiedNamePart name=\"")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_iterName)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("\"/>\n")).clone() }))?;
            txt = Tpl::popBlock(txt.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_startValue)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_stepValue)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_stopValue)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
...
pub(crate) fn algStmtForRange_implXml(mut txt: Tpl::Text, mut a_range: Arc<DAE::Exp>, mut a_iterator: ArcStr, mut a_type: ArcStr, mut a_shortType: ArcStr, mut a_body: Tpl::Text, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = fun_256(txt, a_range, (a_iterator).clone(), a_body.clone(), a_context, a_varDecls)?;
    out_a_body = a_body;
    Ok((out_txt, out_a_body, out_a_varDecls))
}

fn lm_258(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn algStmtForGenericXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_FOR { type_: i_type__, iterIsArray: i_iterIsArray, statementLst: i_statementLst, range: i_range, iter: i_iter, .. }, a_context, a_varDecls) => {
            ...
            l_stmtStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            (l_stmtStr, a_varDecls) = lm_258(l_stmtStr, i_statementLst.clone(), a_varDecls.clone(), a_context.clone())?;
            l_stmtStr = Tpl::popIter(l_stmtStr)?;
            (txt, l_stmtStr, a_varDecls) = algStmtForGeneric_implXml(txt.clone(), i_range.clone(), (i_iter.clone()).clone(), (Tpl::textString(l_iterType)?).clone(), (Tpl::textString(l_arrayType)?).clone(), i_iterIsArray.clone(), l_stmtStr, a_context.clone(), a_varDecls.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_varDecls) => {
            (txt.clone(), a_varDecls.clone())
...
pub(crate) fn algStmtForGeneric_implXml(mut txt: Tpl::Text, mut a_exp: Arc<DAE::Exp>, mut a_iterator: ArcStr, mut a_type: ArcStr, mut a_arrayType: ArcStr, mut a_iterIsArray: bool, mut a_body: Tpl::Text, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut l_preExp: Tpl::Text;
    let mut l_iterName: Tpl::Text;
    l_iterName = contextIteratorNameXml(Tpl::emptyTxt.clone(), (a_iterator).clone(), a_context.clone())?;
    l_preExp = Tpl::emptyTxt.clone();
    (l_evar, l_preExp, out_a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), a_exp, a_context, l_preExp, a_varDecls)?;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("<fun:For>\n")).clone(), (literal!("  <fun:Index>\n")).clone(), (literal!("    <fun:IterationVariable>\n")).clone()], lastHasNewLine: true }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("<exp:QualifiedNamePart name=\"")).clone() }))?;
    out_txt = Tpl::writeText(out_txt, l_iterName)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("\"/>\n")).clone() }))?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("    </fun:IterationVariable>\n")).clone(), (literal!("    <fun:IterationSet>\n")).clone(), (literal!("      <exp:Array>\n")).clone()], lastHasNewLine: true }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 8 }))?;
    out_txt = Tpl::writeText(out_txt, l_preExp)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("      </exp:Array>\n")).clone(), (literal!("    </fun:IterationSet>\n")).clone(), (literal!("  </fun:Index>\n")).clone(), (literal!("  <fun:Statements>\n")).clone()], lastHasNewLine: true }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
    out_txt = Tpl::writeText(out_txt, a_body.clone())?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("  </fun:Statements>\n")).clone(), (literal!("</fun:For>")).clone()], lastHasNewLine: false }))?;
    out_a_body = a_body;
    Ok((out_txt, out_a_body, out_a_varDecls))
}

fn lm_261(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn algStmtWhileXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_WHILE { exp: i_exp, statementLst: i_statementLst, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_var, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("<fun:While>\n")).clone(), (literal!("  <fun:Condition>\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::writeText(txt.clone(), l_var)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("  </fun:Condition>\n")).clone(), (literal!("  <fun:Statements>\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
...
pub(crate) fn algStmtTerminateXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_TERMINATE { msg: i_msg, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_msgVar, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_msg.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeText(txt.clone(), l_preExp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_msgVar)?;
            (txt.clone(), a_varDecls.clone())
...
fn lm_266(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn lm_267(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn algStmtWhenXml(mut in_txt: Tpl::Text, mut in_a_when: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_when, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_WHEN { conditions: i_conditions, statementLst: i_statementLst, elseWhen: i_elseWhen, .. }, a_context, a_varDecls) => {
            ...
            l_cond = lm_266(l_cond, i_conditions.clone())?;
            ...
            (l_statements, a_varDecls) = lm_267(l_statements, i_statementLst.clone(), a_varDecls.clone(), a_context.clone())?;
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("  </fun:Condition>\n")).clone(), (literal!("  <fun:Statements>\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            txt = Tpl::writeText(txt.clone(), l_statements)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("  </fun:Statements>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_else)?;
            txt = Tpl::popBlock(txt.clone())?;
            (txt.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_varDecls) => {
...
fn lm_269(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
fn lm_270(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::ComponentRef>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
pub(crate) fn algStatementWhenElseXml(mut in_txt: Tpl::Text, mut in_a_stmt: Option<Arc<DAE::Statement>>, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_varDecls)) {
        (txt, Some(Deref @ DAE::Statement::STMT_WHEN { statementLst: i_when_statementLst, elseWhen: i_when_elseWhen, conditions: i_when_conditions, .. }), a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_statements = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE()), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            (l_statements, a_varDecls) = lm_269(l_statements, i_when_statementLst.clone(), a_varDecls.clone())?;
            l_statements = Tpl::popIter(l_statements)?;
            ...
            l_elseCondStr = lm_270(l_elseCondStr, i_when_conditions.clone())?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_elseCondStr)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("</fun:Condition>\n")).clone(), (literal!("<fun:Statements>\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
...
pub(crate) fn algStmtReinitXml(mut in_txt: Tpl::Text, mut in_a_stmt: Arc<DAE::Statement>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_stmt, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Statement::STMT_REINIT { var: i_var, value: i_value, .. }, a_context, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            l_preExp = Tpl::emptyTxt.clone();
            (l_expPart1, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_var.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            (l_expPart2, l_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_value.clone(), a_context.clone(), l_preExp, a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<exp:Reinit>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_expPart1)?;
            txt = Tpl::softNewLine(txt.clone())?;
...
pub(crate) fn indexSpecFromCrefXml(mut in_txt: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_cr, in_a_context, in_a_preExp, in_a_varDecls)) {
...
fn lm_274(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Statement>>>, mut in_a_varDecls: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, _) => {
            return Ok((txt.clone(), a_varDecls.clone()))
...
pub(crate) fn elseExprXml(mut in_txt: Tpl::Text, mut in_a_else__: Arc<DAE::Else>, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_a_else__, in_a_context, in_a_varDecls)) {
...
fn fun_277(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_ecr_componentRef: Arc<DAE::ComponentRef>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_ecr: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_ecr_componentRef, in_a_varDecls, in_a_preExp, in_a_context, in_a_ecr)) {
...
pub(crate) fn scalarLhsCrefXml(mut in_txt: Tpl::Text, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ecr, in_a_context, in_a_preExp, in_a_varDecls)) {
        ...
        (txt, i_ecr @ Deref @ DAE::Exp::CREF { componentRef: i_ecr_componentRef @ Deref @ DAE::ComponentRef::CREF_IDENT { ident: _, .. }, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            (txt, a_varDecls, a_preExp) = fun_277(txt.clone(), ret_0, i_ecr_componentRef.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone(), i_ecr.clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
...
fn fun_279(mut in_txt: Tpl::Text, mut in_a_e: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_e, in_a_preExp)) {
...
fn fun_280(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_preExp: Tpl::Text, mut in_a_eStr1: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_preExp, in_a_eStr1) {
...
pub(crate) fn daeExpXml(mut txt: Tpl::Text, mut a_exp: Arc<DAE::Exp>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (l_e, out_a_preExp, out_a_varDecls) = daeExpXml_dispatch(Tpl::emptyTxt.clone(), a_exp, a_context, a_preExp, a_varDecls)?;
    l_eStr1 = fun_279(Tpl::emptyTxt.clone(), l_e, out_a_preExp.clone())?;
    ret_3 = System::stringFind((Tpl::textString(l_eStr1.clone())?).clone(), (literal!("tmp")).clone())?;
    ret_4 = intEq(0, ret_3);
    l_eStr2 = fun_280(Tpl::emptyTxt.clone(), ret_4, out_a_preExp.clone(), l_eStr1)?;
    out_txt = Tpl::writeText(txt, l_eStr2)?;
    Ok((out_txt, out_a_preExp, out_a_varDecls))
}
...
pub(crate) fn daeExpXml_dispatch(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        ...
        (txt, i_exp, _, a_preExp, a_varDecls) => {
            ...
            txt_0 = ExpressionDumpTpl::dumpExp(txt_0, i_exp.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 2141, 14), (Tpl::textString(txt_0)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_286(mut in_txt: Tpl::Text, mut in_mArg: Arc<DAE::Type>, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
...
pub(crate) fn daeExternalXmlExp(mut txt: Tpl::Text, mut a_exp: Arc<DAE::Exp>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = fun_286(txt, ret_0, a_exp, a_context, a_preExp, a_varDecls)?;
    Ok((out_txt, out_a_preExp, out_a_varDecls))
}
...
pub(crate) fn daeExpSconstXml(mut txt: Tpl::Text, mut a_string: ArcStr, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    ret_0 = (Util::escapeModelicaStringToXmlString((a_string).clone())?).clone();
    out_txt = Tpl::writeStr(out_txt, (ret_0).clone())?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\"")).clone() }))?;
    out_a_preExp = a_preExp;
    out_a_varDecls = a_varDecls;
    Ok((out_txt, out_a_preExp, out_a_varDecls))
...
fn fun_289(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_t: Arc<DAE::Type>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_cr, in_a_t, in_a_varDecls, in_a_preExp, in_a_exp)) {
...
fn lm_291(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ DAE::Subscript::INDEX { exp: i_exp }, tail: rest }, a_varDecls, a_preExp, a_context) => {
            ...
            (txt, a_preExp, a_varDecls) = daeExpXml(txt.clone(), i_exp.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone()); continue '__tco; }
        },
...
fn fun_293(mut in_txt: Tpl::Text, mut in_mArg: Arc<DAE::Type>, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_arrName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_ecr, in_a_varDecls, in_a_preExp, in_a_context, in_a_cr, in_a_arrName)) {
        (txt, Deref @ DAE::Type::T_ARRAY { dims: i_et_dims, .. }, _, a_varDecls, a_preExp, a_context, a_cr, a_arrName) => {
            ...
            (txt, a_preExp, a_varDecls) = threadDimSubListXml(txt.clone(), i_et_dims.clone(), ret_0, a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("]")).clone() }))?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        (txt, _, a_ecr, a_varDecls, a_preExp, _, _, _) => {
            ...
            txt_1 = ExpressionDumpTpl::dumpExp(txt_1, a_ecr.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 2256, 28), (Tpl::textString(txt_1)?).clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_294(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_arrName: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_ecr, in_a_arrName, in_a_varDecls, in_a_preExp, in_a_cr)) {
        (txt, i_context @ SimCodeFunction::Context::FUNCTION_CONTEXT { cref_prefix: _, .. }, _, a_arrName, a_varDecls, a_preExp, a_cr) => {
            ...
            (l_dimsValuesStr, a_varDecls, a_preExp) = lm_292(l_dimsValuesStr, ret_1, a_varDecls.clone(), a_preExp.clone(), i_context.clone())?;
            ...
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 6 }))?;
            txt = Tpl::writeText(txt.clone(), l_dimsValuesStr)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
        ...
        (txt, i_context, a_ecr, a_arrName, a_varDecls, a_preExp, a_cr) => {
            ...
            (txt, a_varDecls, a_preExp) = fun_293(txt.clone(), ret_2, a_ecr.clone(), a_varDecls.clone(), a_preExp.clone(), i_context.clone(), a_cr.clone(), a_arrName.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_295(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_arrName: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_ecr, in_a_arrName, in_a_varDecls, in_a_preExp, in_a_context, in_a_cr)) {
        (txt, Deref @ "metatype_array", _, a_arrName, a_varDecls, a_preExp, a_context, a_cr) => {
            ...
            (l_dimsValuesStr, a_varDecls, a_preExp) = lm_291(l_dimsValuesStr, ret_1, a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            l_dimsValuesStr = Tpl::popIter(l_dimsValuesStr)?;
...
fn fun_296(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_ecr, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)) {
        (txt, false, _, a_preExp, a_varDecls, a_ty, a_context, a_cr) => {
            ...
            (l_tmp, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(l_arrayType)?).clone(), a_varDecls.clone())?;
            ret_4 = ComponentReferenceBasics::crefSubs(a_cr.clone())?;
            (l_spec1, a_preExp, a_varDecls) = daeExpCrefRhsIndexSpecXml(Tpl::emptyTxt.clone(), ret_4, a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_arrName)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_spec1)?;
        ...
        (txt, _, a_ecr, a_preExp, a_varDecls, a_ty, a_context, a_cr) => {
            ...
            l_arrName = contextCrefXml(Tpl::emptyTxt.clone(), ret_5, a_context.clone())?;
            l_arrayType = expTypeArrayXml(Tpl::emptyTxt.clone(), a_ty.clone())?;
            ret_7 = ComponentReferenceBasics::crefSubs(a_cr.clone())?;
            ret_8 = (ret_7.len() as i32);
            l_dimsLenStr = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_8)).clone())?;
            str_9 = (Tpl::textString(l_arrayType)?).clone();
            (txt, a_varDecls, a_preExp) = fun_295(txt.clone(), (str_9).clone(), a_ecr.clone(), l_arrName, a_varDecls.clone(), a_preExp.clone(), a_context.clone(), a_cr.clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_297(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_ecr_componentRef: Arc<DAE::ComponentRef>, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_ecr_componentRef, in_a_ecr, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)) {
        (txt, false, _, a_ecr, a_preExp, a_varDecls, a_ty, a_context, a_cr) => {
            ...
            (txt, a_preExp, a_varDecls) = fun_296(txt.clone(), ret_0, a_ecr.clone(), a_preExp.clone(), a_varDecls.clone(), a_ty.clone(), a_context.clone(), a_cr.clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
...
fn fun_298(mut in_txt: Tpl::Text, mut in_a_box: Tpl::Text, mut in_a_ecr_componentRef: Arc<DAE::ComponentRef>, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_box, in_a_ecr_componentRef, in_a_ecr, in_a_preExp, in_a_varDecls, in_a_ty, in_a_context, in_a_cr)) {
        (txt, Tpl::Text::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }, a_ecr_componentRef, a_ecr, a_preExp, a_varDecls, a_ty, a_context, a_cr) => {
            ...
            (txt, a_preExp, a_varDecls) = fun_297(txt.clone(), ret_0, a_ecr_componentRef.clone(), a_ecr.clone(), a_preExp.clone(), a_varDecls.clone(), a_ty.clone(), a_context.clone(), a_cr.clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
...
pub(crate) fn daeExpCrefRhs2Xml(mut in_txt: Tpl::Text, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ecr, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, i_ecr @ Deref @ DAE::Exp::CREF { componentRef: i_ecr_componentRef @ i_cr, ty: i_ty }, a_context, a_preExp, a_varDecls) => {
            ...
            (txt, a_preExp, a_varDecls) = fun_298(txt.clone(), l_box, i_ecr_componentRef.clone(), i_ecr.clone(), a_preExp.clone(), a_varDecls.clone(), i_ty.clone(), a_context.clone(), i_cr.clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, i_ecr, _, a_preExp, a_varDecls) => {
            ...
            txt_1 = ExpressionDumpTpl::dumpExp(txt_1, i_ecr.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 2273, 11), (Tpl::textString(txt_1)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn lm_301(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn fun_302(mut in_txt: Tpl::Text, mut in_a_subrest: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_dimrest: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_subrest, in_a_varDecls, in_a_preExp, in_a_context, in_a_dimrest)) {
...
fn fun_303(mut in_txt: Tpl::Text, mut in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut in_a_subrest: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_sub_exp: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_dims, in_a_subrest, in_a_varDecls, in_a_preExp, in_a_context, in_a_sub_exp)) {
        (txt, Deref @ metamodelica::List::Cons { head: _, tail: i_dimrest }, a_subrest, a_varDecls, a_preExp, a_context, a_sub_exp) => {
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("((")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_estr)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
...
fn fun_304(mut in_txt: Tpl::Text, mut in_a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_subs, in_a_dims, in_a_context, in_a_preExp, in_a_varDecls)) {
...
pub(crate) fn threadDimSubListXml(mut txt: Tpl::Text, mut a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = fun_304(txt, a_subs, a_dims, a_context, a_preExp, a_varDecls)?;
    Ok((out_txt, out_a_preExp, out_a_varDecls))
}
...
fn fun_306(mut in_txt: Tpl::Text, mut in_a_sub: Arc<DAE::Subscript>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_sub, in_a_varDecls, in_a_preExp, in_a_context)) {
        (txt, Deref @ DAE::Subscript::INDEX { exp: i_exp }, a_varDecls, a_preExp, a_context) => {
            ...
            l_str = Tpl::writeText(Tpl::emptyTxt.clone(), l_expPart)?;
        ...
        (txt, Deref @ DAE::Subscript::SLICE { exp: i_exp }, a_varDecls, a_preExp, a_context) => {
            ...
            a_preExp = Tpl::writeTok(a_preExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            l_str = Tpl::writeText(Tpl::emptyTxt.clone(), l_tmp)?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", integer_array_make_index_array(")).clone() }))?;
            l_str = Tpl::writeText(l_str, l_expPart)?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("), 'A'")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_str)?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        (txt, _, a_varDecls, a_preExp, _) => {
...
fn lm_307(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
...
pub(crate) fn daeExpCrefRhsIndexSpecXml(mut txt: Tpl::Text, mut a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    l_nridx__str = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_1)).clone())?;
    ...
    (l_idx__str, out_a_varDecls, out_a_preExp) = lm_307(l_idx__str, a_subs, a_varDecls, a_preExp, a_context)?;
    l_idx__str = Tpl::popIter(l_idx__str)?;
    (l_tmp, out_a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (literal!("index_spec_t")).clone(), out_a_varDecls)?;
    out_a_preExp = Tpl::writeTok(out_a_preExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("create_index_spec(&")).clone() }))?;
    out_a_preExp = Tpl::writeText(out_a_preExp, l_tmp.clone())?;
    out_a_preExp = Tpl::writeTok(out_a_preExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
    out_a_preExp = Tpl::writeText(out_a_preExp, l_nridx__str)?;
    out_a_preExp = Tpl::writeTok(out_a_preExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
    out_a_preExp = Tpl::writeText(out_a_preExp, l_idx__str)?;
    out_a_preExp = Tpl::writeTok(out_a_preExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
    out_a_preExp = Tpl::writeTok(out_a_preExp, openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
    out_txt = Tpl::writeText(txt, l_tmp)?;
    Ok((out_txt, out_a_preExp, out_a_varDecls))
}

fn lm_309(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn fun_310(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_ecr_componentRef: Arc<DAE::ComponentRef>, mut in_a_preExp: Tpl::Text, mut in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut in_a_varDecls: Tpl::Text, mut in_a_aty: Arc<DAE::Type>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_ecr_componentRef, in_a_preExp, in_a_dims, in_a_varDecls, in_a_aty)) {
        ...
        (txt, _, a_ecr_componentRef, a_preExp, a_dims, a_varDecls, a_aty) => {
            ...
            (l_tmpArr, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(txt_1)?).clone(), a_varDecls.clone())?;
            ret_3 = (a_dims.clone().len() as i32);
            l_dimsLenStr = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_3)).clone())?;
            l_dimsValuesStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            l_dimsValuesStr = lm_309(l_dimsValuesStr, a_dims.clone())?;
            l_dimsValuesStr = Tpl::popIter(l_dimsValuesStr)?;
            l_type = expTypeShortXml(Tpl::emptyTxt.clone(), a_aty.clone())?;
            a_preExp = arrayCrefXmlStr(a_preExp.clone(), a_ecr_componentRef.clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::writeText(txt.clone(), l_tmpArr)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn lm_312(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Var>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context, in_a_cr)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp, _, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_v, tail: rest }, a_varDecls, a_preExp, a_context, a_cr) => {
            ...
            (txt, a_preExp, a_varDecls) = daeExpXml(txt.clone(), ret_0, a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context, in_a_cr) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone(), a_cr.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn daeExpRecordCrefRhsXml(mut in_txt: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ty, in_a_cr, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Type::T_COMPLEX { complexClassType: _, varLst: i_var__lst, .. }, a_cr, a_context, a_preExp, a_varDecls) => {
            ...
            (l_vars, a_varDecls, a_preExp) = lm_312(l_vars, i_var__lst.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone(), a_cr.clone())?;
            l_vars = Tpl::popIter(l_vars)?;
            txt = Tpl::writeText(txt.clone(), l_vars)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_314(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_t: Arc<DAE::Type>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_cr, in_a_t, in_a_varDecls, in_a_afterExp, in_a_exp)) {
...
pub(crate) fn daeExpCrefLhsXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_afterExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_afterExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_afterExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_afterExp, in_a_varDecls)) {
...
fn lm_316(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context)) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: Deref @ DAE::Subscript::INDEX { exp: i_exp }, tail: rest }, a_varDecls, a_afterExp, a_context) => {
            ...
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone()); continue '__tco; }
        },
...
fn fun_317(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_dimsValuesStr: Tpl::Text, mut in_a_arrName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_dimsValuesStr, in_a_arrName)) {
...
fn fun_318(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_afterExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_afterExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_varDecls, in_a_ty, in_a_context, in_a_cr, in_a_ecr, in_a_afterExp)) {
        (txt, false, a_varDecls, a_ty, a_context, a_cr, a_ecr, a_afterExp) => {
            ...
            ret_4 = ComponentReferenceBasics::crefSubs(a_cr.clone())?;
            (l_spec1, a_afterExp, a_varDecls) = daeExpCrefLhsIndexSpecXml(Tpl::emptyTxt.clone(), ret_4, a_context.clone(), a_afterExp.clone(), a_varDecls.clone())?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("indexed_assign_")).clone() }))?;
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_arrayType)?;
            ...
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", &")).clone() }))?;
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_arrName)?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", &")).clone() }))?;
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_spec1)?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::writeText(txt.clone(), l_tmp)?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        ...
        (txt, _, a_varDecls, a_ty, a_context, a_cr, a_ecr, a_afterExp) => {
            ...
            (l_dimsValuesStr, a_varDecls, a_afterExp) = lm_316(l_dimsValuesStr, ret_10, a_varDecls.clone(), a_afterExp.clone(), a_context.clone())?;
            l_dimsValuesStr = Tpl::popIter(l_dimsValuesStr)?;
            str_11 = (Tpl::textString(l_arrayType)?).clone();
            txt = fun_317(txt.clone(), (str_11).clone(), l_dimsValuesStr, l_arrName)?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_319(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_context: SimCodeFunction::Context, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_afterExp: Tpl::Text, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_afterExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_varDecls, in_a_ty, in_a_context, in_a_ecr, in_a_afterExp, in_a_cr)) {
        (txt, false, a_varDecls, a_ty, a_context, a_ecr, a_afterExp, a_cr) => {
            ...
            let mut a_afterExp = (*a_afterExp).clone();
            ret_0 = SimCodeFunctionUtil::crefSubIsScalar(a_cr.clone())?;
            (txt, a_varDecls, a_afterExp) = fun_318(txt.clone(), ret_0, a_varDecls.clone(), a_ty.clone(), a_context.clone(), a_cr.clone(), a_ecr.clone(), a_afterExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
...
fn fun_320(mut in_txt: Tpl::Text, mut in_a_box: Tpl::Text, mut in_a_varDecls: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_afterExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt, in_a_box, in_a_varDecls, in_a_ty, in_a_ecr, in_a_afterExp, in_a_context, in_a_cr)) {
        (txt, Tpl::Text::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }, a_varDecls, a_ty, a_ecr, a_afterExp, a_context, a_cr) => {
            ...
            let mut a_afterExp = (*a_afterExp).clone();
            ret_0 = SimCodeFunctionUtil::crefIsScalar(a_cr.clone(), a_context.clone())?;
            (txt, a_varDecls, a_afterExp) = fun_319(txt.clone(), ret_0, a_varDecls.clone(), a_ty.clone(), a_context.clone(), a_ecr.clone(), a_afterExp.clone(), a_cr.clone())?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
...
pub(crate) fn daeExpCrefLhs2Xml(mut in_txt: Tpl::Text, mut in_a_ecr: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_afterExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_afterExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_afterExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ecr, in_a_context, in_a_afterExp, in_a_varDecls)) {
        (txt, i_ecr @ Deref @ DAE::Exp::CREF { componentRef: i_cr, ty: i_ty }, a_context, a_afterExp, a_varDecls) => {
            ...
            (txt, a_varDecls, a_afterExp) = fun_320(txt.clone(), l_box, a_varDecls.clone(), i_ty.clone(), i_ecr.clone(), a_afterExp.clone(), a_context.clone(), i_cr.clone())?;
            (txt.clone(), a_afterExp.clone(), a_varDecls.clone())
        },
...
fn fun_322(mut in_txt: Tpl::Text, mut in_a_sub: Arc<DAE::Subscript>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_afterExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_afterExp) = (::match_deref::match_deref! { match &((in_txt, in_a_sub, in_a_varDecls, in_a_afterExp, in_a_context)) {
        (txt, Deref @ DAE::Subscript::INDEX { exp: i_exp }, a_varDecls, a_afterExp, a_context) => {
            ...
            l_str = Tpl::writeText(l_str, l_expPart)?;
            l_str = Tpl::writeTok(l_str, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("), 'S'")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_str)?;
            (txt.clone(), a_varDecls.clone(), a_afterExp.clone())
        },
...
fn lm_323(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_afterExp, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_afterExp.clone()))
...
pub(crate) fn daeExpCrefLhsIndexSpecXml(mut txt: Tpl::Text, mut a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut a_context: SimCodeFunction::Context, mut a_afterExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    l_nridx__str = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_1)).clone())?;
    l_idx__str = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    (l_idx__str, out_a_varDecls, out_a_afterExp) = lm_323(l_idx__str, a_subs, a_varDecls, a_afterExp, a_context)?;
    l_idx__str = Tpl::popIter(l_idx__str)?;
    (l_tmp, out_a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (literal!("index_spec_t")).clone(), out_a_varDecls)?;
    out_a_afterExp = Tpl::writeTok(out_a_afterExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("create_index_spec(&")).clone() }))?;
    out_a_afterExp = Tpl::writeText(out_a_afterExp, l_tmp.clone())?;
    out_a_afterExp = Tpl::writeTok(out_a_afterExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
    out_a_afterExp = Tpl::writeText(out_a_afterExp, l_nridx__str)?;
    out_a_afterExp = Tpl::writeTok(out_a_afterExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
    out_a_afterExp = Tpl::writeText(out_a_afterExp, l_idx__str)?;
    out_a_afterExp = Tpl::writeTok(out_a_afterExp, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
    out_a_afterExp = Tpl::writeTok(out_a_afterExp, openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
    out_txt = Tpl::writeText(txt, l_tmp)?;
    Ok((out_txt, out_a_afterExp, out_a_varDecls))
}

fn lm_325(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Dimension>>>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items)) {
        (txt, Deref @ metamodelica::List::Nil) => {
            return Ok(txt.clone())
...
fn fun_326(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_ecr_componentRef: Arc<DAE::ComponentRef>, mut in_a_afterExp: Tpl::Text, mut in_a_dims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut in_a_varDecls: Tpl::Text, mut in_a_aty: Arc<DAE::Type>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_afterExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_afterExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_ecr_componentRef, in_a_afterExp, in_a_dims, in_a_varDecls, in_a_aty)) {
        ...
        (txt, _, a_ecr_componentRef, a_afterExp, a_dims, a_varDecls, a_aty) => {
            ...
            l_dimsLenStr = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_3)).clone())?;
            l_dimsValuesStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
            l_dimsValuesStr = lm_325(l_dimsValuesStr, a_dims.clone())?;
            l_dimsValuesStr = Tpl::popIter(l_dimsValuesStr)?;
            l_type = expTypeShortXml(Tpl::emptyTxt.clone(), a_aty.clone())?;
            ...
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_type)?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("*)&(")).clone() }))?;
            a_afterExp = arrayCrefXmlStr(a_afterExp.clone(), a_ecr_componentRef.clone())?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")), ")).clone() }))?;
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_dimsLenStr)?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_dimsValuesStr)?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::writeText(txt.clone(), l_tmpArr)?;
            (txt.clone(), a_afterExp.clone(), a_varDecls.clone())
...
fn lm_328(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Var>>>, mut in_a_varDecls: Tpl::Text, mut in_a_afterExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_cr: Arc<DAE::ComponentRef>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context, in_a_cr)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_afterExp, _, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_afterExp.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_v, tail: rest }, a_varDecls, a_afterExp, a_context, a_cr) => {
            ...
            let mut a_afterExp = (*a_afterExp).clone();
            ret_0 = SimCodeFunctionUtil::makeCrefRecordExp(a_cr.clone(), i_v.clone())?;
            (txt, a_afterExp, a_varDecls) = daeExpXml(txt.clone(), ret_0, a_context.clone(), a_afterExp.clone(), a_varDecls.clone())?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varDecls, in_a_afterExp, in_a_context, in_a_cr) = (txt.clone(), rest.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone(), a_cr.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn daeExpRecordCrefLhsXml(mut in_txt: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_cr: Arc<DAE::ComponentRef>, mut in_a_context: SimCodeFunction::Context, mut in_a_afterExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_afterExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_afterExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ty, in_a_cr, in_a_context, in_a_afterExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Type::T_COMPLEX { complexClassType: i_record__state, varLst: i_var__lst, .. }, a_cr, a_context, a_afterExp, a_varDecls) => {
            ...
            (l_vars, a_varDecls, a_afterExp) = lm_328(l_vars, i_var__lst.clone(), a_varDecls.clone(), a_afterExp.clone(), a_context.clone(), a_cr.clone())?;
            l_vars = Tpl::popIter(l_vars)?;
            ret_2 = ClassInfUtil::getStateName(i_record__state.clone());
            l_record__type__name = underscorePathXml(Tpl::emptyTxt.clone(), ret_2)?;
            l_ret__type = Tpl::writeText(Tpl::emptyTxt.clone(), l_record__type__name.clone())?;
            l_ret__type = Tpl::writeTok(l_ret__type, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_rettype")).clone() }))?;
            ...
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_record__type__name)?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(")).clone() }))?;
            a_afterExp = Tpl::writeText(a_afterExp.clone(), l_vars)?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
            a_afterExp = Tpl::writeTok(a_afterExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::writeText(txt.clone(), l_ret__var)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(".")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_ret__type)?;
...
fn fun_336(mut in_txt: Tpl::Text, mut in_a_operator: DAE::Operator, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_exp: Arc<DAE::Exp>, mut in_a_e2: Tpl::Text, mut in_a_e1: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_operator, in_a_varDecls, in_a_preExp, in_a_context, in_a_exp, in_a_e2, in_a_e1)) {
        ...
        (txt, DAE::Operator::ADD_ARR { ty: i_ty }, a_varDecls, a_preExp, _, _, a_e2, a_e1) => {
            ...
            (l_var, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(l_type)?).clone(), a_varDecls.clone())?;
        ...
        (txt, DAE::Operator::MUL_SCALAR_PRODUCT { ty: i_ty }, a_varDecls, a_preExp, _, _, a_e2, a_e1) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_type)?;
        ...
        (txt, DAE::Operator::MUL_MATRIX_PRODUCT { ty: i_ty }, a_varDecls, a_preExp, _, _, a_e2, a_e1) => {
            ...
            l_type = Tpl::writeText(Tpl::emptyTxt.clone(), l_typeShort)?;
            l_type = Tpl::writeTok(l_type, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("_array")).clone() }))?;
            (l_var, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(l_type)?).clone(), a_varDecls.clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<exp:Mul>\n")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), a_e1.clone())?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
...
pub(crate) fn daeExpBinaryXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, i_exp @ Deref @ DAE::Exp::BINARY { exp1: i_exp1, exp2: i_exp2, operator: i_operator }, a_context, a_preExp, a_varDecls) => {
            ...
            (txt, a_varDecls, a_preExp) = fun_336(txt.clone(), i_operator.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone(), i_exp.clone(), l_e2, l_e1)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_338(mut in_txt: Tpl::Text, mut in_a_operator: DAE::Operator, mut in_a_e: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_operator, in_a_e)) {
...
pub(crate) fn daeExpUnaryXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::UNARY { exp: i_exp, operator: i_operator }, a_context, a_preExp, a_varDecls) => {
            ...
            txt = fun_338(txt.clone(), i_operator.clone(), l_e)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_340(mut in_txt: Tpl::Text, mut in_a_operator: DAE::Operator, mut in_a_e2: Tpl::Text, mut in_a_e1: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_operator, in_a_e2, in_a_e1) {
...
pub(crate) fn daeExpLbinaryXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::LBINARY { exp1: i_exp1, exp2: i_exp2, operator: i_operator }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_e1, a_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp1.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            (l_e2, a_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp2.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            txt = fun_340(txt.clone(), i_operator.clone(), l_e2, l_e1)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_342(mut in_txt: Tpl::Text, mut in_a_operator: DAE::Operator, mut in_a_e: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_operator, in_a_e) {
...
pub(crate) fn daeExpLunaryXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::LUNARY { exp: i_exp, operator: i_operator }, a_context, a_preExp, a_varDecls) => {
            ...
            let mut a_varDecls = (*a_varDecls).clone();
            (l_e, a_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            txt = fun_342(txt.clone(), i_operator.clone(), l_e)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_344(mut in_txt: Tpl::Text, mut in_a_rel_operator: DAE::Operator, mut in_a_e2: Tpl::Text, mut in_a_e1: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_rel_operator, in_a_e2, in_a_e1)) {
...
fn fun_345(mut in_txt: Tpl::Text, mut in_a_simRel: Tpl::Text, mut in_a_rel_operator: DAE::Operator, mut in_a_rel_exp2: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_rel_exp1: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_simRel, in_a_rel_operator, in_a_rel_exp2, in_a_varDecls, in_a_preExp, in_a_context, in_a_rel_exp1)) {
        (txt, Tpl::Text::MEM_TEXT { tokens: Deref @ metamodelica::List::Nil, .. }, a_rel_operator, a_rel_exp2, a_varDecls, a_preExp, a_context, a_rel_exp1) => {
            ...
            txt = fun_344(txt.clone(), a_rel_operator.clone(), l_e2, l_e1)?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
...
pub(crate) fn daeExpRelationXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, i_rel @ Deref @ DAE::Exp::RELATION { exp1: i_rel_exp1, exp2: i_rel_exp2, operator: i_rel_operator, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            (txt, a_varDecls, a_preExp) = fun_345(txt.clone(), l_simRel, i_rel_operator.clone(), i_rel_exp2.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone(), i_rel_exp1.clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_347(mut in_txt: Tpl::Text, mut in_a_rel_operator: DAE::Operator, mut in_a_res: Tpl::Text, mut in_a_e2: Tpl::Text, mut in_a_e1: Tpl::Text, mut in_a_preExp: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_preExp) = (match (in_txt, in_a_rel_operator, in_a_res, in_a_e2, in_a_e1, in_a_preExp) {
...
fn fun_349(mut in_txt: Tpl::Text, mut in_a_rel_optionExpisASUB: Option<(Arc<DAE::Exp>, i32, i32)>, mut in_a_rel_operator: DAE::Operator, mut in_a_rel_exp2: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_rel_exp1: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_rel_optionExpisASUB, in_a_rel_operator, in_a_rel_exp2, in_a_varDecls, in_a_preExp, in_a_context, in_a_rel_exp1)) {
        (txt, None, a_rel_operator, a_rel_exp2, a_varDecls, a_preExp, a_context, a_rel_exp1) => {
            ...
            (txt, a_preExp) = fun_347(txt.clone(), a_rel_operator.clone(), l_res, l_e2, l_e1, a_preExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        (txt, Some((i_exp, _, _)), a_rel_operator, a_rel_exp2, a_varDecls, a_preExp, a_context, a_rel_exp1) => {
            ...
            (l_res, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (literal!("modelica_boolean")).clone(), a_varDecls.clone())?;
            (txt, a_preExp) = fun_348(txt.clone(), a_rel_operator.clone(), l_res, l_e2, l_e1, a_preExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
...
fn fun_352(mut in_txt: Tpl::Text, mut in_a_rel_optionExpisASUB: Option<(Arc<DAE::Exp>, i32, i32)>, mut in_a_rel_operator: DAE::Operator, mut in_a_rel_exp2: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_rel_exp1: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_rel_optionExpisASUB, in_a_rel_operator, in_a_rel_exp2, in_a_varDecls, in_a_preExp, in_a_context, in_a_rel_exp1)) {
        (txt, None, a_rel_operator, a_rel_exp2, a_varDecls, a_preExp, a_context, a_rel_exp1) => {
            ...
            (l_e2, a_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), a_rel_exp2.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            (l_res, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (literal!("modelica_boolean")).clone(), a_varDecls.clone())?;
            (txt, a_preExp) = fun_350(txt.clone(), a_rel_operator.clone(), l_res, l_e2, l_e1, a_preExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        (txt, Some((i_exp, _, _)), a_rel_operator, a_rel_exp2, a_varDecls, a_preExp, a_context, a_rel_exp1) => {
            let mut l_iterator: Tpl::Text;
            ...
            (l_res, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (literal!("modelica_boolean")).clone(), a_varDecls.clone())?;
            (l_iterator, a_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_exp.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            (txt, a_preExp) = fun_351(txt.clone(), a_rel_operator.clone(), l_res, l_e2, l_e1, a_preExp.clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        (txt, _, _, _, a_varDecls, a_preExp, _, _) => {
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
...
fn fun_353(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_rel_operator: DAE::Operator, mut in_a_rel_exp2: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_rel_exp1: Arc<DAE::Exp>, mut in_a_rel_optionExpisASUB: Option<(Arc<DAE::Exp>, i32, i32)>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_rel_operator, in_a_rel_exp2, in_a_varDecls, in_a_preExp, in_a_rel_exp1, in_a_rel_optionExpisASUB)) {
...
fn fun_355(mut in_txt: Tpl::Text, mut in_a_rel_operator: DAE::Operator, mut in_a_e2: Tpl::Text, mut in_a_e1: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_rel_operator, in_a_e2, in_a_e1) {
...
fn fun_356(mut in_txt: Tpl::Text, mut in_a_rel_optionExpisASUB: Option<(Arc<DAE::Exp>, i32, i32)>, mut in_a_rel_operator: DAE::Operator, mut in_a_rel_exp2: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_rel_exp1: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_rel_optionExpisASUB, in_a_rel_operator, in_a_rel_exp2, in_a_varDecls, in_a_preExp, in_a_context, in_a_rel_exp1)) {
        (txt, None, a_rel_operator, a_rel_exp2, a_varDecls, a_preExp, a_context, a_rel_exp1) => {
            ...
            (l_e2, a_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), a_rel_exp2.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            (l_res, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (literal!("modelica_boolean")).clone(), a_varDecls.clone())?;
            txt = fun_355(txt.clone(), a_rel_operator.clone(), l_e2, l_e1)?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        (txt, _, _, _, a_varDecls, a_preExp, _, _) => {
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
...
pub(crate) fn daeExpIfXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::IFEXP { expCond: i_expCond, expThen: i_expThen, expElse: i_expElse }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_condExp, l_preExpCond, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_expCond.clone(), a_context.clone(), l_preExpCond, a_varDecls.clone())?;
            l_resVar = Tpl::emptyTxt.clone();
            l_preExpThen = Tpl::emptyTxt.clone();
            (l_eThen, l_preExpThen, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_expThen.clone(), a_context.clone(), l_preExpThen, a_varDecls.clone())?;
            l_preExpElse = Tpl::emptyTxt.clone();
            (l_eElse, l_preExpElse, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_expElse.clone(), a_context.clone(), l_preExpElse, a_varDecls.clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("<fun:If>\n")).clone(), (literal!("  <fun:Condition>\n")).clone()], lastHasNewLine: true }))?;
            a_preExp = Tpl::pushBlock(a_preExp.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_condExp)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            a_preExp = Tpl::popBlock(a_preExp.clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("  </fun:Condition>\n")).clone(), (literal!("  <fun:Statements>\n")).clone()], lastHasNewLine: true }))?;
            a_preExp = Tpl::pushBlock(a_preExp.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_eThen)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            a_preExp = Tpl::popBlock(a_preExp.clone())?;
            ...
            a_preExp = Tpl::pushBlock(a_preExp.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_eElse)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            a_preExp = Tpl::popBlock(a_preExp.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_resVar)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_361(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_var1: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_var1) {
...
fn lm_362(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
...
fn fun_365(mut in_txt: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_argStr: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_preExp, in_a_argStr)) {
...
fn fun_366(mut in_txt: Tpl::Text, mut in_a_attr_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_attr_ty)) {
...
fn fun_367(mut in_txt: Tpl::Text, mut in_a_attr_builtin: bool, mut in_a_attr_ty: Arc<DAE::Type>, mut in_a_funName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_attr_builtin, in_a_attr_ty, in_a_funName)) {
...
fn fun_368(mut in_txt: Tpl::Text, mut in_a_attr_ty: Arc<DAE::Type>, mut in_a_varDecls: Tpl::Text, mut in_a_retType: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_attr_ty, in_a_varDecls, in_a_retType)) {
...
fn fun_369(mut in_txt: Tpl::Text, mut in_a_attr_builtin: bool, mut in_a_builtinFunctionName: Tpl::Text, mut in_a_result: Tpl::Text, mut in_a_funName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_attr_builtin, in_a_builtinFunctionName, in_a_result, in_a_funName) {
...
fn fun_370(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_builtinFunctionName: Tpl::Text, mut in_a_result: Tpl::Text, mut in_a_funName: Tpl::Text) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_builtinFunctionName, in_a_result, in_a_funName)) {
...
pub(crate) fn daeExpCallXml(mut in_txt: Tpl::Text, mut in_a_call: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_call, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "DIVISION" }, expLst: Deref @ metamodelica::List::Cons { head: i_e1, tail: Deref @ metamodelica::List::Cons { head: i_e2, tail: Deref @ metamodelica::List::Cons { head: Deref @ DAE::Exp::SCONST { string: i_string }, tail: Deref @ metamodelica::List::Nil } } }, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            l_var3 = Tpl::writeStr(Tpl::emptyTxt.clone(), (ret_3).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<exp:Div>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_var1)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_var2)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</exp:Div>")).clone() }))?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        ...
        (txt, i_exp @ Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "DIVISION_ARRAY_SCALAR" }, .. }, _, a_preExp, a_varDecls) => {
            ...
            txt_6 = ExpressionDumpTpl::dumpExp(txt_6, i_exp.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3088, 11), (Tpl::textString(txt_6)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "der" }, expLst: Deref @ metamodelica::List::Cons { head: i_exp, tail: Deref @ metamodelica::List::Nil }, .. }, _, a_preExp, a_varDecls) => {
            ...
            txt_7 = ExpressionDumpTpl::dumpExp(txt_7, i_exp.clone(), (literal!("\"")).clone())?;
            txt_7 = Tpl::writeTok(txt_7, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3097, 11), (Tpl::textString(txt_7)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "edge" }, expLst: Deref @ metamodelica::List::Cons { head: i_exp, tail: Deref @ metamodelica::List::Nil }, .. }, _, a_preExp, a_varDecls) => {
            ...
            txt_8 = ExpressionDumpTpl::dumpExp(txt_8, i_exp.clone(), (literal!("\"")).clone())?;
            txt_8 = Tpl::writeTok(txt_8, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3105, 11), (Tpl::textString(txt_8)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "change" }, expLst: Deref @ metamodelica::List::Cons { head: i_exp, tail: Deref @ metamodelica::List::Nil }, .. }, _, a_preExp, a_varDecls) => {
            ...
            txt_9 = ExpressionDumpTpl::dumpExp(txt_9, i_exp.clone(), (literal!("\"")).clone())?;
            txt_9 = Tpl::writeTok(txt_9, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3111, 11), (Tpl::textString(txt_9)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "print" }, expLst: Deref @ metamodelica::List::Cons { head: i_e1, tail: Deref @ metamodelica::List::Nil }, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            txt = fun_361(txt.clone(), ret_10, l_var1)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sum" }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. }, expLst: Deref @ metamodelica::List::Cons { head: i_e, tail: Deref @ metamodelica::List::Nil } }, a_context, a_preExp, a_varDecls) => {
            ...
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(&")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_arr)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(")")).clone() }))?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "sqrt" }, expLst: Deref @ metamodelica::List::Cons { head: i_e1, tail: Deref @ metamodelica::List::Nil }, attr: Deref @ DAE::CallAttributes { ty: _, .. } }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_retPre, a_varDecls) = assertCommonXml(Tpl::emptyTxt.clone(), ret_14, ret_15, a_context.clone(), a_varDecls.clone(), Absyn::dummyInfo.clone())?;
            (l_argStr, a_preExp, a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_e1.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_retPre)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!("<exp:Sqrt>\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_argStr)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "max" }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. }, expLst: Deref @ metamodelica::List::Cons { head: i_array, tail: Deref @ metamodelica::List::Nil } }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_tvar, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(txt_20)?).clone(), a_varDecls.clone())?;
            ...
            a_preExp = Tpl::writeText(a_preExp.clone(), l_arr__tp__str)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(&")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_expVar)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::writeText(txt.clone(), l_tvar)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "min" }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. }, expLst: Deref @ metamodelica::List::Cons { head: i_array, tail: Deref @ metamodelica::List::Nil } }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_tvar, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(txt_21)?).clone(), a_varDecls.clone())?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_tvar.clone())?;
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "fill" }, expLst: Deref @ metamodelica::List::Cons { head: i_val, tail: i_dims }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. } }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_dimsExp, a_varDecls, a_preExp) = lm_362(l_dimsExp, i_dims.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            ...
            a_preExp = Tpl::writeText(a_preExp.clone(), l_ty__str)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(&")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_tvar.clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_valExp)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
            ret_24 = (i_dims.clone().len() as i32);
            a_preExp = Tpl::writeStr(a_preExp.clone(), (intString(ret_24)).clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_dimsExp)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            txt = Tpl::writeText(txt.clone(), l_tvar)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        ...
        (txt, i_call @ Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "vector" }, .. }, _, a_preExp, a_varDecls) => {
            ...
            txt_25 = ExpressionDumpTpl::dumpExp(txt_25, i_call.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3236, 11), (Tpl::textString(txt_25)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "cat" }, expLst: Deref @ metamodelica::List::Cons { head: i_dim, tail: i_arrays }, attr: Deref @ DAE::CallAttributes { ty: i_ty, .. } }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_arrays__exp, a_varDecls, a_preExp) = lm_363(l_arrays__exp, i_arrays.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            ...
            a_preExp = Tpl::writeText(a_preExp.clone(), l_ty__str)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_dim__exp)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", &")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_tvar.clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() }))?;
            ret_28 = (i_arrays.clone().len() as i32);
            a_preExp = Tpl::writeStr(a_preExp.clone(), (intString(ret_28)).clone())?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", &")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_arrays__exp)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(");")).clone() }))?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "rem" }, expLst: Deref @ metamodelica::List::Cons { head: i_e1, tail: Deref @ metamodelica::List::Cons { head: i_e2, tail: Deref @ metamodelica::List::Nil } }, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_typeStr)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("(")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_var1)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(",")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_var2)?;
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "delay" }, expLst: Deref @ metamodelica::List::Cons { head: Deref @ DAE::Exp::ICONST { integer: _ }, tail: Deref @ metamodelica::List::Cons { head: i_e, tail: Deref @ metamodelica::List::Cons { head: i_d, tail: Deref @ metamodelica::List::Cons { head: i_delayMax, tail: Deref @ metamodelica::List::Nil } } } }, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_var2)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_var3)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "integer" }, expLst: Deref @ metamodelica::List::Cons { head: i_toBeCasted, tail: Deref @ metamodelica::List::Nil }, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_castedVar)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "Integer" }, expLst: Deref @ metamodelica::List::Cons { head: i_toBeCasted, tail: Deref @ metamodelica::List::Nil }, .. }, a_context, a_preExp, a_varDecls) => {
            let mut l_castedVar: Tpl::Text;
        ...
        (txt, Deref @ DAE::Exp::CALL { path: Deref @ Absyn::Path::IDENT { name: Deref @ "mmc_get_field" }, expLst: Deref @ metamodelica::List::Cons { head: i_s1, tail: Deref @ metamodelica::List::Cons { head: Deref @ DAE::Exp::ICONST { integer: i_i }, tail: Deref @ metamodelica::List::Nil } }, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            a_preExp = Tpl::writeText(a_preExp.clone(), l_expPart)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("), ")).clone() }))?;
        ...
        (txt, i_exp @ Deref @ DAE::Exp::CALL { attr: Deref @ DAE::CallAttributes { tailCall: DAE::TailCall::TAIL { vars: i_tail_vars, .. }, .. }, expLst: i_expLst, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            l_res = ExpressionDumpTpl::dumpExp(l_res, i_exp.clone(), (literal!("\"")).clone())?;
            l_res = Tpl::writeTok(l_res, Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(" */\n")).clone() }))?;
            (l_res, a_preExp, a_varDecls) = daeExpTailCallXml(l_res, i_expLst.clone(), i_tail_vars.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            l_res = Tpl::writeTok(l_res, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("goto _tailrecursive;\n")).clone(), (literal!("/* TODO: Make sure any eventual dead code below is never generated */")).clone()], lastHasNewLine: false }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_res)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, i_exp @ Deref @ DAE::Exp::CALL { attr: Deref @ DAE::CallAttributes { builtin: i_attr_builtin, ty: i_attr_ty, .. }, expLst: i_expLst, path: i_path }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_argStr, a_varDecls, l_preExp) = lm_364(l_argStr, i_expLst.clone(), a_varDecls.clone(), l_preExp, a_context.clone())?;
            l_argStr = Tpl::popIter(l_argStr)?;
            l_result = fun_365(Tpl::emptyTxt.clone(), l_preExp, l_argStr)?;
            ...
            (l_retVar, a_varDecls) = fun_368(Tpl::emptyTxt.clone(), i_attr_ty.clone(), a_varDecls.clone(), l_retType)?;
            txt = fun_370(txt.clone(), i_exp.clone(), l_builtinFunctionName, l_result, l_funName)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn fun_373(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_vrest: Arc<metamodelica::List<ArcStr>>, mut in_a_erest: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_exp: Tpl::Text, mut in_a_v: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_varDecls, in_a_preExp, in_a_context, in_a_vrest, in_a_erest, in_a_exp, in_a_v)) {
...
fn fun_374(mut in_txt: Tpl::Text, mut in_a_e: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_vrest: Arc<metamodelica::List<ArcStr>>, mut in_a_erest: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_exp: Tpl::Text, mut in_a_v: ArcStr) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_e, in_a_varDecls, in_a_preExp, in_a_context, in_a_vrest, in_a_erest, in_a_exp, in_a_v)) {
        (txt, Deref @ DAE::Exp::CREF { componentRef: i_cr, ty: Deref @ DAE::Type::T_FUNCTION_REFERENCE_VAR { functionType: _ } }, a_varDecls, a_preExp, a_context, a_vrest, a_erest, a_exp, a_v) => {
            ...
            ret_1 = stringEq((a_v.clone()).clone(), (Tpl::textString(txt_0)?).clone());
            (txt, a_varDecls, a_preExp) = fun_373(txt.clone(), ret_1, a_varDecls.clone(), a_preExp.clone(), a_context.clone(), a_vrest.clone(), a_erest.clone(), a_exp.clone(), (a_v.clone()).clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
...
fn fun_375(mut in_txt: Tpl::Text, mut in_a_vs: Arc<metamodelica::List<ArcStr>>, mut in_a_erest: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_e: Arc<DAE::Exp>) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_vs, in_a_erest, in_a_varDecls, in_a_preExp, in_a_context, in_a_e)) {
        (txt, Deref @ metamodelica::List::Cons { head: i_v, tail: i_vrest }, a_erest, a_varDecls, a_preExp, a_context, a_e) => {
            ...
            (txt, a_varDecls, a_preExp) = fun_374(txt.clone(), a_e.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone(), i_vrest.clone(), a_erest.clone(), l_exp, (i_v.clone()).clone())?;
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
        },
        (txt, _, _, a_varDecls, a_preExp, _, _) => {
            (txt.clone(), a_varDecls.clone(), a_preExp.clone())
...
pub(crate) fn daeExpTailCallXml(mut in_txt: Tpl::Text, mut in_a_es: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_vs: Arc<metamodelica::List<ArcStr>>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_es, in_a_vs, in_a_context, in_a_preExp, in_a_varDecls)) {
...
fn lm_378(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
...
pub(crate) fn daeExpArrayXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::ARRAY { array: i_array, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_params, a_varDecls, a_preExp) = lm_378(l_params, i_array.clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_params)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
fn lm_380(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<metamodelica::List<Arc<DAE::Exp>>>>>, mut in_a_vars2: Tpl::Text, mut in_a_promote: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text, mut in_a_arrayTypeStr: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_vars2, in_a_promote, in_a_context, in_a_varDecls, in_a_arrayTypeStr)) {
        (txt, Deref @ metamodelica::List::Nil, a_vars2, a_promote, _, a_varDecls, _) => {
            return Ok((txt.clone(), a_vars2.clone(), a_promote.clone(), a_varDecls.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_row, tail: rest }, a_vars2, a_promote, a_context, a_varDecls, a_arrayTypeStr) => {
            ...
            a_vars2 = Tpl::writeText(a_vars2.clone(), l_tmp)?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_vars2, in_a_promote, in_a_context, in_a_varDecls, in_a_arrayTypeStr) = (txt.clone(), rest.clone(), a_vars2.clone(), a_promote.clone(), a_context.clone(), a_varDecls.clone(), a_arrayTypeStr.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn daeExpMatrixXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        ...
        (txt, Deref @ DAE::Exp::MATRIX { ty: i_m_ty, matrix: i_m_matrix, .. }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_catAlloc, l_vars2, l_promote, a_varDecls) = lm_380(l_catAlloc, i_m_matrix.clone(), l_vars2, l_promote, a_context.clone(), a_varDecls.clone(), l_arrayTypeStr.clone())?;
            l_catAlloc = Tpl::popIter(l_catAlloc)?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_promote)?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_catAlloc)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
            (l_tmp, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(l_arrayTypeStr)?).clone(), a_varDecls.clone())?;
            txt = Tpl::writeText(txt.clone(), l_tmp)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
...
fn lm_382(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_varLstStr: Tpl::Text, mut in_a_arrayTypeStr: ArcStr, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varLstStr, in_a_arrayTypeStr, in_a_varDecls, in_a_preExp, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varLstStr, _, a_varDecls, a_preExp, _) => {
            return Ok((txt.clone(), a_varLstStr.clone(), a_varDecls.clone(), a_preExp.clone()))
        },
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_varLstStr, a_arrayTypeStr, a_varDecls, a_preExp, a_context) => {
            ...
            a_varLstStr = Tpl::writeText(a_varLstStr.clone(), l_tmp)?;
            txt = Tpl::writeText(txt.clone(), l_expVar)?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_varLstStr, in_a_arrayTypeStr, in_a_varDecls, in_a_preExp, in_a_context) = (txt.clone(), rest.clone(), a_varLstStr.clone(), (a_arrayTypeStr.clone()).clone(), a_varDecls.clone(), a_preExp.clone(), a_context.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn daeExpMatrixRowXml(mut txt: Tpl::Text, mut a_row: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut a_arrayTypeStr: ArcStr, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (l_preExp2, l_varLstStr, out_a_varDecls, out_a_preExp) = lm_382(l_preExp2, a_row, l_varLstStr, (a_arrayTypeStr).clone(), a_varDecls, a_preExp, a_context)?;
    l_preExp2 = Tpl::popIter(l_preExp2)?;
    l_preExp2 = Tpl::writeTok(l_preExp2, openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
...
pub(crate) fn daeExpRangeXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::RANGE { ty: i_ty, start: i_start, stop: i_stop, step: i_step }, a_context, a_preExp, a_varDecls) => {
            ...
            (l_tmp, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(l_ty__str)?).clone(), a_varDecls.clone())?;
            ...
            a_preExp = Tpl::pushBlock(a_preExp.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_start__exp)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_step__exp)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_stop__exp)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            a_preExp = Tpl::popBlock(a_preExp.clone())?;
...
fn fun_386(mut in_txt: Tpl::Text, mut in_a_ty: Arc<DAE::Type>, mut in_a_preExp: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_expVar: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ty, in_a_preExp, in_a_exp, in_a_varDecls, in_a_expVar)) {
        ...
        (txt, Deref @ DAE::Type::T_ARRAY { ty: i_ty, .. }, a_preExp, a_exp, a_varDecls, a_expVar) => {
            ...
            (l_tvar, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(l_arrayTypeStr)?).clone(), a_varDecls.clone())?;
...
pub(crate) fn daeExpCastXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::CAST { exp: i_exp, ty: i_ty }, a_context, a_preExp, a_varDecls) => {
            ...
            (txt, a_preExp, a_varDecls) = fun_386(txt.clone(), i_ty.clone(), a_preExp.clone(), i_exp.clone(), a_varDecls.clone(), l_expVar)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, _, _, a_preExp, a_varDecls) => {
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
pub(crate) fn daeSubscriptXML(mut in_txt: Tpl::Text, mut in_a_sub: Arc<DAE::Subscript>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_sub, in_a_context, in_a_preExp, in_a_varDecls)) {
...
fn fun_389(mut in_txt: Tpl::Text, mut in_a_inExp: Arc<DAE::Exp>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_inExp, in_a_varDecls, in_a_preExp, in_a_context)) {
...
fn lm_390(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Exp>>>, mut in_a_res: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_res, in_a_context)) {
        ...
        (txt, Deref @ metamodelica::List::Cons { head: i_e, tail: rest }, a_res, a_context) => {
            ...
            (l_v, l_casePreExp, l_caseVarDecls) = daeExpXml(Tpl::emptyTxt.clone(), i_e.clone(), a_context.clone(), l_casePreExp, l_caseVarDecls)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("case ")).clone() }))?;
            txt = Tpl::writeStr(txt.clone(), (intString(x_i1)).clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(": {\n")).clone() }))?;
            txt = Tpl::pushBlock(txt.clone(), Arc::new(Tpl::BlockType::BT_INDENT { width: 2 }))?;
            txt = Tpl::writeText(txt.clone(), l_caseVarDecls)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_casePreExp)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), a_res.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" = ")).clone() }))?;
            txt = Tpl::writeText(txt.clone(), l_v)?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!(";\n")).clone(), (literal!("break;\n")).clone()], lastHasNewLine: true }))?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("}")).clone() }))?;
            txt = Tpl::nextIter(txt.clone())?;
            { (in_txt, in_items, in_a_res, in_a_context) = (txt.clone(), rest.clone(), a_res.clone(), a_context.clone()); continue '__tco; }
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_391(mut in_txt: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_ecr_ty: Arc<DAE::Type>, mut in_a_arrName: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut out_a_preExp: Tpl::Text;
    (out_txt, out_a_varDecls, out_a_preExp) = (::match_deref::match_deref! { match &((in_txt, in_a_context, in_a_varDecls, in_a_preExp, in_a_subs, in_a_ecr_ty, in_a_arrName)) {
...
fn fun_392(mut in_txt: Tpl::Text, mut in_a_inExp: Arc<DAE::Exp>, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_inExp, in_a_preExp, in_a_context, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::ASUB { exp: i_exp @ Deref @ DAE::Exp::ASUB { exp: _, .. }, .. }, a_preExp, _, a_varDecls) => {
            ...
            txt_0 = ExpressionDumpTpl::dumpExp(txt_0, i_exp.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3600, 11), (Tpl::textString(txt_0)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::ASUB { exp: i_exp @ Deref @ DAE::Exp::ARRAY { scalar: true, array: i_exp_array, .. }, sub: Deref @ metamodelica::List::Cons { head: i_idx, tail: Deref @ metamodelica::List::Nil } }, a_preExp, a_context, a_varDecls) => {
            ...
            (l_res, a_varDecls) = tempDeclXml(Tpl::emptyTxt.clone(), (Tpl::textString(txt_2)?).clone(), a_varDecls.clone())?;
            l_res = Tpl::writeTok(l_res, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" asub tmp test")).clone() }))?;
            (l_idx1, a_preExp, a_varDecls) = daeSubscriptXML(Tpl::emptyTxt.clone(), i_idx.clone(), a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            ...
            l_expl = lm_390(l_expl, i_exp_array.clone(), l_res.clone(), a_context.clone())?;
            ...
            a_preExp = Tpl::writeText(a_preExp.clone(), l_idx1)?;
            a_preExp = Tpl::writeTok(a_preExp.clone(), Arc::new(Tpl::StringToken::ST_LINE { line: (literal!(") { /* ASUB */\n")).clone() }))?;
            a_preExp = Tpl::writeText(a_preExp.clone(), l_expl)?;
            a_preExp = Tpl::softNewLine(a_preExp.clone())?;
            ...
            txt = Tpl::writeText(txt.clone(), l_res)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::ASUB { exp: i_exp @ Deref @ DAE::Exp::RANGE { ty: _, .. }, sub: Deref @ metamodelica::List::Cons { head: _, tail: Deref @ metamodelica::List::Nil } }, a_preExp, _, a_varDecls) => {
            ...
            txt_5 = ExpressionDumpTpl::dumpExp(txt_5, i_exp.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3629, 11), (Tpl::textString(txt_5)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        (txt, Deref @ DAE::Exp::ASUB { exp: i_ecr @ Deref @ DAE::Exp::CREF { ty: i_ecr_ty, .. }, sub: i_subs }, a_preExp, a_context, a_varDecls) => {
            ...
            (l_arrName, a_preExp, a_varDecls) = daeExpCrefRhsXml(Tpl::emptyTxt.clone(), ret_7, a_context.clone(), a_preExp.clone(), a_varDecls.clone())?;
            (txt, a_varDecls, a_preExp) = fun_391(txt.clone(), a_context.clone(), a_varDecls.clone(), a_preExp.clone(), i_subs.clone(), i_ecr_ty.clone(), l_arrName)?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        ...
        (txt, i_exp, a_preExp, _, a_varDecls) => {
            ...
            txt_9 = ExpressionDumpTpl::dumpExp(txt_9, i_exp.clone(), (literal!("\"")).clone())?;
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3644, 11), (Tpl::textString(txt_9)?).clone())?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
fn fun_393(mut in_txt: Tpl::Text, mut in_mArg: ArcStr, mut in_a_inExp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_mArg, in_a_inExp, in_a_context, in_a_preExp, in_a_varDecls)) {
...
pub(crate) fn daeExpAsubXml(mut txt: Tpl::Text, mut a_inExp: Arc<DAE::Exp>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = fun_393(txt, (str_1).clone(), a_inExp, a_context, a_preExp, a_varDecls)?;
    Ok((out_txt, out_a_preExp, out_a_varDecls))
}
...
fn fun_396(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_exp)) {
        ...
        (txt, i_exp) => {
            ...
            txt = error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3671, 11), (Tpl::textString(txt_0)?).clone())?;
            txt.clone()
        },
        _ => unreachable!("match_deref! exhaustiveness placeholder"),
    } });
...
pub(crate) fn daeExpSizeXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_context: SimCodeFunction::Context, mut in_a_preExp: Tpl::Text, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    (out_txt, out_a_preExp, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_context, in_a_preExp, in_a_varDecls)) {
        (txt, Deref @ DAE::Exp::SIZE { exp: i_exp @ Deref @ DAE::Exp::CREF { componentRef: _, .. }, sz: Some(i_dim) }, a_context, a_preExp, a_varDecls) => {
            ...
            txt = Tpl::writeText(txt.clone(), l_expPart)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::writeText(txt.clone(), l_dimPart)?;
            txt = Tpl::softNewLine(txt.clone())?;
            txt = Tpl::popBlock(txt.clone())?;
            txt = Tpl::writeTok(txt.clone(), Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("</exp:Size>")).clone() }))?;
            (txt.clone(), a_preExp.clone(), a_varDecls.clone())
...
pub(crate) fn daeExpSharedLiteralXml(mut txt: Tpl::Text, mut a_exp: Arc<DAE::Exp>, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> (Tpl::Text, Tpl::Text, Tpl::Text) {
    ...
    let mut out_a_preExp: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    out_txt = fun_401(txt, a_exp);
    out_a_preExp = a_preExp;
    out_a_varDecls = a_varDecls;
    (out_txt, out_a_preExp, out_a_varDecls)
}

fn lm_403(mut in_txt: Tpl::Text, mut in_items: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut in_a_varDecls: Tpl::Text, mut in_a_preExp: Tpl::Text, mut in_a_context: SimCodeFunction::Context) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_items, in_a_varDecls, in_a_preExp, in_a_context)) {
        (txt, Deref @ metamodelica::List::Nil, a_varDecls, a_preExp, _) => {
            return Ok((txt.clone(), a_varDecls.clone(), a_preExp.clone()))
...
pub(crate) fn arrayScalarRhsXml(mut txt: Tpl::Text, mut a_ty: Arc<DAE::Type>, mut a_subs: Arc<metamodelica::List<Arc<DAE::Subscript>>>, mut a_arrName: ArcStr, mut a_context: SimCodeFunction::Context, mut a_preExp: Tpl::Text, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text, Tpl::Text)> {
    ...
    let mut l_dimsLenStr: Tpl::Text;
    let mut l_arrayType: Tpl::Text;
    l_arrayType = expTypeArrayXml(Tpl::emptyTxt.clone(), a_ty)?;
    ret_2 = (a_subs.clone().len() as i32);
    l_dimsLenStr = Tpl::writeStr(Tpl::emptyTxt.clone(), (intString(ret_2)).clone())?;
    l_dimsValuesStr = Tpl::pushIter(Tpl::emptyTxt.clone(), Arc::new(Tpl::IterOptions { startIndex0: 0, empty: None, separator: Some(Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(", ")).clone() })), alignNum: 0, alignOfset: 0, alignSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE(), wrapWidth: 0, wrapSeparator: openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE() }))?;
    (l_dimsValuesStr, out_a_varDecls, out_a_preExp) = lm_403(l_dimsValuesStr, a_subs, a_varDecls, a_preExp, a_context)?;
    l_dimsValuesStr = Tpl::popIter(l_dimsValuesStr)?;
    str_4 = (Tpl::textString(l_arrayType)?).clone();
    out_txt = fun_404(txt, (str_4).clone(), l_dimsValuesStr, (a_arrName).clone())?;
    Ok((out_txt, out_a_preExp, out_a_varDecls))
}
...
pub(crate) fn outDeclXml(mut txt: Tpl::Text, mut a_ty: ArcStr, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    out_a_varDecls = Tpl::writeStr(a_varDecls, (a_ty).clone())?;
    out_a_varDecls = Tpl::writeTok(out_a_varDecls, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
    out_a_varDecls = Tpl::writeText(out_a_varDecls, l_newVar.clone())?;
    out_a_varDecls = Tpl::writeTok(out_a_varDecls, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(";")).clone() }))?;
    out_a_varDecls = Tpl::writeTok(out_a_varDecls, openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
...
fn fun_407(mut in_txt: Tpl::Text, mut in_a_ty: ArcStr, mut in_a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    let mut out_txt: Tpl::Text;
    let mut out_a_varDecls: Tpl::Text;
    (out_txt, out_a_varDecls) = (::match_deref::match_deref! { match &((in_txt, in_a_ty, in_a_varDecls)) {
...
pub(crate) fn tempDeclXml(mut txt: Tpl::Text, mut a_ty: ArcStr, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    let mut out_a_varDecls: Tpl::Text;
    let mut l_newVar: Tpl::Text;
    (l_newVar, out_a_varDecls) = fun_407(Tpl::emptyTxt.clone(), (a_ty).clone(), a_varDecls)?;
    out_txt = Tpl::writeText(txt, l_newVar)?;
    Ok((out_txt, out_a_varDecls))
}
...
pub(crate) fn tempDeclConstXml(mut txt: Tpl::Text, mut a_ty: ArcStr, mut a_val: ArcStr, mut a_varDecls: Tpl::Text) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    ret_1 = System::tmpTick();
    l_newVar = Tpl::writeStr(l_newVar, (intString(ret_1)).clone())?;
    out_a_varDecls = Tpl::writeStr(a_varDecls, (a_ty).clone())?;
    out_a_varDecls = Tpl::writeTok(out_a_varDecls, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
    out_a_varDecls = Tpl::writeText(out_a_varDecls, l_newVar.clone())?;
    out_a_varDecls = Tpl::writeTok(out_a_varDecls, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" = ")).clone() }))?;
    out_a_varDecls = Tpl::writeStr(out_a_varDecls, (a_val).clone())?;
    out_a_varDecls = Tpl::writeTok(out_a_varDecls, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(";")).clone() }))?;
    out_a_varDecls = Tpl::writeTok(out_a_varDecls, openmodelica_tpl::Tpl::StringToken::interned_ST_NEW_LINE())?;
    out_txt = Tpl::writeText(txt, l_newVar)?;
    Ok((out_txt, out_a_varDecls))
...
fn fun_410(mut in_txt: Tpl::Text, mut in_a_instDims: Arc<metamodelica::List<Arc<DAE::Dimension>>>, mut in_a_var_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_instDims, in_a_var_ty)) {
...
pub(crate) fn expTypeShortXml(mut in_txt: Tpl::Text, mut in_a_type: Arc<DAE::Type>) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_a_type)) {
        (txt, Deref @ DAE::Type::T_INTEGER { varLst: _ }) => {
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::Type::T_STRING { varLst: _ }) => {
            ...
            return Ok(fun_414(txt.clone(), ret_0)?)
        },
        (txt, Deref @ DAE::Type::T_BOOL { varLst: _ }) => {
            let mut txt = (*txt).clone();
        ...
        (txt, Deref @ DAE::Type::T_COMPLEX { complexClassType: i_complexClassType, .. }) => {
            ...
            return Ok(underscorePathXml(txt.clone(), ret_1)?)
        },
        (txt, Deref @ DAE::Type::T_METATYPE { ty: _ }) => {
            let mut txt = (*txt).clone();
        ...
        (txt, i_type) => {
            ...
            txt_2 = Tpl::writeStr(txt_2, (ret_2).clone())?;
            return Ok(error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3835, 14), (Tpl::textString(txt_2)?).clone())?)
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
fn fun_416(mut in_txt: Tpl::Text, mut in_a_array: bool, mut in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_array, in_a_ty)) {
        (txt, true, a_ty) => {
            let mut txt = (*txt).clone();
...
pub(crate) fn expTypeXml(mut txt: Tpl::Text, mut a_ty: Arc<DAE::Type>, mut a_array: bool) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = fun_416(txt, a_array, a_ty)?;
    Ok(out_txt)
}
...
fn fun_425(mut in_txt: Tpl::Text, mut in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    ...
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_ty)) {
        (txt, Deref @ DAE::Type::T_COMPLEX { complexClassType: i_complexClassType, .. }) => {
            ...
            txt = underscorePathXml(txt.clone(), ret_0)?;
            txt.clone()
        },
        (txt, i_ty) => {
            let mut txt = (*txt).clone();
...
fn fun_428(mut in_txt: Tpl::Text, mut in_a_flag: i32, mut in_a_ty: Arc<DAE::Type>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_flag, in_a_ty)) {
        (txt, 1, a_ty) => {
            let mut txt = (*txt).clone();
...
fn fun_434(mut in_txt: Tpl::Text, mut in_mArg: bool, mut in_a_flag: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_mArg, in_a_flag) {
...
pub(crate) fn expTypeFromExpFlagXml(mut in_txt: Tpl::Text, mut in_a_exp: Arc<DAE::Exp>, mut in_a_flag: i32) -> Result<Tpl::Text> {
    '__tco: loop {
        ::match_deref::match_deref! { match &((in_txt, in_a_exp, in_a_flag)) {
        ...
        (txt, Deref @ DAE::Exp::SCONST { string: _ }, a_flag) => {
            ...
            let mut txt = (*txt).clone();
            ret_0 = Config::acceptMetaModelicaGrammar()?;
            return Ok(fun_434(txt.clone(), ret_0, a_flag.clone())?)
        },
        ...
        (txt, i_exp, _) => {
            ...
            txt_7 = ExpressionDumpTpl::dumpExp(txt_7, i_exp.clone(), (literal!("\"")).clone())?;
            return Ok(error(txt.clone(), Tpl::sourceInfo((literal!("CodegenXML.tpl")).clone(), 3951, 14), (Tpl::textString(txt_7)?).clone())?)
        },
        _ => return Err(anyhow::anyhow!("match: no arm matched")),
    } }
    }
...
pub(crate) fn expTypeFromOpFlagXml(mut in_txt: Tpl::Text, mut in_a_op: DAE::Operator, mut in_a_flag: i32) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (match (in_txt, in_a_op, in_a_flag) {
...
pub(crate) fn dimensionXml(mut in_txt: Tpl::Text, mut in_a_d: Arc<DAE::Dimension>) -> Result<Tpl::Text> {
    let mut out_txt: Tpl::Text;
    out_txt = (::match_deref::match_deref! { match &((in_txt, in_a_d)) {
        (txt, Deref @ DAE::Dimension::DIM_INTEGER { integer: i_integer }) => {
            let mut txt = (*txt).clone();
            txt = Tpl::writeStr(txt.clone(), (intString(i_integer.clone())).clone())?;
            txt.clone()
...
pub(crate) fn assertCommonXml(mut txt: Tpl::Text, mut a_condition: Arc<DAE::Exp>, mut a_message: Arc<DAE::Exp>, mut a_context: SimCodeFunction::Context, mut a_varDecls: Tpl::Text, mut a_info: SourceInfo) -> Result<(Tpl::Text, Tpl::Text)> {
    ...
    (l_condVar, l_preExpCond, out_a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), a_condition, a_context.clone(), l_preExpCond, a_varDecls)?;
    (l_msgVar, l_preExpMsg, out_a_varDecls) = daeExpXml(Tpl::emptyTxt.clone(), a_message, a_context, l_preExpMsg, out_a_varDecls)?;
    out_txt = Tpl::writeTok(txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("<fun:Assertion>\n")).clone(), (literal!("  <fun:Condition>\n")).clone()], lastHasNewLine: true }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
    out_txt = Tpl::writeText(out_txt, l_condVar)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("  </fun:Condition>\n")).clone(), (literal!("  <fun:Message>\n")).clone()], lastHasNewLine: true }))?;
    out_txt = Tpl::pushBlock(out_txt, Arc::new(Tpl::BlockType::BT_INDENT { width: 4 }))?;
    out_txt = Tpl::writeText(out_txt, l_msgVar)?;
    out_txt = Tpl::softNewLine(out_txt)?;
    out_txt = Tpl::popBlock(out_txt)?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING_LIST { strList: list![(literal!("  </fun:Message>\n")).clone(), (literal!("</fun:Assertion>")).clone()], lastHasNewLine: false }))?;
    Ok((out_txt, out_a_varDecls))
}
...
pub(crate) fn error(mut txt: Tpl::Text, mut a_srcInfo: SourceInfo, mut a_errMessage: ArcStr) -> Result<Tpl::Text> {
    ...
    ret_0 = (Error::infoStr(a_srcInfo)?).clone();
    out_txt = Tpl::writeStr(out_txt, (ret_0).clone())?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!(" ")).clone() }))?;
    out_txt = Tpl::writeStr(out_txt, (a_errMessage).clone())?;
    out_txt = Tpl::writeTok(out_txt, Arc::new(Tpl::StringToken::ST_STRING { value: (literal!("\"")).clone() }))?;
